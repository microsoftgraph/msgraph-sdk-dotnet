...
namespace Microsoft.Graph
{
    ...
    public partial interface IIosVppAppRequest : IBaseRequest
    {
        ...
        IIosVppAppRequest Expand(string value);
        ...
        /// <returns>The request object to send.</returns>
        IIosVppAppRequest Expand(Expression<Func<IosVppApp, object>> expandExpression);
        ...
        /// <returns>The request object to send.</returns>
        IIosVppAppRequest Select(string value);
        ...
        /// <returns>The request object to send.</returns>
        IIosVppAppRequest Select(Expression<Func<IosVppApp, object>> selectExpression);
