...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class DirectoryObjectPartnerReferenceRequest : BaseRequest, IDirectoryObjectPartnerReferenceRequest
    {
        /// <summary>
        ...
        public DirectoryObjectPartnerReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        public IDirectoryObjectPartnerReferenceRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IDirectoryObjectPartnerReferenceRequest Expand(Expression<Func<DirectoryObjectPartnerReference, object>> expandExpression)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IDirectoryObjectPartnerReferenceRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IDirectoryObjectPartnerReferenceRequest Select(Expression<Func<DirectoryObjectPartnerReference, object>> selectExpression)
        {
        ...
        /// </summary>
        /// <param name="directoryObjectPartnerReferenceToInitialize">The <see cref="DirectoryObjectPartnerReference"/> with the collection properties to initialize.</param>
        private void InitializeCollectionProperties(DirectoryObjectPartnerReference directoryObjectPartnerReferenceToInitialize)
        {
