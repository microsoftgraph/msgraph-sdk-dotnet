...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type PlannerBucketReferenceRequest.
    /// </summary>
    public partial class PlannerBucketReferenceRequest : BaseRequest, IPlannerBucketReferenceRequest
    {
        /// <summary>
        /// Constructs a new PlannerBucketReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public PlannerBucketReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Deletes the specified PlannerBucket reference.
        /// </summary>
        ...
        /// <summary>
        /// Puts the specified PlannerBucket reference.
        /// </summary>
        /// <param name="id">The PlannerBucket reference to update.</param>
        /// <returns>The task to await.</returns>
