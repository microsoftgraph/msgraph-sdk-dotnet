...
namespace Microsoft.Graph
{
    ...
    public partial interface IWindowsUpdateForBusinessConfigurationRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<WindowsUpdateForBusinessConfiguration> GetAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The WindowsUpdateForBusinessConfiguration.</returns>
        System.Threading.Tasks.Task<WindowsUpdateForBusinessConfiguration> GetAsync(CancellationToken cancellationToken);
        ...
        System.Threading.Tasks.Task<WindowsUpdateForBusinessConfiguration> UpdateAsync(WindowsUpdateForBusinessConfiguration windowsUpdateForBusinessConfigurationToUpdate);
        ...
        /// <returns>The updated WindowsUpdateForBusinessConfiguration.</returns>
        System.Threading.Tasks.Task<WindowsUpdateForBusinessConfiguration> UpdateAsync(WindowsUpdateForBusinessConfiguration windowsUpdateForBusinessConfigurationToUpdate, CancellationToken cancellationToken);
        ...
        IWindowsUpdateForBusinessConfigurationRequest Expand(string value);
        ...
        /// <returns>The request object to send.</returns>
        IWindowsUpdateForBusinessConfigurationRequest Expand(Expression<Func<WindowsUpdateForBusinessConfiguration, object>> expandExpression);
        ...
        /// <returns>The request object to send.</returns>
        IWindowsUpdateForBusinessConfigurationRequest Select(string value);
        ...
        /// <returns>The request object to send.</returns>
        IWindowsUpdateForBusinessConfigurationRequest Select(Expression<Func<WindowsUpdateForBusinessConfiguration, object>> selectExpression);
