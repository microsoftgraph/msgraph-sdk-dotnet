...
namespace Microsoft.Graph
{
    ...
    public partial class OnenoteEntityHierarchyModelRequest : BaseRequest, IOnenoteEntityHierarchyModelRequest
    {
        ...
        public System.Threading.Tasks.Task<OnenoteEntityHierarchyModel> CreateAsync(OnenoteEntityHierarchyModel onenoteEntityHierarchyModelToCreate)
        {
            return this.CreateAsync(onenoteEntityHierarchyModelToCreate, CancellationToken.None);
        }
        ...
        /// <returns>The created OnenoteEntityHierarchyModel.</returns>
        public async System.Threading.Tasks.Task<OnenoteEntityHierarchyModel> CreateAsync(OnenoteEntityHierarchyModel onenoteEntityHierarchyModelToCreate, CancellationToken cancellationToken)
        {
        ...
        public System.Threading.Tasks.Task<OnenoteEntityHierarchyModel> UpdateAsync(OnenoteEntityHierarchyModel onenoteEntityHierarchyModelToUpdate)
        {
            return this.UpdateAsync(onenoteEntityHierarchyModelToUpdate, CancellationToken.None);
        }
