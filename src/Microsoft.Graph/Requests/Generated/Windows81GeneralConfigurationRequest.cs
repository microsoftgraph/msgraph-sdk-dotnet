...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class Windows81GeneralConfigurationRequest : BaseRequest, IWindows81GeneralConfigurationRequest
    {
        /// <summary>
        ...
        public Windows81GeneralConfigurationRequest(
            string requestUrl,
            IBaseClient client,
        ...
        public IWindows81GeneralConfigurationRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWindows81GeneralConfigurationRequest Expand(Expression<Func<Windows81GeneralConfiguration, object>> expandExpression)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWindows81GeneralConfigurationRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWindows81GeneralConfigurationRequest Select(Expression<Func<Windows81GeneralConfiguration, object>> selectExpression)
        {
        ...
        /// </summary>
        /// <param name="windows81GeneralConfigurationToInitialize">The <see cref="Windows81GeneralConfiguration"/> with the collection properties to initialize.</param>
        private void InitializeCollectionProperties(Windows81GeneralConfiguration windows81GeneralConfigurationToInitialize)
        {
