...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type ItemActivityReferenceRequest.
    /// </summary>
    public partial class ItemActivityReferenceRequest : BaseRequest, IItemActivityReferenceRequest
    {
        /// <summary>
        /// Constructs a new ItemActivityReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public ItemActivityReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Deletes the specified ItemActivity reference.
        /// </summary>
        ...
        /// <summary>
        /// Puts the specified ItemActivity reference.
        /// </summary>
        /// <param name="id">The ItemActivity reference to update.</param>
        /// <returns>The task to await.</returns>
