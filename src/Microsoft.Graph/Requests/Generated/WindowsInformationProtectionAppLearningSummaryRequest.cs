...
namespace Microsoft.Graph
{
    ...
    public partial class WindowsInformationProtectionAppLearningSummaryRequest : BaseRequest, IWindowsInformationProtectionAppLearningSummaryRequest
    {
        ...
        public System.Threading.Tasks.Task<WindowsInformationProtectionAppLearningSummary> CreateAsync(WindowsInformationProtectionAppLearningSummary windowsInformationProtectionAppLearningSummaryToCreate)
        {
            return this.CreateAsync(windowsInformationProtectionAppLearningSummaryToCreate, CancellationToken.None);
        }
        ...
        /// <returns>The created WindowsInformationProtectionAppLearningSummary.</returns>
        public async System.Threading.Tasks.Task<WindowsInformationProtectionAppLearningSummary> CreateAsync(WindowsInformationProtectionAppLearningSummary windowsInformationProtectionAppLearningSummaryToCreate, CancellationToken cancellationToken)
        {
        ...
        public System.Threading.Tasks.Task<WindowsInformationProtectionAppLearningSummary> UpdateAsync(WindowsInformationProtectionAppLearningSummary windowsInformationProtectionAppLearningSummaryToUpdate)
        {
            return this.UpdateAsync(windowsInformationProtectionAppLearningSummaryToUpdate, CancellationToken.None);
        }
        ...
        /// <returns>The updated WindowsInformationProtectionAppLearningSummary.</returns>
        public async System.Threading.Tasks.Task<WindowsInformationProtectionAppLearningSummary> UpdateAsync(WindowsInformationProtectionAppLearningSummary windowsInformationProtectionAppLearningSummaryToUpdate, CancellationToken cancellationToken)
        {
			if (windowsInformationProtectionAppLearningSummaryToUpdate.AdditionalData != null)
			{
				if (windowsInformationProtectionAppLearningSummaryToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
					windowsInformationProtectionAppLearningSummaryToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.StatusCode))
				{
					throw new ClientException(
						new Error
						{
							Code = GeneratedErrorConstants.Codes.NotAllowed,
							Message = String.Format(GeneratedErrorConstants.Messages.ResponseObjectUsedForUpdate, windowsInformationProtectionAppLearningSummaryToUpdate.GetType().Name)
						});
				}
			}
            this.ContentType = "application/json";
