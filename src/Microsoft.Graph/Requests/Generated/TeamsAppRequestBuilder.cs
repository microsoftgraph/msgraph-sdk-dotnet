...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class TeamsAppRequestBuilder : EntityRequestBuilder, ITeamsAppRequestBuilder
    {
        ...
        public new ITeamsAppRequest Request()
        {
        ...
        /// <returns>The built request.</returns>
        public new ITeamsAppRequest Request(IEnumerable<Option> options)
        {
            return new TeamsAppRequest(this.RequestUrl, this.Client, options);
        }
