...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WebAppRequest : BaseRequest, IWebAppRequest
    {
        /// <summary>
        ...
        public System.Threading.Tasks.Task<WebApp> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The WebApp.</returns>
        public async System.Threading.Tasks.Task<WebApp> GetAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            var retrievedEntity = await this.SendAsync<WebApp>(null, cancellationToken).ConfigureAwait(false);
        ...
        /// <returns>The request object to send.</returns>
        public IWebAppRequest Expand(Expression<Func<WebApp, object>> expandExpression)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWebAppRequest Select(Expression<Func<WebApp, object>> selectExpression)
        {
        ...
        /// </summary>
        /// <param name="webAppToInitialize">The <see cref="WebApp"/> with the collection properties to initialize.</param>
        private void InitializeCollectionProperties(WebApp webAppToInitialize)
        {
