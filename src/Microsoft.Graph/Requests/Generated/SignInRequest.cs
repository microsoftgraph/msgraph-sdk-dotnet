...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class SignInRequest : BaseRequest, ISignInRequest
    {
        /// <summary>
        ...
        /// <returns>The created SignIn.</returns>
        public async System.Threading.Tasks.Task<SignIn> CreateAsync(SignIn signInToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            var newEntity = await this.SendAsync<SignIn>(signInToCreate, cancellationToken).ConfigureAwait(false);
        ...
        {
            this.Method = "DELETE";
            await this.SendAsync<SignIn>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        public System.Threading.Tasks.Task<SignIn> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The SignIn.</returns>
        public async System.Threading.Tasks.Task<SignIn> GetAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            var retrievedEntity = await this.SendAsync<SignIn>(null, cancellationToken).ConfigureAwait(false);
        ...
        public System.Threading.Tasks.Task<SignIn> UpdateAsync(SignIn signInToUpdate)
        {
            return this.UpdateAsync(signInToUpdate, CancellationToken.None);
        }
        ...
        public async System.Threading.Tasks.Task<SignIn> UpdateAsync(SignIn signInToUpdate, CancellationToken cancellationToken)
        {
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            var updatedEntity = await this.SendAsync<SignIn>(signInToUpdate, cancellationToken).ConfigureAwait(false);
        ...
        public ISignInRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public ISignInRequest Expand(Expression<Func<SignIn, object>> expandExpression)
        {
        ...
        /// <returns>The request object to send.</returns>
        public ISignInRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public ISignInRequest Select(Expression<Func<SignIn, object>> selectExpression)
        {
