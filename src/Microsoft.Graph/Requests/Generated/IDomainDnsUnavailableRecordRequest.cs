...
namespace Microsoft.Graph
{
    ...
    public partial interface IDomainDnsUnavailableRecordRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<DomainDnsUnavailableRecord> GetAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The DomainDnsUnavailableRecord.</returns>
        System.Threading.Tasks.Task<DomainDnsUnavailableRecord> GetAsync(CancellationToken cancellationToken);
        ...
        System.Threading.Tasks.Task<DomainDnsUnavailableRecord> UpdateAsync(DomainDnsUnavailableRecord domainDnsUnavailableRecordToUpdate);
        ...
        /// <returns>The updated DomainDnsUnavailableRecord.</returns>
        System.Threading.Tasks.Task<DomainDnsUnavailableRecord> UpdateAsync(DomainDnsUnavailableRecord domainDnsUnavailableRecordToUpdate, CancellationToken cancellationToken);
        ...
        IDomainDnsUnavailableRecordRequest Expand(string value);
        ...
        /// <returns>The request object to send.</returns>
        IDomainDnsUnavailableRecordRequest Expand(Expression<Func<DomainDnsUnavailableRecord, object>> expandExpression);
        ...
        /// <returns>The request object to send.</returns>
        IDomainDnsUnavailableRecordRequest Select(string value);
        ...
        /// <returns>The request object to send.</returns>
        IDomainDnsUnavailableRecordRequest Select(Expression<Func<DomainDnsUnavailableRecord, object>> selectExpression);
