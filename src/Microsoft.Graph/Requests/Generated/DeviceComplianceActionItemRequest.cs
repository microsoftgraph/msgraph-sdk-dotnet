...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceComplianceActionItemRequest : BaseRequest, IDeviceComplianceActionItemRequest
    {
        ...
        public System.Threading.Tasks.Task<DeviceComplianceActionItem> CreateAsync(DeviceComplianceActionItem deviceComplianceActionItemToCreate)
        {
            return this.CreateAsync(deviceComplianceActionItemToCreate, CancellationToken.None);
        }
        ...
        /// <returns>The created DeviceComplianceActionItem.</returns>
        public async System.Threading.Tasks.Task<DeviceComplianceActionItem> CreateAsync(DeviceComplianceActionItem deviceComplianceActionItemToCreate, CancellationToken cancellationToken)
        {
        ...
        public System.Threading.Tasks.Task<DeviceComplianceActionItem> UpdateAsync(DeviceComplianceActionItem deviceComplianceActionItemToUpdate)
        {
            return this.UpdateAsync(deviceComplianceActionItemToUpdate, CancellationToken.None);
        }
        ...
        /// <returns>The updated DeviceComplianceActionItem.</returns>
        public async System.Threading.Tasks.Task<DeviceComplianceActionItem> UpdateAsync(DeviceComplianceActionItem deviceComplianceActionItemToUpdate, CancellationToken cancellationToken)
        {
