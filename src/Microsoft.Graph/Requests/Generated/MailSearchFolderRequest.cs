...
namespace Microsoft.Graph
{
    ...
    public partial class MailSearchFolderRequest : BaseRequest, IMailSearchFolderRequest
    {
        ...
        public System.Threading.Tasks.Task<MailSearchFolder> CreateAsync(MailSearchFolder mailSearchFolderToCreate)
        {
            return this.CreateAsync(mailSearchFolderToCreate, CancellationToken.None);
        }
        ...
        /// <returns>The created MailSearchFolder.</returns>
        public async System.Threading.Tasks.Task<MailSearchFolder> CreateAsync(MailSearchFolder mailSearchFolderToCreate, CancellationToken cancellationToken)
        {
        ...
        public System.Threading.Tasks.Task<MailSearchFolder> UpdateAsync(MailSearchFolder mailSearchFolderToUpdate)
        {
            return this.UpdateAsync(mailSearchFolderToUpdate, CancellationToken.None);
        }
