...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type PlannerUserPlansCollectionReferencesRequest.
    /// </summary>
    public partial class PlannerUserPlansCollectionReferencesRequest : BaseRequest, IPlannerUserPlansCollectionReferencesRequest
    {
        /// <summary>
        /// Constructs a new PlannerUserPlansCollectionReferencesRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public PlannerUserPlansCollectionReferencesRequest(
            string requestUrl,
            IBaseClient client,
