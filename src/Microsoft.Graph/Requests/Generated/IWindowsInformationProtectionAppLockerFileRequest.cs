...
namespace Microsoft.Graph
{
    ...
    public partial interface IWindowsInformationProtectionAppLockerFileRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<WindowsInformationProtectionAppLockerFile> GetAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The WindowsInformationProtectionAppLockerFile.</returns>
        System.Threading.Tasks.Task<WindowsInformationProtectionAppLockerFile> GetAsync(CancellationToken cancellationToken);
        ...
        IWindowsInformationProtectionAppLockerFileRequest Expand(string value);
        ...
        /// <returns>The request object to send.</returns>
        IWindowsInformationProtectionAppLockerFileRequest Expand(Expression<Func<WindowsInformationProtectionAppLockerFile, object>> expandExpression);
        ...
        /// <returns>The request object to send.</returns>
        IWindowsInformationProtectionAppLockerFileRequest Select(string value);
        ...
        /// <returns>The request object to send.</returns>
        IWindowsInformationProtectionAppLockerFileRequest Select(Expression<Func<WindowsInformationProtectionAppLockerFile, object>> selectExpression);
