...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class UserEventsCollectionRequest : BaseRequest, IUserEventsCollectionRequest
    {
        /// <summary>
        ...
        {
            this.Method = "GET";
            var response = await this.SendAsync<UserEventsCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
