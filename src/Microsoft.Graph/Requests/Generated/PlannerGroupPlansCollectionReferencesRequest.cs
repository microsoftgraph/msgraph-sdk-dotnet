...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type PlannerGroupPlansCollectionReferencesRequest.
    /// </summary>
    public partial class PlannerGroupPlansCollectionReferencesRequest : BaseRequest, IPlannerGroupPlansCollectionReferencesRequest
    {
        /// <summary>
        /// Constructs a new PlannerGroupPlansCollectionReferencesRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public PlannerGroupPlansCollectionReferencesRequest(
            string requestUrl,
            IBaseClient client,
