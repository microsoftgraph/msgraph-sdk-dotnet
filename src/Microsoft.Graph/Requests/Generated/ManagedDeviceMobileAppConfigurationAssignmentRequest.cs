...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class ManagedDeviceMobileAppConfigurationAssignmentRequest : BaseRequest, IManagedDeviceMobileAppConfigurationAssignmentRequest
    {
        /// <summary>
        ...
        public ManagedDeviceMobileAppConfigurationAssignmentRequest(
            string requestUrl,
            IBaseClient client,
        ...
        public System.Threading.Tasks.Task<ManagedDeviceMobileAppConfigurationAssignment> CreateAsync(ManagedDeviceMobileAppConfigurationAssignment managedDeviceMobileAppConfigurationAssignmentToCreate)
        {
            return this.CreateAsync(managedDeviceMobileAppConfigurationAssignmentToCreate, CancellationToken.None);
        }
        ...
        {
            this.Method = "DELETE";
            await this.SendAsync<ManagedDeviceMobileAppConfigurationAssignment>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        public System.Threading.Tasks.Task<ManagedDeviceMobileAppConfigurationAssignment> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The ManagedDeviceMobileAppConfigurationAssignment.</returns>
        public async System.Threading.Tasks.Task<ManagedDeviceMobileAppConfigurationAssignment> GetAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            var retrievedEntity = await this.SendAsync<ManagedDeviceMobileAppConfigurationAssignment>(null, cancellationToken).ConfigureAwait(false);
        ...
        public System.Threading.Tasks.Task<ManagedDeviceMobileAppConfigurationAssignment> UpdateAsync(ManagedDeviceMobileAppConfigurationAssignment managedDeviceMobileAppConfigurationAssignmentToUpdate)
        {
            return this.UpdateAsync(managedDeviceMobileAppConfigurationAssignmentToUpdate, CancellationToken.None);
        }
        ...
        public IManagedDeviceMobileAppConfigurationAssignmentRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IManagedDeviceMobileAppConfigurationAssignmentRequest Expand(Expression<Func<ManagedDeviceMobileAppConfigurationAssignment, object>> expandExpression)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IManagedDeviceMobileAppConfigurationAssignmentRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IManagedDeviceMobileAppConfigurationAssignmentRequest Select(Expression<Func<ManagedDeviceMobileAppConfigurationAssignment, object>> selectExpression)
        {
