...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type PlannerTaskReferenceRequest.
    /// </summary>
    public partial class PlannerTaskReferenceRequest : BaseRequest, IPlannerTaskReferenceRequest
    {
        /// <summary>
        /// Constructs a new PlannerTaskReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public PlannerTaskReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Deletes the specified PlannerTask reference.
        /// </summary>
        ...
        /// <summary>
        /// Puts the specified PlannerTask reference.
        /// </summary>
        /// <param name="id">The PlannerTask reference to update.</param>
        /// <returns>The task to await.</returns>
