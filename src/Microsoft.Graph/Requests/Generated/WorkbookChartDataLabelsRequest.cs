...
namespace Microsoft.Graph
{
    ...
    public partial class WorkbookChartDataLabelsRequest : BaseRequest, IWorkbookChartDataLabelsRequest
    {
        ...
        {
			if (workbookChartDataLabelsToUpdate.AdditionalData != null)
			{
				if (workbookChartDataLabelsToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
					workbookChartDataLabelsToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.StatusCode))
				{
					throw new ClientException(
						new Error
						{
							Code = GeneratedErrorConstants.Codes.NotAllowed,
							Message = String.Format(GeneratedErrorConstants.Messages.ResponseObjectUsedForUpdate, workbookChartDataLabelsToUpdate.GetType().Name)
						});
				}
			}
            this.ContentType = "application/json";
