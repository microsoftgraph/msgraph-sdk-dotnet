...
namespace Microsoft.Graph.Organization.Item.Branding.Localizations.Item.SquareLogoDark
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Organization.Item.Branding.Localizations.Item.SquareLogoDark.SquareLogoDarkRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Organization.Item.Branding.Localizations.Item.SquareLogoDark.SquareLogoDarkRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Organization.Item.Branding.Localizations.Item.SquareLogoDark.SquareLogoDarkRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Organization.Item.Branding.Localizations.Item.SquareLogoDark.SquareLogoDarkRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class SquareLogoDarkRequestBuilderDeleteRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class SquareLogoDarkRequestBuilderGetRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class SquareLogoDarkRequestBuilderPutRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
    }
}
