...
namespace Microsoft.Graph.Policies.TokenIssuancePolicies {
    ...
    public class TokenIssuancePoliciesRequestBuilder : BaseRequestBuilder {
        ...
        /// </summary>
        /// <returns>A <cref="TokenIssuancePolicyCollectionResponse"></returns>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<TokenIssuancePolicy?> PostAsync(TokenIssuancePolicy body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<TokenIssuancePolicy> PostAsync(TokenIssuancePolicy body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <cref="TokenIssuancePoliciesRequestBuilder"></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
