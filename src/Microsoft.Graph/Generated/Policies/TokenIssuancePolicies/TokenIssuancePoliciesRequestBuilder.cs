...
using Microsoft.Graph.Policies.TokenIssuancePolicies.Count;
using Microsoft.Graph.Policies.TokenIssuancePolicies.Item;
...
namespace Microsoft.Graph.Policies.TokenIssuancePolicies {
    ...
    public class TokenIssuancePoliciesRequestBuilder : BaseRequestBuilder {
        ...
        public TokenIssuancePoliciesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/policies/tokenIssuancePolicies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new TokenIssuancePoliciesRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<TokenIssuancePolicyCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<TokenIssuancePoliciesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<TokenIssuancePolicyCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<TokenIssuancePoliciesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<TokenIssuancePolicy?> PostAsync(TokenIssuancePolicy body, CancellationToken cancellationToken = default, Action<TokenIssuancePoliciesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<TokenIssuancePolicy> PostAsync(TokenIssuancePolicy body, CancellationToken cancellationToken = default, Action<TokenIssuancePoliciesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(TokenIssuancePolicy body, Action<TokenIssuancePoliciesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(TokenIssuancePolicy body, Action<TokenIssuancePoliciesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new TokenIssuancePoliciesRequestBuilderPostRequestConfiguration();
                requestConfiguration.Invoke(requestConfig);
                requestInfo.AddRequestOptions(requestConfig.Options);
                requestInfo.AddHeaders(requestConfig.Headers);
            }
...
#nullable restore
        ...
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
        public class TokenIssuancePoliciesRequestBuilderPostRequestConfiguration {
            /// <summary>Request headers</summary>
            public RequestHeaders Headers { get; set; }
            /// <summary>Request options</summary>
            public IList<IRequestOption> Options { get; set; }
            /// <summary>
            /// Instantiates a new tokenIssuancePoliciesRequestBuilderPostRequestConfiguration and sets the default values.
            /// </summary>
            public TokenIssuancePoliciesRequestBuilderPostRequestConfiguration() {
                Options = new List<IRequestOption>();
                Headers = new RequestHeaders();
            }
        }
