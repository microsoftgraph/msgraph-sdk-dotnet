...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<AppManagementPolicyItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<AppManagementPolicyItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AppManagementPolicy?> GetAsync(CancellationToken cancellationToken = default, Action<AppManagementPolicyItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AppManagementPolicy> GetAsync(CancellationToken cancellationToken = default, Action<AppManagementPolicyItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AppManagementPolicy?> PatchAsync(AppManagementPolicy body, CancellationToken cancellationToken = default, Action<AppManagementPolicyItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AppManagementPolicy> PatchAsync(AppManagementPolicy body, CancellationToken cancellationToken = default, Action<AppManagementPolicyItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
