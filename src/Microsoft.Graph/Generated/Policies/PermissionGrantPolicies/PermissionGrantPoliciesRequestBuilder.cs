...
namespace Microsoft.Graph.Policies.PermissionGrantPolicies {
    ...
    public class PermissionGrantPoliciesRequestBuilder : BaseRequestBuilder 
    {
        ...
        public PermissionGrantPolicyItemRequestBuilder this[string position]
        {
            get
            {
...
#nullable enable
        public async Task<PermissionGrantPolicyCollectionResponse?> GetAsync(Action<RequestConfiguration<PermissionGrantPoliciesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<PermissionGrantPolicyCollectionResponse> GetAsync(Action<RequestConfiguration<PermissionGrantPoliciesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<PermissionGrantPolicy?> PostAsync(PermissionGrantPolicy body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<PermissionGrantPolicy> PostAsync(PermissionGrantPolicy body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
...
#endif
            _ = body ?? throw new ArgumentNullException(nameof(body));
            var requestInfo = new RequestInformation(Method.POST, "{+baseurl}/policies/permissionGrantPolicies", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
        ...
        /// </summary>
        /// <returns>A <see cref="PermissionGrantPoliciesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
...
#nullable restore
        ...
        public class PermissionGrantPoliciesRequestBuilderGetRequestConfiguration : RequestConfiguration<PermissionGrantPoliciesRequestBuilderGetQueryParameters> 
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
