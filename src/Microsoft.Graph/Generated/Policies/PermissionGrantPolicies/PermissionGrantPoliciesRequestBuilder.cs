...
namespace Microsoft.Graph.Policies.PermissionGrantPolicies {
    ...
    public class PermissionGrantPoliciesRequestBuilder : BaseRequestBuilder {
        ...
        public PermissionGrantPolicyItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("permissionGrantPolicy%2Did", position);
...
#nullable enable
        public async Task<PermissionGrantPolicyCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<PermissionGrantPoliciesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PermissionGrantPolicyCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<PermissionGrantPoliciesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<PermissionGrantPolicy?> PostAsync(PermissionGrantPolicy body, CancellationToken cancellationToken = default, Action<PermissionGrantPoliciesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PermissionGrantPolicy> PostAsync(PermissionGrantPolicy body, CancellationToken cancellationToken = default, Action<PermissionGrantPoliciesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
