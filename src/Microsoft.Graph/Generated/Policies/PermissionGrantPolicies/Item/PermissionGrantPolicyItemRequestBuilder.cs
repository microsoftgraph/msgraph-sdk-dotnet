...
using Microsoft.Graph.Policies.PermissionGrantPolicies.Item.Excludes;
using Microsoft.Graph.Policies.PermissionGrantPolicies.Item.Includes;
...
#nullable enable
        public async Task<Stream?> DeleteAsync(Action<PermissionGrantPolicyItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Stream> DeleteAsync(Action<PermissionGrantPolicyItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
