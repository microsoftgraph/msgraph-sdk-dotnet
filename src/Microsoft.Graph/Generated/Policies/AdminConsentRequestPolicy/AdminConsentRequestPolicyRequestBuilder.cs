...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.AdminConsentRequestPolicy?> GetAsync(Action<AdminConsentRequestPolicyRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.AdminConsentRequestPolicy> GetAsync(Action<AdminConsentRequestPolicyRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.AdminConsentRequestPolicy?> PatchAsync(Microsoft.Graph.Models.AdminConsentRequestPolicy body, Action<AdminConsentRequestPolicyRequestBuilderPatchRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.AdminConsentRequestPolicy> PatchAsync(Microsoft.Graph.Models.AdminConsentRequestPolicy body, Action<AdminConsentRequestPolicyRequestBuilderPatchRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
