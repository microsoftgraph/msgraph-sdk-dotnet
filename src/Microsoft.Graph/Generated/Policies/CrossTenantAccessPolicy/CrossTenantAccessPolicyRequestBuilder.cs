...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.CrossTenantAccessPolicy?> GetAsync(CancellationToken cancellationToken = default, Action<CrossTenantAccessPolicyRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.CrossTenantAccessPolicy> GetAsync(CancellationToken cancellationToken = default, Action<CrossTenantAccessPolicyRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.CrossTenantAccessPolicy?> PatchAsync(Microsoft.Graph.Models.CrossTenantAccessPolicy body, CancellationToken cancellationToken = default, Action<CrossTenantAccessPolicyRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.CrossTenantAccessPolicy> PatchAsync(Microsoft.Graph.Models.CrossTenantAccessPolicy body, CancellationToken cancellationToken = default, Action<CrossTenantAccessPolicyRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
