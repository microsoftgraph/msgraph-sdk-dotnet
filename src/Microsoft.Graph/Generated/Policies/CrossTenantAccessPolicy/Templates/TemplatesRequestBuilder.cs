...
namespace Microsoft.Graph.Policies.CrossTenantAccessPolicy.Templates
{
    ...
    public class TemplatesRequestBuilder : BaseRequestBuilder
    {
        ...
        public MultiTenantOrganizationIdentitySynchronizationRequestBuilder MultiTenantOrganizationIdentitySynchronization
        {
            get => new MultiTenantOrganizationIdentitySynchronizationRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public MultiTenantOrganizationPartnerConfigurationRequestBuilder MultiTenantOrganizationPartnerConfiguration
        {
            get => new MultiTenantOrganizationPartnerConfigurationRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<PolicyTemplate?> GetAsync(Action<RequestConfiguration<TemplatesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<PolicyTemplate> GetAsync(Action<RequestConfiguration<TemplatesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<PolicyTemplate?> PatchAsync(PolicyTemplate body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<PolicyTemplate> PatchAsync(PolicyTemplate body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
