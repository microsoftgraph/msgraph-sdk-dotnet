...
#nullable enable
        public async Task<CrossTenantAccessPolicyConfigurationPartnerCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<PartnersRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<CrossTenantAccessPolicyConfigurationPartnerCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<PartnersRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<CrossTenantAccessPolicyConfigurationPartner?> PostAsync(CrossTenantAccessPolicyConfigurationPartner body, CancellationToken cancellationToken = default, Action<PartnersRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<CrossTenantAccessPolicyConfigurationPartner> PostAsync(CrossTenantAccessPolicyConfigurationPartner body, CancellationToken cancellationToken = default, Action<PartnersRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
