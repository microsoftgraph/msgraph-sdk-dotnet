...
using Microsoft.Graph.Policies.AuthenticationStrengthPolicies.Count;
using Microsoft.Graph.Policies.AuthenticationStrengthPolicies.Item;
...
#nullable enable
        public async Task<AuthenticationStrengthPolicyCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<AuthenticationStrengthPoliciesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AuthenticationStrengthPolicyCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AuthenticationStrengthPoliciesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AuthenticationStrengthPolicy?> PostAsync(AuthenticationStrengthPolicy body, CancellationToken cancellationToken = default, Action<AuthenticationStrengthPoliciesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AuthenticationStrengthPolicy> PostAsync(AuthenticationStrengthPolicy body, CancellationToken cancellationToken = default, Action<AuthenticationStrengthPoliciesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
