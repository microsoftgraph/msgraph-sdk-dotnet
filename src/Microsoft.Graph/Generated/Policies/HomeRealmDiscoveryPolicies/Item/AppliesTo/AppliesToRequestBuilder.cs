...
using Microsoft.Graph.Policies.HomeRealmDiscoveryPolicies.Item.AppliesTo.Count;
using Microsoft.Graph.Policies.HomeRealmDiscoveryPolicies.Item.AppliesTo.Item;
...
namespace Microsoft.Graph.Policies.HomeRealmDiscoveryPolicies.Item.AppliesTo {
    ...
    public class AppliesToRequestBuilder : BaseRequestBuilder {
        ...
        public AppliesToRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/policies/homeRealmDiscoveryPolicies/{homeRealmDiscoveryPolicy%2Did}/appliesTo{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AppliesToRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AppliesToRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/policies/homeRealmDiscoveryPolicies/{homeRealmDiscoveryPolicy%2Did}/appliesTo{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
