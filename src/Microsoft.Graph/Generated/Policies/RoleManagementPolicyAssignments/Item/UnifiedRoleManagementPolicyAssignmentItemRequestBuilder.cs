...
using Microsoft.Graph.Policies.RoleManagementPolicyAssignments.Item.Policy;
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<UnifiedRoleManagementPolicyAssignmentItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<UnifiedRoleManagementPolicyAssignmentItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<UnifiedRoleManagementPolicyAssignment?> GetAsync(CancellationToken cancellationToken = default, Action<UnifiedRoleManagementPolicyAssignmentItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UnifiedRoleManagementPolicyAssignment> GetAsync(CancellationToken cancellationToken = default, Action<UnifiedRoleManagementPolicyAssignmentItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<UnifiedRoleManagementPolicyAssignment?> PatchAsync(UnifiedRoleManagementPolicyAssignment body, CancellationToken cancellationToken = default, Action<UnifiedRoleManagementPolicyAssignmentItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UnifiedRoleManagementPolicyAssignment> PatchAsync(UnifiedRoleManagementPolicyAssignment body, CancellationToken cancellationToken = default, Action<UnifiedRoleManagementPolicyAssignmentItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
