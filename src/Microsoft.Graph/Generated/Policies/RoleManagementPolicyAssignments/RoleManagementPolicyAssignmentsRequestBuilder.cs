...
using Microsoft.Graph.Policies.RoleManagementPolicyAssignments.Count;
using Microsoft.Graph.Policies.RoleManagementPolicyAssignments.Item;
...
#nullable enable
        public async Task<UnifiedRoleManagementPolicyAssignmentCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<RoleManagementPolicyAssignmentsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UnifiedRoleManagementPolicyAssignmentCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<RoleManagementPolicyAssignmentsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<UnifiedRoleManagementPolicyAssignment?> PostAsync(UnifiedRoleManagementPolicyAssignment body, CancellationToken cancellationToken = default, Action<RoleManagementPolicyAssignmentsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UnifiedRoleManagementPolicyAssignment> PostAsync(UnifiedRoleManagementPolicyAssignment body, CancellationToken cancellationToken = default, Action<RoleManagementPolicyAssignmentsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
