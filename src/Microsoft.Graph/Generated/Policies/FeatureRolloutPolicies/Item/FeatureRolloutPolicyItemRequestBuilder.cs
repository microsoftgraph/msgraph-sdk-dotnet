...
using Microsoft.Graph.Policies.FeatureRolloutPolicies.Item.AppliesTo;
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<FeatureRolloutPolicyItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<FeatureRolloutPolicyItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<FeatureRolloutPolicy?> GetAsync(CancellationToken cancellationToken = default, Action<FeatureRolloutPolicyItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<FeatureRolloutPolicy> GetAsync(CancellationToken cancellationToken = default, Action<FeatureRolloutPolicyItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<FeatureRolloutPolicy?> PatchAsync(FeatureRolloutPolicy body, CancellationToken cancellationToken = default, Action<FeatureRolloutPolicyItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<FeatureRolloutPolicy> PatchAsync(FeatureRolloutPolicy body, CancellationToken cancellationToken = default, Action<FeatureRolloutPolicyItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
