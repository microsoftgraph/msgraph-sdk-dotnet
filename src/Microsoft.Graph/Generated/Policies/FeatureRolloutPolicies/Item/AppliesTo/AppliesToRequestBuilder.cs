...
namespace Microsoft.Graph.Policies.FeatureRolloutPolicies.Item.AppliesTo
{
    ...
    public class AppliesToRequestBuilder : BaseRequestBuilder
    {
        ...
        public Microsoft.Graph.Policies.FeatureRolloutPolicies.Item.AppliesTo.Count.CountRequestBuilder Count
        {
            get => new Microsoft.Graph.Policies.FeatureRolloutPolicies.Item.AppliesTo.Count.CountRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to manage the collection of policyRoot entities.</summary>
        public Microsoft.Graph.Policies.FeatureRolloutPolicies.Item.AppliesTo.Ref.RefRequestBuilder Ref
        {
            get => new Microsoft.Graph.Policies.FeatureRolloutPolicies.Item.AppliesTo.Ref.RefRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        /// <returns>A <see cref="Microsoft.Graph.Policies.FeatureRolloutPolicies.Item.AppliesTo.Item.DirectoryObjectItemRequestBuilder"/></returns>
        public Microsoft.Graph.Policies.FeatureRolloutPolicies.Item.AppliesTo.Item.DirectoryObjectItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("directoryObject%2Did", position);
                return new Microsoft.Graph.Policies.FeatureRolloutPolicies.Item.AppliesTo.Item.DirectoryObjectItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Policies.FeatureRolloutPolicies.Item.AppliesTo.AppliesToRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Microsoft.Graph.Models.DirectoryObjectCollectionResponse?> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Policies.FeatureRolloutPolicies.Item.AppliesTo.AppliesToRequestBuilder.AppliesToRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.DirectoryObjectCollectionResponse> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Policies.FeatureRolloutPolicies.Item.AppliesTo.AppliesToRequestBuilder.AppliesToRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Policies.FeatureRolloutPolicies.Item.AppliesTo.AppliesToRequestBuilder.AppliesToRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Policies.FeatureRolloutPolicies.Item.AppliesTo.AppliesToRequestBuilder.AppliesToRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Policies.FeatureRolloutPolicies.Item.AppliesTo.AppliesToRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Policies.FeatureRolloutPolicies.Item.AppliesTo.AppliesToRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Policies.FeatureRolloutPolicies.Item.AppliesTo.AppliesToRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Nullable. Specifies a list of directoryObject resources that feature is enabled for.
        /// </summary>
...
#nullable restore
        ...
        public class AppliesToRequestBuilderGetRequestConfiguration : RequestConfiguration<Microsoft.Graph.Policies.FeatureRolloutPolicies.Item.AppliesTo.AppliesToRequestBuilder.AppliesToRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
