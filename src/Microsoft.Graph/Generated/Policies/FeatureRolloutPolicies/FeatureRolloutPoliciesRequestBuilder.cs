...
#nullable enable
        public async Task<FeatureRolloutPolicyCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<FeatureRolloutPoliciesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<FeatureRolloutPolicyCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<FeatureRolloutPoliciesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<FeatureRolloutPolicy?> PostAsync(FeatureRolloutPolicy body, CancellationToken cancellationToken = default, Action<FeatureRolloutPoliciesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<FeatureRolloutPolicy> PostAsync(FeatureRolloutPolicy body, CancellationToken cancellationToken = default, Action<FeatureRolloutPoliciesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
