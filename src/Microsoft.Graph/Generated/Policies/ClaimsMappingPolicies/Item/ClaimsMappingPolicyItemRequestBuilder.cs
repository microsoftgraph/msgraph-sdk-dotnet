...
namespace Microsoft.Graph.Policies.ClaimsMappingPolicies.Item {
    ...
    public class ClaimsMappingPolicyItemRequestBuilder : BaseRequestBuilder {
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/claimsmappingpolicy-delete?view=graph-rest-1.0" />
        /// </summary>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ClaimsMappingPolicyItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ClaimsMappingPolicyItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/claimsmappingpolicy-get?view=graph-rest-1.0" />
        /// </summary>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ClaimsMappingPolicy?> GetAsync(CancellationToken cancellationToken = default, Action<ClaimsMappingPolicyItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ClaimsMappingPolicy> GetAsync(CancellationToken cancellationToken = default, Action<ClaimsMappingPolicyItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/claimsmappingpolicy-update?view=graph-rest-1.0" />
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ClaimsMappingPolicy?> PatchAsync(ClaimsMappingPolicy body, CancellationToken cancellationToken = default, Action<ClaimsMappingPolicyItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ClaimsMappingPolicy> PatchAsync(ClaimsMappingPolicy body, CancellationToken cancellationToken = default, Action<ClaimsMappingPolicyItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
