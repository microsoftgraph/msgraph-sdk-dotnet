...
using Microsoft.Graph.Policies.ClaimsMappingPolicies.Count;
using Microsoft.Graph.Policies.ClaimsMappingPolicies.Item;
...
#nullable enable
        public async Task<ClaimsMappingPolicyCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ClaimsMappingPoliciesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ClaimsMappingPolicyCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ClaimsMappingPoliciesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ClaimsMappingPolicy?> PostAsync(ClaimsMappingPolicy body, CancellationToken cancellationToken = default, Action<ClaimsMappingPoliciesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ClaimsMappingPolicy> PostAsync(ClaimsMappingPolicy body, CancellationToken cancellationToken = default, Action<ClaimsMappingPoliciesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
