...
namespace Microsoft.Graph.Teams.Item.Schedule.OpenShifts.Item
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Teams.Item.Schedule.OpenShifts.Item.OpenShiftItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.OpenShift?> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Teams.Item.Schedule.OpenShifts.Item.OpenShiftItemRequestBuilder.OpenShiftItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.OpenShift> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Teams.Item.Schedule.OpenShifts.Item.OpenShiftItemRequestBuilder.OpenShiftItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Teams.Item.Schedule.OpenShifts.Item.OpenShiftItemRequestBuilder.OpenShiftItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Teams.Item.Schedule.OpenShifts.Item.OpenShiftItemRequestBuilder.OpenShiftItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Teams.Item.Schedule.OpenShifts.Item.OpenShiftItemRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Teams.Item.Schedule.OpenShifts.Item.OpenShiftItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class OpenShiftItemRequestBuilderGetRequestConfiguration : RequestConfiguration<Microsoft.Graph.Teams.Item.Schedule.OpenShifts.Item.OpenShiftItemRequestBuilder.OpenShiftItemRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
