...
using Microsoft.Graph.Teams.Item.Schedule.OpenShiftChangeRequests.Count;
using Microsoft.Graph.Teams.Item.Schedule.OpenShiftChangeRequests.Item;
...
namespace Microsoft.Graph.Teams.Item.Schedule.OpenShiftChangeRequests {
    ...
    public class OpenShiftChangeRequestsRequestBuilder : BaseRequestBuilder {
        ...
        public OpenShiftChangeRequestsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/teams/{team%2Did}/schedule/openShiftChangeRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new OpenShiftChangeRequestsRequestBuilder and sets the default values.
        /// </summary>
