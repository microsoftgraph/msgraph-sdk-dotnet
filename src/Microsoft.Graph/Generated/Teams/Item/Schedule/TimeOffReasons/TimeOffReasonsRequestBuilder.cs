...
using Microsoft.Graph.Teams.Item.Schedule.TimeOffReasons.Count;
using Microsoft.Graph.Teams.Item.Schedule.TimeOffReasons.Item;
...
namespace Microsoft.Graph.Teams.Item.Schedule.TimeOffReasons {
    ...
    public class TimeOffReasonsRequestBuilder : BaseRequestBuilder {
        ...
        public TimeOffReasonsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/teams/{team%2Did}/schedule/timeOffReasons{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new TimeOffReasonsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TimeOffReasonsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/teams/{team%2Did}/schedule/timeOffReasons{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select}", rawUrl) {
        }
        /// <summary>
