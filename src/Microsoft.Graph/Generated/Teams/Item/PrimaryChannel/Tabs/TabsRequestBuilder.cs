...
using Microsoft.Graph.Teams.Item.PrimaryChannel.Tabs.Count;
using Microsoft.Graph.Teams.Item.PrimaryChannel.Tabs.Item;
...
namespace Microsoft.Graph.Teams.Item.PrimaryChannel.Tabs {
    ...
    public class TabsRequestBuilder : BaseRequestBuilder {
        ...
        public TabsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/teams/{team%2Did}/primaryChannel/tabs{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new TabsRequestBuilder and sets the default values.
        /// </summary>
