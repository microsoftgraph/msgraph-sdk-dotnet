...
namespace Microsoft.Graph.Teams.Item.Unarchive {
    ...
    public class UnarchiveRequestBuilder : BaseRequestBuilder {
        ...
        public UnarchiveRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/teams/{team%2Did}/unarchive", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new UnarchiveRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public UnarchiveRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/teams/{team%2Did}/unarchive", rawUrl) {
        }
        /// <summary>
