...
using Microsoft.Graph.Teams.Item.AllChannels.Count;
using Microsoft.Graph.Teams.Item.AllChannels.Item;
...
namespace Microsoft.Graph.Teams.Item.AllChannels {
    ...
    public class AllChannelsRequestBuilder : BaseRequestBuilder {
        ...
        public AllChannelsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/teams/{team%2Did}/allChannels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AllChannelsRequestBuilder and sets the default values.
        /// </summary>
