...
using Microsoft.Graph.Teams.Item.IncomingChannels.Count;
using Microsoft.Graph.Teams.Item.IncomingChannels.Item;
...
namespace Microsoft.Graph.Teams.Item.IncomingChannels {
    ...
    public class IncomingChannelsRequestBuilder : BaseRequestBuilder {
        ...
        public IncomingChannelsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/teams/{team%2Did}/incomingChannels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new IncomingChannelsRequestBuilder and sets the default values.
        /// </summary>
