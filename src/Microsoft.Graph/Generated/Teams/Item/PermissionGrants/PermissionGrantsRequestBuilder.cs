...
using Microsoft.Graph.Teams.Item.PermissionGrants.Delta;
using Microsoft.Graph.Teams.Item.PermissionGrants.GetAvailableExtensionProperties;
using Microsoft.Graph.Teams.Item.PermissionGrants.GetByIds;
using Microsoft.Graph.Teams.Item.PermissionGrants.Item;
using Microsoft.Graph.Teams.Item.PermissionGrants.ValidateProperties;
...
namespace Microsoft.Graph.Teams.Item.PermissionGrants {
    ...
    public class PermissionGrantsRequestBuilder : BaseRequestBuilder {
        ...
        public PermissionGrantsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/teams/{team%2Did}/permissionGrants{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new PermissionGrantsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PermissionGrantsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/teams/{team%2Did}/permissionGrants{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
