...
namespace Microsoft.Graph.Teams.Item.Operations.Item {
    ...
    public class TeamsAsyncOperationItemRequestBuilder : BaseRequestBuilder {
        ...
        public TeamsAsyncOperationItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/teams/{team%2Did}/operations/{teamsAsyncOperation%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new TeamsAsyncOperationItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TeamsAsyncOperationItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/teams/{team%2Did}/operations/{teamsAsyncOperation%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
