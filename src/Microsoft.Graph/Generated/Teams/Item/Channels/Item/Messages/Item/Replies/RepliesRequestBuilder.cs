...
using Microsoft.Graph.Teams.Item.Channels.Item.Messages.Item.Replies.Count;
using Microsoft.Graph.Teams.Item.Channels.Item.Messages.Item.Replies.Item;
using Microsoft.Graph.Teams.Item.Channels.Item.Messages.Item.Replies.MicrosoftGraphDelta;
...
namespace Microsoft.Graph.Teams.Item.Channels.Item.Messages.Item.Replies {
    ...
    public class RepliesRequestBuilder {
        ...
        public Microsoft.Graph.Teams.Item.Channels.Item.Messages.Item.Replies.Item.ChatMessageItemRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("chatMessage%2Did1", position);
            return new Microsoft.Graph.Teams.Item.Channels.Item.Messages.Item.Replies.Item.ChatMessageItemRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
