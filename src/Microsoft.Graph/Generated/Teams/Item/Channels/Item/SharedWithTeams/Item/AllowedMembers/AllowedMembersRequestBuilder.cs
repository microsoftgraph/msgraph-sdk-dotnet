...
using Microsoft.Graph.Teams.Item.Channels.Item.SharedWithTeams.Item.AllowedMembers.Count;
using Microsoft.Graph.Teams.Item.Channels.Item.SharedWithTeams.Item.AllowedMembers.Item;
...
namespace Microsoft.Graph.Teams.Item.Channels.Item.SharedWithTeams.Item.AllowedMembers {
    ...
    public class AllowedMembersRequestBuilder : BaseRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AllowedMembersRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/teams/{team%2Did}/channels/{channel%2Did}/sharedWithTeams/{sharedWithChannelTeamInfo%2Did}/allowedMembers{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
