...
using Microsoft.Graph.Teams.Count;
using Microsoft.Graph.Teams.GetAllMessages;
using Microsoft.Graph.Teams.Item;
...
#nullable enable
        public async Task<TeamCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<TeamsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<TeamCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<TeamsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.Team?> PostAsync(Microsoft.Graph.Models.Team body, CancellationToken cancellationToken = default, Action<TeamsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Team> PostAsync(Microsoft.Graph.Models.Team body, CancellationToken cancellationToken = default, Action<TeamsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Models.Team body, Action<TeamsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Models.Team body, Action<TeamsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
