...
namespace Microsoft.Graph.EmployeeExperience {
    ...
    public class EmployeeExperienceRequestBuilder : BaseRequestBuilder {
        ...
        public EmployeeExperienceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/employeeExperience{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new EmployeeExperienceRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EmployeeExperienceRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/employeeExperience{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<Microsoft.Graph.Models.EmployeeExperience?> GetAsync(CancellationToken cancellationToken = default, Action<EmployeeExperienceRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.EmployeeExperience> GetAsync(CancellationToken cancellationToken = default, Action<EmployeeExperienceRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<Microsoft.Graph.Models.EmployeeExperience>(requestInfo, Microsoft.Graph.Models.EmployeeExperience.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.EmployeeExperience?> PatchAsync(Microsoft.Graph.Models.EmployeeExperience body, CancellationToken cancellationToken = default, Action<EmployeeExperienceRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.EmployeeExperience> PatchAsync(Microsoft.Graph.Models.EmployeeExperience body, CancellationToken cancellationToken = default, Action<EmployeeExperienceRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(Microsoft.Graph.Models.EmployeeExperience body, Action<EmployeeExperienceRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(Microsoft.Graph.Models.EmployeeExperience body, Action<EmployeeExperienceRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
