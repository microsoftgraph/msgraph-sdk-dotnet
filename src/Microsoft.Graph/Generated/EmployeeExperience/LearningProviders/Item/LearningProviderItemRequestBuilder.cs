...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<LearningProviderItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<LearningProviderItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<LearningProvider?> GetAsync(CancellationToken cancellationToken = default, Action<LearningProviderItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<LearningProvider> GetAsync(CancellationToken cancellationToken = default, Action<LearningProviderItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<LearningProvider?> PatchAsync(LearningProvider body, CancellationToken cancellationToken = default, Action<LearningProviderItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<LearningProvider> PatchAsync(LearningProvider body, CancellationToken cancellationToken = default, Action<LearningProviderItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
