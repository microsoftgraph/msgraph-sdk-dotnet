...
namespace Microsoft.Graph.EmployeeExperience.LearningProviders {
    ...
    public class LearningProvidersRequestBuilder : BaseRequestBuilder {
        ...
        public LearningProviderItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("learningProvider%2Did", position);
...
#nullable enable
        public async Task<LearningProviderCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<LearningProvidersRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<LearningProviderCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<LearningProvidersRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<LearningProvider?> PostAsync(LearningProvider body, CancellationToken cancellationToken = default, Action<LearningProvidersRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<LearningProvider> PostAsync(LearningProvider body, CancellationToken cancellationToken = default, Action<LearningProvidersRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
