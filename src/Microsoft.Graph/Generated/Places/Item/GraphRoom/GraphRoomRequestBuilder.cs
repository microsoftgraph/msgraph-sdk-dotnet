...
#nullable enable
        public async Task<Room?> GetAsync(CancellationToken cancellationToken = default, Action<GraphRoomRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Room> GetAsync(CancellationToken cancellationToken = default, Action<GraphRoomRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
