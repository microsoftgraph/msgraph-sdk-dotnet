...
#nullable enable
        public async Task<RoomCollectionResponse?> GetAsync(Action<RequestConfiguration<GraphRoomRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<RoomCollectionResponse> GetAsync(Action<RequestConfiguration<GraphRoomRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <cref="GraphRoomRequestBuilder"></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
