...
namespace Microsoft.Graph.Places.GraphRoom {
    ...
    public class GraphRoomRequestBuilder : BaseRequestBuilder {
        ...
        public GraphRoomRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/places/graph.room{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GraphRoomRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GraphRoomRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/places/graph.room{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<RoomCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<GraphRoomRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<RoomCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<GraphRoomRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
