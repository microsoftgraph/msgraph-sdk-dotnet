...
namespace Microsoft.Graph.GroupSettingTemplates.Item.GetMemberGroups {
    ...
    public class GetMemberGroupsRequestBuilder : BaseRequestBuilder {
        ...
        public GetMemberGroupsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groupSettingTemplates/{groupSettingTemplate%2Did}/getMemberGroups", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GetMemberGroupsRequestBuilder and sets the default values.
        /// </summary>
