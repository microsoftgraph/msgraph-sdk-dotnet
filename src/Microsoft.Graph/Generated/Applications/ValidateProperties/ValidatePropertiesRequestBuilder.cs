...
namespace Microsoft.Graph.Applications.ValidateProperties {
    ...
    public class ValidatePropertiesRequestBuilder : BaseRequestBuilder {
        ...
        public ValidatePropertiesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/applications/validateProperties", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ValidatePropertiesRequestBuilder and sets the default values.
        /// </summary>
