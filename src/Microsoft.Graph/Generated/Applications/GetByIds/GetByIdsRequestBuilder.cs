...
namespace Microsoft.Graph.Applications.GetByIds {
    ...
    public class GetByIdsRequestBuilder : BaseRequestBuilder {
        ...
        public GetByIdsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/applications/getByIds", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GetByIdsRequestBuilder and sets the default values.
        /// </summary>
