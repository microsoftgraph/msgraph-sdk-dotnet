...
namespace Microsoft.Graph.Applications.Item.AddKey {
    ...
    public class AddKeyRequestBuilder : BaseRequestBuilder {
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/application-addkey?view=graph-rest-1.0" />
        /// </summary>
...
#nullable enable
        public async Task<KeyCredential?> PostAsync(AddKeyPostRequestBody body, CancellationToken cancellationToken = default, Action<AddKeyRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<KeyCredential> PostAsync(AddKeyPostRequestBody body, CancellationToken cancellationToken = default, Action<AddKeyRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
