...
namespace Microsoft.Graph.Applications.Item.AddKey
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Applications.Item.AddKey.AddKeyRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Microsoft.Graph.Models.KeyCredential?> PostAsync(Microsoft.Graph.Applications.Item.AddKey.AddKeyPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.KeyCredential> PostAsync(Microsoft.Graph.Applications.Item.AddKey.AddKeyPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Applications.Item.AddKey.AddKeyPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Applications.Item.AddKey.AddKeyPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Applications.Item.AddKey.AddKeyRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Applications.Item.AddKey.AddKeyRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Applications.Item.AddKey.AddKeyRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
