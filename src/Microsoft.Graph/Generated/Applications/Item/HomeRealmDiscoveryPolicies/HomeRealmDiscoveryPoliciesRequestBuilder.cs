using Microsoft.Graph.Applications.Item.HomeRealmDiscoveryPolicies.Count;
using Microsoft.Graph.Applications.Item.HomeRealmDiscoveryPolicies.Item;
...
namespace Microsoft.Graph.Applications.Item.HomeRealmDiscoveryPolicies {
    ...
    public class HomeRealmDiscoveryPoliciesRequestBuilder : BaseRequestBuilder {
        ...
        public HomeRealmDiscoveryPoliciesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/applications/{application%2Did}/homeRealmDiscoveryPolicies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new HomeRealmDiscoveryPoliciesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public HomeRealmDiscoveryPoliciesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/applications/{application%2Did}/homeRealmDiscoveryPolicies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
