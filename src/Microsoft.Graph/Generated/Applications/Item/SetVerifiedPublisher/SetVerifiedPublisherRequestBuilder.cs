...
namespace Microsoft.Graph.Applications.Item.SetVerifiedPublisher {
    ...
    /// </summary>
    public class SetVerifiedPublisherRequestBuilder : BaseRequestBuilder {
        /// <summary>
        /// Instantiates a new SetVerifiedPublisherRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SetVerifiedPublisherRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/applications/{application%2Did}/setVerifiedPublisher", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SetVerifiedPublisherRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task PostAsync(SetVerifiedPublisherPostRequestBody body, CancellationToken cancellationToken = default, Action<SetVerifiedPublisherRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(SetVerifiedPublisherPostRequestBody body, CancellationToken cancellationToken = default, Action<SetVerifiedPublisherRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
