...
namespace Microsoft.Graph.Applications.Item.Logo {
    ...
    public class LogoRequestBuilder : BaseRequestBuilder {
        ...
        public LogoRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/applications/{application%2Did}/logo", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new LogoRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public LogoRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/applications/{application%2Did}/logo", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<Stream?> GetAsync(CancellationToken cancellationToken = default, Action<LogoRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Stream> GetAsync(CancellationToken cancellationToken = default, Action<LogoRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Stream?> PutAsync(Stream body, CancellationToken cancellationToken = default, Action<LogoRequestBuilderPutRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Stream> PutAsync(Stream body, CancellationToken cancellationToken = default, Action<LogoRequestBuilderPutRequestConfiguration> requestConfiguration = default) {
#endif
