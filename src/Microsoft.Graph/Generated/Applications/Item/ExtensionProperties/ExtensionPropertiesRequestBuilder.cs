...
namespace Microsoft.Graph.Applications.Item.ExtensionProperties {
    ...
    public class ExtensionPropertiesRequestBuilder : BaseRequestBuilder 
    {
        ...
        public ExtensionPropertyItemRequestBuilder this[string position]
        {
            get
            {
...
#nullable enable
        public async Task<ExtensionPropertyCollectionResponse?> GetAsync(Action<RequestConfiguration<ExtensionPropertiesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<ExtensionPropertyCollectionResponse> GetAsync(Action<RequestConfiguration<ExtensionPropertiesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ExtensionProperty?> PostAsync(ExtensionProperty body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<ExtensionProperty> PostAsync(ExtensionProperty body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
...
#endif
            _ = body ?? throw new ArgumentNullException(nameof(body));
            var requestInfo = new RequestInformation(Method.POST, "{+baseurl}/applications/{application%2Did}/extensionProperties", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
        ...
        /// </summary>
        /// <returns>A <see cref="ExtensionPropertiesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
...
#nullable restore
        ...
        public class ExtensionPropertiesRequestBuilderGetRequestConfiguration : RequestConfiguration<ExtensionPropertiesRequestBuilderGetQueryParameters> 
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
