...
namespace Microsoft.Graph.Applications.Item.Synchronization.Jobs.ValidateCredentials {
    ...
    public class ValidateCredentialsRequestBuilder : BaseRequestBuilder {
        ...
        public ValidateCredentialsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/applications/{application%2Did}/synchronization/jobs/validateCredentials", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ValidateCredentialsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ValidateCredentialsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/applications/{application%2Did}/synchronization/jobs/validateCredentials", rawUrl) {
        }
        /// <summary>
