...
namespace Microsoft.Graph.Applications.Item.Synchronization.Jobs.Item.Start
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Applications.Item.Synchronization.Jobs.Item.Start.StartRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Applications.Item.Synchronization.Jobs.Item.Start.StartRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Applications.Item.Synchronization.Jobs.Item.Start.StartRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Applications.Item.Synchronization.Jobs.Item.Start.StartRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
