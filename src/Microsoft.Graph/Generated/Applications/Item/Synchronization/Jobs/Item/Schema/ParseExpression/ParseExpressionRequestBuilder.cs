...
namespace Microsoft.Graph.Applications.Item.Synchronization.Jobs.Item.Schema.ParseExpression {
    ...
    public class ParseExpressionRequestBuilder : BaseRequestBuilder {
        ...
        public ParseExpressionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/applications/{application%2Did}/synchronization/jobs/{synchronizationJob%2Did}/schema/parseExpression", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ParseExpressionRequestBuilder and sets the default values.
        /// </summary>
