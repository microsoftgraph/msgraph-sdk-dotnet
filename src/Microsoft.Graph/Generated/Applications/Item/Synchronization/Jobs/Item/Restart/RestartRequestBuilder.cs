...
namespace Microsoft.Graph.Applications.Item.Synchronization.Jobs.Item.Restart {
    ...
    public class RestartRequestBuilder : BaseRequestBuilder {
        ...
        public RestartRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/applications/{application%2Did}/synchronization/jobs/{synchronizationJob%2Did}/restart", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RestartRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task PostAsync(RestartPostRequestBody body, CancellationToken cancellationToken = default, Action<RestartRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(RestartPostRequestBody body, CancellationToken cancellationToken = default, Action<RestartRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
