using Microsoft.Graph.Applications.Item.Synchronization.Jobs.Item.Pause;
using Microsoft.Graph.Applications.Item.Synchronization.Jobs.Item.ProvisionOnDemand;
using Microsoft.Graph.Applications.Item.Synchronization.Jobs.Item.Restart;
using Microsoft.Graph.Applications.Item.Synchronization.Jobs.Item.Schema;
using Microsoft.Graph.Applications.Item.Synchronization.Jobs.Item.Start;
using Microsoft.Graph.Applications.Item.Synchronization.Jobs.Item.ValidateCredentials;
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<SynchronizationJobItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<SynchronizationJobItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<SynchronizationJob?> GetAsync(CancellationToken cancellationToken = default, Action<SynchronizationJobItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<SynchronizationJob> GetAsync(CancellationToken cancellationToken = default, Action<SynchronizationJobItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<SynchronizationJob?> PatchAsync(SynchronizationJob body, CancellationToken cancellationToken = default, Action<SynchronizationJobItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<SynchronizationJob> PatchAsync(SynchronizationJob body, CancellationToken cancellationToken = default, Action<SynchronizationJobItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
