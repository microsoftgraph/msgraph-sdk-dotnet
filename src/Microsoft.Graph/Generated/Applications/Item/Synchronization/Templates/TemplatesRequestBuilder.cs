using Microsoft.Graph.Applications.Item.Synchronization.Templates.Count;
using Microsoft.Graph.Applications.Item.Synchronization.Templates.Item;
...
namespace Microsoft.Graph.Applications.Item.Synchronization.Templates {
    ...
    public class TemplatesRequestBuilder : BaseRequestBuilder {
        ...
        public TemplatesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/applications/{application%2Did}/synchronization/templates{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new TemplatesRequestBuilder and sets the default values.
        /// </summary>
