...
using Microsoft.Graph.Applications.Item.Synchronization.Jobs;
using Microsoft.Graph.Applications.Item.Synchronization.Secrets;
using Microsoft.Graph.Applications.Item.Synchronization.Templates;
...
namespace Microsoft.Graph.Applications.Item.Synchronization {
    ...
    public class SynchronizationRequestBuilder : BaseRequestBuilder {
        ...
        public SynchronizationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/applications/{application%2Did}/synchronization{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SynchronizationRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SynchronizationRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/applications/{application%2Did}/synchronization{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<SynchronizationRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<SynchronizationRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.Synchronization?> GetAsync(CancellationToken cancellationToken = default, Action<SynchronizationRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Synchronization> GetAsync(CancellationToken cancellationToken = default, Action<SynchronizationRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.Synchronization?> PutAsync(Microsoft.Graph.Models.Synchronization body, CancellationToken cancellationToken = default, Action<SynchronizationRequestBuilderPutRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Synchronization> PutAsync(Microsoft.Graph.Models.Synchronization body, CancellationToken cancellationToken = default, Action<SynchronizationRequestBuilderPutRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPutRequestInformation(Microsoft.Graph.Models.Synchronization body, Action<SynchronizationRequestBuilderPutRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPutRequestInformation(Microsoft.Graph.Models.Synchronization body, Action<SynchronizationRequestBuilderPutRequestConfiguration> requestConfiguration = default) {
#endif
