...
namespace Microsoft.Graph.Applications.Item.GetMemberObjects {
    ...
    public class GetMemberObjectsRequestBuilder : BaseRequestBuilder {
        ...
        public GetMemberObjectsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/applications/{application%2Did}/getMemberObjects", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GetMemberObjectsRequestBuilder and sets the default values.
        /// </summary>
