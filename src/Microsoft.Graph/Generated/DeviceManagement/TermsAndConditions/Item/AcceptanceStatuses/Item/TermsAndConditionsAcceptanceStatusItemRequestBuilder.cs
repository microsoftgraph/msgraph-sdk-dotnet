...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<TermsAndConditionsAcceptanceStatusItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<TermsAndConditionsAcceptanceStatusItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<TermsAndConditionsAcceptanceStatus?> GetAsync(CancellationToken cancellationToken = default, Action<TermsAndConditionsAcceptanceStatusItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<TermsAndConditionsAcceptanceStatus> GetAsync(CancellationToken cancellationToken = default, Action<TermsAndConditionsAcceptanceStatusItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<TermsAndConditionsAcceptanceStatus?> PatchAsync(TermsAndConditionsAcceptanceStatus body, CancellationToken cancellationToken = default, Action<TermsAndConditionsAcceptanceStatusItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<TermsAndConditionsAcceptanceStatus> PatchAsync(TermsAndConditionsAcceptanceStatus body, CancellationToken cancellationToken = default, Action<TermsAndConditionsAcceptanceStatusItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
