...
#nullable enable
        public async Task<TermsAndConditionsAcceptanceStatusCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<AcceptanceStatusesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<TermsAndConditionsAcceptanceStatusCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AcceptanceStatusesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<TermsAndConditionsAcceptanceStatus?> PostAsync(TermsAndConditionsAcceptanceStatus body, CancellationToken cancellationToken = default, Action<AcceptanceStatusesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<TermsAndConditionsAcceptanceStatus> PostAsync(TermsAndConditionsAcceptanceStatus body, CancellationToken cancellationToken = default, Action<AcceptanceStatusesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
