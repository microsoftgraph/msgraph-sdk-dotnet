...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<IosUpdateDeviceStatusItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<IosUpdateDeviceStatusItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<IosUpdateDeviceStatus?> GetAsync(CancellationToken cancellationToken = default, Action<IosUpdateDeviceStatusItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<IosUpdateDeviceStatus> GetAsync(CancellationToken cancellationToken = default, Action<IosUpdateDeviceStatusItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<IosUpdateDeviceStatus?> PatchAsync(IosUpdateDeviceStatus body, CancellationToken cancellationToken = default, Action<IosUpdateDeviceStatusItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<IosUpdateDeviceStatus> PatchAsync(IosUpdateDeviceStatus body, CancellationToken cancellationToken = default, Action<IosUpdateDeviceStatusItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
