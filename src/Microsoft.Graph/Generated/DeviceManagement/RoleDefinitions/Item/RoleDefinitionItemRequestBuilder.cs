...
namespace Microsoft.Graph.DeviceManagement.RoleDefinitions.Item
{
    ...
    public class RoleDefinitionItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public Microsoft.Graph.DeviceManagement.RoleDefinitions.Item.RoleAssignments.RoleAssignmentsRequestBuilder RoleAssignments
        {
            get => new Microsoft.Graph.DeviceManagement.RoleDefinitions.Item.RoleAssignments.RoleAssignmentsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.DeviceManagement.RoleDefinitions.Item.RoleDefinitionItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.RoleDefinition?> GetAsync(Action<RequestConfiguration<Microsoft.Graph.DeviceManagement.RoleDefinitions.Item.RoleDefinitionItemRequestBuilder.RoleDefinitionItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.RoleDefinition> GetAsync(Action<RequestConfiguration<Microsoft.Graph.DeviceManagement.RoleDefinitions.Item.RoleDefinitionItemRequestBuilder.RoleDefinitionItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.DeviceManagement.RoleDefinitions.Item.RoleDefinitionItemRequestBuilder.RoleDefinitionItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.DeviceManagement.RoleDefinitions.Item.RoleDefinitionItemRequestBuilder.RoleDefinitionItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.DeviceManagement.RoleDefinitions.Item.RoleDefinitionItemRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.DeviceManagement.RoleDefinitions.Item.RoleDefinitionItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class RoleDefinitionItemRequestBuilderGetRequestConfiguration : RequestConfiguration<Microsoft.Graph.DeviceManagement.RoleDefinitions.Item.RoleDefinitionItemRequestBuilder.RoleDefinitionItemRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
