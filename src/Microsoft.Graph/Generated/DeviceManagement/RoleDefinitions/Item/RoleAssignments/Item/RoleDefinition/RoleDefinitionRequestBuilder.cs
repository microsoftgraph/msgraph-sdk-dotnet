...
namespace Microsoft.Graph.DeviceManagement.RoleDefinitions.Item.RoleAssignments.Item.RoleDefinition {
    ...
    public class RoleDefinitionRequestBuilder : BaseRequestBuilder {
        ...
        public RoleDefinitionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/roleDefinitions/{roleDefinition%2Did}/roleAssignments/{roleAssignment%2Did}/roleDefinition{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RoleDefinitionRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RoleDefinitionRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/roleDefinitions/{roleDefinition%2Did}/roleAssignments/{roleAssignment%2Did}/roleDefinition{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<Microsoft.Graph.Models.RoleDefinition?> GetAsync(CancellationToken cancellationToken = default, Action<RoleDefinitionRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.RoleDefinition> GetAsync(CancellationToken cancellationToken = default, Action<RoleDefinitionRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
