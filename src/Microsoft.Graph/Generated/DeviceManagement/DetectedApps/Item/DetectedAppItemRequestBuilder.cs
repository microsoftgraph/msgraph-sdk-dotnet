...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DetectedAppItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DetectedAppItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DetectedApp?> PatchAsync(DetectedApp body, CancellationToken cancellationToken = default, Action<DetectedAppItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DetectedApp> PatchAsync(DetectedApp body, CancellationToken cancellationToken = default, Action<DetectedAppItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
