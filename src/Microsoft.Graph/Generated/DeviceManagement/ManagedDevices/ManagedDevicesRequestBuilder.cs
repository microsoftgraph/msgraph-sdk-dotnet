using Microsoft.Graph.DeviceManagement.ManagedDevices.Count;
using Microsoft.Graph.DeviceManagement.ManagedDevices.Item;
...
namespace Microsoft.Graph.DeviceManagement.ManagedDevices {
    ...
    public class ManagedDevicesRequestBuilder : BaseRequestBuilder {
        ...
        public ManagedDevicesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/managedDevices{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ManagedDevicesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ManagedDevicesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/managedDevices{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<ManagedDeviceCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ManagedDevicesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ManagedDeviceCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ManagedDevicesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ManagedDevice?> PostAsync(ManagedDevice body, CancellationToken cancellationToken = default, Action<ManagedDevicesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ManagedDevice> PostAsync(ManagedDevice body, CancellationToken cancellationToken = default, Action<ManagedDevicesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
