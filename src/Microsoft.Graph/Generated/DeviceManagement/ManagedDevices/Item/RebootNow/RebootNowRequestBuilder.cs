...
namespace Microsoft.Graph.DeviceManagement.ManagedDevices.Item.RebootNow {
    ...
    public class RebootNowRequestBuilder : BaseRequestBuilder {
        ...
        public RebootNowRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/rebootNow", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RebootNowRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RebootNowRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/rebootNow", rawUrl) {
        }
        /// <summary>
        /// Reboot device
        /// </summary>
...
#nullable enable
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<RebootNowRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<RebootNowRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
