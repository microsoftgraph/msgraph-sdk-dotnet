...
namespace Microsoft.Graph.DeviceManagement.ManagedDevices.Item.DeleteUserFromSharedAppleDevice {
    ...
    public class DeleteUserFromSharedAppleDeviceRequestBuilder : BaseRequestBuilder {
        ...
        public DeleteUserFromSharedAppleDeviceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/deleteUserFromSharedAppleDevice", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new DeleteUserFromSharedAppleDeviceRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DeleteUserFromSharedAppleDeviceRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/deleteUserFromSharedAppleDevice", rawUrl) {
        }
        /// <summary>
