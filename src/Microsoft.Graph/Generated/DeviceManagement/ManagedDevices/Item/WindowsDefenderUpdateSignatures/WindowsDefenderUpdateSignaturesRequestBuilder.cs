...
namespace Microsoft.Graph.DeviceManagement.ManagedDevices.Item.WindowsDefenderUpdateSignatures {
    ...
    public class WindowsDefenderUpdateSignaturesRequestBuilder : BaseRequestBuilder {
        ...
        public WindowsDefenderUpdateSignaturesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/windowsDefenderUpdateSignatures", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WindowsDefenderUpdateSignaturesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WindowsDefenderUpdateSignaturesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/windowsDefenderUpdateSignatures", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<WindowsDefenderUpdateSignaturesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<WindowsDefenderUpdateSignaturesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
