...
namespace Microsoft.Graph.DeviceManagement.ManagedDevices.Item.ShutDown {
    ...
    public class ShutDownRequestBuilder : BaseRequestBuilder {
        ...
        public ShutDownRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/shutDown", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ShutDownRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ShutDownRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/shutDown", rawUrl) {
        }
        /// <summary>
        /// Shut down device
        /// </summary>
...
#nullable enable
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<ShutDownRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<ShutDownRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
