...
namespace Microsoft.Graph.DeviceManagement.ManagedDevices.Item.ResetPasscode {
    ...
    public class ResetPasscodeRequestBuilder : BaseRequestBuilder {
        ...
        public ResetPasscodeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/resetPasscode", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ResetPasscodeRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ResetPasscodeRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/resetPasscode", rawUrl) {
        }
        /// <summary>
        /// Reset passcode
        /// </summary>
