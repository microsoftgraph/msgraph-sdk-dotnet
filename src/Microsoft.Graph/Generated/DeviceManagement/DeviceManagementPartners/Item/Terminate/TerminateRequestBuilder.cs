...
namespace Microsoft.Graph.DeviceManagement.DeviceManagementPartners.Item.Terminate
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.DeviceManagement.DeviceManagementPartners.Item.Terminate.TerminateRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.DeviceManagement.DeviceManagementPartners.Item.Terminate.TerminateRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.DeviceManagement.DeviceManagementPartners.Item.Terminate.TerminateRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.DeviceManagement.DeviceManagementPartners.Item.Terminate.TerminateRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class TerminateRequestBuilderPostRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
    }
}
