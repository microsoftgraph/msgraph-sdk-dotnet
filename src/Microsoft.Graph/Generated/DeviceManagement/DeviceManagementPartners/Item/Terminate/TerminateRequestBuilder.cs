...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="TerminateRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public TerminateRequestBuilder WithUrl(string rawUrl)
        {
            return new TerminateRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
