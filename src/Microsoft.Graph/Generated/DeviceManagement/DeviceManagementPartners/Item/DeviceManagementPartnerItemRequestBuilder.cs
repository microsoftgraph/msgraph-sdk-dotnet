using Microsoft.Graph.DeviceManagement.DeviceManagementPartners.Item.Terminate;
...
#nullable enable
        public async Task<Stream?> DeleteAsync(Action<DeviceManagementPartnerItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Stream> DeleteAsync(Action<DeviceManagementPartnerItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
