...
namespace Microsoft.Graph.DeviceManagement.DeviceManagementPartners {
    ...
    public class DeviceManagementPartnersRequestBuilder : BaseRequestBuilder {
        ...
        /// </summary>
        /// <returns>A <cref="DeviceManagementPartnerCollectionResponse"></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="ODataError">When receiving a 4XX or 5XX status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceManagementPartnerCollectionResponse?> GetAsync(Action<RequestConfiguration<DeviceManagementPartnersRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<DeviceManagementPartnerCollectionResponse> GetAsync(Action<RequestConfiguration<DeviceManagementPartnersRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceManagementPartner?> PostAsync(DeviceManagementPartner body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<DeviceManagementPartner> PostAsync(DeviceManagementPartner body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <cref="DeviceManagementPartnersRequestBuilder"></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
...
#nullable restore
        ...
        public class DeviceManagementPartnersRequestBuilderGetRequestConfiguration : RequestConfiguration<DeviceManagementPartnersRequestBuilderGetQueryParameters> {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
