...
namespace Microsoft.Graph.DeviceManagement.AuditEvents.GetAuditActivityTypesWithCategory {
    ...
    /// </summary>
    public class GetAuditActivityTypesWithCategoryRequestBuilder : BaseRequestBuilder {
        /// <summary>
...
#nullable enable
        public async Task<GetAuditActivityTypesWithCategoryResponse?> GetAsync(CancellationToken cancellationToken = default, Action<GetAuditActivityTypesWithCategoryRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GetAuditActivityTypesWithCategoryResponse> GetAsync(CancellationToken cancellationToken = default, Action<GetAuditActivityTypesWithCategoryRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
