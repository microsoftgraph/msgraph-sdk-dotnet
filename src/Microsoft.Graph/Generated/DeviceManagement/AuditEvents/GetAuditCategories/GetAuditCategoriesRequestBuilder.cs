...
namespace Microsoft.Graph.DeviceManagement.AuditEvents.GetAuditCategories {
    ...
    public class GetAuditCategoriesRequestBuilder : BaseRequestBuilder {
        ...
        /// </summary>
        /// <returns>A <cref="GetAuditCategoriesGetResponse"></returns>
...
#nullable restore
        ...
        /// Invoke function getAuditCategories
        /// </summary>
        /// <returns>A <cref="GetAuditCategoriesResponse"></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="ODataError">When receiving a 4XX or 5XX status code</exception>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <cref="GetAuditCategoriesRequestBuilder"></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
