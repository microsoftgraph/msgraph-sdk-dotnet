...
namespace Microsoft.Graph.DeviceManagement.MobileAppTroubleshootingEvents.Item {
    ...
    public class MobileAppTroubleshootingEventItemRequestBuilder : BaseRequestBuilder 
    {
        ...
        {
            get => new AppLogCollectionRequestsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<MobileAppTroubleshootingEvent?> GetAsync(Action<RequestConfiguration<MobileAppTroubleshootingEventItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<MobileAppTroubleshootingEvent> GetAsync(Action<RequestConfiguration<MobileAppTroubleshootingEventItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<MobileAppTroubleshootingEvent?> PatchAsync(MobileAppTroubleshootingEvent body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<MobileAppTroubleshootingEvent> PatchAsync(MobileAppTroubleshootingEvent body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public MobileAppTroubleshootingEventItemRequestBuilder WithUrl(string rawUrl)
        {
...
#nullable restore
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class MobileAppTroubleshootingEventItemRequestBuilderGetRequestConfiguration : RequestConfiguration<MobileAppTroubleshootingEventItemRequestBuilderGetQueryParameters> 
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
