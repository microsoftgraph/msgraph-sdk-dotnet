...
#nullable enable
        public async Task<VerifyWindowsEnrollmentAutoDiscoveryWithDomainNameResponse?> GetAsync(CancellationToken cancellationToken = default, Action<VerifyWindowsEnrollmentAutoDiscoveryWithDomainNameRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<VerifyWindowsEnrollmentAutoDiscoveryWithDomainNameResponse> GetAsync(CancellationToken cancellationToken = default, Action<VerifyWindowsEnrollmentAutoDiscoveryWithDomainNameRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
