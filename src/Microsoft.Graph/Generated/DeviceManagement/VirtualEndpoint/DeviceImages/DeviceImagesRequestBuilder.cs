...
namespace Microsoft.Graph.DeviceManagement.VirtualEndpoint.DeviceImages
{
    ...
    public class DeviceImagesRequestBuilder : BaseRequestBuilder
    {
        ...
        {
            get => new GetSourceImagesRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public CloudPcDeviceImageItemRequestBuilder this[string position]
        {
            get
            {
...
#nullable enable
        public async Task<CloudPcDeviceImageCollectionResponse?> GetAsync(Action<RequestConfiguration<DeviceImagesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<CloudPcDeviceImageCollectionResponse> GetAsync(Action<RequestConfiguration<DeviceImagesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<CloudPcDeviceImage?> PostAsync(CloudPcDeviceImage body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<CloudPcDeviceImage> PostAsync(CloudPcDeviceImage body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="DeviceImagesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
...
#nullable restore
        ...
        public class DeviceImagesRequestBuilderGetRequestConfiguration : RequestConfiguration<DeviceImagesRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
