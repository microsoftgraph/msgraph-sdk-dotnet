...
namespace Microsoft.Graph.DeviceManagement.Reports.GetPolicyNonComplianceSummaryReport {
    ...
    /// </summary>
    public class GetPolicyNonComplianceSummaryReportRequestBuilder : BaseRequestBuilder {
        /// <summary>
        ...
        public GetPolicyNonComplianceSummaryReportRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/reports/getPolicyNonComplianceSummaryReport", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GetPolicyNonComplianceSummaryReportRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetPolicyNonComplianceSummaryReportRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/reports/getPolicyNonComplianceSummaryReport", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<Stream?> PostAsync(GetPolicyNonComplianceSummaryReportPostRequestBody body, CancellationToken cancellationToken = default, Action<GetPolicyNonComplianceSummaryReportRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Stream> PostAsync(GetPolicyNonComplianceSummaryReportPostRequestBody body, CancellationToken cancellationToken = default, Action<GetPolicyNonComplianceSummaryReportRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
