...
#nullable enable
        public async Task<Stream?> PostAsync(GetConfigurationPolicyNonComplianceReportPostRequestBody body, CancellationToken cancellationToken = default, Action<GetConfigurationPolicyNonComplianceReportRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Stream> PostAsync(GetConfigurationPolicyNonComplianceReportPostRequestBody body, CancellationToken cancellationToken = default, Action<GetConfigurationPolicyNonComplianceReportRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
