...
#nullable enable
        public async Task<Stream?> PostAsync(GetPolicyNonComplianceMetadataPostRequestBody body, CancellationToken cancellationToken = default, Action<GetPolicyNonComplianceMetadataRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Stream> PostAsync(GetPolicyNonComplianceMetadataPostRequestBody body, CancellationToken cancellationToken = default, Action<GetPolicyNonComplianceMetadataRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
