...
namespace Microsoft.Graph.DeviceManagement.Reports.GetDevicesWithoutCompliancePolicyReport {
    ...
    /// </summary>
    public class GetDevicesWithoutCompliancePolicyReportRequestBuilder : BaseRequestBuilder {
        /// <summary>
        ...
        public GetDevicesWithoutCompliancePolicyReportRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/reports/getDevicesWithoutCompliancePolicyReport", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GetDevicesWithoutCompliancePolicyReportRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetDevicesWithoutCompliancePolicyReportRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/reports/getDevicesWithoutCompliancePolicyReport", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<Stream?> PostAsync(GetDevicesWithoutCompliancePolicyReportPostRequestBody body, CancellationToken cancellationToken = default, Action<GetDevicesWithoutCompliancePolicyReportRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Stream> PostAsync(GetDevicesWithoutCompliancePolicyReportPostRequestBody body, CancellationToken cancellationToken = default, Action<GetDevicesWithoutCompliancePolicyReportRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
