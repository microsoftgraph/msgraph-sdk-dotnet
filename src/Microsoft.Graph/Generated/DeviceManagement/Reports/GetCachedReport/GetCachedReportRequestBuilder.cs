...
#nullable enable
        public async Task<Stream?> PostAsync(GetCachedReportPostRequestBody body, CancellationToken cancellationToken = default, Action<GetCachedReportRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Stream> PostAsync(GetCachedReportPostRequestBody body, CancellationToken cancellationToken = default, Action<GetCachedReportRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
