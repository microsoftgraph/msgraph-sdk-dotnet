...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DeviceManagementExportJobItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DeviceManagementExportJobItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceManagementExportJob?> GetAsync(CancellationToken cancellationToken = default, Action<DeviceManagementExportJobItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceManagementExportJob> GetAsync(CancellationToken cancellationToken = default, Action<DeviceManagementExportJobItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceManagementExportJob?> PatchAsync(DeviceManagementExportJob body, CancellationToken cancellationToken = default, Action<DeviceManagementExportJobItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceManagementExportJob> PatchAsync(DeviceManagementExportJob body, CancellationToken cancellationToken = default, Action<DeviceManagementExportJobItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
