...
#nullable enable
        public async Task<Stream?> PostAsync(GetConfigurationSettingNonComplianceReportPostRequestBody body, CancellationToken cancellationToken = default, Action<GetConfigurationSettingNonComplianceReportRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Stream> PostAsync(GetConfigurationSettingNonComplianceReportPostRequestBody body, CancellationToken cancellationToken = default, Action<GetConfigurationSettingNonComplianceReportRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
