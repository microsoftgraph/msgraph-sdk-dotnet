...
namespace Microsoft.Graph.DeviceManagement.DeviceCompliancePolicies.Item.Assignments {
    ...
    public class AssignmentsRequestBuilder : BaseRequestBuilder {
        ...
        /// <returns>A <see cref="DeviceCompliancePolicyAssignmentItemRequestBuilder"/></returns>
...
#nullable enable
        public async Task<DeviceCompliancePolicyAssignmentCollectionResponse?> GetAsync(Action<RequestConfiguration<AssignmentsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<DeviceCompliancePolicyAssignmentCollectionResponse> GetAsync(Action<RequestConfiguration<AssignmentsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceCompliancePolicyAssignment?> PostAsync(DeviceCompliancePolicyAssignment body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<DeviceCompliancePolicyAssignment> PostAsync(DeviceCompliancePolicyAssignment body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
