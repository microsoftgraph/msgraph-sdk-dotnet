...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DeviceComplianceScheduledActionForRuleItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DeviceComplianceScheduledActionForRuleItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceComplianceScheduledActionForRule?> GetAsync(CancellationToken cancellationToken = default, Action<DeviceComplianceScheduledActionForRuleItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceComplianceScheduledActionForRule> GetAsync(CancellationToken cancellationToken = default, Action<DeviceComplianceScheduledActionForRuleItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceComplianceScheduledActionForRule?> PatchAsync(DeviceComplianceScheduledActionForRule body, CancellationToken cancellationToken = default, Action<DeviceComplianceScheduledActionForRuleItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceComplianceScheduledActionForRule> PatchAsync(DeviceComplianceScheduledActionForRule body, CancellationToken cancellationToken = default, Action<DeviceComplianceScheduledActionForRuleItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
