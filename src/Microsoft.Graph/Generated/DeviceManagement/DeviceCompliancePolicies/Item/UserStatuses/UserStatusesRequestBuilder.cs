using Microsoft.Graph.DeviceManagement.DeviceCompliancePolicies.Item.UserStatuses.Count;
using Microsoft.Graph.DeviceManagement.DeviceCompliancePolicies.Item.UserStatuses.Item;
...
namespace Microsoft.Graph.DeviceManagement.DeviceCompliancePolicies.Item.UserStatuses {
    ...
    public class UserStatusesRequestBuilder : BaseRequestBuilder {
        ...
        public DeviceComplianceUserStatusItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("deviceComplianceUserStatus%2Did", position);
        ...
        public UserStatusesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicy%2Did}/userStatuses{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new UserStatusesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public UserStatusesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicy%2Did}/userStatuses{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<DeviceComplianceUserStatusCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<UserStatusesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceComplianceUserStatusCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<UserStatusesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<DeviceComplianceUserStatusCollectionResponse>(requestInfo, DeviceComplianceUserStatusCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceComplianceUserStatus?> PostAsync(DeviceComplianceUserStatus body, CancellationToken cancellationToken = default, Action<UserStatusesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceComplianceUserStatus> PostAsync(DeviceComplianceUserStatus body, CancellationToken cancellationToken = default, Action<UserStatusesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
