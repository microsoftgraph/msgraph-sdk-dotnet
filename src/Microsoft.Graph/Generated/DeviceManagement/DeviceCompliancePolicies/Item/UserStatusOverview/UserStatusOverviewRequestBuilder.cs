...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceComplianceUserOverview?> GetAsync(CancellationToken cancellationToken = default, Action<UserStatusOverviewRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceComplianceUserOverview> GetAsync(CancellationToken cancellationToken = default, Action<UserStatusOverviewRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceComplianceUserOverview?> PatchAsync(DeviceComplianceUserOverview body, CancellationToken cancellationToken = default, Action<UserStatusOverviewRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceComplianceUserOverview> PatchAsync(DeviceComplianceUserOverview body, CancellationToken cancellationToken = default, Action<UserStatusOverviewRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
