...
namespace Microsoft.Graph.DeviceManagement.DeviceCompliancePolicies.Item.ScheduleActionsForRules {
    ...
    /// </summary>
    public class ScheduleActionsForRulesRequestBuilder : BaseRequestBuilder {
        /// <summary>
        /// Instantiates a new ScheduleActionsForRulesRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ScheduleActionsForRulesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicy%2Did}/scheduleActionsForRules", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ScheduleActionsForRulesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ScheduleActionsForRulesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicy%2Did}/scheduleActionsForRules", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task PostAsync(ScheduleActionsForRulesPostRequestBody body, CancellationToken cancellationToken = default, Action<ScheduleActionsForRulesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(ScheduleActionsForRulesPostRequestBody body, CancellationToken cancellationToken = default, Action<ScheduleActionsForRulesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
