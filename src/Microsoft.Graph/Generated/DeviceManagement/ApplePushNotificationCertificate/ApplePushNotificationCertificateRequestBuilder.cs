...
namespace Microsoft.Graph.DeviceManagement.ApplePushNotificationCertificate
{
    ...
    public class ApplePushNotificationCertificateRequestBuilder : BaseRequestBuilder
    {
        ...
        {
            get => new DownloadApplePushNotificationCertificateSigningRequestRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.ApplePushNotificationCertificate?> GetAsync(Action<RequestConfiguration<ApplePushNotificationCertificateRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.ApplePushNotificationCertificate> GetAsync(Action<RequestConfiguration<ApplePushNotificationCertificateRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ApplePushNotificationCertificateRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public ApplePushNotificationCertificateRequestBuilder WithUrl(string rawUrl)
        {
            return new ApplePushNotificationCertificateRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class ApplePushNotificationCertificateRequestBuilderGetRequestConfiguration : RequestConfiguration<ApplePushNotificationCertificateRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
