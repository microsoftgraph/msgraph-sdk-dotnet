...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ApplePushNotificationCertificateRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ApplePushNotificationCertificateRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.ApplePushNotificationCertificate?> GetAsync(CancellationToken cancellationToken = default, Action<ApplePushNotificationCertificateRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.ApplePushNotificationCertificate> GetAsync(CancellationToken cancellationToken = default, Action<ApplePushNotificationCertificateRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.ApplePushNotificationCertificate?> PatchAsync(Microsoft.Graph.Models.ApplePushNotificationCertificate body, CancellationToken cancellationToken = default, Action<ApplePushNotificationCertificateRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.ApplePushNotificationCertificate> PatchAsync(Microsoft.Graph.Models.ApplePushNotificationCertificate body, CancellationToken cancellationToken = default, Action<ApplePushNotificationCertificateRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
