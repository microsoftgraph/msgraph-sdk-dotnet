...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ImportedWindowsAutopilotDeviceIdentityItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ImportedWindowsAutopilotDeviceIdentityItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ImportedWindowsAutopilotDeviceIdentity?> GetAsync(CancellationToken cancellationToken = default, Action<ImportedWindowsAutopilotDeviceIdentityItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ImportedWindowsAutopilotDeviceIdentity> GetAsync(CancellationToken cancellationToken = default, Action<ImportedWindowsAutopilotDeviceIdentityItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ImportedWindowsAutopilotDeviceIdentity?> PatchAsync(ImportedWindowsAutopilotDeviceIdentity body, CancellationToken cancellationToken = default, Action<ImportedWindowsAutopilotDeviceIdentityItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ImportedWindowsAutopilotDeviceIdentity> PatchAsync(ImportedWindowsAutopilotDeviceIdentity body, CancellationToken cancellationToken = default, Action<ImportedWindowsAutopilotDeviceIdentityItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
