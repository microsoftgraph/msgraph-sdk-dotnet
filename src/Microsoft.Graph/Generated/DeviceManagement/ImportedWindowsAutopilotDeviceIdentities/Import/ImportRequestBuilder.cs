...
#nullable enable
        public async Task<ImportResponse?> PostAsync(ImportPostRequestBody body, CancellationToken cancellationToken = default, Action<ImportRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ImportResponse> PostAsync(ImportPostRequestBody body, CancellationToken cancellationToken = default, Action<ImportRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(ImportPostRequestBody body, Action<ImportRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ImportPostRequestBody body, Action<ImportRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new ImportRequestBuilderPostRequestConfiguration();
