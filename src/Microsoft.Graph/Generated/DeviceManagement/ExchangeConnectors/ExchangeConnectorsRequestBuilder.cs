using Microsoft.Graph.DeviceManagement.ExchangeConnectors.Count;
using Microsoft.Graph.DeviceManagement.ExchangeConnectors.Item;
...
namespace Microsoft.Graph.DeviceManagement.ExchangeConnectors {
    ...
    public class ExchangeConnectorsRequestBuilder : BaseRequestBuilder {
        ...
        public ExchangeConnectorsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/exchangeConnectors{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ExchangeConnectorsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ExchangeConnectorsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/exchangeConnectors{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<DeviceManagementExchangeConnectorCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ExchangeConnectorsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceManagementExchangeConnectorCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ExchangeConnectorsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceManagementExchangeConnector?> PostAsync(DeviceManagementExchangeConnector body, CancellationToken cancellationToken = default, Action<ExchangeConnectorsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceManagementExchangeConnector> PostAsync(DeviceManagementExchangeConnector body, CancellationToken cancellationToken = default, Action<ExchangeConnectorsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
