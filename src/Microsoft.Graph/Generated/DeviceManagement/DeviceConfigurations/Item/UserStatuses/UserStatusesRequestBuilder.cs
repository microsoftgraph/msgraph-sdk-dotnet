using Microsoft.Graph.DeviceManagement.DeviceConfigurations.Item.UserStatuses.Count;
using Microsoft.Graph.DeviceManagement.DeviceConfigurations.Item.UserStatuses.Item;
...
namespace Microsoft.Graph.DeviceManagement.DeviceConfigurations.Item.UserStatuses {
    ...
    public class UserStatusesRequestBuilder : BaseRequestBuilder {
        ...
        public DeviceConfigurationUserStatusItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("deviceConfigurationUserStatus%2Did", position);
        ...
        public UserStatusesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/deviceConfigurations/{deviceConfiguration%2Did}/userStatuses{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new UserStatusesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public UserStatusesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/deviceConfigurations/{deviceConfiguration%2Did}/userStatuses{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<DeviceConfigurationUserStatusCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<UserStatusesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceConfigurationUserStatusCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<UserStatusesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<DeviceConfigurationUserStatusCollectionResponse>(requestInfo, DeviceConfigurationUserStatusCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceConfigurationUserStatus?> PostAsync(DeviceConfigurationUserStatus body, CancellationToken cancellationToken = default, Action<UserStatusesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceConfigurationUserStatus> PostAsync(DeviceConfigurationUserStatus body, CancellationToken cancellationToken = default, Action<UserStatusesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(DeviceConfigurationUserStatus body, Action<UserStatusesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(DeviceConfigurationUserStatus body, Action<UserStatusesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
