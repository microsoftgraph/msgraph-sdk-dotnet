...
#nullable enable
        public async Task<GetOmaSettingPlainTextValueWithSecretReferenceValueIdResponse?> GetAsync(CancellationToken cancellationToken = default, Action<GetOmaSettingPlainTextValueWithSecretReferenceValueIdRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GetOmaSettingPlainTextValueWithSecretReferenceValueIdResponse> GetAsync(CancellationToken cancellationToken = default, Action<GetOmaSettingPlainTextValueWithSecretReferenceValueIdRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
