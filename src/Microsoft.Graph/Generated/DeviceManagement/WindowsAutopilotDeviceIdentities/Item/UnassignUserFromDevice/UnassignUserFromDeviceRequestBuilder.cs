...
#nullable enable
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<UnassignUserFromDeviceRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<UnassignUserFromDeviceRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
