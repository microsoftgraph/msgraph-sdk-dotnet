...
namespace Microsoft.Graph.DeviceManagement.WindowsAutopilotDeviceIdentities.Item.UnassignUserFromDevice
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.DeviceManagement.WindowsAutopilotDeviceIdentities.Item.UnassignUserFromDevice.UnassignUserFromDeviceRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.DeviceManagement.WindowsAutopilotDeviceIdentities.Item.UnassignUserFromDevice.UnassignUserFromDeviceRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.DeviceManagement.WindowsAutopilotDeviceIdentities.Item.UnassignUserFromDevice.UnassignUserFromDeviceRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.DeviceManagement.WindowsAutopilotDeviceIdentities.Item.UnassignUserFromDevice.UnassignUserFromDeviceRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class UnassignUserFromDeviceRequestBuilderPostRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
    }
}
