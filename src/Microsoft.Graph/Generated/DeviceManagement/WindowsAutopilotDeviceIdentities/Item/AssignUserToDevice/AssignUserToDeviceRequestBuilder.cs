...
#nullable enable
        public async Task PostAsync(AssignUserToDevicePostRequestBody body, CancellationToken cancellationToken = default, Action<AssignUserToDeviceRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(AssignUserToDevicePostRequestBody body, CancellationToken cancellationToken = default, Action<AssignUserToDeviceRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
