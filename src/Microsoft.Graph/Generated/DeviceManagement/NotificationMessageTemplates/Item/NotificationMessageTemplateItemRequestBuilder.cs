using Microsoft.Graph.DeviceManagement.NotificationMessageTemplates.Item.LocalizedNotificationMessages;
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<NotificationMessageTemplateItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<NotificationMessageTemplateItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<NotificationMessageTemplate?> GetAsync(CancellationToken cancellationToken = default, Action<NotificationMessageTemplateItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<NotificationMessageTemplate> GetAsync(CancellationToken cancellationToken = default, Action<NotificationMessageTemplateItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<NotificationMessageTemplate?> PatchAsync(NotificationMessageTemplate body, CancellationToken cancellationToken = default, Action<NotificationMessageTemplateItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<NotificationMessageTemplate> PatchAsync(NotificationMessageTemplate body, CancellationToken cancellationToken = default, Action<NotificationMessageTemplateItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
