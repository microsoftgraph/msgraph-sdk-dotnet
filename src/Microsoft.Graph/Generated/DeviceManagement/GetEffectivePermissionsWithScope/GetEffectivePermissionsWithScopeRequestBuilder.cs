...
#nullable enable
        public async Task<GetEffectivePermissionsWithScopeResponse?> GetAsync(CancellationToken cancellationToken = default, Action<GetEffectivePermissionsWithScopeRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GetEffectivePermissionsWithScopeResponse> GetAsync(CancellationToken cancellationToken = default, Action<GetEffectivePermissionsWithScopeRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
