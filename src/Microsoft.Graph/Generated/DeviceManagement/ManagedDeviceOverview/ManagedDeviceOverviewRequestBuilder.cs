...
#nullable enable
        public async Task<Microsoft.Graph.Models.ManagedDeviceOverview?> GetAsync(CancellationToken cancellationToken = default, Action<ManagedDeviceOverviewRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.ManagedDeviceOverview> GetAsync(CancellationToken cancellationToken = default, Action<ManagedDeviceOverviewRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
