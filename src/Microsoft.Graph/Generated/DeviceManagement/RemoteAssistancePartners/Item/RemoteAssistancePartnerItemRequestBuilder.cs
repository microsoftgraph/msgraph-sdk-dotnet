...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<RemoteAssistancePartnerItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<RemoteAssistancePartnerItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<RemoteAssistancePartner?> GetAsync(CancellationToken cancellationToken = default, Action<RemoteAssistancePartnerItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<RemoteAssistancePartner> GetAsync(CancellationToken cancellationToken = default, Action<RemoteAssistancePartnerItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<RemoteAssistancePartner?> PatchAsync(RemoteAssistancePartner body, CancellationToken cancellationToken = default, Action<RemoteAssistancePartnerItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<RemoteAssistancePartner> PatchAsync(RemoteAssistancePartner body, CancellationToken cancellationToken = default, Action<RemoteAssistancePartnerItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
