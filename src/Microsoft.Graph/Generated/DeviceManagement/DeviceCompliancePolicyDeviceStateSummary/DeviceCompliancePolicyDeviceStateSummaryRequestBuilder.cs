...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.DeviceCompliancePolicyDeviceStateSummary?> GetAsync(CancellationToken cancellationToken = default, Action<DeviceCompliancePolicyDeviceStateSummaryRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.DeviceCompliancePolicyDeviceStateSummary> GetAsync(CancellationToken cancellationToken = default, Action<DeviceCompliancePolicyDeviceStateSummaryRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
