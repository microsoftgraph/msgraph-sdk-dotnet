...
namespace Microsoft.Graph.DeviceManagement.RoleAssignments {
    ...
    public class RoleAssignmentsRequestBuilder : BaseRequestBuilder 
    {
        ...
        public DeviceAndAppManagementRoleAssignmentItemRequestBuilder this[string position]
        {
            get
            {
...
#nullable enable
        public async Task<DeviceAndAppManagementRoleAssignmentCollectionResponse?> GetAsync(Action<RequestConfiguration<RoleAssignmentsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<DeviceAndAppManagementRoleAssignmentCollectionResponse> GetAsync(Action<RequestConfiguration<RoleAssignmentsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceAndAppManagementRoleAssignment?> PostAsync(DeviceAndAppManagementRoleAssignment body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<DeviceAndAppManagementRoleAssignment> PostAsync(DeviceAndAppManagementRoleAssignment body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
