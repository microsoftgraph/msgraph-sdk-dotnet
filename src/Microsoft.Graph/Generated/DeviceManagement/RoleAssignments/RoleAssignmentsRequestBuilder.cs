using Microsoft.Graph.DeviceManagement.RoleAssignments.Count;
using Microsoft.Graph.DeviceManagement.RoleAssignments.Item;
...
namespace Microsoft.Graph.DeviceManagement.RoleAssignments {
    ...
    public class RoleAssignmentsRequestBuilder : BaseRequestBuilder {
        ...
        public DeviceAndAppManagementRoleAssignmentItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("deviceAndAppManagementRoleAssignment%2Did", position);
        ...
        public RoleAssignmentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/roleAssignments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RoleAssignmentsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RoleAssignmentsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceManagement/roleAssignments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<DeviceAndAppManagementRoleAssignmentCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<RoleAssignmentsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceAndAppManagementRoleAssignmentCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<RoleAssignmentsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceAndAppManagementRoleAssignment?> PostAsync(DeviceAndAppManagementRoleAssignment body, CancellationToken cancellationToken = default, Action<RoleAssignmentsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceAndAppManagementRoleAssignment> PostAsync(DeviceAndAppManagementRoleAssignment body, CancellationToken cancellationToken = default, Action<RoleAssignmentsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(DeviceAndAppManagementRoleAssignment body, Action<RoleAssignmentsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(DeviceAndAppManagementRoleAssignment body, Action<RoleAssignmentsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
