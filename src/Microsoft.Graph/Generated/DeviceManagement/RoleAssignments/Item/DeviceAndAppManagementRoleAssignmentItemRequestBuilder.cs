...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DeviceAndAppManagementRoleAssignmentItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DeviceAndAppManagementRoleAssignmentItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceAndAppManagementRoleAssignment?> GetAsync(CancellationToken cancellationToken = default, Action<DeviceAndAppManagementRoleAssignmentItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceAndAppManagementRoleAssignment> GetAsync(CancellationToken cancellationToken = default, Action<DeviceAndAppManagementRoleAssignmentItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeviceAndAppManagementRoleAssignment?> PatchAsync(DeviceAndAppManagementRoleAssignment body, CancellationToken cancellationToken = default, Action<DeviceAndAppManagementRoleAssignmentItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceAndAppManagementRoleAssignment> PatchAsync(DeviceAndAppManagementRoleAssignment body, CancellationToken cancellationToken = default, Action<DeviceAndAppManagementRoleAssignmentItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
