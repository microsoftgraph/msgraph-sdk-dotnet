...
#nullable enable
        public async Task PostAsync(WipeManagedAppRegistrationsByDeviceTagPostRequestBody body, CancellationToken cancellationToken = default, Action<WipeManagedAppRegistrationsByDeviceTagRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(WipeManagedAppRegistrationsByDeviceTagPostRequestBody body, CancellationToken cancellationToken = default, Action<WipeManagedAppRegistrationsByDeviceTagRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
