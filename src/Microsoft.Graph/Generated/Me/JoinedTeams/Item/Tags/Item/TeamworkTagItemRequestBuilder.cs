using Microsoft.Graph.Me.JoinedTeams.Item.Tags.Item.Members;
...
namespace Microsoft.Graph.Me.JoinedTeams.Item.Tags.Item {
    ...
    public class TeamworkTagItemRequestBuilder : BaseRequestBuilder {
        ...
        public TeamworkTagItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/joinedTeams/{team%2Did}/tags/{teamworkTag%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new TeamworkTagItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TeamworkTagItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/joinedTeams/{team%2Did}/tags/{teamworkTag%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
