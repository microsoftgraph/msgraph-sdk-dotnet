...
using System;
namespace Microsoft.Graph.Me.JoinedTeams.Item.PermissionGrants.GetAvailableExtensionProperties {
    /// <summary>
    ...
    public class GetAvailableExtensionPropertiesRequestBuilder : BaseRequestBuilder {
        ...
        public GetAvailableExtensionPropertiesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/joinedTeams/{team%2Did}/permissionGrants/getAvailableExtensionProperties", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GetAvailableExtensionPropertiesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetAvailableExtensionPropertiesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/joinedTeams/{team%2Did}/permissionGrants/getAvailableExtensionProperties", rawUrl) {
        }
        /// <summary>
