...
using Microsoft.Graph.Me.JoinedTeams.Item.Channels.Item.Messages.Item.SoftDelete;
using Microsoft.Graph.Me.JoinedTeams.Item.Channels.Item.Messages.Item.UndoSoftDelete;
...
namespace Microsoft.Graph.Me.JoinedTeams.Item.Channels.Item.Messages.Item {
    ...
    public class ChatMessageItemRequestBuilder : BaseRequestBuilder {
        ...
        public ChatMessageItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/joinedTeams/{team%2Did}/channels/{channel%2Did}/messages/{chatMessage%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ChatMessageItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ChatMessageItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/joinedTeams/{team%2Did}/channels/{channel%2Did}/messages/{chatMessage%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
