using Microsoft.Graph.Me.JoinedTeams.Item.Channels.Item.SharedWithTeams.Count;
using Microsoft.Graph.Me.JoinedTeams.Item.Channels.Item.SharedWithTeams.Item;
...
namespace Microsoft.Graph.Me.JoinedTeams.Item.Channels.Item.SharedWithTeams {
    ...
    public class SharedWithTeamsRequestBuilder : BaseRequestBuilder {
        ...
        public SharedWithTeamsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/joinedTeams/{team%2Did}/channels/{channel%2Did}/sharedWithTeams{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SharedWithTeamsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SharedWithTeamsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/joinedTeams/{team%2Did}/channels/{channel%2Did}/sharedWithTeams{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
