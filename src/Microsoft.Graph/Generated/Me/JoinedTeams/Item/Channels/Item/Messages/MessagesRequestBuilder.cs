...
using Microsoft.Graph.Me.JoinedTeams.Item.Channels.Item.Messages.ReplyWithQuote;
...
namespace Microsoft.Graph.Me.JoinedTeams.Item.Channels.Item.Messages
{
    ...
    public partial class MessagesRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Microsoft.Graph.Me.JoinedTeams.Item.Channels.Item.Messages.ReplyWithQuote.ReplyWithQuoteRequestBuilder ReplyWithQuote
        {
            get => new global::Microsoft.Graph.Me.JoinedTeams.Item.Channels.Item.Messages.ReplyWithQuote.ReplyWithQuoteRequestBuilder(PathParameters, RequestAdapter);
        }
...
#nullable restore
        ...
        {
#endif
            var requestInfo = new RequestInformation(Method.GET, "{+baseurl}/me/joinedTeams/{team%2Did}/channels/{channel%2Did}/messages{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", PathParameters);
...
#endif
            if(ReferenceEquals(body, null)) throw new ArgumentNullException(nameof(body));
            var requestInfo = new RequestInformation(Method.POST, "{+baseurl}/me/joinedTeams/{team%2Did}/channels/{channel%2Did}/messages", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
