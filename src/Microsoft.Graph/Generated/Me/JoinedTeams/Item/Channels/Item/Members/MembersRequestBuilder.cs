...
using Microsoft.Graph.Me.JoinedTeams.Item.Channels.Item.Members.MicrosoftGraphAdd;
...
namespace Microsoft.Graph.Me.JoinedTeams.Item.Channels.Item.Members {
    ...
    public class MembersRequestBuilder {
        ...
        public MembersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedTeams/{team%2Did}/channels/{channel%2Did}/members{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
