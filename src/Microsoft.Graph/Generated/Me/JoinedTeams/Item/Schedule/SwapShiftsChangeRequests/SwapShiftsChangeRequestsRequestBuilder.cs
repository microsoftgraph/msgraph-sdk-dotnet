using Microsoft.Graph.Me.JoinedTeams.Item.Schedule.SwapShiftsChangeRequests.Count;
using Microsoft.Graph.Me.JoinedTeams.Item.Schedule.SwapShiftsChangeRequests.Item;
...
namespace Microsoft.Graph.Me.JoinedTeams.Item.Schedule.SwapShiftsChangeRequests {
    ...
    public class SwapShiftsChangeRequestsRequestBuilder : BaseRequestBuilder {
        ...
        public SwapShiftsChangeRequestsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/joinedTeams/{team%2Did}/schedule/swapShiftsChangeRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SwapShiftsChangeRequestsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SwapShiftsChangeRequestsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/joinedTeams/{team%2Did}/schedule/swapShiftsChangeRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<SwapShiftsChangeRequestCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<SwapShiftsChangeRequestsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<SwapShiftsChangeRequestCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<SwapShiftsChangeRequestsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<SwapShiftsChangeRequest?> PostAsync(SwapShiftsChangeRequest body, CancellationToken cancellationToken = default, Action<SwapShiftsChangeRequestsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<SwapShiftsChangeRequest> PostAsync(SwapShiftsChangeRequest body, CancellationToken cancellationToken = default, Action<SwapShiftsChangeRequestsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
