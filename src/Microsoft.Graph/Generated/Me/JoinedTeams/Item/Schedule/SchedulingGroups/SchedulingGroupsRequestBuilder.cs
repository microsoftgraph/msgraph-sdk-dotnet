...
namespace Microsoft.Graph.Me.JoinedTeams.Item.Schedule.SchedulingGroups {
    ...
    public class SchedulingGroupsRequestBuilder : BaseRequestBuilder {
        ...
        public SchedulingGroupsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/joinedTeams/{team%2Did}/schedule/schedulingGroups{?%24count,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new <see cref="SchedulingGroupsRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SchedulingGroupsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/joinedTeams/{team%2Did}/schedule/schedulingGroups{?%24count,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl) {
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>A <cref="SchedulingGroupCollectionResponse"></returns>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <cref="SchedulingGroupsRequestBuilder"></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
