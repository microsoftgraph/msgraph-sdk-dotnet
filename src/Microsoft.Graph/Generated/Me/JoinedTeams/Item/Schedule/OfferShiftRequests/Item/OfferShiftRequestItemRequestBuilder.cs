...
namespace Microsoft.Graph.Me.JoinedTeams.Item.Schedule.OfferShiftRequests.Item {
    ...
    public class OfferShiftRequestItemRequestBuilder : BaseRequestBuilder {
        ...
        public OfferShiftRequestItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/joinedTeams/{team%2Did}/schedule/offerShiftRequests/{offerShiftRequest%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new OfferShiftRequestItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public OfferShiftRequestItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/joinedTeams/{team%2Did}/schedule/offerShiftRequests/{offerShiftRequest%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<OfferShiftRequestItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<OfferShiftRequestItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<OfferShiftRequest?> GetAsync(CancellationToken cancellationToken = default, Action<OfferShiftRequestItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<OfferShiftRequest> GetAsync(CancellationToken cancellationToken = default, Action<OfferShiftRequestItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<OfferShiftRequest?> PatchAsync(OfferShiftRequest body, CancellationToken cancellationToken = default, Action<OfferShiftRequestItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<OfferShiftRequest> PatchAsync(OfferShiftRequest body, CancellationToken cancellationToken = default, Action<OfferShiftRequestItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
