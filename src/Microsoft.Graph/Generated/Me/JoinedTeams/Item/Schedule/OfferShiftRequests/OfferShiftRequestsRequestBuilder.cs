using Microsoft.Graph.Me.JoinedTeams.Item.Schedule.OfferShiftRequests.Count;
using Microsoft.Graph.Me.JoinedTeams.Item.Schedule.OfferShiftRequests.Item;
...
namespace Microsoft.Graph.Me.JoinedTeams.Item.Schedule.OfferShiftRequests {
    ...
    public class OfferShiftRequestsRequestBuilder : BaseRequestBuilder {
        ...
        public OfferShiftRequestsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/joinedTeams/{team%2Did}/schedule/offerShiftRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new OfferShiftRequestsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public OfferShiftRequestsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/joinedTeams/{team%2Did}/schedule/offerShiftRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
