...
namespace Microsoft.Graph.Me.JoinedTeams.Item.CompleteMigration {
    ...
    public class CompleteMigrationRequestBuilder : BaseRequestBuilder {
        ...
        public CompleteMigrationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/joinedTeams/{team%2Did}/completeMigration", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CompleteMigrationRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CompleteMigrationRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/joinedTeams/{team%2Did}/completeMigration", rawUrl) {
        }
        /// <summary>
