...
namespace Microsoft.Graph.Me.JoinedTeams.Item.Clone {
    ...
    public class CloneRequestBuilder : BaseRequestBuilder {
        ...
        public CloneRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/joinedTeams/{team%2Did}/clone", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CloneRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task PostAsync(ClonePostRequestBody body, CancellationToken cancellationToken = default, Action<CloneRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(ClonePostRequestBody body, CancellationToken cancellationToken = default, Action<CloneRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
