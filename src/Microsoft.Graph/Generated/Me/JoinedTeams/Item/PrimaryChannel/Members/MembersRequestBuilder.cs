using Microsoft.Graph.Me.JoinedTeams.Item.PrimaryChannel.Members.Add;
using Microsoft.Graph.Me.JoinedTeams.Item.PrimaryChannel.Members.Count;
using Microsoft.Graph.Me.JoinedTeams.Item.PrimaryChannel.Members.Item;
...
namespace Microsoft.Graph.Me.JoinedTeams.Item.PrimaryChannel.Members {
    ...
    public class MembersRequestBuilder : BaseRequestBuilder {
        ...
        public MembersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/joinedTeams/{team%2Did}/primaryChannel/members{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new MembersRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MembersRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/joinedTeams/{team%2Did}/primaryChannel/members{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
