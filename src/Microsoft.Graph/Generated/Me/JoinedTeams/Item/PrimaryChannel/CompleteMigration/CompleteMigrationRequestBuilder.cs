...
namespace Microsoft.Graph.Me.JoinedTeams.Item.PrimaryChannel.CompleteMigration {
    ...
    public class CompleteMigrationRequestBuilder : BaseRequestBuilder {
        ...
        public CompleteMigrationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/joinedTeams/{team%2Did}/primaryChannel/completeMigration", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CompleteMigrationRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CompleteMigrationRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/joinedTeams/{team%2Did}/primaryChannel/completeMigration", rawUrl) {
        }
        /// <summary>
