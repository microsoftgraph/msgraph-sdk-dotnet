...
using Microsoft.Graph.Me.JoinedTeams.Item.PrimaryChannel.Messages.Item.Replies.MicrosoftGraphDelta;
...
namespace Microsoft.Graph.Me.JoinedTeams.Item.PrimaryChannel.Messages.Item.Replies {
    ...
    public class RepliesRequestBuilder {
        ...
        public RepliesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedTeams/{team%2Did}/primaryChannel/messages/{chatMessage%2Did}/replies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
