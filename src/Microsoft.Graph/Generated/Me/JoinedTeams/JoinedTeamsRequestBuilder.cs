...
namespace Microsoft.Graph.Me.JoinedTeams {
    ...
    public class JoinedTeamsRequestBuilder : BaseRequestBuilder {
        ...
        public JoinedTeamsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/joinedTeams{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new JoinedTeamsRequestBuilder and sets the default values.
        /// </summary>
