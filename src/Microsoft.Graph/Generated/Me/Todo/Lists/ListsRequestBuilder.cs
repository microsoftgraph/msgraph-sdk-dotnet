using Microsoft.Graph.Me.Todo.Lists.Count;
using Microsoft.Graph.Me.Todo.Lists.Delta;
using Microsoft.Graph.Me.Todo.Lists.Item;
...
namespace Microsoft.Graph.Me.Todo.Lists {
    ...
    public class ListsRequestBuilder : BaseRequestBuilder {
        ...
        public ListsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/todo/lists{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ListsRequestBuilder and sets the default values.
        /// </summary>
