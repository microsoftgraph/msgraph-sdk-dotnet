using Microsoft.Graph.Me.Todo.Lists.Item.Tasks.Item.Attachments.Item.Value;
...
namespace Microsoft.Graph.Me.Todo.Lists.Item.Tasks.Item.Attachments.Item {
    ...
    public class AttachmentBaseItemRequestBuilder : BaseRequestBuilder {
        ...
        public AttachmentBaseItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/todo/lists/{todoTaskList%2Did}/tasks/{todoTask%2Did}/attachments/{attachmentBase%2Did}{?%24select}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AttachmentBaseItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AttachmentBaseItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/todo/lists/{todoTaskList%2Did}/tasks/{todoTask%2Did}/attachments/{attachmentBase%2Did}{?%24select}", rawUrl) {
        }
        /// <summary>
