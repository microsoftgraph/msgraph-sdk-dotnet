using Microsoft.Graph.Me.Todo.Lists.Item.Tasks.Count;
using Microsoft.Graph.Me.Todo.Lists.Item.Tasks.Delta;
using Microsoft.Graph.Me.Todo.Lists.Item.Tasks.Item;
...
namespace Microsoft.Graph.Me.Todo.Lists.Item.Tasks {
    ...
    public class TasksRequestBuilder : BaseRequestBuilder {
        ...
        public TasksRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/todo/lists/{todoTaskList%2Did}/tasks{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new TasksRequestBuilder and sets the default values.
        /// </summary>
