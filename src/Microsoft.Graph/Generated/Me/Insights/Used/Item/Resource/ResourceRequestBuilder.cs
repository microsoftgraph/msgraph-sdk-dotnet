...
namespace Microsoft.Graph.Me.Insights.Used.Item.Resource {
    ...
    public class ResourceRequestBuilder : BaseRequestBuilder {
        ...
        public ResourceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/insights/used/{usedInsight%2Did}/resource{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ResourceRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ResourceRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/insights/used/{usedInsight%2Did}/resource{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
