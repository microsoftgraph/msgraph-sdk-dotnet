...
namespace Microsoft.Graph.Me.Chats.Item.MarkChatUnreadForUser {
    ...
    public class MarkChatUnreadForUserRequestBuilder : BaseRequestBuilder {
        ...
        public MarkChatUnreadForUserRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/chats/{chat%2Did}/markChatUnreadForUser", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new MarkChatUnreadForUserRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MarkChatUnreadForUserRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/chats/{chat%2Did}/markChatUnreadForUser", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task PostAsync(MarkChatUnreadForUserPostRequestBody body, CancellationToken cancellationToken = default, Action<MarkChatUnreadForUserRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(MarkChatUnreadForUserPostRequestBody body, CancellationToken cancellationToken = default, Action<MarkChatUnreadForUserRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
