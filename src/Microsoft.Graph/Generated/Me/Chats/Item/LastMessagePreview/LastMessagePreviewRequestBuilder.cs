...
namespace Microsoft.Graph.Me.Chats.Item.LastMessagePreview {
    ...
    public class LastMessagePreviewRequestBuilder : BaseRequestBuilder {
        ...
        public LastMessagePreviewRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/chats/{chat%2Did}/lastMessagePreview{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new LastMessagePreviewRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public LastMessagePreviewRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/chats/{chat%2Did}/lastMessagePreview{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
