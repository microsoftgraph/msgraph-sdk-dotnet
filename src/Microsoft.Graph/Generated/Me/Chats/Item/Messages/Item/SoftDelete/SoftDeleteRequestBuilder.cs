...
namespace Microsoft.Graph.Me.Chats.Item.Messages.Item.SoftDelete {
    ...
    public class SoftDeleteRequestBuilder : BaseRequestBuilder {
        ...
        public SoftDeleteRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/chats/{chat%2Did}/messages/{chatMessage%2Did}/softDelete", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SoftDeleteRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SoftDeleteRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/chats/{chat%2Did}/messages/{chatMessage%2Did}/softDelete", rawUrl) {
        }
        /// <summary>
