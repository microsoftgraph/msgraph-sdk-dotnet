...
using Microsoft.Graph.Me.Chats.Item.Messages.Item.Replies.MicrosoftGraphDelta;
...
namespace Microsoft.Graph.Me.Chats.Item.Messages.Item.Replies {
    ...
    public class RepliesRequestBuilder {
        ...
        public Microsoft.Graph.Me.Chats.Item.Messages.Item.Replies.Item.ChatMessageItemRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("chatMessage%2Did1", position);
            return new Microsoft.Graph.Me.Chats.Item.Messages.Item.Replies.Item.ChatMessageItemRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
