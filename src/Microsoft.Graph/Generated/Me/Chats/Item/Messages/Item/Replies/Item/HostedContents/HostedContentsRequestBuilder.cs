using Microsoft.Graph.Me.Chats.Item.Messages.Item.Replies.Item.HostedContents.Count;
using Microsoft.Graph.Me.Chats.Item.Messages.Item.Replies.Item.HostedContents.Item;
...
namespace Microsoft.Graph.Me.Chats.Item.Messages.Item.Replies.Item.HostedContents {
    ...
    public class HostedContentsRequestBuilder : BaseRequestBuilder {
        ...
        public HostedContentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/chats/{chat%2Did}/messages/{chatMessage%2Did}/replies/{chatMessage%2Did1}/hostedContents{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new HostedContentsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public HostedContentsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/chats/{chat%2Did}/messages/{chatMessage%2Did}/replies/{chatMessage%2Did1}/hostedContents{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
