using Microsoft.Graph.Me.Chats.Item.InstalledApps.Count;
using Microsoft.Graph.Me.Chats.Item.InstalledApps.Item;
...
namespace Microsoft.Graph.Me.Chats.Item.InstalledApps {
    ...
    public class InstalledAppsRequestBuilder : BaseRequestBuilder {
        ...
        public InstalledAppsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/chats/{chat%2Did}/installedApps{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new InstalledAppsRequestBuilder and sets the default values.
        /// </summary>
