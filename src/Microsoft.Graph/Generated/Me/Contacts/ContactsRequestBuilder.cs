using Microsoft.Graph.Me.Contacts.Count;
using Microsoft.Graph.Me.Contacts.Delta;
...
namespace Microsoft.Graph.Me.Contacts {
    ...
    public class ContactsRequestBuilder : BaseRequestBuilder {
        ...
        public ContactsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/contacts{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ContactsRequestBuilder and sets the default values.
        /// </summary>
