...
namespace Microsoft.Graph.Me.ScopedRoleMemberOf.Item {
    ...
    public class ScopedRoleMembershipItemRequestBuilder : BaseRequestBuilder {
        ...
        public ScopedRoleMembershipItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/scopedRoleMemberOf/{scopedRoleMembership%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ScopedRoleMembershipItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ScopedRoleMembershipItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/scopedRoleMemberOf/{scopedRoleMembership%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
