...
namespace Microsoft.Graph.Me.People {
    ...
    public class PeopleRequestBuilder : BaseRequestBuilder {
        ...
        public PersonItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("person%2Did", position);
        ...
        public PeopleRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/people{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new PeopleRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PeopleRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/people{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<PersonCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<PeopleRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PersonCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<PeopleRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
