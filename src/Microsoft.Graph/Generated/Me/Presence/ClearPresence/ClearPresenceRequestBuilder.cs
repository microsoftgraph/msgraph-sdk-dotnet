...
namespace Microsoft.Graph.Me.Presence.ClearPresence {
    ...
    public class ClearPresenceRequestBuilder : BaseRequestBuilder {
        ...
        public ClearPresenceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/presence/clearPresence", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ClearPresenceRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ClearPresenceRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/presence/clearPresence", rawUrl) {
        }
        /// <summary>
