...
namespace Microsoft.Graph.Me.Presence.SetPresence {
    ...
    public class SetPresenceRequestBuilder : BaseRequestBuilder {
        ...
        public SetPresenceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/presence/setPresence", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SetPresenceRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SetPresenceRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/presence/setPresence", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task PostAsync(SetPresencePostRequestBody body, CancellationToken cancellationToken = default, Action<SetPresenceRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(SetPresencePostRequestBody body, CancellationToken cancellationToken = default, Action<SetPresenceRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
