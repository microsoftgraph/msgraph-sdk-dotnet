...
namespace Microsoft.Graph.Me.Presence.ClearUserPreferredPresence {
    ...
    public class ClearUserPreferredPresenceRequestBuilder : BaseRequestBuilder {
        ...
        public ClearUserPreferredPresenceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/presence/clearUserPreferredPresence", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ClearUserPreferredPresenceRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ClearUserPreferredPresenceRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/presence/clearUserPreferredPresence", rawUrl) {
        }
        /// <summary>
