using Microsoft.Graph.Me.Onenote.SectionGroups.Item.Sections.Item.CopyToNotebook;
using Microsoft.Graph.Me.Onenote.SectionGroups.Item.Sections.Item.CopyToSectionGroup;
using Microsoft.Graph.Me.Onenote.SectionGroups.Item.Sections.Item.Pages;
using Microsoft.Graph.Me.Onenote.SectionGroups.Item.Sections.Item.ParentNotebook;
using Microsoft.Graph.Me.Onenote.SectionGroups.Item.Sections.Item.ParentSectionGroup;
...
namespace Microsoft.Graph.Me.Onenote.SectionGroups.Item.Sections.Item {
    ...
    public class OnenoteSectionItemRequestBuilder : BaseRequestBuilder {
        ...
        public OnenoteSectionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/onenote/sectionGroups/{sectionGroup%2Did}/sections/{onenoteSection%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new OnenoteSectionItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public OnenoteSectionItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/onenote/sectionGroups/{sectionGroup%2Did}/sections/{onenoteSection%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
