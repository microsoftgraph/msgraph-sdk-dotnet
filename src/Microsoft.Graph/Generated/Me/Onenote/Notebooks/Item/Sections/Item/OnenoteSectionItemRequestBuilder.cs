using Microsoft.Graph.Me.Onenote.Notebooks.Item.Sections.Item.CopyToNotebook;
using Microsoft.Graph.Me.Onenote.Notebooks.Item.Sections.Item.CopyToSectionGroup;
using Microsoft.Graph.Me.Onenote.Notebooks.Item.Sections.Item.Pages;
using Microsoft.Graph.Me.Onenote.Notebooks.Item.Sections.Item.ParentNotebook;
using Microsoft.Graph.Me.Onenote.Notebooks.Item.Sections.Item.ParentSectionGroup;
...
namespace Microsoft.Graph.Me.Onenote.Notebooks.Item.Sections.Item {
    ...
    public class OnenoteSectionItemRequestBuilder : BaseRequestBuilder {
        ...
        public OnenoteSectionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/onenote/notebooks/{notebook%2Did}/sections/{onenoteSection%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new OnenoteSectionItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public OnenoteSectionItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/onenote/notebooks/{notebook%2Did}/sections/{onenoteSection%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
