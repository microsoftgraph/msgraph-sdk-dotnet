using Microsoft.Graph.Me.Onenote.Notebooks.Item.SectionGroups.Item.ParentNotebook;
using Microsoft.Graph.Me.Onenote.Notebooks.Item.SectionGroups.Item.ParentSectionGroup;
using Microsoft.Graph.Me.Onenote.Notebooks.Item.SectionGroups.Item.SectionGroups;
using Microsoft.Graph.Me.Onenote.Notebooks.Item.SectionGroups.Item.Sections;
...
namespace Microsoft.Graph.Me.Onenote.Notebooks.Item.SectionGroups.Item {
    ...
    public class SectionGroupItemRequestBuilder : BaseRequestBuilder {
        ...
        public Microsoft.Graph.Me.Onenote.Notebooks.Item.SectionGroups.Item.SectionGroups.SectionGroupsRequestBuilder SectionGroups { get =>
            new Microsoft.Graph.Me.Onenote.Notebooks.Item.SectionGroups.Item.SectionGroups.SectionGroupsRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public SectionGroupItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/onenote/notebooks/{notebook%2Did}/sectionGroups/{sectionGroup%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SectionGroupItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SectionGroupItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/onenote/notebooks/{notebook%2Did}/sectionGroups/{sectionGroup%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
