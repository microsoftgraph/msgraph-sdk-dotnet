...
namespace Microsoft.Graph.Me.Onenote.Notebooks.Item.CopyNotebook {
    ...
    public class CopyNotebookRequestBuilder : BaseRequestBuilder {
        ...
        public CopyNotebookRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/onenote/notebooks/{notebook%2Did}/copyNotebook", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CopyNotebookRequestBuilder and sets the default values.
        /// </summary>
