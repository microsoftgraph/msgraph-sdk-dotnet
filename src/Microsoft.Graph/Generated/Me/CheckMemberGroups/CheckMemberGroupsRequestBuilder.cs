...
namespace Microsoft.Graph.Me.CheckMemberGroups {
    ...
    public class CheckMemberGroupsRequestBuilder : BaseRequestBuilder {
        ...
        public CheckMemberGroupsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/checkMemberGroups", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CheckMemberGroupsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CheckMemberGroupsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/checkMemberGroups", rawUrl) {
        }
        /// <summary>
