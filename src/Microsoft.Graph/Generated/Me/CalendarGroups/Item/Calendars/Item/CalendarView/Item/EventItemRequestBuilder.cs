using Microsoft.Graph.Me.CalendarGroups.Item.Calendars.Item.CalendarView.Item.Accept;
using Microsoft.Graph.Me.CalendarGroups.Item.Calendars.Item.CalendarView.Item.Attachments;
using Microsoft.Graph.Me.CalendarGroups.Item.Calendars.Item.CalendarView.Item.Calendar;
...
using System;
namespace Microsoft.Graph.Me.CalendarGroups.Item.Calendars.Item.CalendarView.Item {
    /// <summary>
    ...
    public class EventItemRequestBuilder : BaseRequestBuilder {
        ...
        public EventItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/calendarGroups/{calendarGroup%2Did}/calendars/{calendar%2Did}/calendarView/{event%2Did}{?%24select}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new EventItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EventItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/calendarGroups/{calendarGroup%2Did}/calendars/{calendar%2Did}/calendarView/{event%2Did}{?%24select}", rawUrl) {
        }
        /// <summary>
