...
namespace Microsoft.Graph.Me.CalendarGroups.Item.Calendars.Item.Events.Item.SnoozeReminder {
    ...
    public class SnoozeReminderRequestBuilder : BaseRequestBuilder {
        ...
        public SnoozeReminderRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/calendarGroups/{calendarGroup%2Did}/calendars/{calendar%2Did}/events/{event%2Did}/snoozeReminder", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SnoozeReminderRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SnoozeReminderRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/calendarGroups/{calendarGroup%2Did}/calendars/{calendar%2Did}/events/{event%2Did}/snoozeReminder", rawUrl) {
        }
        /// <summary>
