using Microsoft.Graph.Me.CalendarGroups.Item.Calendars;
...
namespace Microsoft.Graph.Me.CalendarGroups.Item {
    ...
    public class CalendarGroupItemRequestBuilder : BaseRequestBuilder {
        ...
        public CalendarGroupItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/calendarGroups/{calendarGroup%2Did}{?%24select}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CalendarGroupItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CalendarGroupItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/calendarGroups/{calendarGroup%2Did}{?%24select}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<CalendarGroupItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<CalendarGroupItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<CalendarGroup?> GetAsync(CancellationToken cancellationToken = default, Action<CalendarGroupItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<CalendarGroup> GetAsync(CancellationToken cancellationToken = default, Action<CalendarGroupItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<CalendarGroup?> PatchAsync(CalendarGroup body, CancellationToken cancellationToken = default, Action<CalendarGroupItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<CalendarGroup> PatchAsync(CalendarGroup body, CancellationToken cancellationToken = default, Action<CalendarGroupItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
