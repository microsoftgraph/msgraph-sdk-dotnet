using Microsoft.Graph.Me.Calendar.Events.Item.Accept;
using Microsoft.Graph.Me.Calendar.Events.Item.Attachments;
using Microsoft.Graph.Me.Calendar.Events.Item.Calendar;
using Microsoft.Graph.Me.Calendar.Events.Item.Cancel;
using Microsoft.Graph.Me.Calendar.Events.Item.Decline;
using Microsoft.Graph.Me.Calendar.Events.Item.DismissReminder;
using Microsoft.Graph.Me.Calendar.Events.Item.Extensions;
using Microsoft.Graph.Me.Calendar.Events.Item.Forward;
using Microsoft.Graph.Me.Calendar.Events.Item.Instances;
using Microsoft.Graph.Me.Calendar.Events.Item.MultiValueExtendedProperties;
using Microsoft.Graph.Me.Calendar.Events.Item.SingleValueExtendedProperties;
...
namespace Microsoft.Graph.Me.Calendar.Events.Item {
    ...
    public class EventItemRequestBuilder : BaseRequestBuilder {
        ...
        public Microsoft.Graph.Me.Calendar.Events.Item.Calendar.CalendarRequestBuilder Calendar { get =>
            new Microsoft.Graph.Me.Calendar.Events.Item.Calendar.CalendarRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public EventItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/calendar/events/{event%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new EventItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EventItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/calendar/events/{event%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
