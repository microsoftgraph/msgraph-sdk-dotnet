...
using System;
namespace Microsoft.Graph.Me.Calendar.Events.Item.Instances.Item.SingleValueExtendedProperties.Item {
    /// <summary>
    ...
    public class SingleValueLegacyExtendedPropertyItemRequestBuilder : BaseRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SingleValueLegacyExtendedPropertyItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/calendar/events/{event%2Did}/instances/{event%2Did1}/singleValueExtendedProperties/{singleValueLegacyExtendedProperty%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
