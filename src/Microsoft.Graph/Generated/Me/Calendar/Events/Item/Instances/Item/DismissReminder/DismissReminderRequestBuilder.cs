...
using System;
namespace Microsoft.Graph.Me.Calendar.Events.Item.Instances.Item.DismissReminder {
    /// <summary>
    ...
    public class DismissReminderRequestBuilder : BaseRequestBuilder {
        ...
        public DismissReminderRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/calendar/events/{event%2Did}/instances/{event%2Did1}/dismissReminder", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new DismissReminderRequestBuilder and sets the default values.
        /// </summary>
