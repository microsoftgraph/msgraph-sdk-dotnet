...
namespace Microsoft.Graph.Me.Calendar.CalendarView.Item.Attachments.CreateUploadSession {
    ...
    public class CreateUploadSessionRequestBuilder : BaseRequestBuilder {
        ...
        public CreateUploadSessionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/calendar/calendarView/{event%2Did}/attachments/createUploadSession", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CreateUploadSessionRequestBuilder and sets the default values.
        /// </summary>
