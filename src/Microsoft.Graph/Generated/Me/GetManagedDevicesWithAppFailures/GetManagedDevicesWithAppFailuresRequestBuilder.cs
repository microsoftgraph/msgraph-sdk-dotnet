...
#nullable enable
        public async Task<GetManagedDevicesWithAppFailuresResponse?> GetAsync(CancellationToken cancellationToken = default, Action<GetManagedDevicesWithAppFailuresRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GetManagedDevicesWithAppFailuresResponse> GetAsync(CancellationToken cancellationToken = default, Action<GetManagedDevicesWithAppFailuresRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
