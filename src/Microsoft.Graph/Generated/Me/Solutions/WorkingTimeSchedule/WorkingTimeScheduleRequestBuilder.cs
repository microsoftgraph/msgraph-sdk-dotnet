...
namespace Microsoft.Graph.Me.Solutions.WorkingTimeSchedule
{
    ...
    public partial class WorkingTimeScheduleRequestBuilder : BaseRequestBuilder
    {
        ...
        public WorkingTimeScheduleRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/solutions/workingTimeSchedule", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Microsoft.Graph.Me.Solutions.WorkingTimeSchedule.WorkingTimeScheduleRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WorkingTimeScheduleRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/solutions/workingTimeSchedule", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        {
#endif
            var requestInfo = new RequestInformation(Method.GET, "{+baseurl}/me/solutions/workingTimeSchedule{?%24expand,%24select}", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
