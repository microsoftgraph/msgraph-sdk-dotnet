using Microsoft.Graph.Me.InferenceClassification.Overrides.Count;
...
#nullable enable
        public async Task<InferenceClassificationOverrideCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<OverridesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<InferenceClassificationOverrideCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<OverridesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<InferenceClassificationOverride?> PostAsync(InferenceClassificationOverride body, CancellationToken cancellationToken = default, Action<OverridesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<InferenceClassificationOverride> PostAsync(InferenceClassificationOverride body, CancellationToken cancellationToken = default, Action<OverridesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
