...
#nullable enable
        public async Task<PasswordAuthenticationMethod?> GetAsync(CancellationToken cancellationToken = default, Action<PasswordAuthenticationMethodItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PasswordAuthenticationMethod> GetAsync(CancellationToken cancellationToken = default, Action<PasswordAuthenticationMethodItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
