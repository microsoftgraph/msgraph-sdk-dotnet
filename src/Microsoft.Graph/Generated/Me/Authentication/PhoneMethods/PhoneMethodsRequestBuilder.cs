using Microsoft.Graph.Me.Authentication.PhoneMethods.Count;
using Microsoft.Graph.Me.Authentication.PhoneMethods.Item;
...
namespace Microsoft.Graph.Me.Authentication.PhoneMethods {
    ...
    public class PhoneMethodsRequestBuilder : BaseRequestBuilder {
        ...
        public PhoneAuthenticationMethodItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("phoneAuthenticationMethod%2Did", position);
        ...
        public PhoneMethodsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/authentication/phoneMethods{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new PhoneMethodsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PhoneMethodsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/authentication/phoneMethods{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<PhoneAuthenticationMethodCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<PhoneMethodsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PhoneAuthenticationMethodCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<PhoneMethodsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<PhoneAuthenticationMethodCollectionResponse>(requestInfo, PhoneAuthenticationMethodCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<PhoneAuthenticationMethod?> PostAsync(PhoneAuthenticationMethod body, CancellationToken cancellationToken = default, Action<PhoneMethodsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PhoneAuthenticationMethod> PostAsync(PhoneAuthenticationMethod body, CancellationToken cancellationToken = default, Action<PhoneMethodsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
