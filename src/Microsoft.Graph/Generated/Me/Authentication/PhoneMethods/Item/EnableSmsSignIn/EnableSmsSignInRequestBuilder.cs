...
namespace Microsoft.Graph.Me.Authentication.PhoneMethods.Item.EnableSmsSignIn {
    ...
    public class EnableSmsSignInRequestBuilder : BaseRequestBuilder {
        ...
        public EnableSmsSignInRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/authentication/phoneMethods/{phoneAuthenticationMethod%2Did}/enableSmsSignIn", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new EnableSmsSignInRequestBuilder and sets the default values.
        /// </summary>
