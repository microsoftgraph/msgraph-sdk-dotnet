using Microsoft.Graph.Me.Authentication.SoftwareOathMethods.Count;
using Microsoft.Graph.Me.Authentication.SoftwareOathMethods.Item;
...
#nullable enable
        public async Task<SoftwareOathAuthenticationMethodCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<SoftwareOathMethodsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<SoftwareOathAuthenticationMethodCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<SoftwareOathMethodsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
