...
namespace Microsoft.Graph.Me.LicenseDetails {
    ...
    public class LicenseDetailsRequestBuilder : BaseRequestBuilder {
        ...
        public LicenseDetailsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/licenseDetails{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new LicenseDetailsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public LicenseDetailsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/licenseDetails{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/user-list-licensedetails?view=graph-rest-1.0" />
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.LicenseDetails?> PostAsync(Microsoft.Graph.Models.LicenseDetails body, CancellationToken cancellationToken = default, Action<LicenseDetailsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.LicenseDetails> PostAsync(Microsoft.Graph.Models.LicenseDetails body, CancellationToken cancellationToken = default, Action<LicenseDetailsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Models.LicenseDetails body, Action<LicenseDetailsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Models.LicenseDetails body, Action<LicenseDetailsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
