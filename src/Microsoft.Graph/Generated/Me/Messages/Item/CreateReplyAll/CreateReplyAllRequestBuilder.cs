...
namespace Microsoft.Graph.Me.Messages.Item.CreateReplyAll {
    ...
    public class CreateReplyAllRequestBuilder : BaseRequestBuilder {
        ...
        public CreateReplyAllRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/messages/{message%2Did}/createReplyAll", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CreateReplyAllRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CreateReplyAllRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/messages/{message%2Did}/createReplyAll", rawUrl) {
        }
        /// <summary>
