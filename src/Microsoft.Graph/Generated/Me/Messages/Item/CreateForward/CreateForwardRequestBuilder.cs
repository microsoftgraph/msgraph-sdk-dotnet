...
namespace Microsoft.Graph.Me.Messages.Item.CreateForward {
    ...
    public class CreateForwardRequestBuilder : BaseRequestBuilder {
        ...
        public CreateForwardRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/messages/{message%2Did}/createForward", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CreateForwardRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CreateForwardRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/messages/{message%2Did}/createForward", rawUrl) {
        }
        /// <summary>
