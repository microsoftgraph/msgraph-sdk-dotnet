...
namespace Microsoft.Graph.Me.Messages.Item
{
    ...
    public class MessageItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public Microsoft.Graph.Me.Messages.Item.Attachments.AttachmentsRequestBuilder Attachments
        {
            get => new Microsoft.Graph.Me.Messages.Item.Attachments.AttachmentsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to manage the media for the user entity.</summary>
        public Microsoft.Graph.Me.Messages.Item.Value.ContentRequestBuilder Content
        {
            get => new Microsoft.Graph.Me.Messages.Item.Value.ContentRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to call the copy method.</summary>
        public Microsoft.Graph.Me.Messages.Item.Copy.CopyRequestBuilder Copy
        {
            get => new Microsoft.Graph.Me.Messages.Item.Copy.CopyRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to call the createForward method.</summary>
        public Microsoft.Graph.Me.Messages.Item.CreateForward.CreateForwardRequestBuilder CreateForward
        {
            get => new Microsoft.Graph.Me.Messages.Item.CreateForward.CreateForwardRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to call the createReply method.</summary>
        public Microsoft.Graph.Me.Messages.Item.CreateReply.CreateReplyRequestBuilder CreateReply
        {
            get => new Microsoft.Graph.Me.Messages.Item.CreateReply.CreateReplyRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to call the createReplyAll method.</summary>
        public Microsoft.Graph.Me.Messages.Item.CreateReplyAll.CreateReplyAllRequestBuilder CreateReplyAll
        {
            get => new Microsoft.Graph.Me.Messages.Item.CreateReplyAll.CreateReplyAllRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to manage the extensions property of the microsoft.graph.message entity.</summary>
        public Microsoft.Graph.Me.Messages.Item.Extensions.ExtensionsRequestBuilder Extensions
        {
            get => new Microsoft.Graph.Me.Messages.Item.Extensions.ExtensionsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to call the forward method.</summary>
        public Microsoft.Graph.Me.Messages.Item.Forward.ForwardRequestBuilder Forward
        {
            get => new Microsoft.Graph.Me.Messages.Item.Forward.ForwardRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to call the move method.</summary>
        public Microsoft.Graph.Me.Messages.Item.Move.MoveRequestBuilder Move
        {
            get => new Microsoft.Graph.Me.Messages.Item.Move.MoveRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to call the reply method.</summary>
        public Microsoft.Graph.Me.Messages.Item.Reply.ReplyRequestBuilder Reply
        {
            get => new Microsoft.Graph.Me.Messages.Item.Reply.ReplyRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to call the replyAll method.</summary>
        public Microsoft.Graph.Me.Messages.Item.ReplyAll.ReplyAllRequestBuilder ReplyAll
        {
            get => new Microsoft.Graph.Me.Messages.Item.ReplyAll.ReplyAllRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to call the send method.</summary>
        public Microsoft.Graph.Me.Messages.Item.Send.SendRequestBuilder Send
        {
            get => new Microsoft.Graph.Me.Messages.Item.Send.SendRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Me.Messages.Item.MessageItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.Message?> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Me.Messages.Item.MessageItemRequestBuilder.MessageItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Message> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Me.Messages.Item.MessageItemRequestBuilder.MessageItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Me.Messages.Item.MessageItemRequestBuilder.MessageItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Me.Messages.Item.MessageItemRequestBuilder.MessageItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Me.Messages.Item.MessageItemRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Me.Messages.Item.MessageItemRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Me.Messages.Item.MessageItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class MessageItemRequestBuilderGetRequestConfiguration : RequestConfiguration<Microsoft.Graph.Me.Messages.Item.MessageItemRequestBuilder.MessageItemRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
