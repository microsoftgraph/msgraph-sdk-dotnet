...
namespace Microsoft.Graph.Me.OnlineMeetings.Item.AttendeeReport {
    ...
    public class AttendeeReportRequestBuilder : BaseRequestBuilder {
        ...
        public AttendeeReportRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/onlineMeetings/{onlineMeeting%2Did}/attendeeReport", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AttendeeReportRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AttendeeReportRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/onlineMeetings/{onlineMeeting%2Did}/attendeeReport", rawUrl) {
        }
        /// <summary>
