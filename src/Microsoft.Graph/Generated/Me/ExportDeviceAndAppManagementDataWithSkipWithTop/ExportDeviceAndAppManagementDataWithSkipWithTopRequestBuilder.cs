...
#nullable enable
        public async Task<DeviceAndAppManagementData?> GetAsync(CancellationToken cancellationToken = default, Action<ExportDeviceAndAppManagementDataWithSkipWithTopRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeviceAndAppManagementData> GetAsync(CancellationToken cancellationToken = default, Action<ExportDeviceAndAppManagementDataWithSkipWithTopRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
