...
namespace Microsoft.Graph.Me.Planner.Tasks.Item.Details
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Me.Planner.Tasks.Item.Details.DetailsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.PlannerTaskDetails?> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Me.Planner.Tasks.Item.Details.DetailsRequestBuilder.DetailsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.PlannerTaskDetails> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Me.Planner.Tasks.Item.Details.DetailsRequestBuilder.DetailsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Me.Planner.Tasks.Item.Details.DetailsRequestBuilder.DetailsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Me.Planner.Tasks.Item.Details.DetailsRequestBuilder.DetailsRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Me.Planner.Tasks.Item.Details.DetailsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Me.Planner.Tasks.Item.Details.DetailsRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Me.Planner.Tasks.Item.Details.DetailsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class DetailsRequestBuilderGetRequestConfiguration : RequestConfiguration<Microsoft.Graph.Me.Planner.Tasks.Item.Details.DetailsRequestBuilder.DetailsRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
