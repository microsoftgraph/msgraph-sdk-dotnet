...
namespace Microsoft.Graph.Me.ManagedDevices.Item.RemoteLock {
    ...
    public class RemoteLockRequestBuilder : BaseRequestBuilder {
        ...
        public RemoteLockRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/managedDevices/{managedDevice%2Did}/remoteLock", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RemoteLockRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RemoteLockRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/managedDevices/{managedDevice%2Did}/remoteLock", rawUrl) {
        }
        /// <summary>
        /// Remote lock
        /// </summary>
