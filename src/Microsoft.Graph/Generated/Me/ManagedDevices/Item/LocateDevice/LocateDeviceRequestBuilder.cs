...
namespace Microsoft.Graph.Me.ManagedDevices.Item.LocateDevice {
    ...
    public class LocateDeviceRequestBuilder : BaseRequestBuilder {
        ...
        public LocateDeviceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/managedDevices/{managedDevice%2Did}/locateDevice", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new LocateDeviceRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public LocateDeviceRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/managedDevices/{managedDevice%2Did}/locateDevice", rawUrl) {
        }
        /// <summary>
        /// Locate a device
        /// </summary>
