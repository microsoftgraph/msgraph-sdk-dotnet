...
namespace Microsoft.Graph.Me.ManagedDevices.Item.ShutDown {
    ...
    public class ShutDownRequestBuilder : BaseRequestBuilder {
        ...
        public ShutDownRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/managedDevices/{managedDevice%2Did}/shutDown", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ShutDownRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ShutDownRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/managedDevices/{managedDevice%2Did}/shutDown", rawUrl) {
        }
        /// <summary>
        /// Shut down device
        /// </summary>
