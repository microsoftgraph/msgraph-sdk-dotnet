using Microsoft.Graph.Me.Photos.Item.Value;
...
namespace Microsoft.Graph.Me.Photos.Item {
    ...
    public class ProfilePhotoItemRequestBuilder : BaseRequestBuilder {
        ...
        public ProfilePhotoItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/photos/{profilePhoto%2Did}{?%24select}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ProfilePhotoItemRequestBuilder and sets the default values.
        /// </summary>
