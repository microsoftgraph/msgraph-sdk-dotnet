...
namespace Microsoft.Graph.Me.RevokeSignInSessions {
    ...
    public class RevokeSignInSessionsRequestBuilder : BaseRequestBuilder {
        ...
        public RevokeSignInSessionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/revokeSignInSessions", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RevokeSignInSessionsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RevokeSignInSessionsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/revokeSignInSessions", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<RevokeSignInSessionsResponse?> PostAsync(CancellationToken cancellationToken = default, Action<RevokeSignInSessionsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<RevokeSignInSessionsResponse> PostAsync(CancellationToken cancellationToken = default, Action<RevokeSignInSessionsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
