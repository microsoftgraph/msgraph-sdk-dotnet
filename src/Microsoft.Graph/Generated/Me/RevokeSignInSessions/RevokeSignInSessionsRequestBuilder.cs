...
namespace Microsoft.Graph.Me.RevokeSignInSessions {
    ...
    public class RevokeSignInSessionsRequestBuilder : BaseRequestBuilder {
        ...
        /// </summary>
        /// <returns>A <cref="RevokeSignInSessionsPostResponse"></returns>
...
#nullable restore
        ...
        /// Find more info here <see href="https://learn.microsoft.com/graph/api/user-revokesigninsessions?view=graph-rest-1.0" />
        /// </summary>
        /// <returns>A <cref="RevokeSignInSessionsResponse"></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="ODataError">When receiving a 4XX or 5XX status code</exception>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <cref="RevokeSignInSessionsRequestBuilder"></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
