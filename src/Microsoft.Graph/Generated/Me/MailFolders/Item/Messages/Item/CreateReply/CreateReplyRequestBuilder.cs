...
namespace Microsoft.Graph.Me.MailFolders.Item.Messages.Item.CreateReply {
    ...
    public class CreateReplyRequestBuilder : BaseRequestBuilder {
        ...
        public CreateReplyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/mailFolders/{mailFolder%2Did}/messages/{message%2Did}/createReply", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CreateReplyRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CreateReplyRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/mailFolders/{mailFolder%2Did}/messages/{message%2Did}/createReply", rawUrl) {
        }
        /// <summary>
