...
namespace Microsoft.Graph.Me.MailFolders.Item.Messages.Item.Copy {
    ...
    public class CopyRequestBuilder : BaseRequestBuilder {
        ...
        public CopyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/mailFolders/{mailFolder%2Did}/messages/{message%2Did}/copy", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CopyRequestBuilder and sets the default values.
        /// </summary>
