...
namespace Microsoft.Graph.Me.MailFolders.Item.ChildFolders.Item.Move {
    ...
    public class MoveRequestBuilder : BaseRequestBuilder {
        ...
        public MoveRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/mailFolders/{mailFolder%2Did}/childFolders/{mailFolder%2Did1}/move", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new MoveRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MoveRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/mailFolders/{mailFolder%2Did}/childFolders/{mailFolder%2Did1}/move", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<MailFolder?> PostAsync(MovePostRequestBody body, CancellationToken cancellationToken = default, Action<MoveRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<MailFolder> PostAsync(MovePostRequestBody body, CancellationToken cancellationToken = default, Action<MoveRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
