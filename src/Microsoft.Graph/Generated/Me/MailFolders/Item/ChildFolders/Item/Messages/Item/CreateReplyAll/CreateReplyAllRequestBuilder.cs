...
namespace Microsoft.Graph.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.CreateReplyAll {
    ...
    public class CreateReplyAllRequestBuilder : BaseRequestBuilder {
        ...
        public CreateReplyAllRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/mailFolders/{mailFolder%2Did}/childFolders/{mailFolder%2Did1}/messages/{message%2Did}/createReplyAll", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CreateReplyAllRequestBuilder and sets the default values.
        /// </summary>
