using Microsoft.Graph.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.Attachments;
using Microsoft.Graph.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.Copy;
using Microsoft.Graph.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.CreateForward;
using Microsoft.Graph.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.CreateReply;
using Microsoft.Graph.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.CreateReplyAll;
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.Message?> GetAsync(CancellationToken cancellationToken = default, Action<MessageItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Message> GetAsync(CancellationToken cancellationToken = default, Action<MessageItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.Message?> PatchAsync(Microsoft.Graph.Models.Message body, CancellationToken cancellationToken = default, Action<MessageItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Message> PatchAsync(Microsoft.Graph.Models.Message body, CancellationToken cancellationToken = default, Action<MessageItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
