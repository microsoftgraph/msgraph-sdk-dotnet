...
namespace Microsoft.Graph.Me.MailFolders.Item.Copy {
    ...
    public class CopyRequestBuilder : BaseRequestBuilder {
        ...
        public CopyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/mailFolders/{mailFolder%2Did}/copy", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CopyRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CopyRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/mailFolders/{mailFolder%2Did}/copy", rawUrl) {
        }
        /// <summary>
