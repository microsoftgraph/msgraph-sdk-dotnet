...
using System;
namespace Microsoft.Graph.Me.Events.Item.Instances.Item.TentativelyAccept {
    /// <summary>
    ...
    public class TentativelyAcceptRequestBuilder : BaseRequestBuilder {
        ...
        public TentativelyAcceptRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/events/{event%2Did}/instances/{event%2Did1}/tentativelyAccept", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new TentativelyAcceptRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TentativelyAcceptRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/events/{event%2Did}/instances/{event%2Did1}/tentativelyAccept", rawUrl) {
        }
        /// <summary>
