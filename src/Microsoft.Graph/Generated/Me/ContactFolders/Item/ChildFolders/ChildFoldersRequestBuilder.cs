using Microsoft.Graph.Me.ContactFolders.Item.ChildFolders.Count;
using Microsoft.Graph.Me.ContactFolders.Item.ChildFolders.Delta;
using Microsoft.Graph.Me.ContactFolders.Item.ChildFolders.Item;
...
namespace Microsoft.Graph.Me.ContactFolders.Item.ChildFolders {
    ...
    public class ChildFoldersRequestBuilder : BaseRequestBuilder {
        ...
        public Microsoft.Graph.Me.ContactFolders.Item.ChildFolders.Item.ContactFolderItemRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("contactFolder%2Did1", position);
            return new Microsoft.Graph.Me.ContactFolders.Item.ChildFolders.Item.ContactFolderItemRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
