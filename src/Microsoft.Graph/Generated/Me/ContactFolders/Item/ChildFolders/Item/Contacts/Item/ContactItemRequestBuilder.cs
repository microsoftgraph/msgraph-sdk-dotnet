...
using Microsoft.Graph.Me.ContactFolders.Item.ChildFolders.Item.Contacts.Item.MultiValueExtendedProperties;
using Microsoft.Graph.Me.ContactFolders.Item.ChildFolders.Item.Contacts.Item.Photo;
using Microsoft.Graph.Me.ContactFolders.Item.ChildFolders.Item.Contacts.Item.SingleValueExtendedProperties;
...
#nullable enable
        public async Task<Stream?> DeleteAsync(Action<ContactItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Stream> DeleteAsync(Action<ContactItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
