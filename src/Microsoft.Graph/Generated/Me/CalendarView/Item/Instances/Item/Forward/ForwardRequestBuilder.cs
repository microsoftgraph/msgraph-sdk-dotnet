...
using System;
namespace Microsoft.Graph.Me.CalendarView.Item.Instances.Item.Forward {
    /// <summary>
    ...
    public class ForwardRequestBuilder : BaseRequestBuilder {
        ...
        public ForwardRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/calendarView/{event%2Did}/instances/{event%2Did1}/forward", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ForwardRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ForwardRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/calendarView/{event%2Did}/instances/{event%2Did1}/forward", rawUrl) {
        }
        /// <summary>
