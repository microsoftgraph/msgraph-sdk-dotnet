...
namespace Microsoft.Graph.Me.Teamwork.InstalledApps {
    ...
    public class InstalledAppsRequestBuilder : BaseRequestBuilder 
    {
        ...
        public UserScopeTeamsAppInstallationItemRequestBuilder this[string position]
        {
            get
            {
...
#nullable enable
        public async Task<UserScopeTeamsAppInstallationCollectionResponse?> GetAsync(Action<RequestConfiguration<InstalledAppsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<UserScopeTeamsAppInstallationCollectionResponse> GetAsync(Action<RequestConfiguration<InstalledAppsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<UserScopeTeamsAppInstallationCollectionResponse>(requestInfo, UserScopeTeamsAppInstallationCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<UserScopeTeamsAppInstallation?> PostAsync(UserScopeTeamsAppInstallation body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<UserScopeTeamsAppInstallation> PostAsync(UserScopeTeamsAppInstallation body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
