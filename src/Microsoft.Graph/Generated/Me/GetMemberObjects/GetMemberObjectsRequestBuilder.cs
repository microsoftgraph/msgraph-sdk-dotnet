...
namespace Microsoft.Graph.Me.GetMemberObjects {
    ...
    public class GetMemberObjectsRequestBuilder : BaseRequestBuilder {
        ...
        public GetMemberObjectsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/getMemberObjects", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GetMemberObjectsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetMemberObjectsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/getMemberObjects", rawUrl) {
        }
        /// <summary>
