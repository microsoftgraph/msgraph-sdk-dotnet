...
namespace Microsoft.Graph.Me.Settings
{
    ...
    public class SettingsRequestBuilder : BaseRequestBuilder
    {
        ...
        public Microsoft.Graph.Me.Settings.ShiftPreferences.ShiftPreferencesRequestBuilder ShiftPreferences
        {
            get => new Microsoft.Graph.Me.Settings.ShiftPreferences.ShiftPreferencesRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to manage the windows property of the microsoft.graph.userSettings entity.</summary>
        public Microsoft.Graph.Me.Settings.Windows.WindowsRequestBuilder Windows
        {
            get => new Microsoft.Graph.Me.Settings.Windows.WindowsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Me.Settings.SettingsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.UserSettings?> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Me.Settings.SettingsRequestBuilder.SettingsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.UserSettings> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Me.Settings.SettingsRequestBuilder.SettingsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Me.Settings.SettingsRequestBuilder.SettingsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Me.Settings.SettingsRequestBuilder.SettingsRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Me.Settings.SettingsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Me.Settings.SettingsRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Me.Settings.SettingsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class SettingsRequestBuilderGetRequestConfiguration : RequestConfiguration<Microsoft.Graph.Me.Settings.SettingsRequestBuilder.SettingsRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
