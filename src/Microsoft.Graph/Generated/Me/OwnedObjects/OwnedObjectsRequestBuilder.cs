using Microsoft.Graph.Me.OwnedObjects.Count;
using Microsoft.Graph.Me.OwnedObjects.GraphApplication;
using Microsoft.Graph.Me.OwnedObjects.GraphGroup;
using Microsoft.Graph.Me.OwnedObjects.GraphServicePrincipal;
using Microsoft.Graph.Me.OwnedObjects.Item;
...
namespace Microsoft.Graph.Me.OwnedObjects {
    ...
    public class OwnedObjectsRequestBuilder : BaseRequestBuilder {
        ...
        public OwnedObjectsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/ownedObjects{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new OwnedObjectsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public OwnedObjectsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/ownedObjects{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<DirectoryObjectCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<OwnedObjectsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DirectoryObjectCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<OwnedObjectsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
