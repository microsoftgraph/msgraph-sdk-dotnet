...
#nullable enable
        public async Task<Microsoft.Graph.Models.RoleManagement?> GetAsync(CancellationToken cancellationToken = default, Action<RoleManagementRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.RoleManagement> GetAsync(CancellationToken cancellationToken = default, Action<RoleManagementRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<Microsoft.Graph.Models.RoleManagement>(requestInfo, Microsoft.Graph.Models.RoleManagement.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.RoleManagement?> PatchAsync(Microsoft.Graph.Models.RoleManagement body, CancellationToken cancellationToken = default, Action<RoleManagementRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.RoleManagement> PatchAsync(Microsoft.Graph.Models.RoleManagement body, CancellationToken cancellationToken = default, Action<RoleManagementRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
