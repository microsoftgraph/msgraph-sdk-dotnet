...
namespace Microsoft.Graph.RoleManagement.EntitlementManagement.RoleDefinitions
{
    ...
    public class RoleDefinitionsRequestBuilder : BaseRequestBuilder
    {
        ...
        public UnifiedRoleDefinitionItemRequestBuilder this[string position]
        {
            get
            {
        ...
        public RoleDefinitionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/roleManagement/entitlementManagement/roleDefinitions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="RoleDefinitionsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RoleDefinitionsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/roleManagement/entitlementManagement/roleDefinitions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
        public async Task<UnifiedRoleDefinitionCollectionResponse?> GetAsync(Action<RequestConfiguration<RoleDefinitionsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<UnifiedRoleDefinitionCollectionResponse> GetAsync(Action<RequestConfiguration<RoleDefinitionsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
