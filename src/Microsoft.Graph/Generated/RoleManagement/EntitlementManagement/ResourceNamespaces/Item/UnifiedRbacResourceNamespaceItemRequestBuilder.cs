...
using Microsoft.Graph.RoleManagement.EntitlementManagement.ResourceNamespaces.Item.ResourceActions;
...
namespace Microsoft.Graph.RoleManagement.EntitlementManagement.ResourceNamespaces.Item {
    ...
    public class UnifiedRbacResourceNamespaceItemRequestBuilder : BaseRequestBuilder {
        ...
        public UnifiedRbacResourceNamespaceItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/roleManagement/entitlementManagement/resourceNamespaces/{unifiedRbacResourceNamespace%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new UnifiedRbacResourceNamespaceItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public UnifiedRbacResourceNamespaceItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/roleManagement/entitlementManagement/resourceNamespaces/{unifiedRbacResourceNamespace%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
