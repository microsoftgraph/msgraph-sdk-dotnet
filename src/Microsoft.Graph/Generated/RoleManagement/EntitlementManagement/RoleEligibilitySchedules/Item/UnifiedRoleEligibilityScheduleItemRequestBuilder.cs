...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<UnifiedRoleEligibilityScheduleItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<UnifiedRoleEligibilityScheduleItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<UnifiedRoleEligibilitySchedule?> GetAsync(CancellationToken cancellationToken = default, Action<UnifiedRoleEligibilityScheduleItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UnifiedRoleEligibilitySchedule> GetAsync(CancellationToken cancellationToken = default, Action<UnifiedRoleEligibilityScheduleItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<UnifiedRoleEligibilitySchedule?> PatchAsync(UnifiedRoleEligibilitySchedule body, CancellationToken cancellationToken = default, Action<UnifiedRoleEligibilityScheduleItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UnifiedRoleEligibilitySchedule> PatchAsync(UnifiedRoleEligibilitySchedule body, CancellationToken cancellationToken = default, Action<UnifiedRoleEligibilityScheduleItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
