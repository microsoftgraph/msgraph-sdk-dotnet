...
namespace Microsoft.Graph.RoleManagement.EntitlementManagement.RoleEligibilityScheduleRequests {
    ...
    public class RoleEligibilityScheduleRequestsRequestBuilder : BaseRequestBuilder 
    {
        ...
        public UnifiedRoleEligibilityScheduleRequestItemRequestBuilder this[string position]
        {
            get
            {
...
#nullable enable
        public async Task<UnifiedRoleEligibilityScheduleRequestCollectionResponse?> GetAsync(Action<RequestConfiguration<RoleEligibilityScheduleRequestsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<UnifiedRoleEligibilityScheduleRequestCollectionResponse> GetAsync(Action<RequestConfiguration<RoleEligibilityScheduleRequestsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<UnifiedRoleEligibilityScheduleRequest?> PostAsync(UnifiedRoleEligibilityScheduleRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<UnifiedRoleEligibilityScheduleRequest> PostAsync(UnifiedRoleEligibilityScheduleRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="RoleEligibilityScheduleRequestsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
...
#nullable restore
        ...
        public class RoleEligibilityScheduleRequestsRequestBuilderGetRequestConfiguration : RequestConfiguration<RoleEligibilityScheduleRequestsRequestBuilderGetQueryParameters> 
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
