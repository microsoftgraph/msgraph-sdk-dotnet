...
namespace Microsoft.Graph.RoleManagement.EntitlementManagement.RoleEligibilityScheduleRequests.Item.TargetSchedule {
    ...
    public class TargetScheduleRequestBuilder : BaseRequestBuilder {
        ...
        public TargetScheduleRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/roleManagement/entitlementManagement/roleEligibilityScheduleRequests/{unifiedRoleEligibilityScheduleRequest%2Did}/targetSchedule{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new TargetScheduleRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TargetScheduleRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/roleManagement/entitlementManagement/roleEligibilityScheduleRequests/{unifiedRoleEligibilityScheduleRequest%2Did}/targetSchedule{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<UnifiedRoleEligibilitySchedule?> GetAsync(CancellationToken cancellationToken = default, Action<TargetScheduleRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UnifiedRoleEligibilitySchedule> GetAsync(CancellationToken cancellationToken = default, Action<TargetScheduleRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
