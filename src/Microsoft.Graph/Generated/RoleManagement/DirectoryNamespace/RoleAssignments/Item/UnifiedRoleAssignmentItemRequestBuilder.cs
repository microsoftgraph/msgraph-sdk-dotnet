...
using Microsoft.Graph.RoleManagement.DirectoryNamespace.RoleAssignments.Item.AppScope;
using Microsoft.Graph.RoleManagement.DirectoryNamespace.RoleAssignments.Item.DirectoryScope;
using Microsoft.Graph.RoleManagement.DirectoryNamespace.RoleAssignments.Item.Principal;
using Microsoft.Graph.RoleManagement.DirectoryNamespace.RoleAssignments.Item.RoleDefinition;
...
namespace Microsoft.Graph.RoleManagement.DirectoryNamespace.RoleAssignments.Item {
    ...
    public class UnifiedRoleAssignmentItemRequestBuilder : BaseRequestBuilder {
        ...
        public UnifiedRoleAssignmentItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/roleManagement/directory/roleAssignments/{unifiedRoleAssignment%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new UnifiedRoleAssignmentItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public UnifiedRoleAssignmentItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/roleManagement/directory/roleAssignments/{unifiedRoleAssignment%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
