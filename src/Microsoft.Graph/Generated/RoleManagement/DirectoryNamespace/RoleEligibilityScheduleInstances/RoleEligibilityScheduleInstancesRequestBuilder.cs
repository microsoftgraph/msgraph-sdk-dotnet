...
using Microsoft.Graph.RoleManagement.DirectoryNamespace.RoleEligibilityScheduleInstances.Count;
using Microsoft.Graph.RoleManagement.DirectoryNamespace.RoleEligibilityScheduleInstances.FilterByCurrentUserWithOn;
using Microsoft.Graph.RoleManagement.DirectoryNamespace.RoleEligibilityScheduleInstances.Item;
...
namespace Microsoft.Graph.RoleManagement.DirectoryNamespace.RoleEligibilityScheduleInstances {
    ...
    public class RoleEligibilityScheduleInstancesRequestBuilder : BaseRequestBuilder {
        ...
        public UnifiedRoleEligibilityScheduleInstanceItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("unifiedRoleEligibilityScheduleInstance%2Did", position);
        ...
        public RoleEligibilityScheduleInstancesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/roleManagement/directory/roleEligibilityScheduleInstances{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RoleEligibilityScheduleInstancesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RoleEligibilityScheduleInstancesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/roleManagement/directory/roleEligibilityScheduleInstances{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable restore
        ...
        public async Task<UnifiedRoleEligibilityScheduleInstanceCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<RoleEligibilityScheduleInstancesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
            ...
            return await RequestAdapter.SendAsync<UnifiedRoleEligibilityScheduleInstanceCollectionResponse>(requestInfo, UnifiedRoleEligibilityScheduleInstanceCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RoleEligibilityScheduleInstancesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RoleEligibilityScheduleInstancesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RoleEligibilityScheduleInstancesRequestBuilderGetRequestConfiguration();
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(UnifiedRoleEligibilityScheduleInstance body, Action<RoleEligibilityScheduleInstancesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(UnifiedRoleEligibilityScheduleInstance body, Action<RoleEligibilityScheduleInstancesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RoleEligibilityScheduleInstancesRequestBuilderPostRequestConfiguration();
                requestConfiguration.Invoke(requestConfig);
                requestInfo.AddRequestOptions(requestConfig.Options);
                requestInfo.AddHeaders(requestConfig.Headers);
            }
...
#nullable restore
        ...
        public class RoleEligibilityScheduleInstancesRequestBuilderGetRequestConfiguration {
            ...
            public RoleEligibilityScheduleInstancesRequestBuilderGetQueryParameters QueryParameters { get; set; } = new RoleEligibilityScheduleInstancesRequestBuilderGetQueryParameters();
            /// <summary>
