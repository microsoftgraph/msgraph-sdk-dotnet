...
using Microsoft.Graph.RoleManagement.DirectoryNamespace.RoleAssignmentSchedules.Count;
using Microsoft.Graph.RoleManagement.DirectoryNamespace.RoleAssignmentSchedules.FilterByCurrentUserWithOn;
using Microsoft.Graph.RoleManagement.DirectoryNamespace.RoleAssignmentSchedules.Item;
...
namespace Microsoft.Graph.RoleManagement.DirectoryNamespace.RoleAssignmentSchedules {
    ...
    public class RoleAssignmentSchedulesRequestBuilder : BaseRequestBuilder {
        ...
        public RoleAssignmentSchedulesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/roleManagement/directory/roleAssignmentSchedules{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RoleAssignmentSchedulesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RoleAssignmentSchedulesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/roleManagement/directory/roleAssignmentSchedules{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
