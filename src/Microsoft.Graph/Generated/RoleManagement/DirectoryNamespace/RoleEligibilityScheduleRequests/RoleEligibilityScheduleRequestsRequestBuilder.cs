...
using Microsoft.Graph.RoleManagement.DirectoryNamespace.RoleEligibilityScheduleRequests.Count;
using Microsoft.Graph.RoleManagement.DirectoryNamespace.RoleEligibilityScheduleRequests.FilterByCurrentUserWithOn;
using Microsoft.Graph.RoleManagement.DirectoryNamespace.RoleEligibilityScheduleRequests.Item;
...
namespace Microsoft.Graph.RoleManagement.DirectoryNamespace.RoleEligibilityScheduleRequests {
    ...
    public class RoleEligibilityScheduleRequestsRequestBuilder : BaseRequestBuilder {
        ...
        public RoleEligibilityScheduleRequestsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/roleManagement/directory/roleEligibilityScheduleRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RoleEligibilityScheduleRequestsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RoleEligibilityScheduleRequestsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/roleManagement/directory/roleEligibilityScheduleRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<UnifiedRoleEligibilityScheduleRequestCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<RoleEligibilityScheduleRequestsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UnifiedRoleEligibilityScheduleRequestCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<RoleEligibilityScheduleRequestsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<UnifiedRoleEligibilityScheduleRequest?> PostAsync(UnifiedRoleEligibilityScheduleRequest body, CancellationToken cancellationToken = default, Action<RoleEligibilityScheduleRequestsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UnifiedRoleEligibilityScheduleRequest> PostAsync(UnifiedRoleEligibilityScheduleRequest body, CancellationToken cancellationToken = default, Action<RoleEligibilityScheduleRequestsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
