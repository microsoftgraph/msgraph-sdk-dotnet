using Microsoft.Graph.IdentityProtection.RiskyServicePrincipals.Item.History.Count;
using Microsoft.Graph.IdentityProtection.RiskyServicePrincipals.Item.History.Item;
...
namespace Microsoft.Graph.IdentityProtection.RiskyServicePrincipals.Item.History {
    ...
    public class HistoryRequestBuilder : BaseRequestBuilder {
        ...
        public RiskyServicePrincipalHistoryItemItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("riskyServicePrincipalHistoryItem%2Did", position);
        ...
        public HistoryRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/identityProtection/riskyServicePrincipals/{riskyServicePrincipal%2Did}/history{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new HistoryRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public HistoryRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/identityProtection/riskyServicePrincipals/{riskyServicePrincipal%2Did}/history{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<RiskyServicePrincipalHistoryItemCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<HistoryRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<RiskyServicePrincipalHistoryItemCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<HistoryRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<RiskyServicePrincipalHistoryItemCollectionResponse>(requestInfo, RiskyServicePrincipalHistoryItemCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<RiskyServicePrincipalHistoryItem?> PostAsync(RiskyServicePrincipalHistoryItem body, CancellationToken cancellationToken = default, Action<HistoryRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<RiskyServicePrincipalHistoryItem> PostAsync(RiskyServicePrincipalHistoryItem body, CancellationToken cancellationToken = default, Action<HistoryRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(RiskyServicePrincipalHistoryItem body, Action<HistoryRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(RiskyServicePrincipalHistoryItem body, Action<HistoryRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new HistoryRequestBuilderPostRequestConfiguration();
                requestConfiguration.Invoke(requestConfig);
                requestInfo.AddRequestOptions(requestConfig.Options);
                requestInfo.AddHeaders(requestConfig.Headers);
            }
