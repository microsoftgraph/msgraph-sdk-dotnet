...
namespace Microsoft.Graph.IdentityProtection.RiskyServicePrincipals.Dismiss {
    ...
    public class DismissRequestBuilder : BaseRequestBuilder {
        ...
        public DismissRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/identityProtection/riskyServicePrincipals/dismiss", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new DismissRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DismissRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/identityProtection/riskyServicePrincipals/dismiss", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task PostAsync(DismissPostRequestBody body, CancellationToken cancellationToken = default, Action<DismissRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(DismissPostRequestBody body, CancellationToken cancellationToken = default, Action<DismissRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
