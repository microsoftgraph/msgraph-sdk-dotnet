...
#nullable enable
        public async Task<RiskyServicePrincipalCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<RiskyServicePrincipalsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<RiskyServicePrincipalCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<RiskyServicePrincipalsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<RiskyServicePrincipal?> PostAsync(RiskyServicePrincipal body, CancellationToken cancellationToken = default, Action<RiskyServicePrincipalsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<RiskyServicePrincipal> PostAsync(RiskyServicePrincipal body, CancellationToken cancellationToken = default, Action<RiskyServicePrincipalsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
