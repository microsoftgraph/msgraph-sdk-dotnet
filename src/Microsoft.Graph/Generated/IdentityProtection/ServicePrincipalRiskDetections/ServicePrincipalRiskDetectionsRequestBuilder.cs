...
#nullable enable
        public async Task<ServicePrincipalRiskDetectionCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ServicePrincipalRiskDetectionsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ServicePrincipalRiskDetectionCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ServicePrincipalRiskDetectionsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ServicePrincipalRiskDetection?> PostAsync(ServicePrincipalRiskDetection body, CancellationToken cancellationToken = default, Action<ServicePrincipalRiskDetectionsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ServicePrincipalRiskDetection> PostAsync(ServicePrincipalRiskDetection body, CancellationToken cancellationToken = default, Action<ServicePrincipalRiskDetectionsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
