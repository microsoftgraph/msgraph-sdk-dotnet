using Microsoft.Graph.IdentityProtection.RiskyUsers.Item.History.Count;
using Microsoft.Graph.IdentityProtection.RiskyUsers.Item.History.Item;
...
namespace Microsoft.Graph.IdentityProtection.RiskyUsers.Item.History {
    ...
    public class HistoryRequestBuilder : BaseRequestBuilder {
        ...
        public RiskyUserHistoryItemItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("riskyUserHistoryItem%2Did", position);
        ...
        public HistoryRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/identityProtection/riskyUsers/{riskyUser%2Did}/history{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new HistoryRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/riskyuser-get-riskyuserhistoryitem?view=graph-rest-1.0" />
        /// </summary>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<RiskyUserHistoryItemCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<HistoryRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<RiskyUserHistoryItemCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<HistoryRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<RiskyUserHistoryItemCollectionResponse>(requestInfo, RiskyUserHistoryItemCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<RiskyUserHistoryItem?> PostAsync(RiskyUserHistoryItem body, CancellationToken cancellationToken = default, Action<HistoryRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<RiskyUserHistoryItem> PostAsync(RiskyUserHistoryItem body, CancellationToken cancellationToken = default, Action<HistoryRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(RiskyUserHistoryItem body, Action<HistoryRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(RiskyUserHistoryItem body, Action<HistoryRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
