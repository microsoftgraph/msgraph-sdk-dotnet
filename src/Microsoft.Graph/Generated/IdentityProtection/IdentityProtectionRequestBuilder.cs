...
#nullable enable
        public async Task<IdentityProtectionRoot?> GetAsync(CancellationToken cancellationToken = default, Action<IdentityProtectionRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<IdentityProtectionRoot> GetAsync(CancellationToken cancellationToken = default, Action<IdentityProtectionRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<IdentityProtectionRoot?> PatchAsync(IdentityProtectionRoot body, CancellationToken cancellationToken = default, Action<IdentityProtectionRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<IdentityProtectionRoot> PatchAsync(IdentityProtectionRoot body, CancellationToken cancellationToken = default, Action<IdentityProtectionRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
