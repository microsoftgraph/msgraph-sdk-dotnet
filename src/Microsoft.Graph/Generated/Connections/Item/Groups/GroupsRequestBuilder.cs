using Microsoft.Graph.Connections.Item.Groups.Count;
using Microsoft.Graph.Connections.Item.Groups.Item;
...
namespace Microsoft.Graph.Connections.Item.Groups {
    ...
    public class GroupsRequestBuilder : BaseRequestBuilder {
        ...
        public ExternalGroupItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("externalGroup%2Did", position);
        ...
        public GroupsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/connections/{externalConnection%2Did}/groups{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GroupsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GroupsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/connections/{externalConnection%2Did}/groups{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<ExternalGroupCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<GroupsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ExternalGroupCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<GroupsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ExternalGroup?> PostAsync(ExternalGroup body, CancellationToken cancellationToken = default, Action<GroupsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ExternalGroup> PostAsync(ExternalGroup body, CancellationToken cancellationToken = default, Action<GroupsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(ExternalGroup body, Action<GroupsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ExternalGroup body, Action<GroupsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
