...
namespace Microsoft.Graph.Connections.Item.Schema
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Connections.Item.Schema.SchemaRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Microsoft.Graph.Models.ExternalConnectors.Schema?> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Connections.Item.Schema.SchemaRequestBuilder.SchemaRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.ExternalConnectors.Schema> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Connections.Item.Schema.SchemaRequestBuilder.SchemaRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Connections.Item.Schema.SchemaRequestBuilder.SchemaRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Connections.Item.Schema.SchemaRequestBuilder.SchemaRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Connections.Item.Schema.SchemaRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Connections.Item.Schema.SchemaRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Connections.Item.Schema.SchemaRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Get schema from connections
        /// </summary>
...
#nullable restore
        ...
        public class SchemaRequestBuilderGetRequestConfiguration : RequestConfiguration<Microsoft.Graph.Connections.Item.Schema.SchemaRequestBuilder.SchemaRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
