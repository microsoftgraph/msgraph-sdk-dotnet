using Microsoft.Graph.Connections.Item.Items.Item.Activities.Item.PerformedBy;
...
namespace Microsoft.Graph.Connections.Item.Items.Item.Activities.Item {
    ...
    public class ExternalActivityItemRequestBuilder : BaseRequestBuilder {
        ...
        public ExternalActivityItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/connections/{externalConnection%2Did}/items/{externalItem%2Did}/activities/{externalActivity%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ExternalActivityItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ExternalActivityItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/connections/{externalConnection%2Did}/items/{externalItem%2Did}/activities/{externalActivity%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ExternalActivityItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ExternalActivityItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ExternalActivity?> GetAsync(CancellationToken cancellationToken = default, Action<ExternalActivityItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ExternalActivity> GetAsync(CancellationToken cancellationToken = default, Action<ExternalActivityItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ExternalActivity?> PatchAsync(ExternalActivity body, CancellationToken cancellationToken = default, Action<ExternalActivityItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ExternalActivity> PatchAsync(ExternalActivity body, CancellationToken cancellationToken = default, Action<ExternalActivityItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
