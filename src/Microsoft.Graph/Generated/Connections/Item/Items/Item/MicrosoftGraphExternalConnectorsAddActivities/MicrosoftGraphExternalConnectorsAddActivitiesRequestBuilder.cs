...
#nullable enable
        public async Task<AddActivitiesResponse?> PostAsync(AddActivitiesPostRequestBody body, CancellationToken cancellationToken = default, Action<MicrosoftGraphExternalConnectorsAddActivitiesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AddActivitiesResponse> PostAsync(AddActivitiesPostRequestBody body, CancellationToken cancellationToken = default, Action<MicrosoftGraphExternalConnectorsAddActivitiesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
