...
namespace Microsoft.Graph.Connections.Item.Items.Item {
    ...
    public class ExternalItemItemRequestBuilder : BaseRequestBuilder {
        ...
        public ExternalItemItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/connections/{externalConnection%2Did}/items/{externalItem%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ExternalItemItemRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ExternalItemItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ExternalItemItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ExternalItem?> GetAsync(CancellationToken cancellationToken = default, Action<ExternalItemItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ExternalItem> GetAsync(CancellationToken cancellationToken = default, Action<ExternalItemItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ExternalItem?> PutAsync(ExternalItem body, CancellationToken cancellationToken = default, Action<ExternalItemItemRequestBuilderPutRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ExternalItem> PutAsync(ExternalItem body, CancellationToken cancellationToken = default, Action<ExternalItemItemRequestBuilderPutRequestConfiguration> requestConfiguration = default) {
#endif
