...
namespace Microsoft.Graph.External.Connections.Item.Schema {
    ...
    public class SchemaRequestBuilder : BaseRequestBuilder {
        ...
        public SchemaRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/external/connections/{externalConnection%2Did}/schema{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SchemaRequestBuilder and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.ExternalConnectors.Schema?> GetAsync(CancellationToken cancellationToken = default, Action<SchemaRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.ExternalConnectors.Schema> GetAsync(CancellationToken cancellationToken = default, Action<SchemaRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<Microsoft.Graph.Models.ExternalConnectors.Schema>(requestInfo, Microsoft.Graph.Models.ExternalConnectors.Schema.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.ExternalConnectors.Schema?> PatchAsync(Microsoft.Graph.Models.ExternalConnectors.Schema body, CancellationToken cancellationToken = default, Action<SchemaRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.ExternalConnectors.Schema> PatchAsync(Microsoft.Graph.Models.ExternalConnectors.Schema body, CancellationToken cancellationToken = default, Action<SchemaRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(Microsoft.Graph.Models.ExternalConnectors.Schema body, Action<SchemaRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(Microsoft.Graph.Models.ExternalConnectors.Schema body, Action<SchemaRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
