using Microsoft.Graph.External.Connections.Item.Groups.Count;
using Microsoft.Graph.External.Connections.Item.Groups.Item;
...
namespace Microsoft.Graph.External.Connections.Item.Groups {
    ...
    public class GroupsRequestBuilder : BaseRequestBuilder {
        ...
        public GroupsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/external/connections/{externalConnection%2Did}/groups{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GroupsRequestBuilder and sets the default values.
        /// </summary>
