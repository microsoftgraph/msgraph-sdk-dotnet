using Microsoft.Graph.External.Connections.Item.Items.Item.Activities.Count;
using Microsoft.Graph.External.Connections.Item.Items.Item.Activities.Item;
...
namespace Microsoft.Graph.External.Connections.Item.Items.Item.Activities {
    ...
    public class ActivitiesRequestBuilder : BaseRequestBuilder {
        ...
        public ActivitiesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/external/connections/{externalConnection%2Did}/items/{externalItem%2Did}/activities{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ActivitiesRequestBuilder and sets the default values.
        /// </summary>
