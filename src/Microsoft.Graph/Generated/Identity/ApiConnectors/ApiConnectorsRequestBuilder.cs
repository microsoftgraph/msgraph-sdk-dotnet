...
namespace Microsoft.Graph.Identity.ApiConnectors {
    ...
    public class ApiConnectorsRequestBuilder : BaseRequestBuilder {
        ...
        public IdentityApiConnectorItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("identityApiConnector%2Did", position);
        ...
        public ApiConnectorsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/identity/apiConnectors{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ApiConnectorsRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<IdentityApiConnectorCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ApiConnectorsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<IdentityApiConnectorCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ApiConnectorsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<IdentityApiConnectorCollectionResponse>(requestInfo, IdentityApiConnectorCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<IdentityApiConnector?> PostAsync(IdentityApiConnector body, CancellationToken cancellationToken = default, Action<ApiConnectorsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<IdentityApiConnector> PostAsync(IdentityApiConnector body, CancellationToken cancellationToken = default, Action<ApiConnectorsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
