...
#nullable enable
        public async Task<UpdateAllowedCombinationsResult?> PostAsync(UpdateAllowedCombinationsPostRequestBody body, CancellationToken cancellationToken = default, Action<UpdateAllowedCombinationsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UpdateAllowedCombinationsResult> PostAsync(UpdateAllowedCombinationsPostRequestBody body, CancellationToken cancellationToken = default, Action<UpdateAllowedCombinationsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
