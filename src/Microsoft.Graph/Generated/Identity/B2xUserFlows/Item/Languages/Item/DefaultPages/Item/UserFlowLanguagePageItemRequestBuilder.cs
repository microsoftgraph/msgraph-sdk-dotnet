using Microsoft.Graph.Identity.B2xUserFlows.Item.Languages.Item.DefaultPages.Item.Value;
...
namespace Microsoft.Graph.Identity.B2xUserFlows.Item.Languages.Item.DefaultPages.Item {
    ...
    public class UserFlowLanguagePageItemRequestBuilder : BaseRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public UserFlowLanguagePageItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/identity/b2xUserFlows/{b2xIdentityUserFlow%2Did}/languages/{userFlowLanguageConfiguration%2Did}/defaultPages/{userFlowLanguagePage%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
