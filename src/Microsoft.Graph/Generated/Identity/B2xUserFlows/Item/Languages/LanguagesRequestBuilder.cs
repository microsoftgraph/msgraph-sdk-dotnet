using Microsoft.Graph.Identity.B2xUserFlows.Item.Languages.Count;
using Microsoft.Graph.Identity.B2xUserFlows.Item.Languages.Item;
...
namespace Microsoft.Graph.Identity.B2xUserFlows.Item.Languages {
    ...
    public class LanguagesRequestBuilder : BaseRequestBuilder {
        ...
        public LanguagesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/identity/b2xUserFlows/{b2xIdentityUserFlow%2Did}/languages{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new LanguagesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public LanguagesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/identity/b2xUserFlows/{b2xIdentityUserFlow%2Did}/languages{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Retrieve a list of languages supported for customization in a B2X user flow.
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/b2xidentityuserflow-list-languages?view=graph-rest-1.0" />
        /// </summary>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<UserFlowLanguageConfigurationCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<LanguagesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UserFlowLanguageConfigurationCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<LanguagesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<UserFlowLanguageConfigurationCollectionResponse>(requestInfo, UserFlowLanguageConfigurationCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<UserFlowLanguageConfiguration?> PostAsync(UserFlowLanguageConfiguration body, CancellationToken cancellationToken = default, Action<LanguagesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UserFlowLanguageConfiguration> PostAsync(UserFlowLanguageConfiguration body, CancellationToken cancellationToken = default, Action<LanguagesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(UserFlowLanguageConfiguration body, Action<LanguagesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(UserFlowLanguageConfiguration body, Action<LanguagesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
