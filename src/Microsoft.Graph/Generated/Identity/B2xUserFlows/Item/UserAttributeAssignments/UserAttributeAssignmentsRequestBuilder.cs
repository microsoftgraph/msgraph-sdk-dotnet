using Microsoft.Graph.Identity.B2xUserFlows.Item.UserAttributeAssignments.Count;
using Microsoft.Graph.Identity.B2xUserFlows.Item.UserAttributeAssignments.GetOrder;
using Microsoft.Graph.Identity.B2xUserFlows.Item.UserAttributeAssignments.Item;
...
#nullable enable
        public async Task<IdentityUserFlowAttributeAssignmentCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<UserAttributeAssignmentsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<IdentityUserFlowAttributeAssignmentCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<UserAttributeAssignmentsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<IdentityUserFlowAttributeAssignment?> PostAsync(IdentityUserFlowAttributeAssignment body, CancellationToken cancellationToken = default, Action<UserAttributeAssignmentsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<IdentityUserFlowAttributeAssignment> PostAsync(IdentityUserFlowAttributeAssignment body, CancellationToken cancellationToken = default, Action<UserAttributeAssignmentsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
