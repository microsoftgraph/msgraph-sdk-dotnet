...
namespace Microsoft.Graph.Identity.B2xUserFlows {
    ...
    public class B2xUserFlowsRequestBuilder : BaseRequestBuilder {
        ...
        public B2xIdentityUserFlowItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("b2xIdentityUserFlow%2Did", position);
...
#nullable enable
        public async Task<B2xIdentityUserFlowCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<B2xUserFlowsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<B2xIdentityUserFlowCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<B2xUserFlowsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<B2xIdentityUserFlow?> PostAsync(B2xIdentityUserFlow body, CancellationToken cancellationToken = default, Action<B2xUserFlowsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<B2xIdentityUserFlow> PostAsync(B2xIdentityUserFlow body, CancellationToken cancellationToken = default, Action<B2xUserFlowsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
