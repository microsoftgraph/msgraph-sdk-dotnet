...
#nullable enable
        public async Task<ThumbnailSetCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ThumbnailsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ThumbnailSetCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ThumbnailsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ThumbnailSet?> PostAsync(ThumbnailSet body, CancellationToken cancellationToken = default, Action<ThumbnailsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ThumbnailSet> PostAsync(ThumbnailSet body, CancellationToken cancellationToken = default, Action<ThumbnailsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
