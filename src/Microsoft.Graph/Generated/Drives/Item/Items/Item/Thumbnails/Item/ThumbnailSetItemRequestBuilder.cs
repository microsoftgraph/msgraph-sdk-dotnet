...
namespace Microsoft.Graph.Drives.Item.Items.Item.Thumbnails.Item {
    ...
    public class ThumbnailSetItemRequestBuilder : BaseRequestBuilder {
        ...
        public ThumbnailSetItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/thumbnails/{thumbnailSet%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ThumbnailSetItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ThumbnailSetItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/thumbnails/{thumbnailSet%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ThumbnailSetItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ThumbnailSetItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ThumbnailSet?> GetAsync(CancellationToken cancellationToken = default, Action<ThumbnailSetItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ThumbnailSet> GetAsync(CancellationToken cancellationToken = default, Action<ThumbnailSetItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ThumbnailSet?> PatchAsync(ThumbnailSet body, CancellationToken cancellationToken = default, Action<ThumbnailSetItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ThumbnailSet> PatchAsync(ThumbnailSet body, CancellationToken cancellationToken = default, Action<ThumbnailSetItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
