...
#nullable enable
        public async Task<WorkbookFunctionResult?> PostAsync(LogNorm_InvPostRequestBody body, CancellationToken cancellationToken = default, Action<LogNorm_InvRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookFunctionResult> PostAsync(LogNorm_InvPostRequestBody body, CancellationToken cancellationToken = default, Action<LogNorm_InvRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
