...
#nullable enable
        public async Task<WorkbookFunctionResult?> PostAsync(FisherInvPostRequestBody body, CancellationToken cancellationToken = default, Action<FisherInvRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookFunctionResult> PostAsync(FisherInvPostRequestBody body, CancellationToken cancellationToken = default, Action<FisherInvRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
