...
#nullable enable
        public async Task<WorkbookFunctionResult?> PostAsync(MaxAPostRequestBody body, CancellationToken cancellationToken = default, Action<MaxARequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookFunctionResult> PostAsync(MaxAPostRequestBody body, CancellationToken cancellationToken = default, Action<MaxARequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
