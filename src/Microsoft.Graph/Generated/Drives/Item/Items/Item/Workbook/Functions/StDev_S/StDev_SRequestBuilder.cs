...
#nullable enable
        public async Task<WorkbookFunctionResult?> PostAsync(StDev_SPostRequestBody body, CancellationToken cancellationToken = default, Action<StDev_SRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookFunctionResult> PostAsync(StDev_SPostRequestBody body, CancellationToken cancellationToken = default, Action<StDev_SRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
