...
#nullable enable
        public async Task<WorkbookSessionInfo?> GetAsync(CancellationToken cancellationToken = default, Action<SessionInfoResourceWithKeyRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookSessionInfo> GetAsync(CancellationToken cancellationToken = default, Action<SessionInfoResourceWithKeyRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
