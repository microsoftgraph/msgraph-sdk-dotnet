...
#nullable enable
        public async Task<WorkbookFunctionResult?> PostAsync(ReplacePostRequestBody body, CancellationToken cancellationToken = default, Action<ReplaceRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookFunctionResult> PostAsync(ReplacePostRequestBody body, CancellationToken cancellationToken = default, Action<ReplaceRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
