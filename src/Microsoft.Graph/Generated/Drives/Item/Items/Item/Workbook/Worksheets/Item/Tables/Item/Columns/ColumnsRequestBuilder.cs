...
namespace Microsoft.Graph.Drives.Item.Items.Item.Workbook.Worksheets.Item.Tables.Item.Columns {
    ...
    public class ColumnsRequestBuilder : BaseRequestBuilder {
        ...
        public ColumnsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/tables/{workbookTable%2Did}/columns{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ColumnsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ColumnsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/tables/{workbookTable%2Did}/columns{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<WorkbookTableColumnCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ColumnsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookTableColumnCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ColumnsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/table-post-columns?view=graph-rest-1.0" />
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<WorkbookTableColumn?> PostAsync(WorkbookTableColumn body, CancellationToken cancellationToken = default, Action<ColumnsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookTableColumn> PostAsync(WorkbookTableColumn body, CancellationToken cancellationToken = default, Action<ColumnsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
