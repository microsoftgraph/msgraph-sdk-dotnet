...
namespace Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Columns {
    ...
    public class ColumnsRequestBuilder : BaseRequestBuilder {
        ...
        public ColumnsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/columns", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ColumnsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ColumnsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/columns", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<WorkbookFunctionResult?> PostAsync(ColumnsPostRequestBody body, CancellationToken cancellationToken = default, Action<ColumnsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookFunctionResult> PostAsync(ColumnsPostRequestBody body, CancellationToken cancellationToken = default, Action<ColumnsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
