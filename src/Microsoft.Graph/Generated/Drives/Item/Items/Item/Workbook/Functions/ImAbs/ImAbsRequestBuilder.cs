...
#nullable enable
        public async Task<WorkbookFunctionResult?> PostAsync(ImAbsPostRequestBody body, CancellationToken cancellationToken = default, Action<ImAbsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookFunctionResult> PostAsync(ImAbsPostRequestBody body, CancellationToken cancellationToken = default, Action<ImAbsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
