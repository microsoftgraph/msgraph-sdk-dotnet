...
namespace Microsoft.Graph.Drives.Item.Items.Item.Workbook.Worksheets.Item.Charts.Item.SetData {
    ...
    public class SetDataRequestBuilder : BaseRequestBuilder {
        ...
        public SetDataRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/{workbookChart%2Did}/setData", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SetDataRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SetDataRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/{workbookChart%2Did}/setData", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task PostAsync(SetDataPostRequestBody body, CancellationToken cancellationToken = default, Action<SetDataRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(SetDataPostRequestBody body, CancellationToken cancellationToken = default, Action<SetDataRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
