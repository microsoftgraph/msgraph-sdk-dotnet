...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<WorkbookChartDataLabelFormat?> GetAsync(CancellationToken cancellationToken = default, Action<FormatRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookChartDataLabelFormat> GetAsync(CancellationToken cancellationToken = default, Action<FormatRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<WorkbookChartDataLabelFormat?> PatchAsync(WorkbookChartDataLabelFormat body, CancellationToken cancellationToken = default, Action<FormatRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookChartDataLabelFormat> PatchAsync(WorkbookChartDataLabelFormat body, CancellationToken cancellationToken = default, Action<FormatRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
