...
#nullable enable
        public async Task<WorkbookFunctionResult?> PostAsync(Iso_CeilingPostRequestBody body, CancellationToken cancellationToken = default, Action<Iso_CeilingRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookFunctionResult> PostAsync(Iso_CeilingPostRequestBody body, CancellationToken cancellationToken = default, Action<Iso_CeilingRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Iso_CeilingPostRequestBody body, Action<Iso_CeilingRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Iso_CeilingPostRequestBody body, Action<Iso_CeilingRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new Iso_CeilingRequestBuilderPostRequestConfiguration();
        ...
        /// </summary>
        public class Iso_CeilingRequestBuilderPostRequestConfiguration {
            /// <summary>Request headers</summary>
            public RequestHeaders Headers { get; set; }
            /// <summary>Request options</summary>
            public IList<IRequestOption> Options { get; set; }
            /// <summary>
            /// Instantiates a new iso_CeilingRequestBuilderPostRequestConfiguration and sets the default values.
            /// </summary>
            public Iso_CeilingRequestBuilderPostRequestConfiguration() {
