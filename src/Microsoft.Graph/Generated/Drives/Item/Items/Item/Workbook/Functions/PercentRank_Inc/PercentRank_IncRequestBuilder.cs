...
#nullable enable
        public async Task<WorkbookFunctionResult?> PostAsync(PercentRank_IncPostRequestBody body, CancellationToken cancellationToken = default, Action<PercentRank_IncRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookFunctionResult> PostAsync(PercentRank_IncPostRequestBody body, CancellationToken cancellationToken = default, Action<PercentRank_IncRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
