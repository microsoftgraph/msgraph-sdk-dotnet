...
namespace Microsoft.Graph.Drives.Item.Items.Item.Workbook.Worksheets.Item.Charts.ItemAtWithIndex {
    ...
    public class ItemAtWithIndexRequestBuilder : BaseRequestBuilder {
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/chartcollection-itemat?view=graph-rest-1.0" />
        /// </summary>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<WorkbookChart?> GetAsync(CancellationToken cancellationToken = default, Action<ItemAtWithIndexRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookChart> GetAsync(CancellationToken cancellationToken = default, Action<ItemAtWithIndexRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
