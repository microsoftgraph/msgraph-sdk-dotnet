using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Worksheets.Item.PivotTables.Count;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Worksheets.Item.PivotTables.Item;
...
namespace Microsoft.Graph.Drives.Item.Items.Item.Workbook.Worksheets.Item.PivotTables {
    ...
    public class PivotTablesRequestBuilder : BaseRequestBuilder {
        ...
        public WorkbookPivotTableItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("workbookPivotTable%2Did", position);
        ...
        public PivotTablesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/pivotTables{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new PivotTablesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PivotTablesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/pivotTables{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<WorkbookPivotTableCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<PivotTablesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookPivotTableCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<PivotTablesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<WorkbookPivotTableCollectionResponse>(requestInfo, WorkbookPivotTableCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<WorkbookPivotTable?> PostAsync(WorkbookPivotTable body, CancellationToken cancellationToken = default, Action<PivotTablesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookPivotTable> PostAsync(WorkbookPivotTable body, CancellationToken cancellationToken = default, Action<PivotTablesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
