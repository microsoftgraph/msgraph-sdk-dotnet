...
#nullable enable
        public async Task<WorkbookFunctionResult?> PostAsync(MinAPostRequestBody body, CancellationToken cancellationToken = default, Action<MinARequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookFunctionResult> PostAsync(MinAPostRequestBody body, CancellationToken cancellationToken = default, Action<MinARequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
