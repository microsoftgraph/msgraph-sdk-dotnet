...
#nullable enable
        public async Task<WorkbookChart?> GetAsync(CancellationToken cancellationToken = default, Action<ItemWithNameRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookChart> GetAsync(CancellationToken cancellationToken = default, Action<ItemWithNameRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
