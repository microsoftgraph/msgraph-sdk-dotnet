using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Comments.Count;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Comments.Item;
...
namespace Microsoft.Graph.Drives.Item.Items.Item.Workbook.Comments {
    ...
    public class CommentsRequestBuilder : BaseRequestBuilder {
        ...
        public WorkbookCommentItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("workbookComment%2Did", position);
        ...
        public CommentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/comments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CommentsRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<WorkbookCommentCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<CommentsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookCommentCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<CommentsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<WorkbookCommentCollectionResponse>(requestInfo, WorkbookCommentCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<WorkbookComment?> PostAsync(WorkbookComment body, CancellationToken cancellationToken = default, Action<CommentsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookComment> PostAsync(WorkbookComment body, CancellationToken cancellationToken = default, Action<CommentsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(WorkbookComment body, Action<CommentsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(WorkbookComment body, Action<CommentsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
