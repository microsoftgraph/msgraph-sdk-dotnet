...
#nullable enable
        public async Task PostAsync(ApplyTopItemsFilterPostRequestBody body, CancellationToken cancellationToken = default, Action<ApplyTopItemsFilterRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(ApplyTopItemsFilterPostRequestBody body, CancellationToken cancellationToken = default, Action<ApplyTopItemsFilterRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(ApplyTopItemsFilterPostRequestBody body, Action<ApplyTopItemsFilterRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApplyTopItemsFilterPostRequestBody body, Action<ApplyTopItemsFilterRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new ApplyTopItemsFilterRequestBuilderPostRequestConfiguration();
        ...
        /// </summary>
        public class ApplyTopItemsFilterRequestBuilderPostRequestConfiguration {
            ...
            /// </summary>
            public ApplyTopItemsFilterRequestBuilderPostRequestConfiguration() {
