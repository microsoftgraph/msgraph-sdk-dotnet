...
#nullable enable
        public async Task<WorkbookChartSeries?> GetAsync(CancellationToken cancellationToken = default, Action<ItemAtWithIndexRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookChartSeries> GetAsync(CancellationToken cancellationToken = default, Action<ItemAtWithIndexRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
