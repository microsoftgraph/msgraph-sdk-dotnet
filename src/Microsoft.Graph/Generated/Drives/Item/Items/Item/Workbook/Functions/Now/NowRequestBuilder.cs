...
#nullable enable
        public async Task<WorkbookFunctionResult?> PostAsync(CancellationToken cancellationToken = default, Action<NowRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookFunctionResult> PostAsync(CancellationToken cancellationToken = default, Action<NowRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
