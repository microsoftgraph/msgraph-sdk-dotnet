...
#nullable enable
        public async Task<WorkbookFunctionResult?> PostAsync(CombinPostRequestBody body, CancellationToken cancellationToken = default, Action<CombinRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookFunctionResult> PostAsync(CombinPostRequestBody body, CancellationToken cancellationToken = default, Action<CombinRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
