...
#nullable enable
        public async Task<WorkbookFunctionResult?> PostAsync(ChiSq_DistPostRequestBody body, CancellationToken cancellationToken = default, Action<ChiSq_DistRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookFunctionResult> PostAsync(ChiSq_DistPostRequestBody body, CancellationToken cancellationToken = default, Action<ChiSq_DistRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
