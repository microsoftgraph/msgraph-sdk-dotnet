...
namespace Microsoft.Graph.Drives.Item.Items.Item.Workbook.Names.Add {
    ...
    public class AddRequestBuilder : BaseRequestBuilder {
        ...
        public AddRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/names/add", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AddRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AddRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/names/add", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<WorkbookNamedItem?> PostAsync(AddPostRequestBody body, CancellationToken cancellationToken = default, Action<AddRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookNamedItem> PostAsync(AddPostRequestBody body, CancellationToken cancellationToken = default, Action<AddRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
