...
#nullable enable
        public async Task<WorkbookChartPoint?> GetAsync(CancellationToken cancellationToken = default, Action<ItemAtWithIndexRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookChartPoint> GetAsync(CancellationToken cancellationToken = default, Action<ItemAtWithIndexRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
