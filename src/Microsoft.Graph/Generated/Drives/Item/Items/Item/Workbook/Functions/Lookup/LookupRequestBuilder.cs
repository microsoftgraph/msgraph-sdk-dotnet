...
namespace Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Lookup {
    ...
    public class LookupRequestBuilder : BaseRequestBuilder {
        ...
        public LookupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/lookup", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new LookupRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public LookupRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/lookup", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<WorkbookFunctionResult?> PostAsync(LookupPostRequestBody body, CancellationToken cancellationToken = default, Action<LookupRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookFunctionResult> PostAsync(LookupPostRequestBody body, CancellationToken cancellationToken = default, Action<LookupRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
