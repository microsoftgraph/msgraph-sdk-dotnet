...
namespace Microsoft.Graph.Drives.Item.Items.Item.Workbook.Worksheets.Add {
    ...
    public class AddRequestBuilder : BaseRequestBuilder {
        ...
        public AddRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/add", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AddRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AddRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/add", rawUrl) {
        }
        /// <summary>
        /// Adds a new worksheet to the workbook. The worksheet will be added at the end of existing worksheets. If you wish to activate the newly added worksheet, call .activate() on it.
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/worksheetcollection-add?view=graph-rest-1.0" />
        /// </summary>
...
#nullable enable
        public async Task<WorkbookWorksheet?> PostAsync(AddPostRequestBody body, CancellationToken cancellationToken = default, Action<AddRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookWorksheet> PostAsync(AddPostRequestBody body, CancellationToken cancellationToken = default, Action<AddRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
