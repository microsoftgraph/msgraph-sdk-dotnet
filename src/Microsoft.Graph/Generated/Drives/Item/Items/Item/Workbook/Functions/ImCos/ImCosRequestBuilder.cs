...
#nullable enable
        public async Task<WorkbookFunctionResult?> PostAsync(ImCosPostRequestBody body, CancellationToken cancellationToken = default, Action<ImCosRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookFunctionResult> PostAsync(ImCosPostRequestBody body, CancellationToken cancellationToken = default, Action<ImCosRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
