...
#nullable enable
        public async Task<WorkbookFunctionResult?> PostAsync(ErfC_PrecisePostRequestBody body, CancellationToken cancellationToken = default, Action<ErfC_PreciseRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookFunctionResult> PostAsync(ErfC_PrecisePostRequestBody body, CancellationToken cancellationToken = default, Action<ErfC_PreciseRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
