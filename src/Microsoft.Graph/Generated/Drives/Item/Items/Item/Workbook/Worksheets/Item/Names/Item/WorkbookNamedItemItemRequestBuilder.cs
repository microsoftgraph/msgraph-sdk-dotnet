...
namespace Microsoft.Graph.Drives.Item.Items.Item.Workbook.Worksheets.Item.Names.Item {
    ...
    public class WorkbookNamedItemItemRequestBuilder : BaseRequestBuilder {
        ...
        public WorkbookNamedItemItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/names/{workbookNamedItem%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WorkbookNamedItemItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WorkbookNamedItemItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/names/{workbookNamedItem%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<WorkbookNamedItemItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<WorkbookNamedItemItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<WorkbookNamedItem?> GetAsync(CancellationToken cancellationToken = default, Action<WorkbookNamedItemItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookNamedItem> GetAsync(CancellationToken cancellationToken = default, Action<WorkbookNamedItemItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<WorkbookNamedItem?> PatchAsync(WorkbookNamedItem body, CancellationToken cancellationToken = default, Action<WorkbookNamedItemItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookNamedItem> PatchAsync(WorkbookNamedItem body, CancellationToken cancellationToken = default, Action<WorkbookNamedItemItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
