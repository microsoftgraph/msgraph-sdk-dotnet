...
#nullable enable
        public async Task<WorkbookRange?> GetAsync(CancellationToken cancellationToken = default, Action<RangeWithAddressRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookRange> GetAsync(CancellationToken cancellationToken = default, Action<RangeWithAddressRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
