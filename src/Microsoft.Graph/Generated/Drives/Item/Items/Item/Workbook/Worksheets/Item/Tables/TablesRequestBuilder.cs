using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Worksheets.Item.Tables.Add;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Worksheets.Item.Tables.Count;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Worksheets.Item.Tables.Item;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Worksheets.Item.Tables.ItemAtWithIndex;
...
namespace Microsoft.Graph.Drives.Item.Items.Item.Workbook.Worksheets.Item.Tables {
    ...
    public class TablesRequestBuilder : BaseRequestBuilder {
        ...
        public TablesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/tables{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new TablesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TablesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/tables{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Retrieve a list of table objects.
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/worksheet-list-tables?view=graph-rest-1.0" />
        /// </summary>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<WorkbookTableCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<TablesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookTableCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<TablesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<WorkbookTable?> PostAsync(WorkbookTable body, CancellationToken cancellationToken = default, Action<TablesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookTable> PostAsync(WorkbookTable body, CancellationToken cancellationToken = default, Action<TablesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
