...
namespace Microsoft.Graph.Drives.Item.Items.Item.Workbook.Tables.Item.TotalRowRange {
    ...
    public class TotalRowRangeRequestBuilder : BaseRequestBuilder {
        ...
        public TotalRowRangeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/totalRowRange()", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new TotalRowRangeRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TotalRowRangeRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/totalRowRange()", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<WorkbookRange?> GetAsync(CancellationToken cancellationToken = default, Action<TotalRowRangeRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookRange> GetAsync(CancellationToken cancellationToken = default, Action<TotalRowRangeRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
