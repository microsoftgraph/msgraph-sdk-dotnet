...
#nullable enable
        public async Task<WorkbookFunctionResult?> PostAsync(TimePostRequestBody body, CancellationToken cancellationToken = default, Action<TimeRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookFunctionResult> PostAsync(TimePostRequestBody body, CancellationToken cancellationToken = default, Action<TimeRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
