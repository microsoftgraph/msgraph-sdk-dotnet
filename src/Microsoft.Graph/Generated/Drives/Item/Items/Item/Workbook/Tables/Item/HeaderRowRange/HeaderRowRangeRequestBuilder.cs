...
namespace Microsoft.Graph.Drives.Item.Items.Item.Workbook.Tables.Item.HeaderRowRange {
    ...
    public class HeaderRowRangeRequestBuilder : BaseRequestBuilder {
        ...
        public HeaderRowRangeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/headerRowRange()", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new HeaderRowRangeRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public HeaderRowRangeRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/headerRowRange()", rawUrl) {
        }
        /// <summary>
        /// Gets the range object associated with header row of the table.
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/table-headerrowrange?view=graph-rest-1.0" />
        /// </summary>
