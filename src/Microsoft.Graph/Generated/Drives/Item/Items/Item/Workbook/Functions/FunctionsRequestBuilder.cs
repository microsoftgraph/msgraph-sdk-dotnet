using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Abs;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.AccrInt;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.AccrIntM;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Acos;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Acosh;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Acot;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Acoth;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.AmorDegrc;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.AmorLinc;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.And;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Arabic;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Areas;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Asc;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Asin;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Asinh;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Atan2;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Atan;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Atanh;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.AveDev;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Average;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.AverageA;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.AverageIf;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.AverageIfs;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.BahtText;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Base;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.BesselI;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.BesselJ;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.BesselK;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.BesselY;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Beta_Dist;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Beta_Inv;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Bin2Dec;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Bin2Hex;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Bin2Oct;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Binom_Dist;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Binom_Dist_Range;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Binom_Inv;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Bitand;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Bitlshift;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Bitor;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Bitrshift;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Bitxor;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Ceiling_Math;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Ceiling_Precise;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.CharNamespace;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.ChiSq_Dist;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.ChiSq_Dist_RT;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.ChiSq_Inv;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.ChiSq_Inv_RT;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Choose;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Clean;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Code;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Columns;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Combin;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Combina;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Complex;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Concatenate;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Confidence_Norm;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Confidence_T;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.ConvertNamespace;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Cos;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Cosh;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Cot;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Coth;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Count;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.CountA;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.CountBlank;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.CountIf;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.CountIfs;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.CoupDayBs;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.CoupDays;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.CoupDaysNc;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.CoupNcd;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.CoupNum;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.CoupPcd;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Csc;
...
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Days;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Db;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Dbcs;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Dcount;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.DcountA;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Ddb;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Dec2Bin;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Dec2Hex;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Dec2Oct;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.DecimalNamespace;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Degrees;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Delta;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.DevSq;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Dget;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Disc;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Dmax;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Dmin;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Dollar;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.DollarDe;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.DollarFr;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Dproduct;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.DstDev;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.DstDevP;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Dsum;
...
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.DvarP;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Ecma_Ceiling;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Edate;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Effect;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.EoMonth;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Erf;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.ErfC;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.ErfC_Precise;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Erf_Precise;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Error_Type;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Even;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Exact;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Exp;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Expon_Dist;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.F_Dist;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.F_Dist_RT;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.F_Inv;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.F_Inv_RT;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Fact;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.FactDouble;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.False;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Find;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.FindB;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Fisher;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.FisherInv;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Fixed;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Floor_Math;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Floor_Precise;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Fv;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Fvschedule;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Gamma;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.GammaLn;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.GammaLn_Precise;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Gamma_Dist;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Gamma_Inv;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Gauss;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Gcd;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.GeStep;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.GeoMean;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.HarMean;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Hex2Bin;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Hex2Dec;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Hex2Oct;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Hlookup;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Hour;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.HypGeom_Dist;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Hyperlink;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.If;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.ImAbs;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.ImArgument;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.ImConjugate;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.ImCos;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.ImCosh;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.ImCot;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.ImCsc;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.ImCsch;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.ImDiv;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.ImExp;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.ImLn;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.ImLog10;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.ImLog2;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.ImPower;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.ImProduct;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.ImReal;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.ImSec;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.ImSech;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.ImSin;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.ImSinh;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.ImSqrt;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.ImSub;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.ImSum;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.ImTan;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Imaginary;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Int;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.IntRate;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Ipmt;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Irr;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.IsErr;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.IsError;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.IsEven;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.IsFormula;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.IsLogical;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.IsNA;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.IsNonText;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.IsNumber;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.IsOdd;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.IsText;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.IsoWeekNum;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Iso_Ceiling;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Ispmt;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Isref;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Kurt;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Large;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Lcm;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Left;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Leftb;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Len;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Lenb;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Ln;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Log10;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Log;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.LogNorm_Dist;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.LogNorm_Inv;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Lookup;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Lower;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Match;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Max;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.MaxA;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Mduration;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Median;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Mid;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Midb;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Min;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.MinA;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Minute;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Mirr;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Mod;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Month;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Mround;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.MultiNomial;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.N;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Na;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.NegBinom_Dist;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.NetworkDays;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.NetworkDays_Intl;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Nominal;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Norm_Dist;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Norm_Inv;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Norm_S_Dist;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Norm_S_Inv;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Not;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Now;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Nper;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Npv;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.NumberValue;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Oct2Bin;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Oct2Dec;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Oct2Hex;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Odd;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.OddFPrice;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.OddFYield;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.OddLPrice;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.OddLYield;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Or;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Pduration;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.PercentRank_Exc;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.PercentRank_Inc;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Percentile_Exc;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Percentile_Inc;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Permut;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Permutationa;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Phi;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Pi;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Pmt;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Poisson_Dist;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Power;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Ppmt;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Price;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.PriceDisc;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.PriceMat;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Product;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Proper;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Pv;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Quartile_Exc;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Quartile_Inc;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Quotient;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Radians;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Rand;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.RandBetween;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Rank_Avg;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Rank_Eq;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Rate;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Received;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Replace;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.ReplaceB;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Rept;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Right;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Rightb;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Roman;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Round;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.RoundDown;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.RoundUp;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Rows;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Rri;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Sec;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Sech;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Second;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.SeriesSum;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Sheet;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Sheets;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Sign;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Sin;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Sinh;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Skew;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Skew_p;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Sln;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Small;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Sqrt;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.SqrtPi;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.StDevA;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.StDevPA;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.StDev_P;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.StDev_S;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Standardize;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Substitute;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Subtotal;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Sum;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.SumIf;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.SumIfs;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.SumSq;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Syd;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.T;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.T_Dist;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.T_Dist_2T;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.T_Dist_RT;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.T_Inv;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.T_Inv_2T;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Tan;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Tanh;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.TbillEq;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.TbillPrice;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.TbillYield;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Text;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Time;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Timevalue;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Today;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Trim;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.TrimMean;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.True;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Trunc;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.TypeNamespace;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Unichar;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Unicode;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Upper;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Usdollar;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Value;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.VarA;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.VarPA;
...
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.WorkDay;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.WorkDay_Intl;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Xirr;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Xnpv;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Xor;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Year;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.YearFrac;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Yield;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.YieldDisc;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.YieldMat;
...
#nullable enable
        public async Task<Stream?> DeleteAsync(Action<FunctionsRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Stream> DeleteAsync(Action<FunctionsRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<WorkbookFunctions?> GetAsync(Action<FunctionsRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<WorkbookFunctions> GetAsync(Action<FunctionsRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<WorkbookFunctions>(requestInfo, WorkbookFunctions.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<WorkbookFunctions?> PatchAsync(WorkbookFunctions body, Action<FunctionsRequestBuilderPatchRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<WorkbookFunctions> PatchAsync(WorkbookFunctions body, Action<FunctionsRequestBuilderPatchRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
