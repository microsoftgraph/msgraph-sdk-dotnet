...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<FunctionsRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<FunctionsRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<WorkbookFunctions?> GetAsync(CancellationToken cancellationToken = default, Action<FunctionsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookFunctions> GetAsync(CancellationToken cancellationToken = default, Action<FunctionsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<WorkbookFunctions?> PatchAsync(WorkbookFunctions body, CancellationToken cancellationToken = default, Action<FunctionsRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookFunctions> PatchAsync(WorkbookFunctions body, CancellationToken cancellationToken = default, Action<FunctionsRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
