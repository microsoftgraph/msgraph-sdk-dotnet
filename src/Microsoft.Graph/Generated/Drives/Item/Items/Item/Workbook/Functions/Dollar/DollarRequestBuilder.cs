...
#nullable enable
        public async Task<WorkbookFunctionResult?> PostAsync(DollarPostRequestBody body, CancellationToken cancellationToken = default, Action<DollarRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookFunctionResult> PostAsync(DollarPostRequestBody body, CancellationToken cancellationToken = default, Action<DollarRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
