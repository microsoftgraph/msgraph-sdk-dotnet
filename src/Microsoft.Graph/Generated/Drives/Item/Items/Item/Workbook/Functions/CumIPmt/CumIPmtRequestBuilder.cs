...
namespace Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.CumIPmt {
    ...
    public class CumIPmtRequestBuilder : BaseRequestBuilder {
        ...
        public CumIPmtRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/cumIPmt", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CumIPmtRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CumIPmtRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/cumIPmt", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<WorkbookFunctionResult?> PostAsync(CumIPmtPostRequestBody body, CancellationToken cancellationToken = default, Action<CumIPmtRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WorkbookFunctionResult> PostAsync(CumIPmtPostRequestBody body, CancellationToken cancellationToken = default, Action<CumIPmtRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
