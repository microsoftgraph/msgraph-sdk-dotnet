using Microsoft.Graph.Drives.Item.Items.Item.Subscriptions.Count;
using Microsoft.Graph.Drives.Item.Items.Item.Subscriptions.Item;
...
namespace Microsoft.Graph.Drives.Item.Items.Item.Subscriptions {
    ...
    public class SubscriptionsRequestBuilder : BaseRequestBuilder {
        ...
        public SubscriptionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/subscriptions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SubscriptionsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SubscriptionsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/subscriptions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<SubscriptionCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<SubscriptionsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<SubscriptionCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<SubscriptionsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Subscription?> PostAsync(Subscription body, CancellationToken cancellationToken = default, Action<SubscriptionsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Subscription> PostAsync(Subscription body, CancellationToken cancellationToken = default, Action<SubscriptionsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
