...
#nullable enable
        public async Task<Microsoft.Graph.Models.Permission?> PostAsync(CreateLinkPostRequestBody body, CancellationToken cancellationToken = default, Action<CreateLinkRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Permission> PostAsync(CreateLinkPostRequestBody body, CancellationToken cancellationToken = default, Action<CreateLinkRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
