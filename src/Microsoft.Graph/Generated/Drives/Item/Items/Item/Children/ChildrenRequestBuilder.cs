using Microsoft.Graph.Drives.Item.Items.Item.Children.Count;
using Microsoft.Graph.Drives.Item.Items.Item.Children.Item;
...
namespace Microsoft.Graph.Drives.Item.Items.Item.Children {
    ...
    public class ChildrenRequestBuilder : BaseRequestBuilder {
        ...
        public Microsoft.Graph.Drives.Item.Items.Item.Children.Item.DriveItemItemRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("driveItem%2Did1", position);
            return new Microsoft.Graph.Drives.Item.Items.Item.Children.Item.DriveItemItemRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
        ...
        public ChildrenRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/children{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ChildrenRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ChildrenRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/children{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<DriveItemCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ChildrenRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DriveItemCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ChildrenRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.DriveItem?> PostAsync(Microsoft.Graph.Models.DriveItem body, CancellationToken cancellationToken = default, Action<ChildrenRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.DriveItem> PostAsync(Microsoft.Graph.Models.DriveItem body, CancellationToken cancellationToken = default, Action<ChildrenRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Models.DriveItem body, Action<ChildrenRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Models.DriveItem body, Action<ChildrenRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
