using Microsoft.Graph.Drives.Item.Items.Item.Children.Item.Content;
...
namespace Microsoft.Graph.Drives.Item.Items.Item.Children.Item {
    ...
    public class DriveItemItemRequestBuilder : BaseRequestBuilder {
        ...
        public DriveItemItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/children/{driveItem%2Did1}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new DriveItemItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DriveItemItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/children/{driveItem%2Did1}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<Microsoft.Graph.Models.DriveItem?> GetAsync(CancellationToken cancellationToken = default, Action<DriveItemItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.DriveItem> GetAsync(CancellationToken cancellationToken = default, Action<DriveItemItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
