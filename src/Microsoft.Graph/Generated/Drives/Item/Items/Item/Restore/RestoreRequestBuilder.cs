...
#nullable enable
        public async Task<Microsoft.Graph.Models.DriveItem?> PostAsync(RestorePostRequestBody body, CancellationToken cancellationToken = default, Action<RestoreRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.DriveItem> PostAsync(RestorePostRequestBody body, CancellationToken cancellationToken = default, Action<RestoreRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
