...
namespace Microsoft.Graph.Drives.Item.Items.Item.Copy {
    ...
    public class CopyRequestBuilder : BaseRequestBuilder {
        ...
        public CopyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/copy", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CopyRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CopyRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/copy", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<Microsoft.Graph.Models.DriveItem?> PostAsync(CopyPostRequestBody body, CancellationToken cancellationToken = default, Action<CopyRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.DriveItem> PostAsync(CopyPostRequestBody body, CancellationToken cancellationToken = default, Action<CopyRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
