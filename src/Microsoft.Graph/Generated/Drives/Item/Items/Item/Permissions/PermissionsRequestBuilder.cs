using Microsoft.Graph.Drives.Item.Items.Item.Permissions.Count;
using Microsoft.Graph.Drives.Item.Items.Item.Permissions.Item;
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.Permission?> PostAsync(Microsoft.Graph.Models.Permission body, CancellationToken cancellationToken = default, Action<PermissionsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Permission> PostAsync(Microsoft.Graph.Models.Permission body, CancellationToken cancellationToken = default, Action<PermissionsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Models.Permission body, Action<PermissionsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Models.Permission body, Action<PermissionsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
