...
#nullable enable
        public async Task<InviteResponse?> PostAsync(InvitePostRequestBody body, CancellationToken cancellationToken = default, Action<InviteRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<InviteResponse> PostAsync(InvitePostRequestBody body, CancellationToken cancellationToken = default, Action<InviteRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
