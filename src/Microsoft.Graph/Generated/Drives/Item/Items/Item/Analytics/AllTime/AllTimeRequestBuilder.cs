...
namespace Microsoft.Graph.Drives.Item.Items.Item.Analytics.AllTime {
    ...
    /// </summary>
    public class AllTimeRequestBuilder : BaseRequestBuilder {
        /// <summary>
        /// Instantiates a new AllTimeRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AllTimeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/analytics/allTime{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AllTimeRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AllTimeRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/analytics/allTime{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<ItemActivityStat?> GetAsync(CancellationToken cancellationToken = default, Action<AllTimeRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ItemActivityStat> GetAsync(CancellationToken cancellationToken = default, Action<AllTimeRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
