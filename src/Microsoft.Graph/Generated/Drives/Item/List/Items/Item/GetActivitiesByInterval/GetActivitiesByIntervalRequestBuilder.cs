...
namespace Microsoft.Graph.Drives.Item.List.Items.Item.GetActivitiesByInterval {
    ...
    public class GetActivitiesByIntervalRequestBuilder : BaseRequestBuilder {
        ...
        /// </summary>
        /// <returns>A <cref="GetActivitiesByIntervalGetResponse"></returns>
...
#nullable restore
        ...
        /// Invoke function getActivitiesByInterval
        /// </summary>
        /// <returns>A <cref="GetActivitiesByIntervalResponse"></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="ODataError">When receiving a 4XX or 5XX status code</exception>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <cref="GetActivitiesByIntervalRequestBuilder"></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
