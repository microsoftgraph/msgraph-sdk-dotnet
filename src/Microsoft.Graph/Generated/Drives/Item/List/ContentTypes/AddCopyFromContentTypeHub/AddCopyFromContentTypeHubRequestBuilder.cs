...
namespace Microsoft.Graph.Drives.Item.List.ContentTypes.AddCopyFromContentTypeHub {
    ...
    public class AddCopyFromContentTypeHubRequestBuilder : BaseRequestBuilder {
        ...
        public AddCopyFromContentTypeHubRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/list/contentTypes/addCopyFromContentTypeHub", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AddCopyFromContentTypeHubRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AddCopyFromContentTypeHubRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/list/contentTypes/addCopyFromContentTypeHub", rawUrl) {
        }
        /// <summary>
