...
namespace Microsoft.Graph.Drives.Item.List.ContentTypes.Item.Unpublish {
    ...
    public class UnpublishRequestBuilder : BaseRequestBuilder {
        ...
        public UnpublishRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/list/contentTypes/{contentType%2Did}/unpublish", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new UnpublishRequestBuilder and sets the default values.
        /// </summary>
