...
namespace Microsoft.Graph.Drives.Item.List.ContentTypes.Item.AssociateWithHubSites {
    ...
    public class AssociateWithHubSitesRequestBuilder : BaseRequestBuilder {
        ...
        public AssociateWithHubSitesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/list/contentTypes/{contentType%2Did}/associateWithHubSites", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AssociateWithHubSitesRequestBuilder and sets the default values.
        /// </summary>
