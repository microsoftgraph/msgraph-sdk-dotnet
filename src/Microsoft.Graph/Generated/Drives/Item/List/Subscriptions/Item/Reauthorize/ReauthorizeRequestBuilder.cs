...
namespace Microsoft.Graph.Drives.Item.List.Subscriptions.Item.Reauthorize {
    ...
    public class ReauthorizeRequestBuilder : BaseRequestBuilder {
        ...
        public ReauthorizeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/list/subscriptions/{subscription%2Did}/reauthorize", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ReauthorizeRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ReauthorizeRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/list/subscriptions/{subscription%2Did}/reauthorize", rawUrl) {
        }
        /// <summary>
