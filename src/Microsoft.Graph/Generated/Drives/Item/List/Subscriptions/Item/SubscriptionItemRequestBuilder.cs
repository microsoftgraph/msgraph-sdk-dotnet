using Microsoft.Graph.Drives.Item.List.Subscriptions.Item.Reauthorize;
...
namespace Microsoft.Graph.Drives.Item.List.Subscriptions.Item {
    ...
    public class SubscriptionItemRequestBuilder : BaseRequestBuilder {
        ...
        public SubscriptionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/list/subscriptions/{subscription%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SubscriptionItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SubscriptionItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/list/subscriptions/{subscription%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
