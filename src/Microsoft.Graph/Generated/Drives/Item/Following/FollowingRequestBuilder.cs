using Microsoft.Graph.Drives.Item.Following.Count;
using Microsoft.Graph.Drives.Item.Following.Item;
...
namespace Microsoft.Graph.Drives.Item.Following {
    ...
    public class FollowingRequestBuilder : BaseRequestBuilder {
        ...
        public FollowingRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/drives/{drive%2Did}/following{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new FollowingRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<DriveItemCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<FollowingRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DriveItemCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<FollowingRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
