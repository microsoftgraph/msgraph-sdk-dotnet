...
namespace Microsoft.Graph.Drives.Item.SearchWithQ
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Microsoft.Graph.Drives.Item.SearchWithQ.SearchWithQRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// Find more info here <see href="https://learn.microsoft.com/graph/api/driveitem-search?view=graph-rest-1.0" />
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.Drives.Item.SearchWithQ.SearchWithQResponse"/></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="global::Microsoft.Graph.Models.ODataErrors.ODataError">When receiving a 4XX or 5XX status code</exception>
...
#nullable restore
        ...
        public async Task<global::Microsoft.Graph.Drives.Item.SearchWithQ.SearchWithQResponse> GetAsync(Action<RequestConfiguration<global::Microsoft.Graph.Drives.Item.SearchWithQ.SearchWithQRequestBuilder.SearchWithQRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Microsoft.Graph.Drives.Item.SearchWithQ.SearchWithQResponse>(requestInfo, global::Microsoft.Graph.Drives.Item.SearchWithQ.SearchWithQResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Search the hierarchy of items for items matching a query.You can search within a folder hierarchy, a whole drive, or files shared with the current user.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Microsoft.Graph.Drives.Item.SearchWithQ.SearchWithQRequestBuilder.SearchWithQRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Microsoft.Graph.Drives.Item.SearchWithQ.SearchWithQRequestBuilder.SearchWithQRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Microsoft.Graph.Drives.Item.SearchWithQ.SearchWithQRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Microsoft.Graph.Drives.Item.SearchWithQ.SearchWithQRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Search the hierarchy of items for items matching a query.You can search within a folder hierarchy, a whole drive, or files shared with the current user.
        /// </summary>
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.18.0")]
        public partial class SearchWithQRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Microsoft.Graph.Drives.Item.SearchWithQ.SearchWithQRequestBuilder.SearchWithQRequestBuilderGetQueryParameters>
        {
        }
    }
}
