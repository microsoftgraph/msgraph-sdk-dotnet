using Microsoft.Graph.IdentityGovernance.AppConsent.AppConsentRequests.Item.UserConsentRequests.Count;
using Microsoft.Graph.IdentityGovernance.AppConsent.AppConsentRequests.Item.UserConsentRequests.FilterByCurrentUserWithOn;
using Microsoft.Graph.IdentityGovernance.AppConsent.AppConsentRequests.Item.UserConsentRequests.Item;
...
namespace Microsoft.Graph.IdentityGovernance.AppConsent.AppConsentRequests.Item.UserConsentRequests {
    ...
    public class UserConsentRequestsRequestBuilder : BaseRequestBuilder {
        ...
        public UserConsentRequestItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("userConsentRequest%2Did", position);
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/appconsentrequest-list-userconsentrequests?view=graph-rest-1.0" />
        /// </summary>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<UserConsentRequestCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<UserConsentRequestsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UserConsentRequestCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<UserConsentRequestsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<UserConsentRequestCollectionResponse>(requestInfo, UserConsentRequestCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<UserConsentRequest?> PostAsync(UserConsentRequest body, CancellationToken cancellationToken = default, Action<UserConsentRequestsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UserConsentRequest> PostAsync(UserConsentRequest body, CancellationToken cancellationToken = default, Action<UserConsentRequestsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
