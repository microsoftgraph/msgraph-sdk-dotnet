...
#nullable enable
        public async Task<AccessPackageAssignment?> GetAsync(CancellationToken cancellationToken = default, Action<AssignmentRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AccessPackageAssignment> GetAsync(CancellationToken cancellationToken = default, Action<AssignmentRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
