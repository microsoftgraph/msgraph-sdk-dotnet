...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<EntitlementManagementRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<EntitlementManagementRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.EntitlementManagement?> GetAsync(CancellationToken cancellationToken = default, Action<EntitlementManagementRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.EntitlementManagement> GetAsync(CancellationToken cancellationToken = default, Action<EntitlementManagementRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.EntitlementManagement?> PatchAsync(Microsoft.Graph.Models.EntitlementManagement body, CancellationToken cancellationToken = default, Action<EntitlementManagementRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.EntitlementManagement> PatchAsync(Microsoft.Graph.Models.EntitlementManagement body, CancellationToken cancellationToken = default, Action<EntitlementManagementRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
