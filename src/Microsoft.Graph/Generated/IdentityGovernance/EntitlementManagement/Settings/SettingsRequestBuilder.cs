...
namespace Microsoft.Graph.IdentityGovernance.EntitlementManagement.Settings {
    ...
    public class SettingsRequestBuilder : BaseRequestBuilder {
        ...
        public SettingsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/settings{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SettingsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SettingsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/settings{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<EntitlementManagementSettings?> GetAsync(CancellationToken cancellationToken = default, Action<SettingsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<EntitlementManagementSettings> GetAsync(CancellationToken cancellationToken = default, Action<SettingsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<EntitlementManagementSettings?> PatchAsync(EntitlementManagementSettings body, CancellationToken cancellationToken = default, Action<SettingsRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<EntitlementManagementSettings> PatchAsync(EntitlementManagementSettings body, CancellationToken cancellationToken = default, Action<SettingsRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(EntitlementManagementSettings body, Action<SettingsRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(EntitlementManagementSettings body, Action<SettingsRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
