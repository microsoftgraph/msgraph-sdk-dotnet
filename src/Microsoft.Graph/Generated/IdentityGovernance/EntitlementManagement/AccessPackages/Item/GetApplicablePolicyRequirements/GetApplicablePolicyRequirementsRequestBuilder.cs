...
#nullable enable
        public async Task<GetApplicablePolicyRequirementsResponse?> PostAsync(CancellationToken cancellationToken = default, Action<GetApplicablePolicyRequirementsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GetApplicablePolicyRequirementsResponse> PostAsync(CancellationToken cancellationToken = default, Action<GetApplicablePolicyRequirementsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
