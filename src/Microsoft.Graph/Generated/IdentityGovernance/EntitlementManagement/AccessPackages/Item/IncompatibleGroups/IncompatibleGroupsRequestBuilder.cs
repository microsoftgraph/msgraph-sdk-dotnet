...
#nullable enable
        public async Task<GroupCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<IncompatibleGroupsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GroupCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<IncompatibleGroupsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
