...
#nullable enable
        public async Task<AccessPackageAssignmentPolicy?> GetAsync(CancellationToken cancellationToken = default, Action<AssignmentPolicyRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AccessPackageAssignmentPolicy> GetAsync(CancellationToken cancellationToken = default, Action<AssignmentPolicyRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
