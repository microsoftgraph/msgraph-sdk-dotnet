...
namespace Microsoft.Graph.IdentityGovernance.EntitlementManagement.Catalogs.Item.CustomWorkflowExtensions {
    ...
    public class CustomWorkflowExtensionsRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// <returns>A <see cref="CustomCalloutExtensionItemRequestBuilder"/></returns>
        public CustomCalloutExtensionItemRequestBuilder this[string position]
        {
            get
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="CustomWorkflowExtensionsRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="CustomCalloutExtensionCollectionResponse"/></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="ODataError">When receiving a 4XX or 5XX status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<CustomCalloutExtensionCollectionResponse?> GetAsync(Action<RequestConfiguration<CustomWorkflowExtensionsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<CustomCalloutExtensionCollectionResponse> GetAsync(Action<RequestConfiguration<CustomWorkflowExtensionsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<CustomWorkflowExtensionsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<CustomWorkflowExtensionsRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="CustomWorkflowExtensionsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public CustomWorkflowExtensionsRequestBuilder WithUrl(string rawUrl)
        {
...
#nullable restore
        ...
        public class CustomWorkflowExtensionsRequestBuilderGetRequestConfiguration : RequestConfiguration<CustomWorkflowExtensionsRequestBuilderGetQueryParameters> 
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
