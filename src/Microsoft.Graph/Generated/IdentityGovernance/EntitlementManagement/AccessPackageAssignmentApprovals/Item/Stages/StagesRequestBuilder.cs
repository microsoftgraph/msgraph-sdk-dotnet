using Microsoft.Graph.IdentityGovernance.EntitlementManagement.AccessPackageAssignmentApprovals.Item.Stages.Count;
using Microsoft.Graph.IdentityGovernance.EntitlementManagement.AccessPackageAssignmentApprovals.Item.Stages.Item;
...
namespace Microsoft.Graph.IdentityGovernance.EntitlementManagement.AccessPackageAssignmentApprovals.Item.Stages {
    ...
    public class StagesRequestBuilder : BaseRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public StagesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/accessPackageAssignmentApprovals/{approval%2Did}/stages{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<ApprovalStageCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<StagesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ApprovalStageCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<StagesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ApprovalStage?> PostAsync(ApprovalStage body, CancellationToken cancellationToken = default, Action<StagesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ApprovalStage> PostAsync(ApprovalStage body, CancellationToken cancellationToken = default, Action<StagesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
