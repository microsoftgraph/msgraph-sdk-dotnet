...
#nullable enable
        public async Task<ApprovalCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<AccessPackageAssignmentApprovalsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ApprovalCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AccessPackageAssignmentApprovalsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.Approval?> PostAsync(Microsoft.Graph.Models.Approval body, CancellationToken cancellationToken = default, Action<AccessPackageAssignmentApprovalsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Approval> PostAsync(Microsoft.Graph.Models.Approval body, CancellationToken cancellationToken = default, Action<AccessPackageAssignmentApprovalsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
