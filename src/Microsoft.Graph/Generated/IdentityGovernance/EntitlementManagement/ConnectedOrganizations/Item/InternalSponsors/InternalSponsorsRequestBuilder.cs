...
using Microsoft.Graph.IdentityGovernance.EntitlementManagement.ConnectedOrganizations.Item.InternalSponsors.Delta;
...
#nullable enable
        public async Task<DirectoryObjectCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<InternalSponsorsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DirectoryObjectCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<InternalSponsorsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DirectoryObject?> PostAsync(DirectoryObject body, CancellationToken cancellationToken = default, Action<InternalSponsorsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DirectoryObject> PostAsync(DirectoryObject body, CancellationToken cancellationToken = default, Action<InternalSponsorsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
