...
namespace Microsoft.Graph.IdentityGovernance.AccessReviews.Definitions {
    ...
    public class DefinitionsRequestBuilder : BaseRequestBuilder 
    {
        ...
        public AccessReviewScheduleDefinitionItemRequestBuilder this[string position]
        {
            get
            {
...
#nullable enable
        public async Task<AccessReviewScheduleDefinitionCollectionResponse?> GetAsync(Action<RequestConfiguration<DefinitionsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<AccessReviewScheduleDefinitionCollectionResponse> GetAsync(Action<RequestConfiguration<DefinitionsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AccessReviewScheduleDefinition?> PostAsync(AccessReviewScheduleDefinition body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<AccessReviewScheduleDefinition> PostAsync(AccessReviewScheduleDefinition body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="DefinitionsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
...
#nullable restore
        ...
        public class DefinitionsRequestBuilderGetRequestConfiguration : RequestConfiguration<DefinitionsRequestBuilderGetQueryParameters> 
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
