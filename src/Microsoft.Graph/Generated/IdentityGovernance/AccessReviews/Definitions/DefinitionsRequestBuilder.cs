...
#nullable enable
        public async Task<AccessReviewScheduleDefinitionCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<DefinitionsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AccessReviewScheduleDefinitionCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<DefinitionsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/accessreviewset-post-definitions?view=graph-rest-1.0" />
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AccessReviewScheduleDefinition?> PostAsync(AccessReviewScheduleDefinition body, CancellationToken cancellationToken = default, Action<DefinitionsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AccessReviewScheduleDefinition> PostAsync(AccessReviewScheduleDefinition body, CancellationToken cancellationToken = default, Action<DefinitionsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
