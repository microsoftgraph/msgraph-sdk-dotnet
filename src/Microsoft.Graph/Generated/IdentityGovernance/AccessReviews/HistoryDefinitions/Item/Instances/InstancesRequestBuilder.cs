using Microsoft.Graph.IdentityGovernance.AccessReviews.HistoryDefinitions.Item.Instances.Count;
using Microsoft.Graph.IdentityGovernance.AccessReviews.HistoryDefinitions.Item.Instances.Item;
...
namespace Microsoft.Graph.IdentityGovernance.AccessReviews.HistoryDefinitions.Item.Instances {
    ...
    public class InstancesRequestBuilder : BaseRequestBuilder {
        ...
        public AccessReviewHistoryInstanceItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("accessReviewHistoryInstance%2Did", position);
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public InstancesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/identityGovernance/accessReviews/historyDefinitions/{accessReviewHistoryDefinition%2Did}/instances{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Retrieve the instances of an access review history definition created in the last 30 days.
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/accessreviewhistorydefinition-list-instances?view=graph-rest-1.0" />
        /// </summary>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AccessReviewHistoryInstanceCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<InstancesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AccessReviewHistoryInstanceCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<InstancesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<AccessReviewHistoryInstanceCollectionResponse>(requestInfo, AccessReviewHistoryInstanceCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AccessReviewHistoryInstance?> PostAsync(AccessReviewHistoryInstance body, CancellationToken cancellationToken = default, Action<InstancesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AccessReviewHistoryInstance> PostAsync(AccessReviewHistoryInstance body, CancellationToken cancellationToken = default, Action<InstancesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
