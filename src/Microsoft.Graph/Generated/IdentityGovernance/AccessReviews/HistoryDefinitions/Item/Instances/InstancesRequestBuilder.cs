...
namespace Microsoft.Graph.IdentityGovernance.AccessReviews.HistoryDefinitions.Item.Instances {
    ...
    public class InstancesRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// <returns>A <see cref="AccessReviewHistoryInstanceItemRequestBuilder"/></returns>
        public AccessReviewHistoryInstanceItemRequestBuilder this[string position]
        {
            get
            {
...
#nullable enable
        public async Task<AccessReviewHistoryInstanceCollectionResponse?> GetAsync(Action<RequestConfiguration<InstancesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<AccessReviewHistoryInstanceCollectionResponse> GetAsync(Action<RequestConfiguration<InstancesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<AccessReviewHistoryInstanceCollectionResponse>(requestInfo, AccessReviewHistoryInstanceCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AccessReviewHistoryInstance?> PostAsync(AccessReviewHistoryInstance body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<AccessReviewHistoryInstance> PostAsync(AccessReviewHistoryInstance body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
