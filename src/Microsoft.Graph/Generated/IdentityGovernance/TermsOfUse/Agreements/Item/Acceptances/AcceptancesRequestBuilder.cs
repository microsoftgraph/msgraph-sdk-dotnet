using Microsoft.Graph.IdentityGovernance.TermsOfUse.Agreements.Item.Acceptances.Count;
using Microsoft.Graph.IdentityGovernance.TermsOfUse.Agreements.Item.Acceptances.Item;
...
namespace Microsoft.Graph.IdentityGovernance.TermsOfUse.Agreements.Item.Acceptances {
    ...
    /// </summary>
    public class AcceptancesRequestBuilder : BaseRequestBuilder {
        ...
        public AcceptancesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/identityGovernance/termsOfUse/agreements/{agreement%2Did}/acceptances{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AcceptancesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AcceptancesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/identityGovernance/termsOfUse/agreements/{agreement%2Did}/acceptances{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<AgreementAcceptanceCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<AcceptancesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AgreementAcceptanceCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AcceptancesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AgreementAcceptance?> PostAsync(AgreementAcceptance body, CancellationToken cancellationToken = default, Action<AcceptancesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AgreementAcceptance> PostAsync(AgreementAcceptance body, CancellationToken cancellationToken = default, Action<AcceptancesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<AcceptancesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<AcceptancesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(AgreementAcceptance body, Action<AcceptancesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(AgreementAcceptance body, Action<AcceptancesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
