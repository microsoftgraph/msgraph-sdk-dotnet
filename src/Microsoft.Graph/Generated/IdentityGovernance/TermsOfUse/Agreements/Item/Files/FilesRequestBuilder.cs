using Microsoft.Graph.IdentityGovernance.TermsOfUse.Agreements.Item.Files.Count;
using Microsoft.Graph.IdentityGovernance.TermsOfUse.Agreements.Item.Files.Item;
...
namespace Microsoft.Graph.IdentityGovernance.TermsOfUse.Agreements.Item.Files {
    ...
    public class FilesRequestBuilder : BaseRequestBuilder {
        ...
        public FilesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/identityGovernance/termsOfUse/agreements/{agreement%2Did}/files{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new FilesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public FilesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/identityGovernance/termsOfUse/agreements/{agreement%2Did}/files{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<AgreementFileLocalizationCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<FilesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AgreementFileLocalizationCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<FilesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AgreementFileLocalization?> PostAsync(AgreementFileLocalization body, CancellationToken cancellationToken = default, Action<FilesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AgreementFileLocalization> PostAsync(AgreementFileLocalization body, CancellationToken cancellationToken = default, Action<FilesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
