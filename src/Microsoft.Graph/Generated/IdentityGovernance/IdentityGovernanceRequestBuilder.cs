...
#nullable enable
        public async Task<Microsoft.Graph.Models.IdentityGovernance?> GetAsync(CancellationToken cancellationToken = default, Action<IdentityGovernanceRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.IdentityGovernance> GetAsync(CancellationToken cancellationToken = default, Action<IdentityGovernanceRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.IdentityGovernance?> PatchAsync(Microsoft.Graph.Models.IdentityGovernance body, CancellationToken cancellationToken = default, Action<IdentityGovernanceRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.IdentityGovernance> PatchAsync(Microsoft.Graph.Models.IdentityGovernance body, CancellationToken cancellationToken = default, Action<IdentityGovernanceRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
