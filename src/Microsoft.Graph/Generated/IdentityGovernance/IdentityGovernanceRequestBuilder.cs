...
namespace Microsoft.Graph.IdentityGovernance
{
    ...
    public class IdentityGovernanceRequestBuilder : BaseRequestBuilder
    {
        ...
        public Microsoft.Graph.IdentityGovernance.AccessReviews.AccessReviewsRequestBuilder AccessReviews
        {
            get => new Microsoft.Graph.IdentityGovernance.AccessReviews.AccessReviewsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to manage the appConsent property of the microsoft.graph.identityGovernance entity.</summary>
        public Microsoft.Graph.IdentityGovernance.AppConsent.AppConsentRequestBuilder AppConsent
        {
            get => new Microsoft.Graph.IdentityGovernance.AppConsent.AppConsentRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public Microsoft.Graph.IdentityGovernance.EntitlementManagement.EntitlementManagementRequestBuilder EntitlementManagement
        {
            get => new Microsoft.Graph.IdentityGovernance.EntitlementManagement.EntitlementManagementRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public Microsoft.Graph.IdentityGovernance.LifecycleWorkflows.LifecycleWorkflowsRequestBuilder LifecycleWorkflows
        {
            get => new Microsoft.Graph.IdentityGovernance.LifecycleWorkflows.LifecycleWorkflowsRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public Microsoft.Graph.IdentityGovernance.PrivilegedAccess.PrivilegedAccessRequestBuilder PrivilegedAccess
        {
            get => new Microsoft.Graph.IdentityGovernance.PrivilegedAccess.PrivilegedAccessRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to manage the termsOfUse property of the microsoft.graph.identityGovernance entity.</summary>
        public Microsoft.Graph.IdentityGovernance.TermsOfUse.TermsOfUseRequestBuilder TermsOfUse
        {
            get => new Microsoft.Graph.IdentityGovernance.TermsOfUse.TermsOfUseRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.IdentityGovernance.IdentityGovernanceRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.IdentityGovernance.IdentityGovernanceRequestBuilder.IdentityGovernanceRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.IdentityGovernance.IdentityGovernanceRequestBuilder.IdentityGovernanceRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.IdentityGovernance.IdentityGovernanceRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.IdentityGovernance.IdentityGovernanceRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.IdentityGovernance.IdentityGovernanceRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Get identityGovernance
        /// </summary>
...
#nullable restore
        ...
        public class IdentityGovernanceRequestBuilderGetRequestConfiguration : RequestConfiguration<Microsoft.Graph.IdentityGovernance.IdentityGovernanceRequestBuilder.IdentityGovernanceRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
