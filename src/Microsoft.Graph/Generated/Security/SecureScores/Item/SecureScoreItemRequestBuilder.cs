...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<SecureScoreItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<SecureScoreItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<SecureScore?> GetAsync(CancellationToken cancellationToken = default, Action<SecureScoreItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<SecureScore> GetAsync(CancellationToken cancellationToken = default, Action<SecureScoreItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<SecureScore?> PatchAsync(SecureScore body, CancellationToken cancellationToken = default, Action<SecureScoreItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<SecureScore> PatchAsync(SecureScore body, CancellationToken cancellationToken = default, Action<SecureScoreItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
