...
#nullable enable
        public async Task PostAsync(AddToReviewSetPostRequestBody body, CancellationToken cancellationToken = default, Action<MicrosoftGraphSecurityAddToReviewSetRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(AddToReviewSetPostRequestBody body, CancellationToken cancellationToken = default, Action<MicrosoftGraphSecurityAddToReviewSetRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
