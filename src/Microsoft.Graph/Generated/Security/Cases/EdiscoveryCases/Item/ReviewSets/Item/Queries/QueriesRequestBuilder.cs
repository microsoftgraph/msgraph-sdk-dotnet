...
namespace Microsoft.Graph.Security.Cases.EdiscoveryCases.Item.ReviewSets.Item.Queries {
    ...
    public class QueriesRequestBuilder : BaseRequestBuilder {
        ...
        public EdiscoveryReviewSetQueryItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("ediscoveryReviewSetQuery%2Did", position);
...
#nullable enable
        public async Task<EdiscoveryReviewSetQueryCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<QueriesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<EdiscoveryReviewSetQueryCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<QueriesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<EdiscoveryReviewSetQueryCollectionResponse>(requestInfo, EdiscoveryReviewSetQueryCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<EdiscoveryReviewSetQuery?> PostAsync(EdiscoveryReviewSetQuery body, CancellationToken cancellationToken = default, Action<QueriesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<EdiscoveryReviewSetQuery> PostAsync(EdiscoveryReviewSetQuery body, CancellationToken cancellationToken = default, Action<QueriesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
