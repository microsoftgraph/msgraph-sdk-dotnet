...
namespace Microsoft.Graph.Security.Cases.EdiscoveryCases.Item.ReviewSets.Item.Queries.Item.MicrosoftGraphSecurityApplyTags {
    ...
    /// </summary>
    public class MicrosoftGraphSecurityApplyTagsRequestBuilder : BaseRequestBuilder {
        /// <summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphSecurityApplyTagsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/reviewSets/{ediscoveryReviewSet%2Did}/queries/{ediscoveryReviewSetQuery%2Did}/microsoft.graph.security.applyTags", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task PostAsync(ApplyTagsPostRequestBody body, CancellationToken cancellationToken = default, Action<MicrosoftGraphSecurityApplyTagsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(ApplyTagsPostRequestBody body, CancellationToken cancellationToken = default, Action<MicrosoftGraphSecurityApplyTagsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
