...
namespace Microsoft.Graph.Security.Cases.EdiscoveryCases.Item.MicrosoftGraphSecurityReopen {
    ...
    /// </summary>
    public class MicrosoftGraphSecurityReopenRequestBuilder : BaseRequestBuilder {
        /// <summary>
        /// Instantiates a new MicrosoftGraphSecurityReopenRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphSecurityReopenRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/microsoft.graph.security.reopen", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new MicrosoftGraphSecurityReopenRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<MicrosoftGraphSecurityReopenRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<MicrosoftGraphSecurityReopenRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
