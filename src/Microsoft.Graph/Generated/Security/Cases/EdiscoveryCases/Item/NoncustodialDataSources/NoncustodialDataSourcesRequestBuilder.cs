...
namespace Microsoft.Graph.Security.Cases.EdiscoveryCases.Item.NoncustodialDataSources {
    ...
    public class NoncustodialDataSourcesRequestBuilder : BaseRequestBuilder {
        ...
        public NoncustodialDataSourcesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/noncustodialDataSources{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new NoncustodialDataSourcesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public NoncustodialDataSourcesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/noncustodialDataSources{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<EdiscoveryNoncustodialDataSourceCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<NoncustodialDataSourcesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<EdiscoveryNoncustodialDataSourceCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<NoncustodialDataSourcesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<EdiscoveryNoncustodialDataSource?> PostAsync(EdiscoveryNoncustodialDataSource body, CancellationToken cancellationToken = default, Action<NoncustodialDataSourcesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<EdiscoveryNoncustodialDataSource> PostAsync(EdiscoveryNoncustodialDataSource body, CancellationToken cancellationToken = default, Action<NoncustodialDataSourcesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
