...
namespace Microsoft.Graph.Security.Cases.EdiscoveryCases.Item.Tags.Item.Parent {
    ...
    public class ParentRequestBuilder : BaseRequestBuilder {
        ...
        public ParentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/tags/{ediscoveryReviewTag%2Did}/parent{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ParentRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ParentRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/tags/{ediscoveryReviewTag%2Did}/parent{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<EdiscoveryReviewTag?> GetAsync(CancellationToken cancellationToken = default, Action<ParentRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<EdiscoveryReviewTag> GetAsync(CancellationToken cancellationToken = default, Action<ParentRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
