...
#nullable enable
        public async Task<EdiscoveryReviewTagCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<TagsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<EdiscoveryReviewTagCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<TagsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<EdiscoveryReviewTag?> PostAsync(EdiscoveryReviewTag body, CancellationToken cancellationToken = default, Action<TagsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<EdiscoveryReviewTag> PostAsync(EdiscoveryReviewTag body, CancellationToken cancellationToken = default, Action<TagsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
