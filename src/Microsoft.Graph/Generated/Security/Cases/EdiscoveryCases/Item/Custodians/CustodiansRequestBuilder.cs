...
namespace Microsoft.Graph.Security.Cases.EdiscoveryCases.Item.Custodians {
    ...
    public class CustodiansRequestBuilder : BaseRequestBuilder {
        ...
        /// <returns>A <cref="EdiscoveryCustodianItemRequestBuilder"></returns>
        ...
        /// </summary>
        /// <returns>A <cref="EdiscoveryCustodianCollectionResponse"></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="ODataError">When receiving a 4XX or 5XX status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<EdiscoveryCustodianCollectionResponse?> GetAsync(Action<RequestConfiguration<CustodiansRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<EdiscoveryCustodianCollectionResponse> GetAsync(Action<RequestConfiguration<CustodiansRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
        ...
        /// </summary>
        /// <returns>A <cref="EdiscoveryCustodian"></returns>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<EdiscoveryCustodian?> PostAsync(EdiscoveryCustodian body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<EdiscoveryCustodian> PostAsync(EdiscoveryCustodian body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <cref="CustodiansRequestBuilder"></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
