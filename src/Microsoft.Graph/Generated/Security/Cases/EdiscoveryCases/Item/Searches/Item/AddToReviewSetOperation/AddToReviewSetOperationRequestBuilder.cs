...
namespace Microsoft.Graph.Security.Cases.EdiscoveryCases.Item.Searches.Item.AddToReviewSetOperation {
    ...
    public class AddToReviewSetOperationRequestBuilder : BaseRequestBuilder {
        ...
        public AddToReviewSetOperationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/searches/{ediscoverySearch%2Did}/addToReviewSetOperation{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AddToReviewSetOperationRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AddToReviewSetOperationRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/searches/{ediscoverySearch%2Did}/addToReviewSetOperation{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<EdiscoveryAddToReviewSetOperation?> GetAsync(CancellationToken cancellationToken = default, Action<AddToReviewSetOperationRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<EdiscoveryAddToReviewSetOperation> GetAsync(CancellationToken cancellationToken = default, Action<AddToReviewSetOperationRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<EdiscoveryAddToReviewSetOperation>(requestInfo, EdiscoveryAddToReviewSetOperation.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
        /// Adds the results of the eDiscovery search to the specified reviewSet.
        /// </summary>
