...
using Microsoft.Graph.Security.Cases.EdiscoveryCases.Item.Searches.Item.CustodianSources.Count;
using Microsoft.Graph.Security.Cases.EdiscoveryCases.Item.Searches.Item.CustodianSources.Item;
...
namespace Microsoft.Graph.Security.Cases.EdiscoveryCases.Item.Searches.Item.CustodianSources {
    ...
    public class CustodianSourcesRequestBuilder : BaseRequestBuilder {
        ...
        public CustodianSourcesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/searches/{ediscoverySearch%2Did}/custodianSources{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CustodianSourcesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CustodianSourcesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/searches/{ediscoverySearch%2Did}/custodianSources{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Get the list of custodial data sources associated with an eDiscovery search.
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/security-ediscoverysearch-list-custodiansources?view=graph-rest-1.0" />
        /// </summary>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DataSourceCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<CustodianSourcesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DataSourceCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<CustodianSourcesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
