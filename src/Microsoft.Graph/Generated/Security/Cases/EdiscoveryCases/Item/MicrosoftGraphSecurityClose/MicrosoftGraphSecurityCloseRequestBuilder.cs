...
#nullable enable
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<MicrosoftGraphSecurityCloseRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<MicrosoftGraphSecurityCloseRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
