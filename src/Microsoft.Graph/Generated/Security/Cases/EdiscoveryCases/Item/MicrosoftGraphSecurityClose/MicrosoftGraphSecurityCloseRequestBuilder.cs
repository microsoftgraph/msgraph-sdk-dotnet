...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="MicrosoftGraphSecurityCloseRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public MicrosoftGraphSecurityCloseRequestBuilder WithUrl(string rawUrl)
        {
            return new MicrosoftGraphSecurityCloseRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
