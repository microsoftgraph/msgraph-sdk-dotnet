...
namespace Microsoft.Graph.Security.Alerts.Item {
    ...
    public class AlertItemRequestBuilder : BaseRequestBuilder {
        ...
        public AlertItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/alerts/{alert%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AlertItemRequestBuilder and sets the default values.
        /// </summary>
