...
namespace Microsoft.Graph.Security.TriggerTypes.RetentionEventTypes.Item
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Security.TriggerTypes.RetentionEventTypes.Item.RetentionEventTypeItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.Security.RetentionEventType?> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Security.TriggerTypes.RetentionEventTypes.Item.RetentionEventTypeItemRequestBuilder.RetentionEventTypeItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Security.RetentionEventType> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Security.TriggerTypes.RetentionEventTypes.Item.RetentionEventTypeItemRequestBuilder.RetentionEventTypeItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Security.TriggerTypes.RetentionEventTypes.Item.RetentionEventTypeItemRequestBuilder.RetentionEventTypeItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Security.TriggerTypes.RetentionEventTypes.Item.RetentionEventTypeItemRequestBuilder.RetentionEventTypeItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Security.TriggerTypes.RetentionEventTypes.Item.RetentionEventTypeItemRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Security.TriggerTypes.RetentionEventTypes.Item.RetentionEventTypeItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class RetentionEventTypeItemRequestBuilderGetRequestConfiguration : RequestConfiguration<Microsoft.Graph.Security.TriggerTypes.RetentionEventTypes.Item.RetentionEventTypeItemRequestBuilder.RetentionEventTypeItemRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
