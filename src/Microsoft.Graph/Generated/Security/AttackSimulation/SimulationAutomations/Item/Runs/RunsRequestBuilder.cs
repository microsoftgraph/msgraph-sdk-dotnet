...
namespace Microsoft.Graph.Security.AttackSimulation.SimulationAutomations.Item.Runs {
    ...
    public class RunsRequestBuilder : BaseRequestBuilder {
        ...
        public SimulationAutomationRunItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("simulationAutomationRun%2Did", position);
        ...
        public RunsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/attackSimulation/simulationAutomations/{simulationAutomation%2Did}/runs{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RunsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RunsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/attackSimulation/simulationAutomations/{simulationAutomation%2Did}/runs{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<SimulationAutomationRunCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<RunsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<SimulationAutomationRunCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<RunsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<SimulationAutomationRunCollectionResponse>(requestInfo, SimulationAutomationRunCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<SimulationAutomationRun?> PostAsync(SimulationAutomationRun body, CancellationToken cancellationToken = default, Action<RunsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<SimulationAutomationRun> PostAsync(SimulationAutomationRun body, CancellationToken cancellationToken = default, Action<RunsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(SimulationAutomationRun body, Action<RunsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(SimulationAutomationRun body, Action<RunsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
