...
namespace Microsoft.Graph.Security.AttackSimulation.LandingPages.Item
{
    ...
    public class LandingPageItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public Microsoft.Graph.Security.AttackSimulation.LandingPages.Item.Details.DetailsRequestBuilder Details
        {
            get => new Microsoft.Graph.Security.AttackSimulation.LandingPages.Item.Details.DetailsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Security.AttackSimulation.LandingPages.Item.LandingPageItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.LandingPage?> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Security.AttackSimulation.LandingPages.Item.LandingPageItemRequestBuilder.LandingPageItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.LandingPage> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Security.AttackSimulation.LandingPages.Item.LandingPageItemRequestBuilder.LandingPageItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Security.AttackSimulation.LandingPages.Item.LandingPageItemRequestBuilder.LandingPageItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Security.AttackSimulation.LandingPages.Item.LandingPageItemRequestBuilder.LandingPageItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Security.AttackSimulation.LandingPages.Item.LandingPageItemRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Security.AttackSimulation.LandingPages.Item.LandingPageItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class LandingPageItemRequestBuilderGetRequestConfiguration : RequestConfiguration<Microsoft.Graph.Security.AttackSimulation.LandingPages.Item.LandingPageItemRequestBuilder.LandingPageItemRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
