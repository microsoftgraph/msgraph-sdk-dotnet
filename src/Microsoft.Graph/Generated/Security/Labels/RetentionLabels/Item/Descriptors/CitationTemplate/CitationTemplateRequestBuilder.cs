...
#nullable enable
        public async Task<Microsoft.Graph.Models.Security.CitationTemplate?> GetAsync(Action<RequestConfiguration<CitationTemplateRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Security.CitationTemplate> GetAsync(Action<RequestConfiguration<CitationTemplateRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<CitationTemplateRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<CitationTemplateRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        public class CitationTemplateRequestBuilderGetRequestConfiguration : RequestConfiguration<CitationTemplateRequestBuilderGetQueryParameters>
        {
        }
    }
}
