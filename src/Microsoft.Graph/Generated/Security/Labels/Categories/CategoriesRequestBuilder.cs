...
namespace Microsoft.Graph.Security.Labels.Categories
{
    ...
    public class CategoriesRequestBuilder : BaseRequestBuilder
    {
        ...
        public CategoryTemplateItemRequestBuilder this[string position]
        {
            get
            {
...
#nullable enable
        public async Task<CategoryTemplateCollectionResponse?> GetAsync(Action<RequestConfiguration<CategoriesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<CategoryTemplateCollectionResponse> GetAsync(Action<RequestConfiguration<CategoriesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
