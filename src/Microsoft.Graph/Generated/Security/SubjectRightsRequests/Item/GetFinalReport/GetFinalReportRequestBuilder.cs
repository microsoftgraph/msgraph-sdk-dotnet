...
namespace Microsoft.Graph.Security.SubjectRightsRequests.Item.GetFinalReport
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Security.SubjectRightsRequests.Item.GetFinalReport.GetFinalReportRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Security.SubjectRightsRequests.Item.GetFinalReport.GetFinalReportRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Security.SubjectRightsRequests.Item.GetFinalReport.GetFinalReportRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Security.SubjectRightsRequests.Item.GetFinalReport.GetFinalReportRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
