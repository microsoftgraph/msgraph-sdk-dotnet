...
using Microsoft.Graph.Security.SecureScoreControlProfiles.Count;
using Microsoft.Graph.Security.SecureScoreControlProfiles.Item;
...
namespace Microsoft.Graph.Security.SecureScoreControlProfiles {
    ...
    /// </summary>
    public class SecureScoreControlProfilesRequestBuilder : BaseRequestBuilder {
        ...
        public SecureScoreControlProfileItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("secureScoreControlProfile%2Did", position);
        ...
        public SecureScoreControlProfilesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/secureScoreControlProfiles{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SecureScoreControlProfilesRequestBuilder and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        public async Task<SecureScoreControlProfileCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<SecureScoreControlProfilesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
            ...
            return await RequestAdapter.SendAsync<SecureScoreControlProfileCollectionResponse>(requestInfo, SecureScoreControlProfileCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<SecureScoreControlProfilesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<SecureScoreControlProfilesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new SecureScoreControlProfilesRequestBuilderGetRequestConfiguration();
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(SecureScoreControlProfile body, Action<SecureScoreControlProfilesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(SecureScoreControlProfile body, Action<SecureScoreControlProfilesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new SecureScoreControlProfilesRequestBuilderPostRequestConfiguration();
                requestConfiguration.Invoke(requestConfig);
                requestInfo.AddRequestOptions(requestConfig.Options);
                requestInfo.AddHeaders(requestConfig.Headers);
            }
...
#nullable restore
        ...
        public class SecureScoreControlProfilesRequestBuilderGetRequestConfiguration {
            ...
            public SecureScoreControlProfilesRequestBuilderGetQueryParameters QueryParameters { get; set; } = new SecureScoreControlProfilesRequestBuilderGetQueryParameters();
            /// <summary>
