...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<TriggersRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<TriggersRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<TriggersRoot?> GetAsync(CancellationToken cancellationToken = default, Action<TriggersRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<TriggersRoot> GetAsync(CancellationToken cancellationToken = default, Action<TriggersRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<TriggersRoot?> PatchAsync(TriggersRoot body, CancellationToken cancellationToken = default, Action<TriggersRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<TriggersRoot> PatchAsync(TriggersRoot body, CancellationToken cancellationToken = default, Action<TriggersRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
