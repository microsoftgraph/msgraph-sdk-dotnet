...
namespace Microsoft.Graph.Security.ThreatIntelligence.HostPorts.Item {
    ...
    public class HostPortItemRequestBuilder : BaseRequestBuilder {
        ...
        public MostRecentSslCertificateRequestBuilder MostRecentSslCertificate { get =>
            new MostRecentSslCertificateRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
...
#nullable restore
        ...
        public RequestInformation ToDeleteRequestInformation(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default) {
#endif
            var requestInfo = new RequestInformation(Method.DELETE, "{+baseurl}/security/threatIntelligence/hostPorts/{hostPort%2Did}", PathParameters);
...
#endif
            _ = body ?? throw new ArgumentNullException(nameof(body));
            var requestInfo = new RequestInformation(Method.PATCH, "{+baseurl}/security/threatIntelligence/hostPorts/{hostPort%2Did}", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
