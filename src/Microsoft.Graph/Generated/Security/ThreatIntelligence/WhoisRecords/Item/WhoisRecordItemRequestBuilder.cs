...
namespace Microsoft.Graph.Security.ThreatIntelligence.WhoisRecords.Item
{
    ...
    public class WhoisRecordItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public Microsoft.Graph.Security.ThreatIntelligence.WhoisRecords.Item.History.HistoryRequestBuilder History
        {
            get => new Microsoft.Graph.Security.ThreatIntelligence.WhoisRecords.Item.History.HistoryRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to manage the host property of the microsoft.graph.security.whoisBaseRecord entity.</summary>
        public Microsoft.Graph.Security.ThreatIntelligence.WhoisRecords.Item.Host.HostRequestBuilder Host
        {
            get => new Microsoft.Graph.Security.ThreatIntelligence.WhoisRecords.Item.Host.HostRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Security.ThreatIntelligence.WhoisRecords.Item.WhoisRecordItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.Security.WhoisRecord?> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Security.ThreatIntelligence.WhoisRecords.Item.WhoisRecordItemRequestBuilder.WhoisRecordItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Security.WhoisRecord> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Security.ThreatIntelligence.WhoisRecords.Item.WhoisRecordItemRequestBuilder.WhoisRecordItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.Security.WhoisRecord?> PatchAsync(Microsoft.Graph.Models.Security.WhoisRecord body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Security.WhoisRecord> PatchAsync(Microsoft.Graph.Models.Security.WhoisRecord body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Security.ThreatIntelligence.WhoisRecords.Item.WhoisRecordItemRequestBuilder.WhoisRecordItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Security.ThreatIntelligence.WhoisRecords.Item.WhoisRecordItemRequestBuilder.WhoisRecordItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(Microsoft.Graph.Models.Security.WhoisRecord body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(Microsoft.Graph.Models.Security.WhoisRecord body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Security.ThreatIntelligence.WhoisRecords.Item.WhoisRecordItemRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Security.ThreatIntelligence.WhoisRecords.Item.WhoisRecordItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class WhoisRecordItemRequestBuilderGetRequestConfiguration : RequestConfiguration<Microsoft.Graph.Security.ThreatIntelligence.WhoisRecords.Item.WhoisRecordItemRequestBuilder.WhoisRecordItemRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
