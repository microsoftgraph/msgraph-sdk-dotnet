...
namespace Microsoft.Graph.Security.ThreatIntelligence.HostPairs.Item {
    ...
    public class HostPairItemRequestBuilder : BaseRequestBuilder 
    {
        ...
        {
            get => new ChildHostRequestBuilder(PathParameters, RequestAdapter);
        }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<HostPair?> PatchAsync(HostPair body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<HostPair> PatchAsync(HostPair body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
