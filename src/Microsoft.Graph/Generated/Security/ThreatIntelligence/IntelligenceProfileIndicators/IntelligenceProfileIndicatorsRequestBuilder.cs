...
namespace Microsoft.Graph.Security.ThreatIntelligence.IntelligenceProfileIndicators {
    ...
    public class IntelligenceProfileIndicatorsRequestBuilder : BaseRequestBuilder 
    {
        ...
        public IntelligenceProfileIndicatorItemRequestBuilder this[string position]
        {
            get
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="IntelligenceProfileIndicatorsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<IntelligenceProfileIndicatorCollectionResponse?> GetAsync(Action<RequestConfiguration<IntelligenceProfileIndicatorsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<IntelligenceProfileIndicatorCollectionResponse> GetAsync(Action<RequestConfiguration<IntelligenceProfileIndicatorsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<IntelligenceProfileIndicator?> PostAsync(IntelligenceProfileIndicator body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<IntelligenceProfileIndicator> PostAsync(IntelligenceProfileIndicator body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<IntelligenceProfileIndicatorsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<IntelligenceProfileIndicatorsRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(IntelligenceProfileIndicator body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(IntelligenceProfileIndicator body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
...
#endif
            _ = body ?? throw new ArgumentNullException(nameof(body));
            var requestInfo = new RequestInformation(Method.POST, "{+baseurl}/security/threatIntelligence/intelligenceProfileIndicators", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
        ...
        /// </summary>
        /// <returns>A <see cref="IntelligenceProfileIndicatorsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
...
#nullable restore
        ...
        public class IntelligenceProfileIndicatorsRequestBuilderGetRequestConfiguration : RequestConfiguration<IntelligenceProfileIndicatorsRequestBuilderGetQueryParameters> 
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
