...
namespace Microsoft.Graph.ServicePrincipals.Item.RemoteDesktopSecurityConfiguration {
    ...
    public class RemoteDesktopSecurityConfigurationRequestBuilder : BaseRequestBuilder {
        ...
        public TargetDeviceGroupsRequestBuilder TargetDeviceGroups { get =>
            new TargetDeviceGroupsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.RemoteDesktopSecurityConfiguration?> GetAsync(Action<RequestConfiguration<RemoteDesktopSecurityConfigurationRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.RemoteDesktopSecurityConfiguration> GetAsync(Action<RequestConfiguration<RemoteDesktopSecurityConfigurationRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="RemoteDesktopSecurityConfigurationRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public RemoteDesktopSecurityConfigurationRequestBuilder WithUrl(string rawUrl) {
...
#nullable restore
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class RemoteDesktopSecurityConfigurationRequestBuilderGetRequestConfiguration : RequestConfiguration<RemoteDesktopSecurityConfigurationRequestBuilderGetQueryParameters> {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
