...
using Microsoft.Graph.ServicePrincipals.Item.Oauth2PermissionGrants.Count;
using Microsoft.Graph.ServicePrincipals.Item.Oauth2PermissionGrants.Item;
...
namespace Microsoft.Graph.ServicePrincipals.Item.Oauth2PermissionGrants {
    ...
    public class Oauth2PermissionGrantsRequestBuilder : BaseRequestBuilder {
        ...
        public Oauth2PermissionGrantsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/oauth2PermissionGrants{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new Oauth2PermissionGrantsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Oauth2PermissionGrantsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/oauth2PermissionGrants{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
