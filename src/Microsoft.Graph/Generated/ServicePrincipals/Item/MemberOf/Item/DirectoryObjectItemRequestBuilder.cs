...
using Microsoft.Graph.ServicePrincipals.Item.MemberOf.Item.GraphAdministrativeUnit;
using Microsoft.Graph.ServicePrincipals.Item.MemberOf.Item.GraphGroup;
...
namespace Microsoft.Graph.ServicePrincipals.Item.MemberOf.Item {
    ...
    public class DirectoryObjectItemRequestBuilder : BaseRequestBuilder {
        ...
        public DirectoryObjectItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/memberOf/{directoryObject%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new DirectoryObjectItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DirectoryObjectItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/memberOf/{directoryObject%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
