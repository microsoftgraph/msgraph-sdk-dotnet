...
namespace Microsoft.Graph.ServicePrincipals.Item.Synchronization.Jobs.Item.ValidateCredentials {
    ...
    public class ValidateCredentialsRequestBuilder : BaseRequestBuilder {
        ...
        public ValidateCredentialsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization/jobs/{synchronizationJob%2Did}/validateCredentials", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ValidateCredentialsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ValidateCredentialsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization/jobs/{synchronizationJob%2Did}/validateCredentials", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task PostAsync(ValidateCredentialsPostRequestBody body, CancellationToken cancellationToken = default, Action<ValidateCredentialsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(ValidateCredentialsPostRequestBody body, CancellationToken cancellationToken = default, Action<ValidateCredentialsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
