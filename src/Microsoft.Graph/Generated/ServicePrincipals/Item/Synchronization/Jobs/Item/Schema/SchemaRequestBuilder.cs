...
using Microsoft.Graph.ServicePrincipals.Item.Synchronization.Jobs.Item.Schema.Directories;
using Microsoft.Graph.ServicePrincipals.Item.Synchronization.Jobs.Item.Schema.FilterOperators;
using Microsoft.Graph.ServicePrincipals.Item.Synchronization.Jobs.Item.Schema.Functions;
using Microsoft.Graph.ServicePrincipals.Item.Synchronization.Jobs.Item.Schema.ParseExpression;
...
namespace Microsoft.Graph.ServicePrincipals.Item.Synchronization.Jobs.Item.Schema {
    ...
    public class SchemaRequestBuilder : BaseRequestBuilder {
        ...
        public SchemaRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization/jobs/{synchronizationJob%2Did}/schema{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SchemaRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SchemaRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization/jobs/{synchronizationJob%2Did}/schema{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
