...
namespace Microsoft.Graph.ServicePrincipals.Item.Synchronization.Jobs.Item.ProvisionOnDemand {
    ...
    public class ProvisionOnDemandRequestBuilder : BaseRequestBuilder {
        ...
        /// </summary>
        /// <returns>A <cref="StringKeyStringValuePair"></returns>
...
#nullable enable
        public async Task<StringKeyStringValuePair?> PostAsync(ProvisionOnDemandPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<StringKeyStringValuePair> PostAsync(ProvisionOnDemandPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <cref="ProvisionOnDemandRequestBuilder"></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public ProvisionOnDemandRequestBuilder WithUrl(string rawUrl) {
            return new ProvisionOnDemandRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
