...
namespace Microsoft.Graph.ServicePrincipals.Item.Synchronization.Templates.Item.Schema.ParseExpression {
    ...
    public class ParseExpressionRequestBuilder : BaseRequestBuilder {
        ...
        public ParseExpressionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization/templates/{synchronizationTemplate%2Did}/schema/parseExpression", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ParseExpressionRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ParseExpressionRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization/templates/{synchronizationTemplate%2Did}/schema/parseExpression", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<ParseExpressionResponse?> PostAsync(ParseExpressionPostRequestBody body, CancellationToken cancellationToken = default, Action<ParseExpressionRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ParseExpressionResponse> PostAsync(ParseExpressionPostRequestBody body, CancellationToken cancellationToken = default, Action<ParseExpressionRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
