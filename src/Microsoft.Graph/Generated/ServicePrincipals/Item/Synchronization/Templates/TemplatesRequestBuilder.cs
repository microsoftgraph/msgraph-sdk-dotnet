...
using Microsoft.Graph.ServicePrincipals.Item.Synchronization.Templates.Count;
using Microsoft.Graph.ServicePrincipals.Item.Synchronization.Templates.Item;
...
namespace Microsoft.Graph.ServicePrincipals.Item.Synchronization.Templates {
    ...
    public class TemplatesRequestBuilder : BaseRequestBuilder {
        ...
        public SynchronizationTemplateItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("synchronizationTemplate%2Did", position);
        ...
        public TemplatesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization/templates{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new TemplatesRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<SynchronizationTemplateCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<TemplatesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<SynchronizationTemplateCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<TemplatesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<SynchronizationTemplateCollectionResponse>(requestInfo, SynchronizationTemplateCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<SynchronizationTemplate?> PostAsync(SynchronizationTemplate body, CancellationToken cancellationToken = default, Action<TemplatesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<SynchronizationTemplate> PostAsync(SynchronizationTemplate body, CancellationToken cancellationToken = default, Action<TemplatesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(SynchronizationTemplate body, Action<TemplatesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(SynchronizationTemplate body, Action<TemplatesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
