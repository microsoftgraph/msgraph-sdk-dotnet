...
namespace Microsoft.Graph.ServicePrincipals.Item.Synchronization.AcquireAccessToken {
    ...
    public class AcquireAccessTokenRequestBuilder : BaseRequestBuilder {
        ...
        public AcquireAccessTokenRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization/acquireAccessToken", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AcquireAccessTokenRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task PostAsync(AcquireAccessTokenPostRequestBody body, CancellationToken cancellationToken = default, Action<AcquireAccessTokenRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(AcquireAccessTokenPostRequestBody body, CancellationToken cancellationToken = default, Action<AcquireAccessTokenRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
