...
using Microsoft.Graph.ServicePrincipals.Item.DelegatedPermissionClassifications.Count;
using Microsoft.Graph.ServicePrincipals.Item.DelegatedPermissionClassifications.Item;
...
namespace Microsoft.Graph.ServicePrincipals.Item.DelegatedPermissionClassifications {
    ...
    /// </summary>
    public class DelegatedPermissionClassificationsRequestBuilder : BaseRequestBuilder {
        ...
        public DelegatedPermissionClassificationsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/delegatedPermissionClassifications{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new DelegatedPermissionClassificationsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DelegatedPermissionClassificationsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/delegatedPermissionClassifications{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<DelegatedPermissionClassificationCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<DelegatedPermissionClassificationsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DelegatedPermissionClassificationCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<DelegatedPermissionClassificationsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<DelegatedPermissionClassificationCollectionResponse>(requestInfo, DelegatedPermissionClassificationCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DelegatedPermissionClassification?> PostAsync(DelegatedPermissionClassification body, CancellationToken cancellationToken = default, Action<DelegatedPermissionClassificationsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DelegatedPermissionClassification> PostAsync(DelegatedPermissionClassification body, CancellationToken cancellationToken = default, Action<DelegatedPermissionClassificationsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
