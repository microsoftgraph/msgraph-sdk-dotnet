...
namespace Microsoft.Graph.ServicePrincipals.Item.AppRoleAssignments
{
    ...
    public class AppRoleAssignmentsRequestBuilder : BaseRequestBuilder
    {
        ...
        public Microsoft.Graph.ServicePrincipals.Item.AppRoleAssignments.Count.CountRequestBuilder Count
        {
            get => new Microsoft.Graph.ServicePrincipals.Item.AppRoleAssignments.Count.CountRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public Microsoft.Graph.ServicePrincipals.Item.AppRoleAssignments.Item.AppRoleAssignmentItemRequestBuilder this[string position]
        {
            get
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.ServicePrincipals.Item.AppRoleAssignments.AppRoleAssignmentsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Microsoft.Graph.Models.AppRoleAssignmentCollectionResponse?> GetAsync(Action<RequestConfiguration<Microsoft.Graph.ServicePrincipals.Item.AppRoleAssignments.AppRoleAssignmentsRequestBuilder.AppRoleAssignmentsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.AppRoleAssignmentCollectionResponse> GetAsync(Action<RequestConfiguration<Microsoft.Graph.ServicePrincipals.Item.AppRoleAssignments.AppRoleAssignmentsRequestBuilder.AppRoleAssignmentsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.ServicePrincipals.Item.AppRoleAssignments.AppRoleAssignmentsRequestBuilder.AppRoleAssignmentsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.ServicePrincipals.Item.AppRoleAssignments.AppRoleAssignmentsRequestBuilder.AppRoleAssignmentsRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.ServicePrincipals.Item.AppRoleAssignments.AppRoleAssignmentsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.ServicePrincipals.Item.AppRoleAssignments.AppRoleAssignmentsRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.ServicePrincipals.Item.AppRoleAssignments.AppRoleAssignmentsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Read the properties and relationships of an appRoleAssignment object.
        /// </summary>
...
#nullable restore
        ...
        public class AppRoleAssignmentsRequestBuilderGetRequestConfiguration : RequestConfiguration<Microsoft.Graph.ServicePrincipals.Item.AppRoleAssignments.AppRoleAssignmentsRequestBuilder.AppRoleAssignmentsRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
