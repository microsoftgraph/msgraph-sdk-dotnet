...
namespace Microsoft.Graph.ServicePrincipals.Item.OwnedObjects.Item.GraphApplication {
    ...
    public class GraphApplicationRequestBuilder : BaseRequestBuilder {
        ...
        public GraphApplicationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/ownedObjects/{directoryObject%2Did}/graph.application{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GraphApplicationRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GraphApplicationRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/ownedObjects/{directoryObject%2Did}/graph.application{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
