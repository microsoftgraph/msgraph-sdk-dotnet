...
#nullable enable
        public async Task<AppRoleAssignment?> GetAsync(Action<RequestConfiguration<GraphAppRoleAssignmentRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<AppRoleAssignment> GetAsync(Action<RequestConfiguration<GraphAppRoleAssignmentRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <cref="GraphAppRoleAssignmentRequestBuilder"></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
