...
namespace Microsoft.Graph.ServicePrincipals.Item.AddPassword {
    ...
    public class AddPasswordRequestBuilder : BaseRequestBuilder {
        ...
        public AddPasswordRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/addPassword", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AddPasswordRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/serviceprincipal-addpassword?view=graph-rest-1.0" />
        /// </summary>
...
#nullable enable
        public async Task<PasswordCredential?> PostAsync(AddPasswordPostRequestBody body, CancellationToken cancellationToken = default, Action<AddPasswordRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PasswordCredential> PostAsync(AddPasswordPostRequestBody body, CancellationToken cancellationToken = default, Action<AddPasswordRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
