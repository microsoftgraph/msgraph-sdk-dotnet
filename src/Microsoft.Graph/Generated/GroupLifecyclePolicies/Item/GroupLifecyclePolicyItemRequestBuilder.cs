...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<GroupLifecyclePolicyItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<GroupLifecyclePolicyItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<GroupLifecyclePolicy?> GetAsync(CancellationToken cancellationToken = default, Action<GroupLifecyclePolicyItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GroupLifecyclePolicy> GetAsync(CancellationToken cancellationToken = default, Action<GroupLifecyclePolicyItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<GroupLifecyclePolicy?> PatchAsync(GroupLifecyclePolicy body, CancellationToken cancellationToken = default, Action<GroupLifecyclePolicyItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GroupLifecyclePolicy> PatchAsync(GroupLifecyclePolicy body, CancellationToken cancellationToken = default, Action<GroupLifecyclePolicyItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
