...
#nullable enable
        public async Task<Domain?> PostAsync(CancellationToken cancellationToken = default, Action<VerifyRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Domain> PostAsync(CancellationToken cancellationToken = default, Action<VerifyRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
