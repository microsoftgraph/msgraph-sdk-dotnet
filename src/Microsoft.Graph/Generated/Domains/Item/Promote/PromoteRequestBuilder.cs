...
#nullable enable
        public async Task<PromoteResponse?> PostAsync(CancellationToken cancellationToken = default, Action<PromoteRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PromoteResponse> PostAsync(CancellationToken cancellationToken = default, Action<PromoteRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
