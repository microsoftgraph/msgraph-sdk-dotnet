...
namespace Microsoft.Graph.Domains.Item.VerificationDnsRecords {
    ...
    public class VerificationDnsRecordsRequestBuilder : BaseRequestBuilder {
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/domain-list-verificationdnsrecords?view=graph-rest-1.0" />
        /// </summary>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DomainDnsRecordCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<VerificationDnsRecordsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DomainDnsRecordCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<VerificationDnsRecordsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DomainDnsRecord?> PostAsync(DomainDnsRecord body, CancellationToken cancellationToken = default, Action<VerificationDnsRecordsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DomainDnsRecord> PostAsync(DomainDnsRecord body, CancellationToken cancellationToken = default, Action<VerificationDnsRecordsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
