...
namespace Microsoft.Graph.Users.Item.Teamwork.InstalledApps.Item.TeamsAppDefinition {
    ...
    public class TeamsAppDefinitionRequestBuilder : BaseRequestBuilder {
        ...
        public TeamsAppDefinitionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/teamwork/installedApps/{userScopeTeamsAppInstallation%2Did}/teamsAppDefinition{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new TeamsAppDefinitionRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TeamsAppDefinitionRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/teamwork/installedApps/{userScopeTeamsAppInstallation%2Did}/teamsAppDefinition{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<Microsoft.Graph.Models.TeamsAppDefinition?> GetAsync(CancellationToken cancellationToken = default, Action<TeamsAppDefinitionRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.TeamsAppDefinition> GetAsync(CancellationToken cancellationToken = default, Action<TeamsAppDefinitionRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
