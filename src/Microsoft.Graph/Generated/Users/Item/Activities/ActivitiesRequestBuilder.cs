...
using Microsoft.Graph.Users.Item.Activities.Count;
using Microsoft.Graph.Users.Item.Activities.Item;
using Microsoft.Graph.Users.Item.Activities.Recent;
...
namespace Microsoft.Graph.Users.Item.Activities {
    ...
    public class ActivitiesRequestBuilder : BaseRequestBuilder {
        ...
        public UserActivityItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("userActivity%2Did", position);
        ...
        public ActivitiesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/activities{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ActivitiesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ActivitiesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/activities{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<UserActivityCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ActivitiesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UserActivityCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ActivitiesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<UserActivityCollectionResponse>(requestInfo, UserActivityCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<UserActivity?> PostAsync(UserActivity body, CancellationToken cancellationToken = default, Action<ActivitiesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UserActivity> PostAsync(UserActivity body, CancellationToken cancellationToken = default, Action<ActivitiesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
