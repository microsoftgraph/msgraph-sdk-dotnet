...
namespace Microsoft.Graph.Users.Item.Activities.Item.HistoryItems.Item.Activity {
    ...
    public class ActivityRequestBuilder : BaseRequestBuilder {
        ...
        public ActivityRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/activities/{userActivity%2Did}/historyItems/{activityHistoryItem%2Did}/activity{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ActivityRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ActivityRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/activities/{userActivity%2Did}/historyItems/{activityHistoryItem%2Did}/activity{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<UserActivity?> GetAsync(CancellationToken cancellationToken = default, Action<ActivityRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UserActivity> GetAsync(CancellationToken cancellationToken = default, Action<ActivityRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
