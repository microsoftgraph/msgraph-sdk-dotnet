...
using Microsoft.Graph.Users.Item.Todo.Lists.Item.Tasks.Count;
using Microsoft.Graph.Users.Item.Todo.Lists.Item.Tasks.Delta;
using Microsoft.Graph.Users.Item.Todo.Lists.Item.Tasks.Item;
...
namespace Microsoft.Graph.Users.Item.Todo.Lists.Item.Tasks {
    ...
    public class TasksRequestBuilder : BaseRequestBuilder {
        ...
        public TodoTaskItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("todoTask%2Did", position);
        ...
        public TasksRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/todo/lists/{todoTaskList%2Did}/tasks{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new TasksRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TasksRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/todo/lists/{todoTaskList%2Did}/tasks{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<TodoTaskCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<TasksRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<TodoTaskCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<TasksRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<TodoTaskCollectionResponse>(requestInfo, TodoTaskCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
        /// Create a new task object in a specified todoTaskList.
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/todotasklist-post-tasks?view=graph-rest-1.0" />
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<TodoTask?> PostAsync(TodoTask body, CancellationToken cancellationToken = default, Action<TasksRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<TodoTask> PostAsync(TodoTask body, CancellationToken cancellationToken = default, Action<TasksRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(TodoTask body, Action<TasksRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(TodoTask body, Action<TasksRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
