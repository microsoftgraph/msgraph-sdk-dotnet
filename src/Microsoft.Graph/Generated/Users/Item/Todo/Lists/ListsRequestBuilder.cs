...
using Microsoft.Graph.Users.Item.Todo.Lists.Count;
using Microsoft.Graph.Users.Item.Todo.Lists.Delta;
using Microsoft.Graph.Users.Item.Todo.Lists.Item;
...
namespace Microsoft.Graph.Users.Item.Todo.Lists {
    ...
    public class ListsRequestBuilder : BaseRequestBuilder {
        ...
        public ListsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/todo/lists{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ListsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ListsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/todo/lists{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<TodoTaskListCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ListsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<TodoTaskListCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ListsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<TodoTaskList?> PostAsync(TodoTaskList body, CancellationToken cancellationToken = default, Action<ListsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<TodoTaskList> PostAsync(TodoTaskList body, CancellationToken cancellationToken = default, Action<ListsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(TodoTaskList body, Action<ListsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(TodoTaskList body, Action<ListsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
