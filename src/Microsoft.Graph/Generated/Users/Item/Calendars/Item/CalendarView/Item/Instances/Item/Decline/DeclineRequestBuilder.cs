...
using System;
namespace Microsoft.Graph.Users.Item.Calendars.Item.CalendarView.Item.Instances.Item.Decline {
    /// <summary>
    ...
    public class DeclineRequestBuilder : BaseRequestBuilder {
        ...
        public DeclineRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/calendars/{calendar%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/decline", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new DeclineRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DeclineRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/calendars/{calendar%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/decline", rawUrl) {
        }
        /// <summary>
