...
namespace Microsoft.Graph.Users.Item.Calendars.Item.Events.Item.DismissReminder {
    ...
    public class DismissReminderRequestBuilder : BaseRequestBuilder {
        ...
        public DismissReminderRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/calendars/{calendar%2Did}/events/{event%2Did}/dismissReminder", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new DismissReminderRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DismissReminderRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/calendars/{calendar%2Did}/events/{event%2Did}/dismissReminder", rawUrl) {
        }
        /// <summary>
