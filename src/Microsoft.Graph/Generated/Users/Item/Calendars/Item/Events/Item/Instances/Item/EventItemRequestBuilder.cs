...
using Microsoft.Graph.Users.Item.Calendars.Item.Events.Item.Instances.Item.Accept;
using Microsoft.Graph.Users.Item.Calendars.Item.Events.Item.Instances.Item.Attachments;
using Microsoft.Graph.Users.Item.Calendars.Item.Events.Item.Instances.Item.Calendar;
using Microsoft.Graph.Users.Item.Calendars.Item.Events.Item.Instances.Item.Cancel;
using Microsoft.Graph.Users.Item.Calendars.Item.Events.Item.Instances.Item.Decline;
using Microsoft.Graph.Users.Item.Calendars.Item.Events.Item.Instances.Item.DismissReminder;
using Microsoft.Graph.Users.Item.Calendars.Item.Events.Item.Instances.Item.Extensions;
using Microsoft.Graph.Users.Item.Calendars.Item.Events.Item.Instances.Item.Forward;
...
using System;
namespace Microsoft.Graph.Users.Item.Calendars.Item.Events.Item.Instances.Item {
    /// <summary>
    ...
    public class EventItemRequestBuilder : BaseRequestBuilder {
        ...
        public EventItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/calendars/{calendar%2Did}/events/{event%2Did}/instances/{event%2Did1}{?startDateTime*,endDateTime*,%24select}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new EventItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EventItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/calendars/{calendar%2Did}/events/{event%2Did}/instances/{event%2Did1}{?startDateTime*,endDateTime*,%24select}", rawUrl) {
        }
        /// <summary>
