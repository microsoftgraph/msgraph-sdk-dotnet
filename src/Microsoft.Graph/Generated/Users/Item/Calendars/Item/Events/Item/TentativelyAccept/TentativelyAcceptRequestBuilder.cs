...
namespace Microsoft.Graph.Users.Item.Calendars.Item.Events.Item.TentativelyAccept {
    ...
    public class TentativelyAcceptRequestBuilder : BaseRequestBuilder {
        ...
        public TentativelyAcceptRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/calendars/{calendar%2Did}/events/{event%2Did}/tentativelyAccept", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new TentativelyAcceptRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TentativelyAcceptRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/calendars/{calendar%2Did}/events/{event%2Did}/tentativelyAccept", rawUrl) {
        }
        /// <summary>
