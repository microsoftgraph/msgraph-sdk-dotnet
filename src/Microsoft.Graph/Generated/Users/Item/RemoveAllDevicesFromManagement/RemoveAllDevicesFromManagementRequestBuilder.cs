...
namespace Microsoft.Graph.Users.Item.RemoveAllDevicesFromManagement {
    ...
    public class RemoveAllDevicesFromManagementRequestBuilder : BaseRequestBuilder {
        ...
        public RemoveAllDevicesFromManagementRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/removeAllDevicesFromManagement", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RemoveAllDevicesFromManagementRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RemoveAllDevicesFromManagementRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/removeAllDevicesFromManagement", rawUrl) {
        }
        /// <summary>
