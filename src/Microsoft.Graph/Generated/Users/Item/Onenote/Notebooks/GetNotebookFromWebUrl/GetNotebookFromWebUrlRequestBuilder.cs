...
namespace Microsoft.Graph.Users.Item.Onenote.Notebooks.GetNotebookFromWebUrl {
    ...
    public class GetNotebookFromWebUrlRequestBuilder : BaseRequestBuilder {
        ...
        public GetNotebookFromWebUrlRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/onenote/notebooks/getNotebookFromWebUrl", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GetNotebookFromWebUrlRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetNotebookFromWebUrlRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/onenote/notebooks/getNotebookFromWebUrl", rawUrl) {
        }
        /// <summary>
