...
using System;
namespace Microsoft.Graph.Users.Item.Calendar.Events.Item.Instances.Item.MultiValueExtendedProperties.Item {
    /// <summary>
    ...
    public class MultiValueLegacyExtendedPropertyItemRequestBuilder : BaseRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MultiValueLegacyExtendedPropertyItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/calendar/events/{event%2Did}/instances/{event%2Did1}/multiValueExtendedProperties/{multiValueLegacyExtendedProperty%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
