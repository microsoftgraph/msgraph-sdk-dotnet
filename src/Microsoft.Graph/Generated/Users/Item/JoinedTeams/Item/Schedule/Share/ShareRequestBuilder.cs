...
namespace Microsoft.Graph.Users.Item.JoinedTeams.Item.Schedule.Share {
    ...
    public class ShareRequestBuilder : BaseRequestBuilder {
        ...
        public ShareRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/schedule/share", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ShareRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ShareRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/schedule/share", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task PostAsync(SharePostRequestBody body, CancellationToken cancellationToken = default, Action<ShareRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(SharePostRequestBody body, CancellationToken cancellationToken = default, Action<ShareRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
