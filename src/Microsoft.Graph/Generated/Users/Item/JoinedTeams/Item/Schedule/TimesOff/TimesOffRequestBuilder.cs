...
using Microsoft.Graph.Users.Item.JoinedTeams.Item.Schedule.TimesOff.Count;
using Microsoft.Graph.Users.Item.JoinedTeams.Item.Schedule.TimesOff.Item;
...
namespace Microsoft.Graph.Users.Item.JoinedTeams.Item.Schedule.TimesOff {
    ...
    public class TimesOffRequestBuilder : BaseRequestBuilder {
        ...
        public TimesOffRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/schedule/timesOff{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new TimesOffRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TimesOffRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/schedule/timesOff{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select}", rawUrl) {
        }
        /// <summary>
        /// Get the list of timeOff instances in a schedule.
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/schedule-list-timesoff?view=graph-rest-1.0" />
        /// </summary>
...
#nullable restore
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/schedule-post-timesoff?view=graph-rest-1.0" />
        /// </summary>
