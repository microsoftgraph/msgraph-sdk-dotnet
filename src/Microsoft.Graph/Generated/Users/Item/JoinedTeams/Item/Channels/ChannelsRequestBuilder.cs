...
using Microsoft.Graph.Users.Item.JoinedTeams.Item.Channels.Count;
using Microsoft.Graph.Users.Item.JoinedTeams.Item.Channels.GetAllMessages;
using Microsoft.Graph.Users.Item.JoinedTeams.Item.Channels.Item;
...
namespace Microsoft.Graph.Users.Item.JoinedTeams.Item.Channels {
    ...
    public class ChannelsRequestBuilder : BaseRequestBuilder {
        ...
        public ChannelsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/channels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ChannelsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ChannelsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/channels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<ChannelCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ChannelsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ChannelCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ChannelsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Channel?> PostAsync(Channel body, CancellationToken cancellationToken = default, Action<ChannelsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Channel> PostAsync(Channel body, CancellationToken cancellationToken = default, Action<ChannelsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
