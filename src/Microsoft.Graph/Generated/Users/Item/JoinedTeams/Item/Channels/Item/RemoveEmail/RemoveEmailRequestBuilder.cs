...
namespace Microsoft.Graph.Users.Item.JoinedTeams.Item.Channels.Item.RemoveEmail {
    ...
    public class RemoveEmailRequestBuilder : BaseRequestBuilder {
        ...
        public RemoveEmailRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/channels/{channel%2Did}/removeEmail", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RemoveEmailRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RemoveEmailRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/channels/{channel%2Did}/removeEmail", rawUrl) {
        }
        /// <summary>
