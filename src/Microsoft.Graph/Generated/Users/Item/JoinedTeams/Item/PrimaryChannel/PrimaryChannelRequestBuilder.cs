...
namespace Microsoft.Graph.Users.Item.JoinedTeams.Item.PrimaryChannel {
    ...
    public class PrimaryChannelRequestBuilder : BaseRequestBuilder {
        ...
        public PrimaryChannelRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/primaryChannel{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new PrimaryChannelRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PrimaryChannelRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/primaryChannel{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
