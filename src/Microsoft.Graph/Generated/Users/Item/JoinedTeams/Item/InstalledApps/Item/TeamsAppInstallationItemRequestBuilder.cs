...
using Microsoft.Graph.Users.Item.JoinedTeams.Item.InstalledApps.Item.TeamsApp;
using Microsoft.Graph.Users.Item.JoinedTeams.Item.InstalledApps.Item.TeamsAppDefinition;
using Microsoft.Graph.Users.Item.JoinedTeams.Item.InstalledApps.Item.Upgrade;
...
namespace Microsoft.Graph.Users.Item.JoinedTeams.Item.InstalledApps.Item {
    ...
    public class TeamsAppInstallationItemRequestBuilder : BaseRequestBuilder {
        ...
        public TeamsAppInstallationItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/installedApps/{teamsAppInstallation%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new TeamsAppInstallationItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TeamsAppInstallationItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/installedApps/{teamsAppInstallation%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
