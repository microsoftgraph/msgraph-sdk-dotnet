...
namespace Microsoft.Graph.Users.Item.JoinedTeams.Item.InstalledApps.Item.Upgrade {
    ...
    public class UpgradeRequestBuilder : BaseRequestBuilder {
        ...
        public UpgradeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/installedApps/{teamsAppInstallation%2Did}/upgrade", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new UpgradeRequestBuilder and sets the default values.
        /// </summary>
