...
using Microsoft.Graph.Users.Item.JoinedTeams.Item.IncomingChannels.Count;
using Microsoft.Graph.Users.Item.JoinedTeams.Item.IncomingChannels.Item;
...
namespace Microsoft.Graph.Users.Item.JoinedTeams.Item.IncomingChannels {
    ...
    public class IncomingChannelsRequestBuilder : BaseRequestBuilder {
        ...
        public IncomingChannelsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/incomingChannels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new IncomingChannelsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public IncomingChannelsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/incomingChannels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<ChannelCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<IncomingChannelsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ChannelCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<IncomingChannelsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
