...
namespace Microsoft.Graph.Users.Item.MailFolders.Item.Messages.Item.CreateReplyAll {
    ...
    public class CreateReplyAllRequestBuilder : BaseRequestBuilder {
        ...
        public CreateReplyAllRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/messages/{message%2Did}/createReplyAll", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CreateReplyAllRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CreateReplyAllRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/messages/{message%2Did}/createReplyAll", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<Microsoft.Graph.Models.Message?> PostAsync(CreateReplyAllPostRequestBody body, CancellationToken cancellationToken = default, Action<CreateReplyAllRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Message> PostAsync(CreateReplyAllPostRequestBody body, CancellationToken cancellationToken = default, Action<CreateReplyAllRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
