...
namespace Microsoft.Graph.Users.Item.MailFolders.Item.Messages.Item.CreateReply {
    ...
    public class CreateReplyRequestBuilder : BaseRequestBuilder {
        ...
        public CreateReplyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/messages/{message%2Did}/createReply", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CreateReplyRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CreateReplyRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/messages/{message%2Did}/createReply", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<Microsoft.Graph.Models.Message?> PostAsync(CreateReplyPostRequestBody body, CancellationToken cancellationToken = default, Action<CreateReplyRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Message> PostAsync(CreateReplyPostRequestBody body, CancellationToken cancellationToken = default, Action<CreateReplyRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
