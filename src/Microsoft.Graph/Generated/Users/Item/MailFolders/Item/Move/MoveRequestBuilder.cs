...
namespace Microsoft.Graph.Users.Item.MailFolders.Item.Move {
    ...
    public class MoveRequestBuilder : BaseRequestBuilder {
        ...
        public MoveRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/move", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new MoveRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MoveRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/move", rawUrl) {
        }
        /// <summary>
