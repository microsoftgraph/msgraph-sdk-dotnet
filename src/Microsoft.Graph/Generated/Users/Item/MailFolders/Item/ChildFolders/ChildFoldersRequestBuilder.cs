...
using Microsoft.Graph.Users.Item.MailFolders.Item.ChildFolders.Count;
using Microsoft.Graph.Users.Item.MailFolders.Item.ChildFolders.Delta;
using Microsoft.Graph.Users.Item.MailFolders.Item.ChildFolders.Item;
...
namespace Microsoft.Graph.Users.Item.MailFolders.Item.ChildFolders {
    ...
    public class ChildFoldersRequestBuilder : BaseRequestBuilder {
        ...
        public Microsoft.Graph.Users.Item.MailFolders.Item.ChildFolders.Item.MailFolderItemRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("mailFolder%2Did1", position);
            return new Microsoft.Graph.Users.Item.MailFolders.Item.ChildFolders.Item.MailFolderItemRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
        ...
        public ChildFoldersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/childFolders{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ChildFoldersRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ChildFoldersRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/childFolders{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
