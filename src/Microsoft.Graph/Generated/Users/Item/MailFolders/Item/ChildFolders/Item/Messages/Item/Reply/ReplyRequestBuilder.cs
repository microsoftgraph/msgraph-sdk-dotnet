...
namespace Microsoft.Graph.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.Reply
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.Reply.ReplyRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task PostAsync(Microsoft.Graph.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.Reply.ReplyPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task PostAsync(Microsoft.Graph.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.Reply.ReplyPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.Reply.ReplyPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.Reply.ReplyPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.Reply.ReplyRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.Reply.ReplyRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.Reply.ReplyRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
