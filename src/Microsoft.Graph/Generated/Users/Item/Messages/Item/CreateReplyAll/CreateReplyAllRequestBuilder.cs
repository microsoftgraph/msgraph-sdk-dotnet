...
namespace Microsoft.Graph.Users.Item.Messages.Item.CreateReplyAll
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Users.Item.Messages.Item.CreateReplyAll.CreateReplyAllRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Microsoft.Graph.Models.Message?> PostAsync(Microsoft.Graph.Users.Item.Messages.Item.CreateReplyAll.CreateReplyAllPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Message> PostAsync(Microsoft.Graph.Users.Item.Messages.Item.CreateReplyAll.CreateReplyAllPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Users.Item.Messages.Item.CreateReplyAll.CreateReplyAllPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Users.Item.Messages.Item.CreateReplyAll.CreateReplyAllPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Users.Item.Messages.Item.CreateReplyAll.CreateReplyAllRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Users.Item.Messages.Item.CreateReplyAll.CreateReplyAllRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Users.Item.Messages.Item.CreateReplyAll.CreateReplyAllRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
