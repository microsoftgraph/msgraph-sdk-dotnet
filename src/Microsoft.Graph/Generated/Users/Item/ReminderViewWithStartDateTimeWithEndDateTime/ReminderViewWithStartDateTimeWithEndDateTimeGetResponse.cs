...
namespace Microsoft.Graph.Users.Item.ReminderViewWithStartDateTimeWithEndDateTime {
    public class ReminderViewWithStartDateTimeWithEndDateTimeGetResponse : BaseCollectionPaginationCountResponse, IParsable {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <cref="ReminderViewWithStartDateTimeWithEndDateTimeGetResponse"></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ReminderViewWithStartDateTimeWithEndDateTimeGetResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
