...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<PlannerUser?> GetAsync(CancellationToken cancellationToken = default, Action<PlannerRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PlannerUser> GetAsync(CancellationToken cancellationToken = default, Action<PlannerRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<PlannerUser?> PatchAsync(PlannerUser body, CancellationToken cancellationToken = default, Action<PlannerRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PlannerUser> PatchAsync(PlannerUser body, CancellationToken cancellationToken = default, Action<PlannerRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
