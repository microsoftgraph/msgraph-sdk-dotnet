...
namespace Microsoft.Graph.Users.Item.MemberOf.Item.GraphGroup
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Users.Item.MemberOf.Item.GraphGroup.GraphGroupRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Microsoft.Graph.Models.Group?> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Users.Item.MemberOf.Item.GraphGroup.GraphGroupRequestBuilder.GraphGroupRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Group> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Users.Item.MemberOf.Item.GraphGroup.GraphGroupRequestBuilder.GraphGroupRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Users.Item.MemberOf.Item.GraphGroup.GraphGroupRequestBuilder.GraphGroupRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Users.Item.MemberOf.Item.GraphGroup.GraphGroupRequestBuilder.GraphGroupRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Users.Item.MemberOf.Item.GraphGroup.GraphGroupRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Users.Item.MemberOf.Item.GraphGroup.GraphGroupRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Users.Item.MemberOf.Item.GraphGroup.GraphGroupRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Get groups, directory roles, and administrative units that the user is a direct member of. This operation isn&apos;t transitive. To retrieve groups, directory roles, and administrative units that the user is a member through transitive membership, use the List user transitive memberOf API.
        /// </summary>
...
#nullable restore
        ...
        public class GraphGroupRequestBuilderGetRequestConfiguration : RequestConfiguration<Microsoft.Graph.Users.Item.MemberOf.Item.GraphGroup.GraphGroupRequestBuilder.GraphGroupRequestBuilderGetQueryParameters>
        {
        }
    }
}
