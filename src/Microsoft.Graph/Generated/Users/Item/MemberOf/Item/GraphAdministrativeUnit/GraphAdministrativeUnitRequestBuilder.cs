...
/// <summary>
/// Casts the previous resource to administrative unit.
/// </summary>
...
#nullable enable
        public async Task<Microsoft.Graph.Models.AdministrativeUnit?> GetAsync(Action<GraphAdministrativeUnitRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
    public async Task<Microsoft.Graph.Models.AdministrativeUnit> GetAsync(Action<GraphAdministrativeUnitRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default)
    {
