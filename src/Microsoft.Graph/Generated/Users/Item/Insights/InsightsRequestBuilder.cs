...
namespace Microsoft.Graph.Users.Item.Insights {
    ...
    public class InsightsRequestBuilder : BaseRequestBuilder {
        ...
        public InsightsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/insights{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new InsightsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public InsightsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/insights{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<OfficeGraphInsights?> GetAsync(CancellationToken cancellationToken = default, Action<InsightsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<OfficeGraphInsights> GetAsync(CancellationToken cancellationToken = default, Action<InsightsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<OfficeGraphInsights>(requestInfo, OfficeGraphInsights.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<OfficeGraphInsights?> PatchAsync(OfficeGraphInsights body, CancellationToken cancellationToken = default, Action<InsightsRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<OfficeGraphInsights> PatchAsync(OfficeGraphInsights body, CancellationToken cancellationToken = default, Action<InsightsRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(OfficeGraphInsights body, Action<InsightsRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(OfficeGraphInsights body, Action<InsightsRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
