...
namespace Microsoft.Graph.Users.Item.Insights.Shared
{
    ...
    public class SharedRequestBuilder : BaseRequestBuilder
    {
        ...
        public Microsoft.Graph.Users.Item.Insights.Shared.Count.CountRequestBuilder Count
        {
            get => new Microsoft.Graph.Users.Item.Insights.Shared.Count.CountRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public Microsoft.Graph.Users.Item.Insights.Shared.Item.SharedInsightItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("sharedInsight%2Did", position);
                return new Microsoft.Graph.Users.Item.Insights.Shared.Item.SharedInsightItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Users.Item.Insights.Shared.SharedRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Microsoft.Graph.Models.SharedInsightCollectionResponse?> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Users.Item.Insights.Shared.SharedRequestBuilder.SharedRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.SharedInsightCollectionResponse> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Users.Item.Insights.Shared.SharedRequestBuilder.SharedRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Users.Item.Insights.Shared.SharedRequestBuilder.SharedRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Users.Item.Insights.Shared.SharedRequestBuilder.SharedRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Users.Item.Insights.Shared.SharedRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Users.Item.Insights.Shared.SharedRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Users.Item.Insights.Shared.SharedRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Calculated relationship identifying documents shared with or by the user. This includes URLs, file attachments, and reference attachments to OneDrive for Business and SharePoint files found in Outlook messages and meetings. This also includes URLs and reference attachments to Teams conversations. Ordered by recency of share.
        /// </summary>
...
#nullable restore
        ...
        public class SharedRequestBuilderGetRequestConfiguration : RequestConfiguration<Microsoft.Graph.Users.Item.Insights.Shared.SharedRequestBuilder.SharedRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
