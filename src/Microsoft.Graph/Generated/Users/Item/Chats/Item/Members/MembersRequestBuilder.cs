...
using Microsoft.Graph.Users.Item.Chats.Item.Members.Add;
using Microsoft.Graph.Users.Item.Chats.Item.Members.Count;
using Microsoft.Graph.Users.Item.Chats.Item.Members.Item;
...
namespace Microsoft.Graph.Users.Item.Chats.Item.Members {
    ...
    public class MembersRequestBuilder : BaseRequestBuilder {
        ...
        public MembersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/members{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new MembersRequestBuilder and sets the default values.
        /// </summary>
