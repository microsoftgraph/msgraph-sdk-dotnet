...
namespace Microsoft.Graph.Users.Item.Contacts.Item.Photo {
    ...
    public class PhotoRequestBuilder : BaseRequestBuilder {
        ...
        public PhotoRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/contacts/{contact%2Did}/photo{?%24select}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new PhotoRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PhotoRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/contacts/{contact%2Did}/photo{?%24select}", rawUrl) {
        }
        /// <summary>
