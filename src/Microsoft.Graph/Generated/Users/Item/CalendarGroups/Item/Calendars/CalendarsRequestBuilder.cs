...
using Microsoft.Graph.Users.Item.CalendarGroups.Item.Calendars.Count;
using Microsoft.Graph.Users.Item.CalendarGroups.Item.Calendars.Item;
...
namespace Microsoft.Graph.Users.Item.CalendarGroups.Item.Calendars {
    ...
    public class CalendarsRequestBuilder : BaseRequestBuilder {
        ...
        public CalendarsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/calendarGroups/{calendarGroup%2Did}/calendars{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CalendarsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/calendargroup-list-calendars?view=graph-rest-1.0" />
        /// </summary>
...
#nullable restore
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/calendargroup-post-calendars?view=graph-rest-1.0" />
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.Calendar?> PostAsync(Microsoft.Graph.Models.Calendar body, CancellationToken cancellationToken = default, Action<CalendarsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Calendar> PostAsync(Microsoft.Graph.Models.Calendar body, CancellationToken cancellationToken = default, Action<CalendarsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Models.Calendar body, Action<CalendarsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Models.Calendar body, Action<CalendarsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
