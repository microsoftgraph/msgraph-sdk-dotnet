...
using Microsoft.Graph.Users.Item.CalendarGroups.Item.Calendars.Item.MultiValueExtendedProperties;
using Microsoft.Graph.Users.Item.CalendarGroups.Item.Calendars.Item.SingleValueExtendedProperties;
...
#nullable enable
        public async Task<Stream?> DeleteAsync(Action<CalendarItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Stream> DeleteAsync(Action<CalendarItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
