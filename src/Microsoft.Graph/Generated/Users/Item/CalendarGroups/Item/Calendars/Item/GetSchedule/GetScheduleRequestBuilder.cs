...
namespace Microsoft.Graph.Users.Item.CalendarGroups.Item.Calendars.Item.GetSchedule
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Users.Item.CalendarGroups.Item.Calendars.Item.GetSchedule.GetScheduleRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Users.Item.CalendarGroups.Item.Calendars.Item.GetSchedule.GetSchedulePostResponse"/></returns>
...
#nullable restore
        ...
        public async Task<Microsoft.Graph.Users.Item.CalendarGroups.Item.Calendars.Item.GetSchedule.GetSchedulePostResponse> PostAsGetSchedulePostResponseAsync(Microsoft.Graph.Users.Item.CalendarGroups.Item.Calendars.Item.GetSchedule.GetSchedulePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<Microsoft.Graph.Users.Item.CalendarGroups.Item.Calendars.Item.GetSchedule.GetSchedulePostResponse>(requestInfo, Microsoft.Graph.Users.Item.CalendarGroups.Item.Calendars.Item.GetSchedule.GetSchedulePostResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Get the free/busy availability information for a collection of users, distributions lists, or resources (rooms or equipment) for a specified time period.
        /// Find more info here <see href="https://learn.microsoft.com/graph/api/calendar-getschedule?view=graph-rest-1.0" />
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Users.Item.CalendarGroups.Item.Calendars.Item.GetSchedule.GetScheduleResponse"/></returns>
        /// <param name="body">The request body</param>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="Microsoft.Graph.Models.ODataErrors.ODataError">When receiving a 4XX or 5XX status code</exception>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Users.Item.CalendarGroups.Item.Calendars.Item.GetSchedule.GetSchedulePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Users.Item.CalendarGroups.Item.Calendars.Item.GetSchedule.GetSchedulePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Users.Item.CalendarGroups.Item.Calendars.Item.GetSchedule.GetScheduleRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Users.Item.CalendarGroups.Item.Calendars.Item.GetSchedule.GetScheduleRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Users.Item.CalendarGroups.Item.Calendars.Item.GetSchedule.GetScheduleRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
