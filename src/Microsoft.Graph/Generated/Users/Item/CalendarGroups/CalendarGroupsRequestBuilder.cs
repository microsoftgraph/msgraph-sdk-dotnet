...
namespace Microsoft.Graph.Users.Item.CalendarGroups {
    ...
    public class CalendarGroupsRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// <returns>A <see cref="CalendarGroupItemRequestBuilder"/></returns>
        public CalendarGroupItemRequestBuilder this[string position]
        {
            get
            {
        ...
        public CalendarGroupsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/calendarGroups{?%24count,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="CalendarGroupsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CalendarGroupsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/calendarGroups{?%24count,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl)
        {
        }
        /// <summary>
        /// The user&apos;s calendar groups. Read-only. Nullable.
        /// </summary>
        /// <returns>A <see cref="CalendarGroupCollectionResponse"/></returns>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="CalendarGroupsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
