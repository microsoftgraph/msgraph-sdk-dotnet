...
namespace Microsoft.Graph.Users.Item.OnlineMeetings.Item.AttendanceReports
{
    ...
    public class AttendanceReportsRequestBuilder : BaseRequestBuilder
    {
        ...
        public Microsoft.Graph.Users.Item.OnlineMeetings.Item.AttendanceReports.Count.CountRequestBuilder Count
        {
            get => new Microsoft.Graph.Users.Item.OnlineMeetings.Item.AttendanceReports.Count.CountRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        /// <returns>A <see cref="Microsoft.Graph.Users.Item.OnlineMeetings.Item.AttendanceReports.Item.MeetingAttendanceReportItemRequestBuilder"/></returns>
        public Microsoft.Graph.Users.Item.OnlineMeetings.Item.AttendanceReports.Item.MeetingAttendanceReportItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("meetingAttendanceReport%2Did", position);
                return new Microsoft.Graph.Users.Item.OnlineMeetings.Item.AttendanceReports.Item.MeetingAttendanceReportItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Users.Item.OnlineMeetings.Item.AttendanceReports.AttendanceReportsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Users.Item.OnlineMeetings.Item.AttendanceReports.AttendanceReportsRequestBuilder.AttendanceReportsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Users.Item.OnlineMeetings.Item.AttendanceReports.AttendanceReportsRequestBuilder.AttendanceReportsRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Users.Item.OnlineMeetings.Item.AttendanceReports.AttendanceReportsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Users.Item.OnlineMeetings.Item.AttendanceReports.AttendanceReportsRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Users.Item.OnlineMeetings.Item.AttendanceReports.AttendanceReportsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// The attendance reports of an online meeting. Read-only.
        /// </summary>
...
#nullable restore
        ...
        public class AttendanceReportsRequestBuilderGetRequestConfiguration : RequestConfiguration<Microsoft.Graph.Users.Item.OnlineMeetings.Item.AttendanceReports.AttendanceReportsRequestBuilder.AttendanceReportsRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
