...
namespace Microsoft.Graph.Users.Item.Settings.ShiftPreferences {
    ...
    public class ShiftPreferencesRequestBuilder : BaseRequestBuilder {
        ...
        public ShiftPreferencesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/settings/shiftPreferences{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ShiftPreferencesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ShiftPreferencesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/settings/shiftPreferences{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ShiftPreferencesRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ShiftPreferencesRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.ShiftPreferences?> GetAsync(CancellationToken cancellationToken = default, Action<ShiftPreferencesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.ShiftPreferences> GetAsync(CancellationToken cancellationToken = default, Action<ShiftPreferencesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.ShiftPreferences?> PatchAsync(Microsoft.Graph.Models.ShiftPreferences body, CancellationToken cancellationToken = default, Action<ShiftPreferencesRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.ShiftPreferences> PatchAsync(Microsoft.Graph.Models.ShiftPreferences body, CancellationToken cancellationToken = default, Action<ShiftPreferencesRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
