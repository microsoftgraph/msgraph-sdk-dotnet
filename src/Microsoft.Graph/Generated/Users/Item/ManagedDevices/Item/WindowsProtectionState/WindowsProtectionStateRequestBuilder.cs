...
namespace Microsoft.Graph.Users.Item.ManagedDevices.Item.WindowsProtectionState
{
    ...
    public class WindowsProtectionStateRequestBuilder : BaseRequestBuilder
    {
        ...
        public Microsoft.Graph.Users.Item.ManagedDevices.Item.WindowsProtectionState.DetectedMalwareState.DetectedMalwareStateRequestBuilder DetectedMalwareState
        {
            get => new Microsoft.Graph.Users.Item.ManagedDevices.Item.WindowsProtectionState.DetectedMalwareState.DetectedMalwareStateRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Users.Item.ManagedDevices.Item.WindowsProtectionState.WindowsProtectionStateRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.WindowsProtectionState?> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Users.Item.ManagedDevices.Item.WindowsProtectionState.WindowsProtectionStateRequestBuilder.WindowsProtectionStateRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.WindowsProtectionState> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Users.Item.ManagedDevices.Item.WindowsProtectionState.WindowsProtectionStateRequestBuilder.WindowsProtectionStateRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Users.Item.ManagedDevices.Item.WindowsProtectionState.WindowsProtectionStateRequestBuilder.WindowsProtectionStateRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Users.Item.ManagedDevices.Item.WindowsProtectionState.WindowsProtectionStateRequestBuilder.WindowsProtectionStateRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Users.Item.ManagedDevices.Item.WindowsProtectionState.WindowsProtectionStateRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Users.Item.ManagedDevices.Item.WindowsProtectionState.WindowsProtectionStateRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Users.Item.ManagedDevices.Item.WindowsProtectionState.WindowsProtectionStateRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class WindowsProtectionStateRequestBuilderGetRequestConfiguration : RequestConfiguration<Microsoft.Graph.Users.Item.ManagedDevices.Item.WindowsProtectionState.WindowsProtectionStateRequestBuilder.WindowsProtectionStateRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
