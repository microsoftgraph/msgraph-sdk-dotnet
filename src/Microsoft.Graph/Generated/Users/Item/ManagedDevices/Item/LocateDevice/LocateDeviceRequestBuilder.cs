...
namespace Microsoft.Graph.Users.Item.ManagedDevices.Item.LocateDevice {
    ...
    public class LocateDeviceRequestBuilder : BaseRequestBuilder {
        ...
        public LocateDeviceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/locateDevice", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new LocateDeviceRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public LocateDeviceRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/locateDevice", rawUrl) {
        }
        /// <summary>
        /// Locate a device
        /// </summary>
