...
namespace Microsoft.Graph.Users.Item.ManagedDevices.Item.UpdateWindowsDeviceAccount {
    ...
    public class UpdateWindowsDeviceAccountRequestBuilder : BaseRequestBuilder {
        ...
        public UpdateWindowsDeviceAccountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/updateWindowsDeviceAccount", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new UpdateWindowsDeviceAccountRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public UpdateWindowsDeviceAccountRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/updateWindowsDeviceAccount", rawUrl) {
        }
        /// <summary>
