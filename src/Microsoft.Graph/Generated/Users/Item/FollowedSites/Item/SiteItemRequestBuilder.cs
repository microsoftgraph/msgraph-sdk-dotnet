...
namespace Microsoft.Graph.Users.Item.FollowedSites.Item {
    ...
    public class SiteItemRequestBuilder : BaseRequestBuilder {
        ...
        public SiteItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/followedSites/{site%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SiteItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SiteItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/followedSites/{site%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
