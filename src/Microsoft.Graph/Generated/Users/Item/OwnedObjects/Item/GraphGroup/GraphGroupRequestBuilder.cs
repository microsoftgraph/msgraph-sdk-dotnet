...
namespace Microsoft.Graph.Users.Item.OwnedObjects.Item.GraphGroup {
    ...
    public class GraphGroupRequestBuilder : BaseRequestBuilder {
        ...
        public GraphGroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/ownedObjects/{directoryObject%2Did}/graph.group{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GraphGroupRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GraphGroupRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/ownedObjects/{directoryObject%2Did}/graph.group{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
