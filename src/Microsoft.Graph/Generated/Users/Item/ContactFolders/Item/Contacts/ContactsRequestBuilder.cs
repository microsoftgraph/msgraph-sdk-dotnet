...
using Microsoft.Graph.Users.Item.ContactFolders.Item.Contacts.Count;
using Microsoft.Graph.Users.Item.ContactFolders.Item.Contacts.Delta;
using Microsoft.Graph.Users.Item.ContactFolders.Item.Contacts.Item;
...
namespace Microsoft.Graph.Users.Item.ContactFolders.Item.Contacts {
    ...
    public class ContactsRequestBuilder : BaseRequestBuilder {
        ...
        public ContactsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/contactFolders/{contactFolder%2Did}/contacts{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ContactsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ContactsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/contactFolders/{contactFolder%2Did}/contacts{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<ContactCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ContactsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ContactCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ContactsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Contact?> PostAsync(Contact body, CancellationToken cancellationToken = default, Action<ContactsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Contact> PostAsync(Contact body, CancellationToken cancellationToken = default, Action<ContactsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
