...
using Microsoft.Graph.Users.Item.ContactFolders.Item.ChildFolders.Count;
using Microsoft.Graph.Users.Item.ContactFolders.Item.ChildFolders.Delta;
using Microsoft.Graph.Users.Item.ContactFolders.Item.ChildFolders.Item;
...
namespace Microsoft.Graph.Users.Item.ContactFolders.Item.ChildFolders {
    ...
    public class ChildFoldersRequestBuilder : BaseRequestBuilder {
        ...
        public Microsoft.Graph.Users.Item.ContactFolders.Item.ChildFolders.Item.ContactFolderItemRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("contactFolder%2Did1", position);
            return new Microsoft.Graph.Users.Item.ContactFolders.Item.ChildFolders.Item.ContactFolderItemRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
        ...
        public ChildFoldersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/contactFolders/{contactFolder%2Did}/childFolders{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ChildFoldersRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ChildFoldersRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/contactFolders/{contactFolder%2Did}/childFolders{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<ContactFolderCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ChildFoldersRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ContactFolderCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ChildFoldersRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ContactFolder?> PostAsync(ContactFolder body, CancellationToken cancellationToken = default, Action<ChildFoldersRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ContactFolder> PostAsync(ContactFolder body, CancellationToken cancellationToken = default, Action<ChildFoldersRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
