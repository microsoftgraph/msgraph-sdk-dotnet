...
namespace Microsoft.Graph.Users.Item.ReprocessLicenseAssignment
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Users.Item.ReprocessLicenseAssignment.ReprocessLicenseAssignmentRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Microsoft.Graph.Models.User?> PostAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.User> PostAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Users.Item.ReprocessLicenseAssignment.ReprocessLicenseAssignmentRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Users.Item.ReprocessLicenseAssignment.ReprocessLicenseAssignmentRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Users.Item.ReprocessLicenseAssignment.ReprocessLicenseAssignmentRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
