...
namespace Microsoft.Graph.Users.Item.Authentication.SoftwareOathMethods.Item {
    ...
    public class SoftwareOathAuthenticationMethodItemRequestBuilder : BaseRequestBuilder {
        ...
        public SoftwareOathAuthenticationMethodItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/authentication/softwareOathMethods/{softwareOathAuthenticationMethod%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SoftwareOathAuthenticationMethodItemRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<SoftwareOathAuthenticationMethodItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<SoftwareOathAuthenticationMethodItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<SoftwareOathAuthenticationMethod?> GetAsync(CancellationToken cancellationToken = default, Action<SoftwareOathAuthenticationMethodItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<SoftwareOathAuthenticationMethod> GetAsync(CancellationToken cancellationToken = default, Action<SoftwareOathAuthenticationMethodItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
