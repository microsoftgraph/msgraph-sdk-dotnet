...
using Microsoft.Graph.Users.Item.Authentication.PasswordMethods.Count;
using Microsoft.Graph.Users.Item.Authentication.PasswordMethods.Item;
...
namespace Microsoft.Graph.Users.Item.Authentication.PasswordMethods {
    ...
    /// </summary>
    public class PasswordMethodsRequestBuilder : BaseRequestBuilder {
        ...
        public PasswordAuthenticationMethodItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("passwordAuthenticationMethod%2Did", position);
        ...
        public PasswordMethodsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/authentication/passwordMethods{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new PasswordMethodsRequestBuilder and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        public async Task<PasswordAuthenticationMethodCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<PasswordMethodsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
            ...
            return await RequestAdapter.SendAsync<PasswordAuthenticationMethodCollectionResponse>(requestInfo, PasswordAuthenticationMethodCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<PasswordMethodsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<PasswordMethodsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(PasswordAuthenticationMethod body, Action<PasswordMethodsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(PasswordAuthenticationMethod body, Action<PasswordMethodsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#nullable restore
        ...
        public class PasswordMethodsRequestBuilderGetRequestConfiguration {
            ...
            public PasswordMethodsRequestBuilderGetQueryParameters QueryParameters { get; set; } = new PasswordMethodsRequestBuilderGetQueryParameters();
            /// <summary>
