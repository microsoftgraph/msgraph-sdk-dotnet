...
namespace Microsoft.Graph.Users.Item.Authentication.PhoneMethods.Item
{
    ...
    public class PhoneAuthenticationMethodItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public Microsoft.Graph.Users.Item.Authentication.PhoneMethods.Item.DisableSmsSignIn.DisableSmsSignInRequestBuilder DisableSmsSignIn
        {
            get => new Microsoft.Graph.Users.Item.Authentication.PhoneMethods.Item.DisableSmsSignIn.DisableSmsSignInRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to call the enableSmsSignIn method.</summary>
        public Microsoft.Graph.Users.Item.Authentication.PhoneMethods.Item.EnableSmsSignIn.EnableSmsSignInRequestBuilder EnableSmsSignIn
        {
            get => new Microsoft.Graph.Users.Item.Authentication.PhoneMethods.Item.EnableSmsSignIn.EnableSmsSignInRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Users.Item.Authentication.PhoneMethods.Item.PhoneAuthenticationMethodItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.PhoneAuthenticationMethod?> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Users.Item.Authentication.PhoneMethods.Item.PhoneAuthenticationMethodItemRequestBuilder.PhoneAuthenticationMethodItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.PhoneAuthenticationMethod> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Users.Item.Authentication.PhoneMethods.Item.PhoneAuthenticationMethodItemRequestBuilder.PhoneAuthenticationMethodItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Users.Item.Authentication.PhoneMethods.Item.PhoneAuthenticationMethodItemRequestBuilder.PhoneAuthenticationMethodItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Users.Item.Authentication.PhoneMethods.Item.PhoneAuthenticationMethodItemRequestBuilder.PhoneAuthenticationMethodItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Users.Item.Authentication.PhoneMethods.Item.PhoneAuthenticationMethodItemRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Users.Item.Authentication.PhoneMethods.Item.PhoneAuthenticationMethodItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class PhoneAuthenticationMethodItemRequestBuilderGetRequestConfiguration : RequestConfiguration<Microsoft.Graph.Users.Item.Authentication.PhoneMethods.Item.PhoneAuthenticationMethodItemRequestBuilder.PhoneAuthenticationMethodItemRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
