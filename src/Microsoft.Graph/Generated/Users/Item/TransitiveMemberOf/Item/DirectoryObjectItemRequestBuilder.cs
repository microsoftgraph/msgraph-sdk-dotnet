...
using Microsoft.Graph.Users.Item.TransitiveMemberOf.Item.GraphAdministrativeUnit;
using Microsoft.Graph.Users.Item.TransitiveMemberOf.Item.GraphGroup;
...
namespace Microsoft.Graph.Users.Item.TransitiveMemberOf.Item {
    ...
    public class DirectoryObjectItemRequestBuilder : BaseRequestBuilder {
        ...
        public DirectoryObjectItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/transitiveMemberOf/{directoryObject%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new DirectoryObjectItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DirectoryObjectItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/transitiveMemberOf/{directoryObject%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
