...
namespace Microsoft.Graph.Users.Item.Presence.SetUserPreferredPresence {
    ...
    public class SetUserPreferredPresenceRequestBuilder : BaseRequestBuilder {
        ...
        public SetUserPreferredPresenceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/presence/setUserPreferredPresence", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SetUserPreferredPresenceRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SetUserPreferredPresenceRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/presence/setUserPreferredPresence", rawUrl) {
        }
        /// <summary>
