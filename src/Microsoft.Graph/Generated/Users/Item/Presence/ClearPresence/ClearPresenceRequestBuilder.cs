...
namespace Microsoft.Graph.Users.Item.Presence.ClearPresence {
    ...
    public class ClearPresenceRequestBuilder : BaseRequestBuilder {
        ...
        public ClearPresenceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/presence/clearPresence", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ClearPresenceRequestBuilder and sets the default values.
        /// </summary>
