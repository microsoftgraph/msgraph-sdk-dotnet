...
using Microsoft.Graph.Users.Item.InferenceClassification.Overrides;
...
#nullable enable
        public async Task<Microsoft.Graph.Models.InferenceClassification?> GetAsync(CancellationToken cancellationToken = default, Action<InferenceClassificationRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.InferenceClassification> GetAsync(CancellationToken cancellationToken = default, Action<InferenceClassificationRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<Microsoft.Graph.Models.InferenceClassification>(requestInfo, Microsoft.Graph.Models.InferenceClassification.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.InferenceClassification?> PatchAsync(Microsoft.Graph.Models.InferenceClassification body, CancellationToken cancellationToken = default, Action<InferenceClassificationRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.InferenceClassification> PatchAsync(Microsoft.Graph.Models.InferenceClassification body, CancellationToken cancellationToken = default, Action<InferenceClassificationRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(Microsoft.Graph.Models.InferenceClassification body, Action<InferenceClassificationRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(Microsoft.Graph.Models.InferenceClassification body, Action<InferenceClassificationRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
