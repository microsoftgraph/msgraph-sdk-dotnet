...
namespace Microsoft.Graph.Users.Item.Events.Item.Decline {
    ...
    public class DeclineRequestBuilder : BaseRequestBuilder {
        ...
        public DeclineRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/events/{event%2Did}/decline", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new DeclineRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DeclineRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/events/{event%2Did}/decline", rawUrl) {
        }
        /// <summary>
