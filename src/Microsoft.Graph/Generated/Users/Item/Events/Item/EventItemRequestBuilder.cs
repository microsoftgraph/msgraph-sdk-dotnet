...
using Microsoft.Graph.Users.Item.Events.Item.Accept;
using Microsoft.Graph.Users.Item.Events.Item.Attachments;
using Microsoft.Graph.Users.Item.Events.Item.Calendar;
using Microsoft.Graph.Users.Item.Events.Item.Cancel;
using Microsoft.Graph.Users.Item.Events.Item.Decline;
using Microsoft.Graph.Users.Item.Events.Item.DismissReminder;
using Microsoft.Graph.Users.Item.Events.Item.Extensions;
using Microsoft.Graph.Users.Item.Events.Item.Forward;
using Microsoft.Graph.Users.Item.Events.Item.Instances;
using Microsoft.Graph.Users.Item.Events.Item.MultiValueExtendedProperties;
using Microsoft.Graph.Users.Item.Events.Item.SingleValueExtendedProperties;
...
namespace Microsoft.Graph.Users.Item.Events.Item {
    ...
    public class EventItemRequestBuilder : BaseRequestBuilder {
        ...
        public EventItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/events/{event%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new EventItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EventItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/events/{event%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
