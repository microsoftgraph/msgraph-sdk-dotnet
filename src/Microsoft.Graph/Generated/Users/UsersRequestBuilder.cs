...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.User?> PostAsync(Microsoft.Graph.Models.User body, CancellationToken cancellationToken = default, Action<UsersRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.User> PostAsync(Microsoft.Graph.Models.User body, CancellationToken cancellationToken = default, Action<UsersRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
