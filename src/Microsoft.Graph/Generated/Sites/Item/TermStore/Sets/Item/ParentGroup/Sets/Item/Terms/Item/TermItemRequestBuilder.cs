...
using Microsoft.Graph.Sites.Item.TermStore.Sets.Item.ParentGroup.Sets.Item.Terms.Item.Children;
using Microsoft.Graph.Sites.Item.TermStore.Sets.Item.ParentGroup.Sets.Item.Terms.Item.Relations;
using Microsoft.Graph.Sites.Item.TermStore.Sets.Item.ParentGroup.Sets.Item.Terms.Item.Set;
...
namespace Microsoft.Graph.Sites.Item.TermStore.Sets.Item.ParentGroup.Sets.Item.Terms.Item {
    ...
    public class TermItemRequestBuilder : BaseRequestBuilder {
        ...
        public TermItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/termStore/sets/{set%2Did}/parentGroup/sets/{set%2Did1}/terms/{term%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new TermItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TermItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/termStore/sets/{set%2Did}/parentGroup/sets/{set%2Did1}/terms/{term%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
