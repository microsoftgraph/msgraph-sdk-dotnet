...
using Microsoft.Graph.Sites.Item.TermStore.Sets.Item.Children.Item.Relations.Item.FromTerm;
using Microsoft.Graph.Sites.Item.TermStore.Sets.Item.Children.Item.Relations.Item.Set;
using Microsoft.Graph.Sites.Item.TermStore.Sets.Item.Children.Item.Relations.Item.ToTerm;
...
namespace Microsoft.Graph.Sites.Item.TermStore.Sets.Item.Children.Item.Relations.Item {
    ...
    public class RelationItemRequestBuilder : BaseRequestBuilder {
        ...
        public RelationItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/termStore/sets/{set%2Did}/children/{term%2Did}/relations/{relation%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RelationItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RelationItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/termStore/sets/{set%2Did}/children/{term%2Did}/relations/{relation%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
