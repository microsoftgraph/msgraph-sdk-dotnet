...
namespace Microsoft.Graph.Sites.Item.ContentTypes.AddCopy {
    ...
    public class AddCopyRequestBuilder : BaseRequestBuilder {
        ...
        public AddCopyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/contentTypes/addCopy", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AddCopyRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AddCopyRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/contentTypes/addCopy", rawUrl) {
        }
        /// <summary>
