...
namespace Microsoft.Graph.Sites.Item.ContentTypes.Item.IsPublished {
    ...
    public class IsPublishedRequestBuilder : BaseRequestBuilder {
        ...
        public IsPublishedRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/contentTypes/{contentType%2Did}/isPublished()", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new IsPublishedRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public IsPublishedRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/contentTypes/{contentType%2Did}/isPublished()", rawUrl) {
        }
        /// <summary>
