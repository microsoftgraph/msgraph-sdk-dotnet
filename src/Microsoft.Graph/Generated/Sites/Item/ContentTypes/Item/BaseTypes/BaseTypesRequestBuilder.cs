...
using Microsoft.Graph.Sites.Item.ContentTypes.Item.BaseTypes.Count;
using Microsoft.Graph.Sites.Item.ContentTypes.Item.BaseTypes.Item;
...
namespace Microsoft.Graph.Sites.Item.ContentTypes.Item.BaseTypes {
    ...
    public class BaseTypesRequestBuilder : BaseRequestBuilder {
        ...
        public Microsoft.Graph.Sites.Item.ContentTypes.Item.BaseTypes.Item.ContentTypeItemRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("contentType%2Did1", position);
            return new Microsoft.Graph.Sites.Item.ContentTypes.Item.BaseTypes.Item.ContentTypeItemRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
