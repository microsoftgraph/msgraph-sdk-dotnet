...
namespace Microsoft.Graph.Sites.Item.Lists.Item.ContentTypes.AddCopyFromContentTypeHub {
    ...
    public class AddCopyFromContentTypeHubRequestBuilder : BaseRequestBuilder {
        ...
        public AddCopyFromContentTypeHubRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/contentTypes/addCopyFromContentTypeHub", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AddCopyFromContentTypeHubRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AddCopyFromContentTypeHubRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/contentTypes/addCopyFromContentTypeHub", rawUrl) {
        }
        /// <summary>
