...
using Microsoft.Graph.Sites.Item.Lists.Item.ContentTypes.Item.ColumnLinks.Count;
using Microsoft.Graph.Sites.Item.Lists.Item.ContentTypes.Item.ColumnLinks.Item;
...
namespace Microsoft.Graph.Sites.Item.Lists.Item.ContentTypes.Item.ColumnLinks {
    ...
    public class ColumnLinksRequestBuilder : BaseRequestBuilder {
        ...
        public ColumnLinksRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/contentTypes/{contentType%2Did}/columnLinks{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ColumnLinksRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ColumnLinksRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/contentTypes/{contentType%2Did}/columnLinks{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
