...
using Microsoft.Graph.Sites.Item.Lists.Item.ContentTypes.Count;
using Microsoft.Graph.Sites.Item.Lists.Item.ContentTypes.GetCompatibleHubContentTypes;
using Microsoft.Graph.Sites.Item.Lists.Item.ContentTypes.Item;
...
namespace Microsoft.Graph.Sites.Item.Lists.Item.ContentTypes {
    ...
    public class ContentTypesRequestBuilder : BaseRequestBuilder {
        ...
        public ContentTypesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/contentTypes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ContentTypesRequestBuilder and sets the default values.
        /// </summary>
