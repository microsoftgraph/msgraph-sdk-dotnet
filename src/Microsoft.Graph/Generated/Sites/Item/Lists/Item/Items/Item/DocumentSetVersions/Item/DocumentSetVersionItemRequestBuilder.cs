...
using Microsoft.Graph.Sites.Item.Lists.Item.Items.Item.DocumentSetVersions.Item.Fields;
...
namespace Microsoft.Graph.Sites.Item.Lists.Item.Items.Item.DocumentSetVersions.Item {
    ...
    public class DocumentSetVersionItemRequestBuilder : BaseRequestBuilder {
        ...
        public DocumentSetVersionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/documentSetVersions/{documentSetVersion%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new DocumentSetVersionItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DocumentSetVersionItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/documentSetVersions/{documentSetVersion%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
