...
namespace Microsoft.Graph.Sites.Item.Lists.Item.Items.Item {
    ...
    public class ListItemItemRequestBuilder : BaseRequestBuilder {
        ...
        public ListItemItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ListItemItemRequestBuilder and sets the default values.
        /// </summary>
