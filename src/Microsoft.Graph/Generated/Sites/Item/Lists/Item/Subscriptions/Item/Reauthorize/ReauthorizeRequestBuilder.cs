...
namespace Microsoft.Graph.Sites.Item.Lists.Item.Subscriptions.Item.Reauthorize {
    ...
    public class ReauthorizeRequestBuilder : BaseRequestBuilder {
        ...
        public ReauthorizeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/subscriptions/{subscription%2Did}/reauthorize", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ReauthorizeRequestBuilder and sets the default values.
        /// </summary>
