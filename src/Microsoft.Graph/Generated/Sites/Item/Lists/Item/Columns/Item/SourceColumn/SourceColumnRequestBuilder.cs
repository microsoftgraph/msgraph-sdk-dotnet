...
namespace Microsoft.Graph.Sites.Item.Lists.Item.Columns.Item.SourceColumn {
    ...
    public class SourceColumnRequestBuilder : BaseRequestBuilder {
        ...
        public SourceColumnRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/columns/{columnDefinition%2Did}/sourceColumn{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SourceColumnRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SourceColumnRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/columns/{columnDefinition%2Did}/sourceColumn{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
