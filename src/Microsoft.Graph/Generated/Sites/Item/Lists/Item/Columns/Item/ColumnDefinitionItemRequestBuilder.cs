...
using Microsoft.Graph.Sites.Item.Lists.Item.Columns.Item.SourceColumn;
...
namespace Microsoft.Graph.Sites.Item.Lists.Item.Columns.Item {
    ...
    public class ColumnDefinitionItemRequestBuilder : BaseRequestBuilder {
        ...
        public ColumnDefinitionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/columns/{columnDefinition%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ColumnDefinitionItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ColumnDefinitionItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/columns/{columnDefinition%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
