...
using Microsoft.Graph.Sites.Item.Onenote.Pages.Item.Content;
using Microsoft.Graph.Sites.Item.Onenote.Pages.Item.CopyToSection;
using Microsoft.Graph.Sites.Item.Onenote.Pages.Item.OnenotePatchContent;
using Microsoft.Graph.Sites.Item.Onenote.Pages.Item.ParentNotebook;
using Microsoft.Graph.Sites.Item.Onenote.Pages.Item.ParentSection;
using Microsoft.Graph.Sites.Item.Onenote.Pages.Item.Preview;
...
namespace Microsoft.Graph.Sites.Item.Onenote.Pages.Item {
    ...
    public class OnenotePageItemRequestBuilder : BaseRequestBuilder {
        ...
        public OnenotePageItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/onenote/pages/{onenotePage%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new OnenotePageItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public OnenotePageItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/onenote/pages/{onenotePage%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
