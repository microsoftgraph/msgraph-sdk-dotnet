...
using Microsoft.Graph.Sites.Item.Onenote.Notebooks.Item.CopyNotebook;
using Microsoft.Graph.Sites.Item.Onenote.Notebooks.Item.SectionGroups;
using Microsoft.Graph.Sites.Item.Onenote.Notebooks.Item.Sections;
...
namespace Microsoft.Graph.Sites.Item.Onenote.Notebooks.Item {
    ...
    public class NotebookItemRequestBuilder : BaseRequestBuilder {
        ...
        public NotebookItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/onenote/notebooks/{notebook%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new NotebookItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public NotebookItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/onenote/notebooks/{notebook%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
