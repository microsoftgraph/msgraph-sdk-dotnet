...
using Microsoft.Graph.Sites.Item.Onenote.Notebooks.Count;
using Microsoft.Graph.Sites.Item.Onenote.Notebooks.GetNotebookFromWebUrl;
using Microsoft.Graph.Sites.Item.Onenote.Notebooks.GetRecentNotebooksWithIncludePersonalNotebooks;
using Microsoft.Graph.Sites.Item.Onenote.Notebooks.Item;
...
namespace Microsoft.Graph.Sites.Item.Onenote.Notebooks {
    ...
    public class NotebooksRequestBuilder : BaseRequestBuilder {
        ...
        public NotebooksRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/onenote/notebooks{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new NotebooksRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public NotebooksRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/onenote/notebooks{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
