...
using Microsoft.Graph.Sites.Item.Onenote.SectionGroups.Item.SectionGroups.Count;
using Microsoft.Graph.Sites.Item.Onenote.SectionGroups.Item.SectionGroups.Item;
...
namespace Microsoft.Graph.Sites.Item.Onenote.SectionGroups.Item.SectionGroups {
    ...
    public class SectionGroupsRequestBuilder : BaseRequestBuilder {
        ...
        public Microsoft.Graph.Sites.Item.Onenote.SectionGroups.Item.SectionGroups.Item.SectionGroupItemRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("sectionGroup%2Did1", position);
            return new Microsoft.Graph.Sites.Item.Onenote.SectionGroups.Item.SectionGroups.Item.SectionGroupItemRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
