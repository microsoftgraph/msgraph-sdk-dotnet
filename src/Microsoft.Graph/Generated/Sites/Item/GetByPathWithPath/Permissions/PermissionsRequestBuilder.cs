...
namespace Microsoft.Graph.Sites.Item.GetByPathWithPath.Permissions
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Sites.Item.GetByPathWithPath.Permissions.PermissionsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Microsoft.Graph.Models.PermissionCollectionResponse?> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Sites.Item.GetByPathWithPath.Permissions.PermissionsRequestBuilder.PermissionsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.PermissionCollectionResponse> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Sites.Item.GetByPathWithPath.Permissions.PermissionsRequestBuilder.PermissionsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Sites.Item.GetByPathWithPath.Permissions.PermissionsRequestBuilder.PermissionsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Sites.Item.GetByPathWithPath.Permissions.PermissionsRequestBuilder.PermissionsRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Sites.Item.GetByPathWithPath.Permissions.PermissionsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Sites.Item.GetByPathWithPath.Permissions.PermissionsRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Sites.Item.GetByPathWithPath.Permissions.PermissionsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// The permissions associated with the site. Nullable.
        /// </summary>
...
#nullable restore
        ...
        public class PermissionsRequestBuilderGetRequestConfiguration : RequestConfiguration<Microsoft.Graph.Sites.Item.GetByPathWithPath.Permissions.PermissionsRequestBuilder.PermissionsRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
