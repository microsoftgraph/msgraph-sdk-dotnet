...
#nullable restore
        ...
        public global::Microsoft.Graph.Sites.Item.GetByPathWithPath.GetByPathWithPath1.GetByPathWithPath1RequestBuilder GetByPathWithPath1(string path1)
        {
            if(string.IsNullOrEmpty(path1)) throw new ArgumentNullException(nameof(path1));
            return new global::Microsoft.Graph.Sites.Item.GetByPathWithPath.GetByPathWithPath1.GetByPathWithPath1RequestBuilder(PathParameters, RequestAdapter, path1);
        }
        /// <summary>
        /// Invoke function getByPath
        /// </summary>
