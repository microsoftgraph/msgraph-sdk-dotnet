...
using Microsoft.Graph.Sites.Item.TermStores.Item.Groups;
using Microsoft.Graph.Sites.Item.TermStores.Item.Sets;
...
namespace Microsoft.Graph.Sites.Item.TermStores.Item {
    ...
    public class StoreItemRequestBuilder : BaseRequestBuilder {
        ...
        public StoreItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/termStores/{store%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new StoreItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public StoreItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/termStores/{store%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<StoreItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<StoreItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Store?> GetAsync(CancellationToken cancellationToken = default, Action<StoreItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Store> GetAsync(CancellationToken cancellationToken = default, Action<StoreItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Store?> PatchAsync(Store body, CancellationToken cancellationToken = default, Action<StoreItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Store> PatchAsync(Store body, CancellationToken cancellationToken = default, Action<StoreItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
