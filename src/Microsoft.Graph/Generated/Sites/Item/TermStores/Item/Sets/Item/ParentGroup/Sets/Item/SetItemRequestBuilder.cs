...
using Microsoft.Graph.Sites.Item.TermStores.Item.Sets.Item.ParentGroup.Sets.Item.Children;
using Microsoft.Graph.Sites.Item.TermStores.Item.Sets.Item.ParentGroup.Sets.Item.Relations;
using Microsoft.Graph.Sites.Item.TermStores.Item.Sets.Item.ParentGroup.Sets.Item.Terms;
...
namespace Microsoft.Graph.Sites.Item.TermStores.Item.Sets.Item.ParentGroup.Sets.Item {
    ...
    public class SetItemRequestBuilder : BaseRequestBuilder {
        ...
        public SetItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/termStores/{store%2Did}/sets/{set%2Did}/parentGroup/sets/{set%2Did1}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SetItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SetItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/termStores/{store%2Did}/sets/{set%2Did}/parentGroup/sets/{set%2Did1}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
