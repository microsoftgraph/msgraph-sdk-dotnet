...
using Microsoft.Graph.Sites.Item.Analytics.ItemActivityStats.Item.Activities;
...
namespace Microsoft.Graph.Sites.Item.Analytics.ItemActivityStats.Item {
    ...
    public class ItemActivityStatItemRequestBuilder : BaseRequestBuilder {
        ...
        public ItemActivityStatItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/analytics/itemActivityStats/{itemActivityStat%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ItemActivityStatItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ItemActivityStatItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/analytics/itemActivityStats/{itemActivityStat%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
