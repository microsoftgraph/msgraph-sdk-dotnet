...
using Microsoft.Graph.Sites.Item.Analytics.ItemActivityStats.Item.Activities.Item.DriveItem;
...
namespace Microsoft.Graph.Sites.Item.Analytics.ItemActivityStats.Item.Activities.Item {
    ...
    public class ItemActivityItemRequestBuilder : BaseRequestBuilder {
        ...
        public ItemActivityItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/analytics/itemActivityStats/{itemActivityStat%2Did}/activities/{itemActivity%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ItemActivityItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ItemActivityItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/analytics/itemActivityStats/{itemActivityStat%2Did}/activities/{itemActivity%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
