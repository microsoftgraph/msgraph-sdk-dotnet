...
namespace Microsoft.Graph.Sites.Item.Analytics.AllTime {
    ...
    public class AllTimeRequestBuilder : BaseRequestBuilder {
        ...
        public AllTimeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/analytics/allTime{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AllTimeRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AllTimeRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/analytics/allTime{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
