...
namespace Microsoft.Graph.Sites.GetAllSites
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Microsoft.Graph.Sites.GetAllSites.GetAllSitesRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// Find more info here <see href="https://learn.microsoft.com/graph/api/site-getallsites?view=graph-rest-1.0" />
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.Sites.GetAllSites.GetAllSitesResponse"/></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="global::Microsoft.Graph.Models.ODataErrors.ODataError">When receiving a 4XX or 5XX status code</exception>
...
#nullable restore
        ...
        public async Task<global::Microsoft.Graph.Sites.GetAllSites.GetAllSitesResponse> GetAsync(Action<RequestConfiguration<global::Microsoft.Graph.Sites.GetAllSites.GetAllSitesRequestBuilder.GetAllSitesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Microsoft.Graph.Sites.GetAllSites.GetAllSitesResponse>(requestInfo, global::Microsoft.Graph.Sites.GetAllSites.GetAllSitesResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// List sites across geographies in an organization. This API can also be used to enumerate all sites in a non-multi-geo tenant. For more information, see Best practices for discovering files and detecting changes at scale.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Microsoft.Graph.Sites.GetAllSites.GetAllSitesRequestBuilder.GetAllSitesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Microsoft.Graph.Sites.GetAllSites.GetAllSitesRequestBuilder.GetAllSitesRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.Sites.GetAllSites.GetAllSitesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Microsoft.Graph.Sites.GetAllSites.GetAllSitesRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Microsoft.Graph.Sites.GetAllSites.GetAllSitesRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// List sites across geographies in an organization. This API can also be used to enumerate all sites in a non-multi-geo tenant. For more information, see Best practices for discovering files and detecting changes at scale.
        /// </summary>
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.18.0")]
        public partial class GetAllSitesRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Microsoft.Graph.Sites.GetAllSites.GetAllSitesRequestBuilder.GetAllSitesRequestBuilderGetQueryParameters>
        {
        }
    }
}
