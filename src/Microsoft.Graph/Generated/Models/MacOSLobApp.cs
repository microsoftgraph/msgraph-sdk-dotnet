...
namespace Microsoft.Graph.Models
{
    ...
    /// </summary>
    public class MacOSLobApp : Microsoft.Graph.Models.MobileLobApp, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Microsoft.Graph.Models.MacOSLobChildApp>? ChildApps
        {
            get { return BackingStore?.Get<List<Microsoft.Graph.Models.MacOSLobChildApp>?>("childApps"); }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Models.MacOSLobApp"/> and sets the default values.
        /// </summary>
        ...
        public static new Microsoft.Graph.Models.MacOSLobApp CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Microsoft.Graph.Models.MacOSLobApp();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "childApps", n => { ChildApps = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.MacOSLobChildApp>(Microsoft.Graph.Models.MacOSLobChildApp.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<Microsoft.Graph.Models.MacOSLobChildApp>("childApps", ChildApps);
