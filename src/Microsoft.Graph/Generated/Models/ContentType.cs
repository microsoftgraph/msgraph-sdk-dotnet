...
namespace Microsoft.Graph.Models
{
    ...
    public class ContentType : Microsoft.Graph.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Microsoft.Graph.Models.ContentType? Base
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.ContentType?>("base"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Microsoft.Graph.Models.ContentType>? BaseTypes
        {
            get { return BackingStore?.Get<List<Microsoft.Graph.Models.ContentType>?>("baseTypes"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Microsoft.Graph.Models.ColumnLink>? ColumnLinks
        {
            get { return BackingStore?.Get<List<Microsoft.Graph.Models.ColumnLink>?>("columnLinks"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Microsoft.Graph.Models.ColumnDefinition>? ColumnPositions
        {
            get { return BackingStore?.Get<List<Microsoft.Graph.Models.ColumnDefinition>?>("columnPositions"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Microsoft.Graph.Models.DocumentSetContent? DocumentTemplate
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.DocumentSetContent?>("documentTemplate"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Microsoft.Graph.Models.ContentTypeOrder? Order
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.ContentTypeOrder?>("order"); }
...
#nullable restore
        ...
        public static new Microsoft.Graph.Models.ContentType CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Microsoft.Graph.Models.ContentType();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "base", n => { Base = n.GetObjectValue<Microsoft.Graph.Models.ContentType>(Microsoft.Graph.Models.ContentType.CreateFromDiscriminatorValue); } },
                { "baseTypes", n => { BaseTypes = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.ContentType>(Microsoft.Graph.Models.ContentType.CreateFromDiscriminatorValue)?.ToList(); } },
                { "columnLinks", n => { ColumnLinks = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.ColumnLink>(Microsoft.Graph.Models.ColumnLink.CreateFromDiscriminatorValue)?.ToList(); } },
                { "columnPositions", n => { ColumnPositions = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.ColumnDefinition>(Microsoft.Graph.Models.ColumnDefinition.CreateFromDiscriminatorValue)?.ToList(); } },
                ...
                { "documentTemplate", n => { DocumentTemplate = n.GetObjectValue<Microsoft.Graph.Models.DocumentSetContent>(Microsoft.Graph.Models.DocumentSetContent.CreateFromDiscriminatorValue); } },
                ...
                { "order", n => { Order = n.GetObjectValue<Microsoft.Graph.Models.ContentTypeOrder>(Microsoft.Graph.Models.ContentTypeOrder.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<Microsoft.Graph.Models.ContentType>("base", Base);
            writer.WriteCollectionOfObjectValues<Microsoft.Graph.Models.ContentType>("baseTypes", BaseTypes);
            writer.WriteCollectionOfObjectValues<Microsoft.Graph.Models.ColumnLink>("columnLinks", ColumnLinks);
            writer.WriteCollectionOfObjectValues<Microsoft.Graph.Models.ColumnDefinition>("columnPositions", ColumnPositions);
            ...
            writer.WriteObjectValue<Microsoft.Graph.Models.DocumentSetContent>("documentTemplate", DocumentTemplate);
            ...
            writer.WriteObjectValue<Microsoft.Graph.Models.ContentTypeOrder>("order", Order);
