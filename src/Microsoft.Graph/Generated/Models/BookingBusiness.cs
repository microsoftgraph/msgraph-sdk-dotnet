...
namespace Microsoft.Graph.Models
{
    ...
    /// </summary>
    public class BookingBusiness : Microsoft.Graph.Models.Entity, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Microsoft.Graph.Models.BookingAppointment>? Appointments
        {
            get { return BackingStore?.Get<List<Microsoft.Graph.Models.BookingAppointment>?>("appointments"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Microsoft.Graph.Models.BookingWorkHours>? BusinessHours
        {
            get { return BackingStore?.Get<List<Microsoft.Graph.Models.BookingWorkHours>?>("businessHours"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Microsoft.Graph.Models.BookingAppointment>? CalendarView
        {
            get { return BackingStore?.Get<List<Microsoft.Graph.Models.BookingAppointment>?>("calendarView"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Microsoft.Graph.Models.BookingCustomerBase>? Customers
        {
            get { return BackingStore?.Get<List<Microsoft.Graph.Models.BookingCustomerBase>?>("customers"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Microsoft.Graph.Models.BookingCustomQuestion>? CustomQuestions
        {
            get { return BackingStore?.Get<List<Microsoft.Graph.Models.BookingCustomQuestion>?>("customQuestions"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Microsoft.Graph.Models.BookingService>? Services
        {
            get { return BackingStore?.Get<List<Microsoft.Graph.Models.BookingService>?>("services"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Microsoft.Graph.Models.BookingStaffMemberBase>? StaffMembers
        {
            get { return BackingStore?.Get<List<Microsoft.Graph.Models.BookingStaffMemberBase>?>("staffMembers"); }
...
#nullable restore
        ...
        public static new Microsoft.Graph.Models.BookingBusiness CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Microsoft.Graph.Models.BookingBusiness();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "appointments", n => { Appointments = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.BookingAppointment>(Microsoft.Graph.Models.BookingAppointment.CreateFromDiscriminatorValue)?.ToList(); } },
                { "businessHours", n => { BusinessHours = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.BookingWorkHours>(Microsoft.Graph.Models.BookingWorkHours.CreateFromDiscriminatorValue)?.ToList(); } },
                { "businessType", n => { BusinessType = n.GetStringValue(); } },
                { "calendarView", n => { CalendarView = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.BookingAppointment>(Microsoft.Graph.Models.BookingAppointment.CreateFromDiscriminatorValue)?.ToList(); } },
                { "customQuestions", n => { CustomQuestions = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.BookingCustomQuestion>(Microsoft.Graph.Models.BookingCustomQuestion.CreateFromDiscriminatorValue)?.ToList(); } },
                { "customers", n => { Customers = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.BookingCustomerBase>(Microsoft.Graph.Models.BookingCustomerBase.CreateFromDiscriminatorValue)?.ToList(); } },
                ...
                { "services", n => { Services = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.BookingService>(Microsoft.Graph.Models.BookingService.CreateFromDiscriminatorValue)?.ToList(); } },
                { "staffMembers", n => { StaffMembers = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.BookingStaffMemberBase>(Microsoft.Graph.Models.BookingStaffMemberBase.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<Microsoft.Graph.Models.BookingAppointment>("appointments", Appointments);
            writer.WriteCollectionOfObjectValues<Microsoft.Graph.Models.BookingWorkHours>("businessHours", BusinessHours);
            writer.WriteStringValue("businessType", BusinessType);
            writer.WriteCollectionOfObjectValues<Microsoft.Graph.Models.BookingAppointment>("calendarView", CalendarView);
            writer.WriteCollectionOfObjectValues<Microsoft.Graph.Models.BookingCustomerBase>("customers", Customers);
            writer.WriteCollectionOfObjectValues<Microsoft.Graph.Models.BookingCustomQuestion>("customQuestions", CustomQuestions);
            ...
            writer.WriteCollectionOfObjectValues<Microsoft.Graph.Models.BookingService>("services", Services);
            writer.WriteCollectionOfObjectValues<Microsoft.Graph.Models.BookingStaffMemberBase>("staffMembers", StaffMembers);
