...
namespace Microsoft.Graph.Models
{
    ...
    public class OutOfBoxExperienceSetting : IAdditionalDataHolder, IBackedModel, IParsable
    {
        ...
        public Microsoft.Graph.Models.WindowsDeviceUsageType? DeviceUsageType
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.WindowsDeviceUsageType?>("deviceUsageType"); }
...
#nullable restore
        ...
        public Microsoft.Graph.Models.WindowsUserType? UserType
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.WindowsUserType?>("userType"); }
            set { BackingStore?.Set("userType", value); }
        }
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Models.OutOfBoxExperienceSetting"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Models.OutOfBoxExperienceSetting"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Microsoft.Graph.Models.OutOfBoxExperienceSetting CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Microsoft.Graph.Models.OutOfBoxExperienceSetting();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "deviceUsageType", n => { DeviceUsageType = n.GetEnumValue<Microsoft.Graph.Models.WindowsDeviceUsageType>(); } },
                ...
                { "userType", n => { UserType = n.GetEnumValue<Microsoft.Graph.Models.WindowsUserType>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<Microsoft.Graph.Models.WindowsDeviceUsageType>("deviceUsageType", DeviceUsageType);
            ...
            writer.WriteEnumValue<Microsoft.Graph.Models.WindowsUserType>("userType", UserType);
