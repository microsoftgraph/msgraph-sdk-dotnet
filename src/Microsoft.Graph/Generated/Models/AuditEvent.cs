...
namespace Microsoft.Graph.Models
{
    ...
    public partial class AuditEvent : global::Microsoft.Graph.Models.Entity, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Microsoft.Graph.Models.AuditActor? Actor
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Models.AuditActor?>("actor"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Models.AuditResource>? Resources
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Models.AuditResource>?>("resources"); }
...
#nullable restore
        ...
        public static new global::Microsoft.Graph.Models.AuditEvent CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.Models.AuditEvent();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "actor", n => { Actor = n.GetObjectValue<global::Microsoft.Graph.Models.AuditActor>(global::Microsoft.Graph.Models.AuditActor.CreateFromDiscriminatorValue); } },
                { "category", n => { Category = n.GetStringValue(); } },
                { "componentName", n => { ComponentName = n.GetStringValue(); } },
                { "correlationId", n => { CorrelationId = n.GetGuidValue(); } },
                { "displayName", n => { DisplayName = n.GetStringValue(); } },
                { "resources", n => { Resources = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Models.AuditResource>(global::Microsoft.Graph.Models.AuditResource.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Microsoft.Graph.Models.AuditActor>("actor", Actor);
            writer.WriteStringValue("category", Category);
            writer.WriteStringValue("componentName", ComponentName);
            writer.WriteGuidValue("correlationId", CorrelationId);
            writer.WriteStringValue("displayName", DisplayName);
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.Models.AuditResource>("resources", Resources);
        }
    }
}
