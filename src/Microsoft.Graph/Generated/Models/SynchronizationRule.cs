...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Microsoft.Graph.Models.StringKeyStringValuePair>? Metadata
        {
            get { return BackingStore?.Get<List<Microsoft.Graph.Models.StringKeyStringValuePair>?>("metadata"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Microsoft.Graph.Models.ObjectMapping>? ObjectMappings
        {
            get { return BackingStore?.Get<List<Microsoft.Graph.Models.ObjectMapping>?>("objectMappings"); }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Models.SynchronizationRule"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Models.SynchronizationRule"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Microsoft.Graph.Models.SynchronizationRule CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Microsoft.Graph.Models.SynchronizationRule();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "metadata", n => { Metadata = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.StringKeyStringValuePair>(Microsoft.Graph.Models.StringKeyStringValuePair.CreateFromDiscriminatorValue)?.ToList(); } },
                { "name", n => { Name = n.GetStringValue(); } },
                { "objectMappings", n => { ObjectMappings = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.ObjectMapping>(Microsoft.Graph.Models.ObjectMapping.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<Microsoft.Graph.Models.StringKeyStringValuePair>("metadata", Metadata);
            writer.WriteStringValue("name", Name);
            writer.WriteCollectionOfObjectValues<Microsoft.Graph.Models.ObjectMapping>("objectMappings", ObjectMappings);
