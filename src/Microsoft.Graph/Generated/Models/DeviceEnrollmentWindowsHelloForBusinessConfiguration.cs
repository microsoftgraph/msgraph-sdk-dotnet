...
namespace Microsoft.Graph.Models
{
    ...
    /// </summary>
    public class DeviceEnrollmentWindowsHelloForBusinessConfiguration : Microsoft.Graph.Models.DeviceEnrollmentConfiguration, IParsable
    {
        /// <summary>Possible values of a property</summary>
        public Microsoft.Graph.Models.Enablement? EnhancedBiometricsState
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.Enablement?>("enhancedBiometricsState"); }
        ...
        public Microsoft.Graph.Models.WindowsHelloForBusinessPinUsage? PinLowercaseCharactersUsage
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.WindowsHelloForBusinessPinUsage?>("pinLowercaseCharactersUsage"); }
        ...
        /// <summary>Windows Hello for Business pin usage options</summary>
        public Microsoft.Graph.Models.WindowsHelloForBusinessPinUsage? PinSpecialCharactersUsage
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.WindowsHelloForBusinessPinUsage?>("pinSpecialCharactersUsage"); }
            set { BackingStore?.Set("pinSpecialCharactersUsage", value); }
        }
        /// <summary>Windows Hello for Business pin usage options</summary>
        public Microsoft.Graph.Models.WindowsHelloForBusinessPinUsage? PinUppercaseCharactersUsage
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.WindowsHelloForBusinessPinUsage?>("pinUppercaseCharactersUsage"); }
        ...
        /// <summary>Possible values of a property</summary>
        public Microsoft.Graph.Models.Enablement? State
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.Enablement?>("state"); }
        ...
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Models.DeviceEnrollmentWindowsHelloForBusinessConfiguration"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Models.DeviceEnrollmentWindowsHelloForBusinessConfiguration"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new Microsoft.Graph.Models.DeviceEnrollmentWindowsHelloForBusinessConfiguration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Microsoft.Graph.Models.DeviceEnrollmentWindowsHelloForBusinessConfiguration();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "enhancedBiometricsState", n => { EnhancedBiometricsState = n.GetEnumValue<Microsoft.Graph.Models.Enablement>(); } },
                { "pinExpirationInDays", n => { PinExpirationInDays = n.GetIntValue(); } },
                { "pinLowercaseCharactersUsage", n => { PinLowercaseCharactersUsage = n.GetEnumValue<Microsoft.Graph.Models.WindowsHelloForBusinessPinUsage>(); } },
                ...
                { "pinSpecialCharactersUsage", n => { PinSpecialCharactersUsage = n.GetEnumValue<Microsoft.Graph.Models.WindowsHelloForBusinessPinUsage>(); } },
                { "pinUppercaseCharactersUsage", n => { PinUppercaseCharactersUsage = n.GetEnumValue<Microsoft.Graph.Models.WindowsHelloForBusinessPinUsage>(); } },
                ...
                { "state", n => { State = n.GetEnumValue<Microsoft.Graph.Models.Enablement>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<Microsoft.Graph.Models.Enablement>("enhancedBiometricsState", EnhancedBiometricsState);
            writer.WriteIntValue("pinExpirationInDays", PinExpirationInDays);
            writer.WriteEnumValue<Microsoft.Graph.Models.WindowsHelloForBusinessPinUsage>("pinLowercaseCharactersUsage", PinLowercaseCharactersUsage);
            ...
            writer.WriteEnumValue<Microsoft.Graph.Models.WindowsHelloForBusinessPinUsage>("pinSpecialCharactersUsage", PinSpecialCharactersUsage);
            writer.WriteEnumValue<Microsoft.Graph.Models.WindowsHelloForBusinessPinUsage>("pinUppercaseCharactersUsage", PinUppercaseCharactersUsage);
            ...
            writer.WriteEnumValue<Microsoft.Graph.Models.Enablement>("state", State);
