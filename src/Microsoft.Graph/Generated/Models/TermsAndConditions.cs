...
namespace Microsoft.Graph.Models
{
    ...
    public partial class TermsAndConditions : global::Microsoft.Graph.Models.Entity, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Models.TermsAndConditionsAcceptanceStatus>? AcceptanceStatuses
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Models.TermsAndConditionsAcceptanceStatus>?>("acceptanceStatuses"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Models.TermsAndConditionsAssignment>? Assignments
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Models.TermsAndConditionsAssignment>?>("assignments"); }
...
#nullable restore
        ...
        public static new global::Microsoft.Graph.Models.TermsAndConditions CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.Models.TermsAndConditions();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "acceptanceStatuses", n => { AcceptanceStatuses = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Models.TermsAndConditionsAcceptanceStatus>(global::Microsoft.Graph.Models.TermsAndConditionsAcceptanceStatus.CreateFromDiscriminatorValue)?.AsList(); } },
                { "assignments", n => { Assignments = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Models.TermsAndConditionsAssignment>(global::Microsoft.Graph.Models.TermsAndConditionsAssignment.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.Models.TermsAndConditionsAcceptanceStatus>("acceptanceStatuses", AcceptanceStatuses);
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.Models.TermsAndConditionsAssignment>("assignments", Assignments);
