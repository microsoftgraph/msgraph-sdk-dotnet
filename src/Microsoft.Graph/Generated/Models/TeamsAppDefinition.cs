...
namespace Microsoft.Graph.Models
{
    ...
    public class TeamsAppDefinition : Microsoft.Graph.Models.Entity, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>Authorization requirements specified in the Teams app manifest.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Microsoft.Graph.Models.TeamsAppAuthorization? Authorization
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.TeamsAppAuthorization?>("authorization"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Microsoft.Graph.Models.TeamworkBot? Bot
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.TeamworkBot?>("bot"); }
...
#nullable restore
        ...
        public Microsoft.Graph.Models.TeamsAppPublishingState? PublishingState
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.TeamsAppPublishingState?>("publishingState"); }
...
#nullable restore
        ...
        public static new Microsoft.Graph.Models.TeamsAppDefinition CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Microsoft.Graph.Models.TeamsAppDefinition();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "authorization", n => { Authorization = n.GetObjectValue<Microsoft.Graph.Models.TeamsAppAuthorization>(Microsoft.Graph.Models.TeamsAppAuthorization.CreateFromDiscriminatorValue); } },
                { "bot", n => { Bot = n.GetObjectValue<Microsoft.Graph.Models.TeamworkBot>(Microsoft.Graph.Models.TeamworkBot.CreateFromDiscriminatorValue); } },
                ...
                { "publishingState", n => { PublishingState = n.GetEnumValue<Microsoft.Graph.Models.TeamsAppPublishingState>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<Microsoft.Graph.Models.TeamsAppAuthorization>("authorization", Authorization);
            writer.WriteObjectValue<Microsoft.Graph.Models.TeamworkBot>("bot", Bot);
            writer.WriteObjectValue<Microsoft.Graph.Models.IdentitySet>("createdBy", CreatedBy);
            writer.WriteStringValue("description", Description);
            writer.WriteStringValue("displayName", DisplayName);
            writer.WriteDateTimeOffsetValue("lastModifiedDateTime", LastModifiedDateTime);
            writer.WriteEnumValue<Microsoft.Graph.Models.TeamsAppPublishingState>("publishingState", PublishingState);
