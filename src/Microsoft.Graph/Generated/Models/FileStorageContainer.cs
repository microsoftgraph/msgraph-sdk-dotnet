...
namespace Microsoft.Graph.Models
{
    ...
    public class FileStorageContainer : Microsoft.Graph.Models.Entity, IParsable
...
#nullable enable
        public Microsoft.Graph.Models.FileStorageContainerCustomPropertyDictionary? CustomProperties
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.FileStorageContainerCustomPropertyDictionary?>("customProperties"); }
...
#nullable restore
        ...
        public Microsoft.Graph.Models.FileStorageContainerStatus? Status
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.FileStorageContainerStatus?>("status"); }
            set { BackingStore?.Set("status", value); }
        }
        /// <summary>Data specific to the current user. Read-only.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Microsoft.Graph.Models.FileStorageContainerViewpoint? Viewpoint
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.FileStorageContainerViewpoint?>("viewpoint"); }
...
#nullable restore
        ...
        public static new Microsoft.Graph.Models.FileStorageContainer CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Microsoft.Graph.Models.FileStorageContainer();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "customProperties", n => { CustomProperties = n.GetObjectValue<Microsoft.Graph.Models.FileStorageContainerCustomPropertyDictionary>(Microsoft.Graph.Models.FileStorageContainerCustomPropertyDictionary.CreateFromDiscriminatorValue); } },
                ...
                { "status", n => { Status = n.GetEnumValue<Microsoft.Graph.Models.FileStorageContainerStatus>(); } },
                { "viewpoint", n => { Viewpoint = n.GetObjectValue<Microsoft.Graph.Models.FileStorageContainerViewpoint>(Microsoft.Graph.Models.FileStorageContainerViewpoint.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<Microsoft.Graph.Models.FileStorageContainerCustomPropertyDictionary>("customProperties", CustomProperties);
            ...
            writer.WriteEnumValue<Microsoft.Graph.Models.FileStorageContainerStatus>("status", Status);
            writer.WriteObjectValue<Microsoft.Graph.Models.FileStorageContainerViewpoint>("viewpoint", Viewpoint);
        }
    }
}
