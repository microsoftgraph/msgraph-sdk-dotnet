...
namespace Microsoft.Graph.Models
{
    ...
    public class EmailFileAssessmentRequest : Microsoft.Graph.Models.ThreatAssessmentRequest, IParsable
...
#nullable restore
        ...
        public Microsoft.Graph.Models.MailDestinationRoutingReason? DestinationRoutingReason
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.MailDestinationRoutingReason?>("destinationRoutingReason"); }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Models.EmailFileAssessmentRequest"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Models.EmailFileAssessmentRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new Microsoft.Graph.Models.EmailFileAssessmentRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Microsoft.Graph.Models.EmailFileAssessmentRequest();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "destinationRoutingReason", n => { DestinationRoutingReason = n.GetEnumValue<Microsoft.Graph.Models.MailDestinationRoutingReason>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<Microsoft.Graph.Models.MailDestinationRoutingReason>("destinationRoutingReason", DestinationRoutingReason);
