...
namespace Microsoft.Graph.Models
{
    ...
    public class CloudPcDeviceImage : Microsoft.Graph.Models.Entity, IParsable
...
#nullable restore
        ...
        public Microsoft.Graph.Models.CloudPcDeviceImageErrorCode? ErrorCode
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.CloudPcDeviceImageErrorCode?>("errorCode"); }
...
#nullable restore
        ...
        public Microsoft.Graph.Models.CloudPcDeviceImageOsStatus? OsStatus
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.CloudPcDeviceImageOsStatus?>("osStatus"); }
...
#nullable restore
        ...
        public Microsoft.Graph.Models.CloudPcDeviceImageStatus? Status
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.CloudPcDeviceImageStatus?>("status"); }
...
#nullable restore
        ...
        public static new Microsoft.Graph.Models.CloudPcDeviceImage CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Microsoft.Graph.Models.CloudPcDeviceImage();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "errorCode", n => { ErrorCode = n.GetEnumValue<Microsoft.Graph.Models.CloudPcDeviceImageErrorCode>(); } },
                { "expirationDate", n => { ExpirationDate = n.GetDateValue(); } },
                { "lastModifiedDateTime", n => { LastModifiedDateTime = n.GetDateTimeOffsetValue(); } },
                { "operatingSystem", n => { OperatingSystem = n.GetStringValue(); } },
                { "osBuildNumber", n => { OsBuildNumber = n.GetStringValue(); } },
                { "osStatus", n => { OsStatus = n.GetEnumValue<Microsoft.Graph.Models.CloudPcDeviceImageOsStatus>(); } },
                { "sourceImageResourceId", n => { SourceImageResourceId = n.GetStringValue(); } },
                { "status", n => { Status = n.GetEnumValue<Microsoft.Graph.Models.CloudPcDeviceImageStatus>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<Microsoft.Graph.Models.CloudPcDeviceImageErrorCode>("errorCode", ErrorCode);
            ...
            writer.WriteEnumValue<Microsoft.Graph.Models.CloudPcDeviceImageOsStatus>("osStatus", OsStatus);
            writer.WriteStringValue("sourceImageResourceId", SourceImageResourceId);
            writer.WriteEnumValue<Microsoft.Graph.Models.CloudPcDeviceImageStatus>("status", Status);
