...
#nullable enable
        public List<Microsoft.Graph.Models.KeyValue>? AttributeCollection
        {
            get { return BackingStore?.Get<List<Microsoft.Graph.Models.KeyValue>?>("attributeCollection"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Microsoft.Graph.Models.KeyValue>? RegistrationCampaign
        {
            get { return BackingStore?.Get<List<Microsoft.Graph.Models.KeyValue>?>("registrationCampaign"); }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Models.ContentCustomization"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Models.ContentCustomization"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Microsoft.Graph.Models.ContentCustomization CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Microsoft.Graph.Models.ContentCustomization();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "attributeCollection", n => { AttributeCollection = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.KeyValue>(Microsoft.Graph.Models.KeyValue.CreateFromDiscriminatorValue)?.ToList(); } },
                { "attributeCollectionRelativeUrl", n => { AttributeCollectionRelativeUrl = n.GetStringValue(); } },
                { "@odata.type", n => { OdataType = n.GetStringValue(); } },
                { "registrationCampaign", n => { RegistrationCampaign = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.KeyValue>(Microsoft.Graph.Models.KeyValue.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<Microsoft.Graph.Models.KeyValue>("attributeCollection", AttributeCollection);
            writer.WriteStringValue("attributeCollectionRelativeUrl", AttributeCollectionRelativeUrl);
            writer.WriteStringValue("@odata.type", OdataType);
            writer.WriteCollectionOfObjectValues<Microsoft.Graph.Models.KeyValue>("registrationCampaign", RegistrationCampaign);
