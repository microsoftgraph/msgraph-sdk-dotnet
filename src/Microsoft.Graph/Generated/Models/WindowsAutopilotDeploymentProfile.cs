...
namespace Microsoft.Graph.Models
{
    ...
    /// </summary>
    public class WindowsAutopilotDeploymentProfile : Microsoft.Graph.Models.Entity, IParsable
    {
        /// <summary>The list of assigned devices for the profile.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Microsoft.Graph.Models.WindowsAutopilotDeviceIdentity>? AssignedDevices
        {
            get { return BackingStore?.Get<List<Microsoft.Graph.Models.WindowsAutopilotDeviceIdentity>?>("assignedDevices"); }
...
#nullable restore
        ...
        public Microsoft.Graph.Models.WindowsAutopilotDeviceType? DeviceType
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.WindowsAutopilotDeviceType?>("deviceType"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Microsoft.Graph.Models.OutOfBoxExperienceSetting? OutOfBoxExperienceSetting
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.OutOfBoxExperienceSetting?>("outOfBoxExperienceSetting"); }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Models.WindowsAutopilotDeploymentProfile"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new Microsoft.Graph.Models.WindowsAutopilotDeploymentProfile CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Microsoft.Graph.Models.WindowsAutopilotDeploymentProfile();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "assignedDevices", n => { AssignedDevices = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.WindowsAutopilotDeviceIdentity>(Microsoft.Graph.Models.WindowsAutopilotDeviceIdentity.CreateFromDiscriminatorValue)?.ToList(); } },
                { "createdDateTime", n => { CreatedDateTime = n.GetDateTimeOffsetValue(); } },
                { "description", n => { Description = n.GetStringValue(); } },
                { "deviceNameTemplate", n => { DeviceNameTemplate = n.GetStringValue(); } },
                { "deviceType", n => { DeviceType = n.GetEnumValue<Microsoft.Graph.Models.WindowsAutopilotDeviceType>(); } },
                ...
                { "outOfBoxExperienceSetting", n => { OutOfBoxExperienceSetting = n.GetObjectValue<Microsoft.Graph.Models.OutOfBoxExperienceSetting>(Microsoft.Graph.Models.OutOfBoxExperienceSetting.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<Microsoft.Graph.Models.WindowsAutopilotDeviceIdentity>("assignedDevices", AssignedDevices);
            writer.WriteDateTimeOffsetValue("createdDateTime", CreatedDateTime);
            writer.WriteStringValue("description", Description);
            writer.WriteStringValue("deviceNameTemplate", DeviceNameTemplate);
            writer.WriteEnumValue<Microsoft.Graph.Models.WindowsAutopilotDeviceType>("deviceType", DeviceType);
            ...
            writer.WriteObjectValue<Microsoft.Graph.Models.OutOfBoxExperienceSetting>("outOfBoxExperienceSetting", OutOfBoxExperienceSetting);
