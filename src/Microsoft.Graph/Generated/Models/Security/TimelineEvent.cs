...
#nullable restore
        ...
        public global::Microsoft.Graph.Models.Security.EventSource? EventSource
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Models.Security.EventSource?>("eventSource"); }
...
#nullable restore
        ...
        public global::Microsoft.Graph.Models.Security.TimelineEventType? EventType
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Models.Security.TimelineEventType?>("eventType"); }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Microsoft.Graph.Models.Security.TimelineEvent"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.Models.Security.TimelineEvent"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Microsoft.Graph.Models.Security.TimelineEvent CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.Models.Security.TimelineEvent();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "eventSource", n => { EventSource = n.GetEnumValue<global::Microsoft.Graph.Models.Security.EventSource>(); } },
                { "eventThreats", n => { EventThreats = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                { "eventType", n => { EventType = n.GetEnumValue<global::Microsoft.Graph.Models.Security.TimelineEventType>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Microsoft.Graph.Models.Security.EventSource>("eventSource", EventSource);
            writer.WriteCollectionOfPrimitiveValues<string>("eventThreats", EventThreats);
            writer.WriteEnumValue<global::Microsoft.Graph.Models.Security.TimelineEventType>("eventType", EventType);
