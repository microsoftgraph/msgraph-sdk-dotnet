...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Microsoft.Graph.Models.Security.Alert>? AlertsV2
        {
            get { return BackingStore?.Get<List<Microsoft.Graph.Models.Security.Alert>?>("alerts_v2"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Microsoft.Graph.Models.Security.CasesRoot? Cases
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.Security.CasesRoot?>("cases"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Microsoft.Graph.Models.Security.IdentityContainer? Identities
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.Security.IdentityContainer?>("identities"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Microsoft.Graph.Models.Security.Incident>? Incidents
        {
            get { return BackingStore?.Get<List<Microsoft.Graph.Models.Security.Incident>?>("incidents"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Microsoft.Graph.Models.Security.LabelsRoot? Labels
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.Security.LabelsRoot?>("labels"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Microsoft.Graph.Models.Security.TriggersRoot? Triggers
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.Security.TriggersRoot?>("triggers"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Microsoft.Graph.Models.Security.TriggerTypesRoot? TriggerTypes
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.Security.TriggerTypesRoot?>("triggerTypes"); }
...
#nullable restore
        ...
        public static new Microsoft.Graph.Models.Security.Security CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Microsoft.Graph.Models.Security.Security();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "alerts_v2", n => { AlertsV2 = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.Security.Alert>(Microsoft.Graph.Models.Security.Alert.CreateFromDiscriminatorValue)?.ToList(); } },
                ...
                { "cases", n => { Cases = n.GetObjectValue<Microsoft.Graph.Models.Security.CasesRoot>(Microsoft.Graph.Models.Security.CasesRoot.CreateFromDiscriminatorValue); } },
                { "identities", n => { Identities = n.GetObjectValue<Microsoft.Graph.Models.Security.IdentityContainer>(Microsoft.Graph.Models.Security.IdentityContainer.CreateFromDiscriminatorValue); } },
                { "incidents", n => { Incidents = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.Security.Incident>(Microsoft.Graph.Models.Security.Incident.CreateFromDiscriminatorValue)?.ToList(); } },
                { "labels", n => { Labels = n.GetObjectValue<Microsoft.Graph.Models.Security.LabelsRoot>(Microsoft.Graph.Models.Security.LabelsRoot.CreateFromDiscriminatorValue); } },
                ...
                { "triggerTypes", n => { TriggerTypes = n.GetObjectValue<Microsoft.Graph.Models.Security.TriggerTypesRoot>(Microsoft.Graph.Models.Security.TriggerTypesRoot.CreateFromDiscriminatorValue); } },
                { "triggers", n => { Triggers = n.GetObjectValue<Microsoft.Graph.Models.Security.TriggersRoot>(Microsoft.Graph.Models.Security.TriggersRoot.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<Microsoft.Graph.Models.Security.Alert>("alerts_v2", AlertsV2);
            writer.WriteObjectValue<Microsoft.Graph.Models.AttackSimulationRoot>("attackSimulation", AttackSimulation);
            writer.WriteObjectValue<Microsoft.Graph.Models.Security.CasesRoot>("cases", Cases);
            writer.WriteObjectValue<Microsoft.Graph.Models.Security.IdentityContainer>("identities", Identities);
            writer.WriteCollectionOfObjectValues<Microsoft.Graph.Models.Security.Incident>("incidents", Incidents);
            writer.WriteObjectValue<Microsoft.Graph.Models.Security.LabelsRoot>("labels", Labels);
            ...
            writer.WriteObjectValue<Microsoft.Graph.Models.Security.TriggersRoot>("triggers", Triggers);
            writer.WriteObjectValue<Microsoft.Graph.Models.Security.TriggerTypesRoot>("triggerTypes", TriggerTypes);
        }
    }
}
