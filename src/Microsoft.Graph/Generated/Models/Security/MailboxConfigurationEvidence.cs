...
namespace Microsoft.Graph.Models.Security
{
    ...
    public class MailboxConfigurationEvidence : Microsoft.Graph.Models.Security.AlertEvidence, IParsable
...
#nullable restore
        ...
        public Microsoft.Graph.Models.Security.MailboxConfigurationType? ConfigurationType
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.Security.MailboxConfigurationType?>("configurationType"); }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Models.Security.MailboxConfigurationEvidence"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Models.Security.MailboxConfigurationEvidence"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new Microsoft.Graph.Models.Security.MailboxConfigurationEvidence CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Microsoft.Graph.Models.Security.MailboxConfigurationEvidence();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "configurationType", n => { ConfigurationType = n.GetEnumValue<Microsoft.Graph.Models.Security.MailboxConfigurationType>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<Microsoft.Graph.Models.Security.MailboxConfigurationType>("configurationType", ConfigurationType);
