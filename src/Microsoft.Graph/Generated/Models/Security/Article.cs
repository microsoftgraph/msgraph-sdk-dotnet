...
namespace Microsoft.Graph.Models.Security
{
    ...
    public partial class Article : global::Microsoft.Graph.Models.Entity, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>The body property</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Microsoft.Graph.Models.Security.FormattedContent? Body
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Models.Security.FormattedContent?>("body"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Models.Security.ArticleIndicator>? Indicators
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Models.Security.ArticleIndicator>?>("indicators"); }
...
#nullable restore
        ...
        public static new global::Microsoft.Graph.Models.Security.Article CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.Models.Security.Article();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "body", n => { Body = n.GetObjectValue<global::Microsoft.Graph.Models.Security.FormattedContent>(global::Microsoft.Graph.Models.Security.FormattedContent.CreateFromDiscriminatorValue); } },
                { "createdDateTime", n => { CreatedDateTime = n.GetDateTimeOffsetValue(); } },
                { "imageUrl", n => { ImageUrl = n.GetStringValue(); } },
                { "indicators", n => { Indicators = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Models.Security.ArticleIndicator>(global::Microsoft.Graph.Models.Security.ArticleIndicator.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Microsoft.Graph.Models.Security.FormattedContent>("body", Body);
            writer.WriteDateTimeOffsetValue("createdDateTime", CreatedDateTime);
            writer.WriteStringValue("imageUrl", ImageUrl);
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.Models.Security.ArticleIndicator>("indicators", Indicators);
