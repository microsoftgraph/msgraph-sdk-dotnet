...
#nullable restore
        ...
        public Microsoft.Graph.Models.Security.ContainerPortProtocol? Protocol
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.Security.ContainerPortProtocol?>("protocol"); }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Models.Security.KubernetesServicePort"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Models.Security.KubernetesServicePort"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Microsoft.Graph.Models.Security.KubernetesServicePort CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Microsoft.Graph.Models.Security.KubernetesServicePort();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "protocol", n => { Protocol = n.GetEnumValue<Microsoft.Graph.Models.Security.ContainerPortProtocol>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<Microsoft.Graph.Models.Security.ContainerPortProtocol>("protocol", Protocol);
