...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Microsoft.Graph.Models.Security.Dictionary? AdditionalDataProperty
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.Security.Dictionary?>("additionalData"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Microsoft.Graph.Models.Security.AlertEvidence>? Evidence
        {
            get { return BackingStore?.Get<List<Microsoft.Graph.Models.Security.AlertEvidence>?>("evidence"); }
...
#nullable restore
        ...
        public Microsoft.Graph.Models.Security.AlertStatus? Status
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.Security.AlertStatus?>("status"); }
...
#nullable restore
        ...
        public static new Microsoft.Graph.Models.Security.Alert CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Microsoft.Graph.Models.Security.Alert();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "additionalData", n => { AdditionalDataProperty = n.GetObjectValue<Microsoft.Graph.Models.Security.Dictionary>(Microsoft.Graph.Models.Security.Dictionary.CreateFromDiscriminatorValue); } },
                ...
                { "detectionSource", n => { DetectionSource = n.GetEnumValue<Microsoft.Graph.Models.Security.DetectionSource>(); } },
                ...
                { "evidence", n => { Evidence = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.Security.AlertEvidence>(Microsoft.Graph.Models.Security.AlertEvidence.CreateFromDiscriminatorValue)?.ToList(); } },
                ...
                { "serviceSource", n => { ServiceSource = n.GetEnumValue<Microsoft.Graph.Models.Security.ServiceSource>(); } },
                { "severity", n => { Severity = n.GetEnumValue<Microsoft.Graph.Models.Security.AlertSeverity>(); } },
                { "status", n => { Status = n.GetEnumValue<Microsoft.Graph.Models.Security.AlertStatus>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<Microsoft.Graph.Models.Security.Dictionary>("additionalData", AdditionalDataProperty);
            ...
            writer.WriteEnumValue<Microsoft.Graph.Models.Security.DetectionSource>("detectionSource", DetectionSource);
            ...
            writer.WriteCollectionOfObjectValues<Microsoft.Graph.Models.Security.AlertEvidence>("evidence", Evidence);
            ...
            writer.WriteEnumValue<Microsoft.Graph.Models.Security.ServiceSource>("serviceSource", ServiceSource);
            writer.WriteEnumValue<Microsoft.Graph.Models.Security.AlertSeverity>("severity", Severity);
            writer.WriteEnumValue<Microsoft.Graph.Models.Security.AlertStatus>("status", Status);
