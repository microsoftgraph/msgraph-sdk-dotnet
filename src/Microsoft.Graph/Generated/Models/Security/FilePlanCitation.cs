...
namespace Microsoft.Graph.Models.Security
{
    ...
    public class FilePlanCitation : Microsoft.Graph.Models.Security.FilePlanDescriptorBase, IParsable
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Models.Security.FilePlanCitation"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new Microsoft.Graph.Models.Security.FilePlanCitation CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Microsoft.Graph.Models.Security.FilePlanCitation();
        }
        /// <summary>
