...
namespace Microsoft.Graph.Models.Security
{
    ...
    public partial class PassiveDnsRecord : global::Microsoft.Graph.Models.Security.Artifact, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>The artifact property</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Microsoft.Graph.Models.Security.Artifact? Artifact
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Models.Security.Artifact?>("artifact"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Microsoft.Graph.Models.Security.Host? ParentHost
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Models.Security.Host?>("parentHost"); }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Microsoft.Graph.Models.Security.PassiveDnsRecord"/> and sets the default values.
        /// </summary>
        ...
        public static new global::Microsoft.Graph.Models.Security.PassiveDnsRecord CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.Models.Security.PassiveDnsRecord();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "artifact", n => { Artifact = n.GetObjectValue<global::Microsoft.Graph.Models.Security.Artifact>(global::Microsoft.Graph.Models.Security.Artifact.CreateFromDiscriminatorValue); } },
                { "collectedDateTime", n => { CollectedDateTime = n.GetDateTimeOffsetValue(); } },
                { "firstSeenDateTime", n => { FirstSeenDateTime = n.GetDateTimeOffsetValue(); } },
                { "lastSeenDateTime", n => { LastSeenDateTime = n.GetDateTimeOffsetValue(); } },
                { "parentHost", n => { ParentHost = n.GetObjectValue<global::Microsoft.Graph.Models.Security.Host>(global::Microsoft.Graph.Models.Security.Host.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Microsoft.Graph.Models.Security.Artifact>("artifact", Artifact);
            writer.WriteDateTimeOffsetValue("collectedDateTime", CollectedDateTime);
            writer.WriteDateTimeOffsetValue("firstSeenDateTime", FirstSeenDateTime);
            writer.WriteDateTimeOffsetValue("lastSeenDateTime", LastSeenDateTime);
            writer.WriteObjectValue<global::Microsoft.Graph.Models.Security.Host>("parentHost", ParentHost);
