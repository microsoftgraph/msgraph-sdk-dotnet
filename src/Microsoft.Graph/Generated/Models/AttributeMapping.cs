...
#nullable restore
        ...
        public Microsoft.Graph.Models.AttributeFlowBehavior? FlowBehavior
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.AttributeFlowBehavior?>("flowBehavior"); }
            set { BackingStore?.Set("flowBehavior", value); }
        }
        /// <summary>The flowType property</summary>
        public Microsoft.Graph.Models.AttributeFlowType? FlowType
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.AttributeFlowType?>("flowType"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Microsoft.Graph.Models.AttributeMappingSource? Source
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.AttributeMappingSource?>("source"); }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Models.AttributeMapping"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Models.AttributeMapping"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Microsoft.Graph.Models.AttributeMapping CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Microsoft.Graph.Models.AttributeMapping();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "flowBehavior", n => { FlowBehavior = n.GetEnumValue<Microsoft.Graph.Models.AttributeFlowBehavior>(); } },
                { "flowType", n => { FlowType = n.GetEnumValue<Microsoft.Graph.Models.AttributeFlowType>(); } },
                { "matchingPriority", n => { MatchingPriority = n.GetIntValue(); } },
                { "@odata.type", n => { OdataType = n.GetStringValue(); } },
                { "source", n => { Source = n.GetObjectValue<Microsoft.Graph.Models.AttributeMappingSource>(Microsoft.Graph.Models.AttributeMappingSource.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<Microsoft.Graph.Models.AttributeFlowBehavior>("flowBehavior", FlowBehavior);
            writer.WriteEnumValue<Microsoft.Graph.Models.AttributeFlowType>("flowType", FlowType);
            writer.WriteIntValue("matchingPriority", MatchingPriority);
            writer.WriteStringValue("@odata.type", OdataType);
            writer.WriteObjectValue<Microsoft.Graph.Models.AttributeMappingSource>("source", Source);
