...
namespace Microsoft.Graph.Models
{
    ...
    /// </summary>
    public class ImportedWindowsAutopilotDeviceIdentity : Microsoft.Graph.Models.Entity, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Microsoft.Graph.Models.ImportedWindowsAutopilotDeviceIdentityState? State
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.ImportedWindowsAutopilotDeviceIdentityState?>("state"); }
...
#nullable restore
        ...
        public static new Microsoft.Graph.Models.ImportedWindowsAutopilotDeviceIdentity CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Microsoft.Graph.Models.ImportedWindowsAutopilotDeviceIdentity();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "state", n => { State = n.GetObjectValue<Microsoft.Graph.Models.ImportedWindowsAutopilotDeviceIdentityState>(Microsoft.Graph.Models.ImportedWindowsAutopilotDeviceIdentityState.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<Microsoft.Graph.Models.ImportedWindowsAutopilotDeviceIdentityState>("state", State);
        }
    }
}
