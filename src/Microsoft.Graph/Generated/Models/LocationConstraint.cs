...
#nullable enable
        public List<Microsoft.Graph.Models.LocationConstraintItem>? Locations
        {
            get { return BackingStore?.Get<List<Microsoft.Graph.Models.LocationConstraintItem>?>("locations"); }
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Models.LocationConstraint"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Models.LocationConstraint"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Microsoft.Graph.Models.LocationConstraint CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Microsoft.Graph.Models.LocationConstraint();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "locations", n => { Locations = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.LocationConstraintItem>(Microsoft.Graph.Models.LocationConstraintItem.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<Microsoft.Graph.Models.LocationConstraintItem>("locations", Locations);
