...
namespace Microsoft.Graph.Models
{
    ...
    public class UsedInsight : Microsoft.Graph.Models.Entity, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>Information about when the item was last viewed or modified by the user. Read only.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Microsoft.Graph.Models.UsageDetails? LastUsed
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.UsageDetails?>("lastUsed"); }
...
#nullable restore
        ...
        public static new Microsoft.Graph.Models.UsedInsight CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Microsoft.Graph.Models.UsedInsight();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "lastUsed", n => { LastUsed = n.GetObjectValue<Microsoft.Graph.Models.UsageDetails>(Microsoft.Graph.Models.UsageDetails.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<Microsoft.Graph.Models.UsageDetails>("lastUsed", LastUsed);
