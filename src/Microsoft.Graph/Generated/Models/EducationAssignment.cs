...
namespace Microsoft.Graph.Models
{
    ...
    public class EducationAssignment : Microsoft.Graph.Models.Entity, IParsable
    #pragma warning restore CS1591
    {
        ...
        public Microsoft.Graph.Models.EducationAddedStudentAction? AddedStudentAction
        {
...
#nullable enable
        public Microsoft.Graph.Models.EducationAssignmentRecipient? AssignTo
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.EducationAssignmentRecipient?>("assignTo"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Microsoft.Graph.Models.EducationCategory>? Categories
        {
            get { return BackingStore?.Get<List<Microsoft.Graph.Models.EducationCategory>?>("categories"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Microsoft.Graph.Models.EducationGradingCategory? GradingCategory
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.EducationGradingCategory?>("gradingCategory"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Microsoft.Graph.Models.EducationItemBody? Instructions
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.EducationItemBody?>("instructions"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Microsoft.Graph.Models.EducationAssignmentResource>? Resources
        {
            get { return BackingStore?.Get<List<Microsoft.Graph.Models.EducationAssignmentResource>?>("resources"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Microsoft.Graph.Models.EducationRubric? Rubric
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.EducationRubric?>("rubric"); }
...
#nullable restore
        ...
        public Microsoft.Graph.Models.EducationAssignmentStatus? Status
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.EducationAssignmentStatus?>("status"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Microsoft.Graph.Models.EducationSubmission>? Submissions
        {
            get { return BackingStore?.Get<List<Microsoft.Graph.Models.EducationSubmission>?>("submissions"); }
...
#nullable restore
        ...
        public static new Microsoft.Graph.Models.EducationAssignment CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Microsoft.Graph.Models.EducationAssignment();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "addToCalendarAction", n => { AddToCalendarAction = n.GetEnumValue<Microsoft.Graph.Models.EducationAddToCalendarOptions>(); } },
                { "addedStudentAction", n => { AddedStudentAction = n.GetEnumValue<Microsoft.Graph.Models.EducationAddedStudentAction>(); } },
                ...
                { "assignTo", n => { AssignTo = n.GetObjectValue<Microsoft.Graph.Models.EducationAssignmentRecipient>(Microsoft.Graph.Models.EducationAssignmentRecipient.CreateFromDiscriminatorValue); } },
                { "assignedDateTime", n => { AssignedDateTime = n.GetDateTimeOffsetValue(); } },
                { "categories", n => { Categories = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.EducationCategory>(Microsoft.Graph.Models.EducationCategory.CreateFromDiscriminatorValue)?.ToList(); } },
                ...
                { "gradingCategory", n => { GradingCategory = n.GetObjectValue<Microsoft.Graph.Models.EducationGradingCategory>(Microsoft.Graph.Models.EducationGradingCategory.CreateFromDiscriminatorValue); } },
                { "instructions", n => { Instructions = n.GetObjectValue<Microsoft.Graph.Models.EducationItemBody>(Microsoft.Graph.Models.EducationItemBody.CreateFromDiscriminatorValue); } },
                ...
                { "resources", n => { Resources = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.EducationAssignmentResource>(Microsoft.Graph.Models.EducationAssignmentResource.CreateFromDiscriminatorValue)?.ToList(); } },
                { "resourcesFolderUrl", n => { ResourcesFolderUrl = n.GetStringValue(); } },
                { "rubric", n => { Rubric = n.GetObjectValue<Microsoft.Graph.Models.EducationRubric>(Microsoft.Graph.Models.EducationRubric.CreateFromDiscriminatorValue); } },
                { "status", n => { Status = n.GetEnumValue<Microsoft.Graph.Models.EducationAssignmentStatus>(); } },
                { "submissions", n => { Submissions = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.EducationSubmission>(Microsoft.Graph.Models.EducationSubmission.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<Microsoft.Graph.Models.EducationAddedStudentAction>("addedStudentAction", AddedStudentAction);
            writer.WriteEnumValue<Microsoft.Graph.Models.EducationAddToCalendarOptions>("addToCalendarAction", AddToCalendarAction);
            ...
            writer.WriteObjectValue<Microsoft.Graph.Models.EducationAssignmentRecipient>("assignTo", AssignTo);
            writer.WriteCollectionOfObjectValues<Microsoft.Graph.Models.EducationCategory>("categories", Categories);
            ...
            writer.WriteObjectValue<Microsoft.Graph.Models.EducationGradingCategory>("gradingCategory", GradingCategory);
            writer.WriteObjectValue<Microsoft.Graph.Models.EducationItemBody>("instructions", Instructions);
            writer.WriteStringValue("moduleUrl", ModuleUrl);
            writer.WriteStringValue("notificationChannelUrl", NotificationChannelUrl);
            writer.WriteCollectionOfObjectValues<Microsoft.Graph.Models.EducationAssignmentResource>("resources", Resources);
            writer.WriteObjectValue<Microsoft.Graph.Models.EducationRubric>("rubric", Rubric);
            writer.WriteCollectionOfObjectValues<Microsoft.Graph.Models.EducationSubmission>("submissions", Submissions);
        }
    }
}
