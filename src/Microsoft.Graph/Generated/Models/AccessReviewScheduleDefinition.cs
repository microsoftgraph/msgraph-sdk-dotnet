...
namespace Microsoft.Graph.Models
{
    ...
    public class AccessReviewScheduleDefinition : Microsoft.Graph.Models.Entity, IParsable
...
#nullable enable
        public List<Microsoft.Graph.Models.AccessReviewNotificationRecipientItem>? AdditionalNotificationRecipients
        {
            get { return BackingStore?.Get<List<Microsoft.Graph.Models.AccessReviewNotificationRecipientItem>?>("additionalNotificationRecipients"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Microsoft.Graph.Models.AccessReviewScope? InstanceEnumerationScope
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.AccessReviewScope?>("instanceEnumerationScope"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Microsoft.Graph.Models.AccessReviewInstance>? Instances
        {
            get { return BackingStore?.Get<List<Microsoft.Graph.Models.AccessReviewInstance>?>("instances"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Microsoft.Graph.Models.AccessReviewScope? Scope
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.AccessReviewScope?>("scope"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Microsoft.Graph.Models.AccessReviewScheduleSettings? Settings
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.AccessReviewScheduleSettings?>("settings"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Microsoft.Graph.Models.AccessReviewStageSettings>? StageSettings
        {
            get { return BackingStore?.Get<List<Microsoft.Graph.Models.AccessReviewStageSettings>?>("stageSettings"); }
...
#nullable restore
        ...
        public static new Microsoft.Graph.Models.AccessReviewScheduleDefinition CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Microsoft.Graph.Models.AccessReviewScheduleDefinition();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "additionalNotificationRecipients", n => { AdditionalNotificationRecipients = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.AccessReviewNotificationRecipientItem>(Microsoft.Graph.Models.AccessReviewNotificationRecipientItem.CreateFromDiscriminatorValue)?.ToList(); } },
                ...
                { "instanceEnumerationScope", n => { InstanceEnumerationScope = n.GetObjectValue<Microsoft.Graph.Models.AccessReviewScope>(Microsoft.Graph.Models.AccessReviewScope.CreateFromDiscriminatorValue); } },
                { "instances", n => { Instances = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.AccessReviewInstance>(Microsoft.Graph.Models.AccessReviewInstance.CreateFromDiscriminatorValue)?.ToList(); } },
                ...
                { "scope", n => { Scope = n.GetObjectValue<Microsoft.Graph.Models.AccessReviewScope>(Microsoft.Graph.Models.AccessReviewScope.CreateFromDiscriminatorValue); } },
                { "settings", n => { Settings = n.GetObjectValue<Microsoft.Graph.Models.AccessReviewScheduleSettings>(Microsoft.Graph.Models.AccessReviewScheduleSettings.CreateFromDiscriminatorValue); } },
                { "stageSettings", n => { StageSettings = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.AccessReviewStageSettings>(Microsoft.Graph.Models.AccessReviewStageSettings.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<Microsoft.Graph.Models.AccessReviewNotificationRecipientItem>("additionalNotificationRecipients", AdditionalNotificationRecipients);
            ...
            writer.WriteObjectValue<Microsoft.Graph.Models.AccessReviewScope>("instanceEnumerationScope", InstanceEnumerationScope);
            writer.WriteCollectionOfObjectValues<Microsoft.Graph.Models.AccessReviewInstance>("instances", Instances);
            writer.WriteDateTimeOffsetValue("lastModifiedDateTime", LastModifiedDateTime);
            writer.WriteCollectionOfObjectValues<Microsoft.Graph.Models.AccessReviewReviewerScope>("reviewers", Reviewers);
            writer.WriteObjectValue<Microsoft.Graph.Models.AccessReviewScope>("scope", Scope);
            writer.WriteObjectValue<Microsoft.Graph.Models.AccessReviewScheduleSettings>("settings", Settings);
            writer.WriteCollectionOfObjectValues<Microsoft.Graph.Models.AccessReviewStageSettings>("stageSettings", StageSettings);
