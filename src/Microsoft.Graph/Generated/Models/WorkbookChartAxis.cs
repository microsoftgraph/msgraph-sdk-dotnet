...
namespace Microsoft.Graph.Models
{
    ...
    public class WorkbookChartAxis : Microsoft.Graph.Models.Entity, IParsable
...
#nullable enable
        public Microsoft.Graph.Models.WorkbookChartAxisFormat? Format
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.WorkbookChartAxisFormat?>("format"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Microsoft.Graph.Models.WorkbookChartGridlines? MajorGridlines
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.WorkbookChartGridlines?>("majorGridlines"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Microsoft.Graph.Models.WorkbookChartGridlines? MinorGridlines
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.WorkbookChartGridlines?>("minorGridlines"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Microsoft.Graph.Models.WorkbookChartAxisTitle? Title
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.WorkbookChartAxisTitle?>("title"); }
...
#nullable restore
        ...
        public static new Microsoft.Graph.Models.WorkbookChartAxis CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Microsoft.Graph.Models.WorkbookChartAxis();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "format", n => { Format = n.GetObjectValue<Microsoft.Graph.Models.WorkbookChartAxisFormat>(Microsoft.Graph.Models.WorkbookChartAxisFormat.CreateFromDiscriminatorValue); } },
                { "majorGridlines", n => { MajorGridlines = n.GetObjectValue<Microsoft.Graph.Models.WorkbookChartGridlines>(Microsoft.Graph.Models.WorkbookChartGridlines.CreateFromDiscriminatorValue); } },
                ...
                { "minorGridlines", n => { MinorGridlines = n.GetObjectValue<Microsoft.Graph.Models.WorkbookChartGridlines>(Microsoft.Graph.Models.WorkbookChartGridlines.CreateFromDiscriminatorValue); } },
                { "minorUnit", n => { MinorUnit = n.GetObjectValue<UntypedNode>(UntypedNode.CreateFromDiscriminatorValue); } },
                { "title", n => { Title = n.GetObjectValue<Microsoft.Graph.Models.WorkbookChartAxisTitle>(Microsoft.Graph.Models.WorkbookChartAxisTitle.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<Microsoft.Graph.Models.WorkbookChartAxisFormat>("format", Format);
            writer.WriteObjectValue<Microsoft.Graph.Models.WorkbookChartGridlines>("majorGridlines", MajorGridlines);
            ...
            writer.WriteObjectValue<Microsoft.Graph.Models.WorkbookChartGridlines>("minorGridlines", MinorGridlines);
            writer.WriteObjectValue<UntypedNode>("minorUnit", MinorUnit);
            writer.WriteObjectValue<Microsoft.Graph.Models.WorkbookChartAxisTitle>("title", Title);
        }
    }
}
