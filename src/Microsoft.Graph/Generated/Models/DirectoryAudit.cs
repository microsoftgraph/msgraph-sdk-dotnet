...
namespace Microsoft.Graph.Models
{
    ...
    public partial class DirectoryAudit : global::Microsoft.Graph.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Models.KeyValue>? AdditionalDetails
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Models.KeyValue>?>("additionalDetails"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Microsoft.Graph.Models.AuditActivityInitiator? InitiatedBy
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Models.AuditActivityInitiator?>("initiatedBy"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Models.TargetResource>? TargetResources
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Models.TargetResource>?>("targetResources"); }
...
#nullable restore
        ...
        public static new global::Microsoft.Graph.Models.DirectoryAudit CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.Models.DirectoryAudit();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "additionalDetails", n => { AdditionalDetails = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Models.KeyValue>(global::Microsoft.Graph.Models.KeyValue.CreateFromDiscriminatorValue)?.AsList(); } },
                { "category", n => { Category = n.GetStringValue(); } },
                { "correlationId", n => { CorrelationId = n.GetStringValue(); } },
                { "initiatedBy", n => { InitiatedBy = n.GetObjectValue<global::Microsoft.Graph.Models.AuditActivityInitiator>(global::Microsoft.Graph.Models.AuditActivityInitiator.CreateFromDiscriminatorValue); } },
                { "loggedByService", n => { LoggedByService = n.GetStringValue(); } },
                { "operationType", n => { OperationType = n.GetStringValue(); } },
                { "result", n => { Result = n.GetEnumValue<global::Microsoft.Graph.Models.OperationResult>(); } },
                { "resultReason", n => { ResultReason = n.GetStringValue(); } },
                { "targetResources", n => { TargetResources = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Models.TargetResource>(global::Microsoft.Graph.Models.TargetResource.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.Models.KeyValue>("additionalDetails", AdditionalDetails);
            writer.WriteStringValue("category", Category);
            writer.WriteStringValue("correlationId", CorrelationId);
            writer.WriteObjectValue<global::Microsoft.Graph.Models.AuditActivityInitiator>("initiatedBy", InitiatedBy);
            writer.WriteStringValue("loggedByService", LoggedByService);
            writer.WriteStringValue("operationType", OperationType);
            writer.WriteEnumValue<global::Microsoft.Graph.Models.OperationResult>("result", Result);
            writer.WriteStringValue("resultReason", ResultReason);
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.Models.TargetResource>("targetResources", TargetResources);
        }
    }
}
