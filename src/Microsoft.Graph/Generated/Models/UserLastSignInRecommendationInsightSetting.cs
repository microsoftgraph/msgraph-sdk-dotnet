...
namespace Microsoft.Graph.Models
{
    ...
    public class UserLastSignInRecommendationInsightSetting : Microsoft.Graph.Models.AccessReviewRecommendationInsightSetting, IParsable
    #pragma warning restore CS1591
    {
        ...
        public Microsoft.Graph.Models.UserSignInRecommendationScope? SignInScope
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.UserSignInRecommendationScope?>("signInScope"); }
            set { BackingStore?.Set("signInScope", value); }
        }
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Models.UserLastSignInRecommendationInsightSetting"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Models.UserLastSignInRecommendationInsightSetting"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new Microsoft.Graph.Models.UserLastSignInRecommendationInsightSetting CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Microsoft.Graph.Models.UserLastSignInRecommendationInsightSetting();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "signInScope", n => { SignInScope = n.GetEnumValue<Microsoft.Graph.Models.UserSignInRecommendationScope>(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<Microsoft.Graph.Models.UserSignInRecommendationScope>("signInScope", SignInScope);
        }
    }
}
