...
namespace Microsoft.Graph.Models
{
    ...
    public class DelegatedAdminRelationshipOperation : Microsoft.Graph.Models.Entity, IParsable
...
#nullable restore
        ...
        public Microsoft.Graph.Models.DelegatedAdminRelationshipOperationType? OperationType
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.DelegatedAdminRelationshipOperationType?>("operationType"); }
        ...
        public static new Microsoft.Graph.Models.DelegatedAdminRelationshipOperation CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Microsoft.Graph.Models.DelegatedAdminRelationshipOperation();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "operationType", n => { OperationType = n.GetEnumValue<Microsoft.Graph.Models.DelegatedAdminRelationshipOperationType>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<Microsoft.Graph.Models.DelegatedAdminRelationshipOperationType>("operationType", OperationType);
