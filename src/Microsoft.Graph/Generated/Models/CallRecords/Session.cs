...
namespace Microsoft.Graph.Models.CallRecords
{
    ...
    public class Session : Microsoft.Graph.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Microsoft.Graph.Models.CallRecords.Segment>? Segments
        {
            get { return BackingStore?.Get<List<Microsoft.Graph.Models.CallRecords.Segment>?>("segments"); }
...
#nullable restore
        ...
        public static new Microsoft.Graph.Models.CallRecords.Session CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Microsoft.Graph.Models.CallRecords.Session();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "segments", n => { Segments = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.CallRecords.Segment>(Microsoft.Graph.Models.CallRecords.Segment.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<Microsoft.Graph.Models.CallRecords.Segment>("segments", Segments);
