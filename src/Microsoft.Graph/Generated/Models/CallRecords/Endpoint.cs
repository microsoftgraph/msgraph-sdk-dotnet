...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Models.CallRecords.Endpoint"/> and sets the default values.
        /// </summary>
        public Endpoint()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Models.CallRecords.Endpoint"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Microsoft.Graph.Models.CallRecords.Endpoint CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            var mappingValue = parseNode.GetChildNode("@odata.type")?.GetStringValue();
            return mappingValue switch
            {
                "#microsoft.graph.callRecords.participantEndpoint" => new Microsoft.Graph.Models.CallRecords.ParticipantEndpoint(),
                "#microsoft.graph.callRecords.serviceEndpoint" => new Microsoft.Graph.Models.CallRecords.ServiceEndpoint(),
                _ => new Microsoft.Graph.Models.CallRecords.Endpoint(),
            };
        }
        /// <summary>
