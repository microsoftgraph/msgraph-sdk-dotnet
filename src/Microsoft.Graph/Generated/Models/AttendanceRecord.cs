...
namespace Microsoft.Graph.Models
{
    ...
    public class AttendanceRecord : Microsoft.Graph.Models.Entity, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>List of time periods between joining and leaving a meeting.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Microsoft.Graph.Models.AttendanceInterval>? AttendanceIntervals
        {
            get { return BackingStore?.Get<List<Microsoft.Graph.Models.AttendanceInterval>?>("attendanceIntervals"); }
...
#nullable restore
        ...
        public static new Microsoft.Graph.Models.AttendanceRecord CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Microsoft.Graph.Models.AttendanceRecord();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "attendanceIntervals", n => { AttendanceIntervals = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.AttendanceInterval>(Microsoft.Graph.Models.AttendanceInterval.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<Microsoft.Graph.Models.AttendanceInterval>("attendanceIntervals", AttendanceIntervals);
