...
namespace Microsoft.Graph.Models
{
    ...
    public partial class ConfigurationDrift : global::Microsoft.Graph.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Models.DriftedProperty>? DriftedProperties
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Models.DriftedProperty>?>("driftedProperties"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Microsoft.Graph.Models.OpenComplexDictionaryType? ResourceInstanceIdentifier
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Models.OpenComplexDictionaryType?>("resourceInstanceIdentifier"); }
...
#nullable restore
        ...
        public global::Microsoft.Graph.Models.DriftStatus? Status
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Models.DriftStatus?>("status"); }
...
#nullable restore
        ...
        public static new global::Microsoft.Graph.Models.ConfigurationDrift CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.Models.ConfigurationDrift();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "driftedProperties", n => { DriftedProperties = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Models.DriftedProperty>(global::Microsoft.Graph.Models.DriftedProperty.CreateFromDiscriminatorValue)?.AsList(); } },
                { "firstReportedDateTime", n => { FirstReportedDateTime = n.GetDateTimeOffsetValue(); } },
                { "monitorId", n => { MonitorId = n.GetStringValue(); } },
                { "resourceInstanceIdentifier", n => { ResourceInstanceIdentifier = n.GetObjectValue<global::Microsoft.Graph.Models.OpenComplexDictionaryType>(global::Microsoft.Graph.Models.OpenComplexDictionaryType.CreateFromDiscriminatorValue); } },
                { "resourceType", n => { ResourceType = n.GetStringValue(); } },
                { "status", n => { Status = n.GetEnumValue<global::Microsoft.Graph.Models.DriftStatus>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Microsoft.Graph.Models.OpenComplexDictionaryType>("resourceInstanceIdentifier", ResourceInstanceIdentifier);
            writer.WriteEnumValue<global::Microsoft.Graph.Models.DriftStatus>("status", Status);
        }
    }
}
