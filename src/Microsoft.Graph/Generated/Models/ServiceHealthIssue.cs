...
namespace Microsoft.Graph.Models
{
    ...
    public class ServiceHealthIssue : Microsoft.Graph.Models.ServiceAnnouncementBase, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>The classification property</summary>
        public Microsoft.Graph.Models.ServiceHealthClassificationType? Classification
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.ServiceHealthClassificationType?>("classification"); }
...
#nullable restore
        ...
        public Microsoft.Graph.Models.ServiceHealthOrigin? Origin
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.ServiceHealthOrigin?>("origin"); }
            set { BackingStore?.Set("origin", value); }
        }
        /// <summary>Collection of historical posts for the service issue.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Microsoft.Graph.Models.ServiceHealthIssuePost>? Posts
        {
            get { return BackingStore?.Get<List<Microsoft.Graph.Models.ServiceHealthIssuePost>?>("posts"); }
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Models.ServiceHealthIssue"/> and sets the default values.
        /// </summary>
        ...
        public static new Microsoft.Graph.Models.ServiceHealthIssue CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Microsoft.Graph.Models.ServiceHealthIssue();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "classification", n => { Classification = n.GetEnumValue<Microsoft.Graph.Models.ServiceHealthClassificationType>(); } },
                ...
                { "origin", n => { Origin = n.GetEnumValue<Microsoft.Graph.Models.ServiceHealthOrigin>(); } },
                { "posts", n => { Posts = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.ServiceHealthIssuePost>(Microsoft.Graph.Models.ServiceHealthIssuePost.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<Microsoft.Graph.Models.ServiceHealthClassificationType>("classification", Classification);
            ...
            writer.WriteEnumValue<Microsoft.Graph.Models.ServiceHealthOrigin>("origin", Origin);
            writer.WriteCollectionOfObjectValues<Microsoft.Graph.Models.ServiceHealthIssuePost>("posts", Posts);
