...
namespace Microsoft.Graph.Models
{
    ...
    public class AccessPackageAssignment : Microsoft.Graph.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Microsoft.Graph.Models.AccessPackageAssignmentPolicy? AssignmentPolicy
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.AccessPackageAssignmentPolicy?>("assignmentPolicy"); }
...
#nullable restore
        ...
        public Microsoft.Graph.Models.AccessPackageAssignmentState? State
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.AccessPackageAssignmentState?>("state"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Microsoft.Graph.Models.AccessPackageSubject? Target
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.AccessPackageSubject?>("target"); }
...
#nullable restore
        ...
        public static new Microsoft.Graph.Models.AccessPackageAssignment CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Microsoft.Graph.Models.AccessPackageAssignment();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "assignmentPolicy", n => { AssignmentPolicy = n.GetObjectValue<Microsoft.Graph.Models.AccessPackageAssignmentPolicy>(Microsoft.Graph.Models.AccessPackageAssignmentPolicy.CreateFromDiscriminatorValue); } },
                ...
                { "state", n => { State = n.GetEnumValue<Microsoft.Graph.Models.AccessPackageAssignmentState>(); } },
                { "status", n => { Status = n.GetStringValue(); } },
                { "target", n => { Target = n.GetObjectValue<Microsoft.Graph.Models.AccessPackageSubject>(Microsoft.Graph.Models.AccessPackageSubject.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<Microsoft.Graph.Models.AccessPackageAssignmentPolicy>("assignmentPolicy", AssignmentPolicy);
            ...
            writer.WriteEnumValue<Microsoft.Graph.Models.AccessPackageAssignmentState>("state", State);
            writer.WriteStringValue("status", Status);
            writer.WriteObjectValue<Microsoft.Graph.Models.AccessPackageSubject>("target", Target);
        }
    }
}
