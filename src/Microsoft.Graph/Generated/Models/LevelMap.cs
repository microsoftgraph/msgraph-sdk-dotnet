...
#nullable enable
        ...
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Models.FixtureMap>?>("fixtures"); }
...
#nullable enable
        ...
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Models.SectionMap>?>("sections"); }
...
#nullable enable
        ...
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Models.UnitMap>?>("units"); }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Microsoft.Graph.Models.LevelMap"/> and sets the default values.
        /// </summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "fixtures", n => { Fixtures = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Models.FixtureMap>(global::Microsoft.Graph.Models.FixtureMap.CreateFromDiscriminatorValue)?.AsList(); } },
                { "placeId", n => { PlaceId = n.GetStringValue(); } },
                { "sections", n => { Sections = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Models.SectionMap>(global::Microsoft.Graph.Models.SectionMap.CreateFromDiscriminatorValue)?.AsList(); } },
                { "units", n => { Units = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Models.UnitMap>(global::Microsoft.Graph.Models.UnitMap.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.Models.FixtureMap>("fixtures", Fixtures);
            writer.WriteStringValue("placeId", PlaceId);
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.Models.SectionMap>("sections", Sections);
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.Models.UnitMap>("units", Units);
        }
    }
}
