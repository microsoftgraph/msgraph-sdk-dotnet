...
namespace Microsoft.Graph.Models
{
    ...
    #pragma warning restore CS1591
    {
        ...
        public Microsoft.Graph.Models.CloudPcDomainJoinType? DomainJoinType
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.CloudPcDomainJoinType?>("domainJoinType"); }
...
#nullable restore
        ...
        public Microsoft.Graph.Models.CloudPcRegionGroup? RegionGroup
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.CloudPcRegionGroup?>("regionGroup"); }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Models.CloudPcDomainJoinConfiguration"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Models.CloudPcDomainJoinConfiguration"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Microsoft.Graph.Models.CloudPcDomainJoinConfiguration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Microsoft.Graph.Models.CloudPcDomainJoinConfiguration();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "domainJoinType", n => { DomainJoinType = n.GetEnumValue<Microsoft.Graph.Models.CloudPcDomainJoinType>(); } },
                { "@odata.type", n => { OdataType = n.GetStringValue(); } },
                { "onPremisesConnectionId", n => { OnPremisesConnectionId = n.GetStringValue(); } },
                { "regionGroup", n => { RegionGroup = n.GetEnumValue<Microsoft.Graph.Models.CloudPcRegionGroup>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<Microsoft.Graph.Models.CloudPcDomainJoinType>("domainJoinType", DomainJoinType);
            writer.WriteStringValue("@odata.type", OdataType);
            writer.WriteStringValue("onPremisesConnectionId", OnPremisesConnectionId);
            writer.WriteEnumValue<Microsoft.Graph.Models.CloudPcRegionGroup>("regionGroup", RegionGroup);
