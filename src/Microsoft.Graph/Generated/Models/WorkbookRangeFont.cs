...
namespace Microsoft.Graph.Models
{
    ...
    {
        /// <summary>Inidicates whether the font is bold.</summary>
        public bool? Bold
        {
            get { return BackingStore?.Get<bool?>("bold"); }
            set { BackingStore?.Set("bold", value); }
        }
        /// <summary>The HTML color code representation of the text color. For example, #FF0000 represents the color red.</summary>
...
#endif
        /// <summary>Inidicates whether the font is italic.</summary>
        public bool? Italic
        {
...
#nullable restore
        ...
        /// <summary>The type of underlining applied to the font. The possible values are: None, Single, Double, SingleAccountant, DoubleAccountant.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
