...
namespace Microsoft.Graph.Models
{
    ...
    public partial class TodoTaskList : global::Microsoft.Graph.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Models.TodoTask>? Tasks
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Models.TodoTask>?>("tasks"); }
...
#nullable restore
        ...
        public global::Microsoft.Graph.Models.WellknownListName? WellknownListName
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Models.WellknownListName?>("wellknownListName"); }
        ...
        public static new global::Microsoft.Graph.Models.TodoTaskList CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.Models.TodoTaskList();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "tasks", n => { Tasks = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Models.TodoTask>(global::Microsoft.Graph.Models.TodoTask.CreateFromDiscriminatorValue)?.AsList(); } },
                { "wellknownListName", n => { WellknownListName = n.GetEnumValue<global::Microsoft.Graph.Models.WellknownListName>(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.Models.TodoTask>("tasks", Tasks);
            writer.WriteEnumValue<global::Microsoft.Graph.Models.WellknownListName>("wellknownListName", WellknownListName);
        }
    }
}
