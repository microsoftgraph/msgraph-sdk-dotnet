...
namespace Microsoft.Graph.Models
{
    ...
    public class DirectoryRole : Microsoft.Graph.Models.DirectoryObject, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Microsoft.Graph.Models.ScopedRoleMembership>? ScopedMembers
        {
            get { return BackingStore?.Get<List<Microsoft.Graph.Models.ScopedRoleMembership>?>("scopedMembers"); }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Models.DirectoryRole"/> and sets the default values.
        /// </summary>
        ...
        public static new Microsoft.Graph.Models.DirectoryRole CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Microsoft.Graph.Models.DirectoryRole();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "scopedMembers", n => { ScopedMembers = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.ScopedRoleMembership>(Microsoft.Graph.Models.ScopedRoleMembership.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<Microsoft.Graph.Models.ScopedRoleMembership>("scopedMembers", ScopedMembers);
        }
    }
}
