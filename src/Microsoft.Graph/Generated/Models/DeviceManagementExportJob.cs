...
namespace Microsoft.Graph.Models
{
    ...
    /// </summary>
    public class DeviceManagementExportJob : Microsoft.Graph.Models.Entity, IParsable
    {
...
#nullable restore
        ...
        public Microsoft.Graph.Models.DeviceManagementReportFileFormat? Format
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.DeviceManagementReportFileFormat?>("format"); }
            set { BackingStore?.Set("format", value); }
        }
        /// <summary>Configures how the requested export job is localized.</summary>
        public Microsoft.Graph.Models.DeviceManagementExportJobLocalizationType? LocalizationType
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.DeviceManagementExportJobLocalizationType?>("localizationType"); }
...
#nullable restore
        ...
        public Microsoft.Graph.Models.DeviceManagementReportStatus? Status
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.DeviceManagementReportStatus?>("status"); }
...
#nullable restore
        ...
        public static new Microsoft.Graph.Models.DeviceManagementExportJob CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Microsoft.Graph.Models.DeviceManagementExportJob();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "format", n => { Format = n.GetEnumValue<Microsoft.Graph.Models.DeviceManagementReportFileFormat>(); } },
                { "localizationType", n => { LocalizationType = n.GetEnumValue<Microsoft.Graph.Models.DeviceManagementExportJobLocalizationType>(); } },
                ...
                { "status", n => { Status = n.GetEnumValue<Microsoft.Graph.Models.DeviceManagementReportStatus>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<Microsoft.Graph.Models.DeviceManagementReportFileFormat>("format", Format);
            writer.WriteEnumValue<Microsoft.Graph.Models.DeviceManagementExportJobLocalizationType>("localizationType", LocalizationType);
            ...
            writer.WriteEnumValue<Microsoft.Graph.Models.DeviceManagementReportStatus>("status", Status);
