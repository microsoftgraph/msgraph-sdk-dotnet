...
namespace Microsoft.Graph.Models
{
    ...
    public class UserActivity : Microsoft.Graph.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Microsoft.Graph.Models.ActivityHistoryItem>? HistoryItems
        {
            get { return BackingStore?.Get<List<Microsoft.Graph.Models.ActivityHistoryItem>?>("historyItems"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Microsoft.Graph.Models.VisualInfo? VisualElements
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.VisualInfo?>("visualElements"); }
...
#nullable restore
        ...
        public static new Microsoft.Graph.Models.UserActivity CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Microsoft.Graph.Models.UserActivity();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "historyItems", n => { HistoryItems = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.ActivityHistoryItem>(Microsoft.Graph.Models.ActivityHistoryItem.CreateFromDiscriminatorValue)?.ToList(); } },
                { "lastModifiedDateTime", n => { LastModifiedDateTime = n.GetDateTimeOffsetValue(); } },
                { "status", n => { Status = n.GetEnumValue<Microsoft.Graph.Models.Status>(); } },
                { "userTimezone", n => { UserTimezone = n.GetStringValue(); } },
                { "visualElements", n => { VisualElements = n.GetObjectValue<Microsoft.Graph.Models.VisualInfo>(Microsoft.Graph.Models.VisualInfo.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<Microsoft.Graph.Models.ActivityHistoryItem>("historyItems", HistoryItems);
            ...
            writer.WriteObjectValue<Microsoft.Graph.Models.VisualInfo>("visualElements", VisualElements);
        }
    }
}
