...
namespace Microsoft.Graph.Models
{
    ...
    #pragma warning restore CS1591
    {
        ...
        public Microsoft.Graph.Models.RegistryHive? Hive
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.RegistryHive?>("hive"); }
...
#nullable restore
        ...
        public Microsoft.Graph.Models.RegistryOperation? Operation
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.RegistryOperation?>("operation"); }
...
#nullable restore
        ...
        public Microsoft.Graph.Models.RegistryValueType? ValueType
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.RegistryValueType?>("valueType"); }
            set { BackingStore?.Set("valueType", value); }
        }
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Models.RegistryKeyState"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Models.RegistryKeyState"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Microsoft.Graph.Models.RegistryKeyState CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Microsoft.Graph.Models.RegistryKeyState();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "hive", n => { Hive = n.GetEnumValue<Microsoft.Graph.Models.RegistryHive>(); } },
                ...
                { "operation", n => { Operation = n.GetEnumValue<Microsoft.Graph.Models.RegistryOperation>(); } },
                { "processId", n => { ProcessId = n.GetIntValue(); } },
                { "valueData", n => { ValueData = n.GetStringValue(); } },
                { "valueName", n => { ValueName = n.GetStringValue(); } },
                { "valueType", n => { ValueType = n.GetEnumValue<Microsoft.Graph.Models.RegistryValueType>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<Microsoft.Graph.Models.RegistryHive>("hive", Hive);
            ...
            writer.WriteEnumValue<Microsoft.Graph.Models.RegistryOperation>("operation", Operation);
            ...
            writer.WriteEnumValue<Microsoft.Graph.Models.RegistryValueType>("valueType", ValueType);
