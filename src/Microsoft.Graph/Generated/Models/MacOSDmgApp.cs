...
namespace Microsoft.Graph.Models
{
    ...
    /// </summary>
    public class MacOSDmgApp : Microsoft.Graph.Models.MobileLobApp, IParsable
    {
...
#nullable enable
        public List<Microsoft.Graph.Models.MacOSIncludedApp>? IncludedApps
        {
            get { return BackingStore?.Get<List<Microsoft.Graph.Models.MacOSIncludedApp>?>("includedApps"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Microsoft.Graph.Models.MacOSMinimumOperatingSystem? MinimumSupportedOperatingSystem
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.MacOSMinimumOperatingSystem?>("minimumSupportedOperatingSystem"); }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Models.MacOSDmgApp"/> and sets the default values.
        /// </summary>
        ...
        public static new Microsoft.Graph.Models.MacOSDmgApp CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Microsoft.Graph.Models.MacOSDmgApp();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "includedApps", n => { IncludedApps = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.MacOSIncludedApp>(Microsoft.Graph.Models.MacOSIncludedApp.CreateFromDiscriminatorValue)?.ToList(); } },
                { "minimumSupportedOperatingSystem", n => { MinimumSupportedOperatingSystem = n.GetObjectValue<Microsoft.Graph.Models.MacOSMinimumOperatingSystem>(Microsoft.Graph.Models.MacOSMinimumOperatingSystem.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<Microsoft.Graph.Models.MacOSIncludedApp>("includedApps", IncludedApps);
            writer.WriteObjectValue<Microsoft.Graph.Models.MacOSMinimumOperatingSystem>("minimumSupportedOperatingSystem", MinimumSupportedOperatingSystem);
