...
namespace Microsoft.Graph.Models
{
    ...
    public partial class VirtualEventRegistration : global::Microsoft.Graph.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Models.VirtualEventRegistrationQuestionAnswer>? RegistrationQuestionAnswers
        {
            get { return BackingStore?.Get<List<global::Microsoft.Graph.Models.VirtualEventRegistrationQuestionAnswer>?>("registrationQuestionAnswers"); }
...
#nullable restore
        ...
        public global::Microsoft.Graph.Models.VirtualEventAttendeeRegistrationStatus? Status
        {
            get { return BackingStore?.Get<global::Microsoft.Graph.Models.VirtualEventAttendeeRegistrationStatus?>("status"); }
...
#nullable restore
        ...
        public static new global::Microsoft.Graph.Models.VirtualEventRegistration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.Models.VirtualEventRegistration();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "registrationQuestionAnswers", n => { RegistrationQuestionAnswers = n.GetCollectionOfObjectValues<global::Microsoft.Graph.Models.VirtualEventRegistrationQuestionAnswer>(global::Microsoft.Graph.Models.VirtualEventRegistrationQuestionAnswer.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "status", n => { Status = n.GetEnumValue<global::Microsoft.Graph.Models.VirtualEventAttendeeRegistrationStatus>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.Models.VirtualEventRegistrationQuestionAnswer>("registrationQuestionAnswers", RegistrationQuestionAnswers);
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.Models.VirtualEventSession>("sessions", Sessions);
            writer.WriteEnumValue<global::Microsoft.Graph.Models.VirtualEventAttendeeRegistrationStatus>("status", Status);
