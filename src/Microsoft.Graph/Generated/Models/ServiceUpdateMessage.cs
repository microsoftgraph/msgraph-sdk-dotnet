...
namespace Microsoft.Graph.Models
{
    ...
    public class ServiceUpdateMessage : Microsoft.Graph.Models.ServiceAnnouncementBase, IParsable
...
#nullable enable
        public List<Microsoft.Graph.Models.ServiceAnnouncementAttachment>? Attachments
        {
            get { return BackingStore?.Get<List<Microsoft.Graph.Models.ServiceAnnouncementAttachment>?>("attachments"); }
...
#nullable restore
        ...
        public Microsoft.Graph.Models.ServiceUpdateCategory? Category
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.ServiceUpdateCategory?>("category"); }
...
#nullable restore
        ...
        public Microsoft.Graph.Models.ServiceUpdateSeverity? Severity
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.ServiceUpdateSeverity?>("severity"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Microsoft.Graph.Models.ServiceUpdateMessageViewpoint? ViewPoint
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.ServiceUpdateMessageViewpoint?>("viewPoint"); }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Models.ServiceUpdateMessage"/> and sets the default values.
        /// </summary>
        ...
        public static new Microsoft.Graph.Models.ServiceUpdateMessage CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Microsoft.Graph.Models.ServiceUpdateMessage();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "attachments", n => { Attachments = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.ServiceAnnouncementAttachment>(Microsoft.Graph.Models.ServiceAnnouncementAttachment.CreateFromDiscriminatorValue)?.ToList(); } },
                ...
                { "category", n => { Category = n.GetEnumValue<Microsoft.Graph.Models.ServiceUpdateCategory>(); } },
                { "hasAttachments", n => { HasAttachments = n.GetBoolValue(); } },
                { "isMajorChange", n => { IsMajorChange = n.GetBoolValue(); } },
                { "services", n => { Services = n.GetCollectionOfPrimitiveValues<string>()?.ToList(); } },
                { "severity", n => { Severity = n.GetEnumValue<Microsoft.Graph.Models.ServiceUpdateSeverity>(); } },
                { "tags", n => { Tags = n.GetCollectionOfPrimitiveValues<string>()?.ToList(); } },
                { "viewPoint", n => { ViewPoint = n.GetObjectValue<Microsoft.Graph.Models.ServiceUpdateMessageViewpoint>(Microsoft.Graph.Models.ServiceUpdateMessageViewpoint.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<Microsoft.Graph.Models.ServiceAnnouncementAttachment>("attachments", Attachments);
            ...
            writer.WriteEnumValue<Microsoft.Graph.Models.ServiceUpdateCategory>("category", Category);
            ...
            writer.WriteEnumValue<Microsoft.Graph.Models.ServiceUpdateSeverity>("severity", Severity);
            writer.WriteCollectionOfPrimitiveValues<string>("tags", Tags);
            writer.WriteObjectValue<Microsoft.Graph.Models.ServiceUpdateMessageViewpoint>("viewPoint", ViewPoint);
        }
    }
}
