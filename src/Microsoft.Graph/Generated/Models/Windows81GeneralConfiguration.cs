...
namespace Microsoft.Graph.Models
{
    ...
    /// </summary>
    public class Windows81GeneralConfiguration : Microsoft.Graph.Models.DeviceConfiguration, IParsable
    {
...
#nullable restore
        ...
        public Microsoft.Graph.Models.InternetSiteSecurityLevel? BrowserInternetSecurityLevel
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.InternetSiteSecurityLevel?>("browserInternetSecurityLevel"); }
            set { BackingStore?.Set("browserInternetSecurityLevel", value); }
        }
        /// <summary>Possible values for site security level.</summary>
        public Microsoft.Graph.Models.SiteSecurityLevel? BrowserIntranetSecurityLevel
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.SiteSecurityLevel?>("browserIntranetSecurityLevel"); }
...
#nullable restore
        ...
        /// <summary>Possible values for site security level.</summary>
        public Microsoft.Graph.Models.SiteSecurityLevel? BrowserTrustedSitesSecurityLevel
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.SiteSecurityLevel?>("browserTrustedSitesSecurityLevel"); }
        ...
        public Microsoft.Graph.Models.WindowsUserAccountControlSettings? UserAccountControlSettings
        {
            get { return BackingStore?.Get<Microsoft.Graph.Models.WindowsUserAccountControlSettings?>("userAccountControlSettings"); }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Models.Windows81GeneralConfiguration"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Models.Windows81GeneralConfiguration"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new Microsoft.Graph.Models.Windows81GeneralConfiguration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Microsoft.Graph.Models.Windows81GeneralConfiguration();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "browserInternetSecurityLevel", n => { BrowserInternetSecurityLevel = n.GetEnumValue<Microsoft.Graph.Models.InternetSiteSecurityLevel>(); } },
                { "browserIntranetSecurityLevel", n => { BrowserIntranetSecurityLevel = n.GetEnumValue<Microsoft.Graph.Models.SiteSecurityLevel>(); } },
                ...
                { "browserTrustedSitesSecurityLevel", n => { BrowserTrustedSitesSecurityLevel = n.GetEnumValue<Microsoft.Graph.Models.SiteSecurityLevel>(); } },
                ...
                { "userAccountControlSettings", n => { UserAccountControlSettings = n.GetEnumValue<Microsoft.Graph.Models.WindowsUserAccountControlSettings>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<Microsoft.Graph.Models.InternetSiteSecurityLevel>("browserInternetSecurityLevel", BrowserInternetSecurityLevel);
            writer.WriteEnumValue<Microsoft.Graph.Models.SiteSecurityLevel>("browserIntranetSecurityLevel", BrowserIntranetSecurityLevel);
            ...
            writer.WriteEnumValue<Microsoft.Graph.Models.SiteSecurityLevel>("browserTrustedSitesSecurityLevel", BrowserTrustedSitesSecurityLevel);
            ...
            writer.WriteEnumValue<Microsoft.Graph.Models.WindowsUserAccountControlSettings>("userAccountControlSettings", UserAccountControlSettings);
