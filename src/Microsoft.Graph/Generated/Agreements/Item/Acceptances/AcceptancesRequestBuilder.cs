using Microsoft.Graph.Agreements.Item.Acceptances.Count;
using Microsoft.Graph.Agreements.Item.Acceptances.Item;
...
namespace Microsoft.Graph.Agreements.Item.Acceptances {
    ...
    public class AcceptancesRequestBuilder : BaseRequestBuilder {
        ...
        public AcceptancesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/agreements/{agreement%2Did}/acceptances{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AcceptancesRequestBuilder and sets the default values.
        /// </summary>
