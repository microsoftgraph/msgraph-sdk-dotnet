using Microsoft.Graph.Agreements.Item.FileNamespace.Localizations;
...
namespace Microsoft.Graph.Agreements.Item.FileNamespace {
    ...
    public class FileRequestBuilder : BaseRequestBuilder {
        ...
        public FileRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/agreements/{agreement%2Did}/file{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new FileRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public FileRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/agreements/{agreement%2Did}/file{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<FileRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<FileRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AgreementFile?> GetAsync(CancellationToken cancellationToken = default, Action<FileRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AgreementFile> GetAsync(CancellationToken cancellationToken = default, Action<FileRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AgreementFile?> PatchAsync(AgreementFile body, CancellationToken cancellationToken = default, Action<FileRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AgreementFile> PatchAsync(AgreementFile body, CancellationToken cancellationToken = default, Action<FileRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
