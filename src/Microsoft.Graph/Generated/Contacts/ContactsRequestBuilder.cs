...
namespace Microsoft.Graph.Contacts {
    ...
    public class ContactsRequestBuilder : BaseRequestBuilder {
        ...
        public OrgContactItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("orgContact%2Did", position);
        ...
        public ContactsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/contacts{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ContactsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ContactsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/contacts{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<OrgContactCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ContactsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<OrgContactCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ContactsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<OrgContact?> PostAsync(OrgContact body, CancellationToken cancellationToken = default, Action<ContactsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<OrgContact> PostAsync(OrgContact body, CancellationToken cancellationToken = default, Action<ContactsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
