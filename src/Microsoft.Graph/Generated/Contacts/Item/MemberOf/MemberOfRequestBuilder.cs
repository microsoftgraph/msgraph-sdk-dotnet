using Microsoft.Graph.Contacts.Item.MemberOf.Count;
using Microsoft.Graph.Contacts.Item.MemberOf.GraphAdministrativeUnit;
using Microsoft.Graph.Contacts.Item.MemberOf.GraphGroup;
using Microsoft.Graph.Contacts.Item.MemberOf.Item;
...
namespace Microsoft.Graph.Contacts.Item.MemberOf {
    ...
    public class MemberOfRequestBuilder : BaseRequestBuilder {
        ...
        public MemberOfRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/contacts/{orgContact%2Did}/memberOf{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new MemberOfRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MemberOfRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/contacts/{orgContact%2Did}/memberOf{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
