...
using Microsoft.Graph.Contacts.Item.OnPremisesSyncBehavior;
...
namespace Microsoft.Graph.Contacts.Item
{
    ...
    public partial class OrgContactItemRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>Provides operations to manage the onPremisesSyncBehavior property of the microsoft.graph.orgContact entity.</summary>
        public global::Microsoft.Graph.Contacts.Item.OnPremisesSyncBehavior.OnPremisesSyncBehaviorRequestBuilder OnPremisesSyncBehavior
        {
            get => new global::Microsoft.Graph.Contacts.Item.OnPremisesSyncBehavior.OnPremisesSyncBehaviorRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public OrgContactItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/contacts/{orgContact%2Did}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Microsoft.Graph.Contacts.Item.OrgContactItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public OrgContactItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/contacts/{orgContact%2Did}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        {
#endif
            var requestInfo = new RequestInformation(Method.GET, "{+baseurl}/contacts/{orgContact%2Did}{?%24expand,%24select}", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
