...
namespace Microsoft.Graph.Contacts.Item.TransitiveMemberOf.Item.GraphAdministrativeUnit {
    ...
    public class GraphAdministrativeUnitRequestBuilder : BaseRequestBuilder {
        ...
        public GraphAdministrativeUnitRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/contacts/{orgContact%2Did}/transitiveMemberOf/{directoryObject%2Did}/graph.administrativeUnit{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GraphAdministrativeUnitRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GraphAdministrativeUnitRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/contacts/{orgContact%2Did}/transitiveMemberOf/{directoryObject%2Did}/graph.administrativeUnit{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
