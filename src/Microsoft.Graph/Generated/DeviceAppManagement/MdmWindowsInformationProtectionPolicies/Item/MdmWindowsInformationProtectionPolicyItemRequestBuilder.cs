...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<MdmWindowsInformationProtectionPolicyItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<MdmWindowsInformationProtectionPolicyItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<MdmWindowsInformationProtectionPolicy?> GetAsync(CancellationToken cancellationToken = default, Action<MdmWindowsInformationProtectionPolicyItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<MdmWindowsInformationProtectionPolicy> GetAsync(CancellationToken cancellationToken = default, Action<MdmWindowsInformationProtectionPolicyItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<MdmWindowsInformationProtectionPolicy?> PatchAsync(MdmWindowsInformationProtectionPolicy body, CancellationToken cancellationToken = default, Action<MdmWindowsInformationProtectionPolicyItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<MdmWindowsInformationProtectionPolicy> PatchAsync(MdmWindowsInformationProtectionPolicy body, CancellationToken cancellationToken = default, Action<MdmWindowsInformationProtectionPolicyItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
