...
using Microsoft.Graph.DeviceAppManagement.AndroidManagedAppProtections.Item.Assignments;
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<AndroidManagedAppProtectionItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<AndroidManagedAppProtectionItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AndroidManagedAppProtection?> GetAsync(CancellationToken cancellationToken = default, Action<AndroidManagedAppProtectionItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AndroidManagedAppProtection> GetAsync(CancellationToken cancellationToken = default, Action<AndroidManagedAppProtectionItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AndroidManagedAppProtection?> PatchAsync(AndroidManagedAppProtection body, CancellationToken cancellationToken = default, Action<AndroidManagedAppProtectionItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AndroidManagedAppProtection> PatchAsync(AndroidManagedAppProtection body, CancellationToken cancellationToken = default, Action<AndroidManagedAppProtectionItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
