...
namespace Microsoft.Graph.DeviceAppManagement.MobileApps.GraphWindowsMobileMSI {
    ...
    public class GraphWindowsMobileMSIRequestBuilder : BaseRequestBuilder {
        ...
        /// </summary>
        /// <returns>A <see cref="WindowsMobileMSICollectionResponse"/></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="ODataError">When receiving a 4XX or 5XX status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<WindowsMobileMSICollectionResponse?> GetAsync(Action<RequestConfiguration<GraphWindowsMobileMSIRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<WindowsMobileMSICollectionResponse> GetAsync(Action<RequestConfiguration<GraphWindowsMobileMSIRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<WindowsMobileMSICollectionResponse>(requestInfo, WindowsMobileMSICollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Get the items of type microsoft.graph.windowsMobileMSI in the microsoft.graph.mobileApp collection
        /// </summary>
