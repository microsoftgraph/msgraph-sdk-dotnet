using Microsoft.Graph.DeviceAppManagement.MobileApps.GraphManagedMobileLobApp.Count;
...
namespace Microsoft.Graph.DeviceAppManagement.MobileApps.GraphManagedMobileLobApp {
    ...
    public class GraphManagedMobileLobAppRequestBuilder : BaseRequestBuilder {
        ...
        public GraphManagedMobileLobAppRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/graph.managedMobileLobApp{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GraphManagedMobileLobAppRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GraphManagedMobileLobAppRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/graph.managedMobileLobApp{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<ManagedMobileLobAppCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<GraphManagedMobileLobAppRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ManagedMobileLobAppCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<GraphManagedMobileLobAppRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
