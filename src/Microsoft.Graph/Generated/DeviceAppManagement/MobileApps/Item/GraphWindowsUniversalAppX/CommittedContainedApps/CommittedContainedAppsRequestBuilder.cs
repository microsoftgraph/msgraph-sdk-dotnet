...
#nullable enable
        public async Task<MobileContainedAppCollectionResponse?> GetAsync(Action<RequestConfiguration<CommittedContainedAppsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<MobileContainedAppCollectionResponse> GetAsync(Action<RequestConfiguration<CommittedContainedAppsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="CommittedContainedAppsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
...
#nullable restore
        ...
        public class CommittedContainedAppsRequestBuilderGetRequestConfiguration : RequestConfiguration<CommittedContainedAppsRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
