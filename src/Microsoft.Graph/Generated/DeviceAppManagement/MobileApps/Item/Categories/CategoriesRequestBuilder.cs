using Microsoft.Graph.DeviceAppManagement.MobileApps.Item.Categories.Count;
using Microsoft.Graph.DeviceAppManagement.MobileApps.Item.Categories.Item;
...
namespace Microsoft.Graph.DeviceAppManagement.MobileApps.Item.Categories {
    ...
    public class CategoriesRequestBuilder : BaseRequestBuilder {
        ...
        public CategoriesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/categories{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CategoriesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CategoriesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/categories{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<MobileAppCategoryCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<CategoriesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<MobileAppCategoryCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<CategoriesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
