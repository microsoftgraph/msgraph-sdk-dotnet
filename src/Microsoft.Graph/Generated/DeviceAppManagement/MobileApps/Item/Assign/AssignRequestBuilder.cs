...
namespace Microsoft.Graph.DeviceAppManagement.MobileApps.Item.Assign {
    ...
    public class AssignRequestBuilder : BaseRequestBuilder {
        ...
        public AssignRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/assign", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AssignRequestBuilder and sets the default values.
        /// </summary>
