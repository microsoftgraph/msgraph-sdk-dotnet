...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="SyncMicrosoftStoreForBusinessAppsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public SyncMicrosoftStoreForBusinessAppsRequestBuilder WithUrl(string rawUrl)
        {
            return new SyncMicrosoftStoreForBusinessAppsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
