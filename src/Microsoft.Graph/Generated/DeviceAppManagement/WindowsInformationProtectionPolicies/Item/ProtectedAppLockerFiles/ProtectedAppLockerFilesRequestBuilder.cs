using Microsoft.Graph.DeviceAppManagement.WindowsInformationProtectionPolicies.Item.ProtectedAppLockerFiles.Count;
using Microsoft.Graph.DeviceAppManagement.WindowsInformationProtectionPolicies.Item.ProtectedAppLockerFiles.Item;
...
namespace Microsoft.Graph.DeviceAppManagement.WindowsInformationProtectionPolicies.Item.ProtectedAppLockerFiles {
    ...
    public class ProtectedAppLockerFilesRequestBuilder : BaseRequestBuilder {
        ...
        public ProtectedAppLockerFilesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceAppManagement/windowsInformationProtectionPolicies/{windowsInformationProtectionPolicy%2Did}/protectedAppLockerFiles{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ProtectedAppLockerFilesRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<WindowsInformationProtectionAppLockerFileCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ProtectedAppLockerFilesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WindowsInformationProtectionAppLockerFileCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ProtectedAppLockerFilesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<WindowsInformationProtectionAppLockerFile?> PostAsync(WindowsInformationProtectionAppLockerFile body, CancellationToken cancellationToken = default, Action<ProtectedAppLockerFilesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WindowsInformationProtectionAppLockerFile> PostAsync(WindowsInformationProtectionAppLockerFile body, CancellationToken cancellationToken = default, Action<ProtectedAppLockerFilesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
