using Microsoft.Graph.DeviceAppManagement.WindowsInformationProtectionPolicies.Item.ExemptAppLockerFiles.Count;
using Microsoft.Graph.DeviceAppManagement.WindowsInformationProtectionPolicies.Item.ExemptAppLockerFiles.Item;
...
#nullable enable
        public async Task<WindowsInformationProtectionAppLockerFileCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ExemptAppLockerFilesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WindowsInformationProtectionAppLockerFileCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ExemptAppLockerFilesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<WindowsInformationProtectionAppLockerFile?> PostAsync(WindowsInformationProtectionAppLockerFile body, CancellationToken cancellationToken = default, Action<ExemptAppLockerFilesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<WindowsInformationProtectionAppLockerFile> PostAsync(WindowsInformationProtectionAppLockerFile body, CancellationToken cancellationToken = default, Action<ExemptAppLockerFilesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
