using Microsoft.Graph.DeviceAppManagement.ManagedAppRegistrations.Count;
using Microsoft.Graph.DeviceAppManagement.ManagedAppRegistrations.GetUserIdsWithFlaggedAppRegistration;
using Microsoft.Graph.DeviceAppManagement.ManagedAppRegistrations.Item;
...
namespace Microsoft.Graph.DeviceAppManagement.ManagedAppRegistrations {
    ...
    public class ManagedAppRegistrationsRequestBuilder : BaseRequestBuilder {
        ...
        public ManagedAppRegistrationsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceAppManagement/managedAppRegistrations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ManagedAppRegistrationsRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<ManagedAppRegistrationCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ManagedAppRegistrationsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ManagedAppRegistrationCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ManagedAppRegistrationsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ManagedAppRegistration?> PostAsync(ManagedAppRegistration body, CancellationToken cancellationToken = default, Action<ManagedAppRegistrationsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ManagedAppRegistration> PostAsync(ManagedAppRegistration body, CancellationToken cancellationToken = default, Action<ManagedAppRegistrationsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<ManagedAppRegistrationsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<ManagedAppRegistrationsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new ManagedAppRegistrationsRequestBuilderGetRequestConfiguration();
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(ManagedAppRegistration body, Action<ManagedAppRegistrationsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ManagedAppRegistration body, Action<ManagedAppRegistrationsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new ManagedAppRegistrationsRequestBuilderPostRequestConfiguration();
                requestConfiguration.Invoke(requestConfig);
                requestInfo.AddRequestOptions(requestConfig.Options);
                requestInfo.AddHeaders(requestConfig.Headers);
            }
...
#nullable restore
        ...
        public class ManagedAppRegistrationsRequestBuilderGetRequestConfiguration {
            ...
            public ManagedAppRegistrationsRequestBuilderGetQueryParameters QueryParameters { get; set; } = new ManagedAppRegistrationsRequestBuilderGetQueryParameters();
            /// <summary>
            /// Instantiates a new managedAppRegistrationsRequestBuilderGetRequestConfiguration and sets the default values.
            /// </summary>
        ...
        public class ManagedAppRegistrationsRequestBuilderPostRequestConfiguration {
            ...
            public IList<IRequestOption> Options { get; set; }
            /// <summary>
            /// Instantiates a new managedAppRegistrationsRequestBuilderPostRequestConfiguration and sets the default values.
            /// </summary>
