...
namespace Microsoft.Graph.DeviceAppManagement.ManagedAppRegistrations.Item.AppliedPolicies.Item.TargetApps {
    ...
    public class TargetAppsRequestBuilder : BaseRequestBuilder {
        ...
        public TargetAppsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceAppManagement/managedAppRegistrations/{managedAppRegistration%2Did}/appliedPolicies/{managedAppPolicy%2Did}/targetApps", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new TargetAppsRequestBuilder and sets the default values.
        /// </summary>
