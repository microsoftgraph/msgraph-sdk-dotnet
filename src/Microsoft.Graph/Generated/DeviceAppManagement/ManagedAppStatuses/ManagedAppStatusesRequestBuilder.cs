using Microsoft.Graph.DeviceAppManagement.ManagedAppStatuses.Count;
using Microsoft.Graph.DeviceAppManagement.ManagedAppStatuses.Item;
...
namespace Microsoft.Graph.DeviceAppManagement.ManagedAppStatuses {
    ...
    public class ManagedAppStatusesRequestBuilder : BaseRequestBuilder {
        ...
        public ManagedAppStatusItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("managedAppStatus%2Did", position);
...
#nullable enable
        public async Task<ManagedAppStatusCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ManagedAppStatusesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ManagedAppStatusCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ManagedAppStatusesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ManagedAppStatus?> PostAsync(ManagedAppStatus body, CancellationToken cancellationToken = default, Action<ManagedAppStatusesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ManagedAppStatus> PostAsync(ManagedAppStatus body, CancellationToken cancellationToken = default, Action<ManagedAppStatusesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
