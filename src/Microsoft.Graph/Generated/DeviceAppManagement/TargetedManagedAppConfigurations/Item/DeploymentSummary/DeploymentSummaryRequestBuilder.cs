...
namespace Microsoft.Graph.DeviceAppManagement.TargetedManagedAppConfigurations.Item.DeploymentSummary {
    ...
    public class DeploymentSummaryRequestBuilder : BaseRequestBuilder {
        ...
        public DeploymentSummaryRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceAppManagement/targetedManagedAppConfigurations/{targetedManagedAppConfiguration%2Did}/deploymentSummary{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new DeploymentSummaryRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DeploymentSummaryRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceAppManagement/targetedManagedAppConfigurations/{targetedManagedAppConfiguration%2Did}/deploymentSummary{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DeploymentSummaryRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DeploymentSummaryRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ManagedAppPolicyDeploymentSummary?> GetAsync(CancellationToken cancellationToken = default, Action<DeploymentSummaryRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ManagedAppPolicyDeploymentSummary> GetAsync(CancellationToken cancellationToken = default, Action<DeploymentSummaryRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ManagedAppPolicyDeploymentSummary?> PatchAsync(ManagedAppPolicyDeploymentSummary body, CancellationToken cancellationToken = default, Action<DeploymentSummaryRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ManagedAppPolicyDeploymentSummary> PatchAsync(ManagedAppPolicyDeploymentSummary body, CancellationToken cancellationToken = default, Action<DeploymentSummaryRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
