...
namespace Microsoft.Graph.DeviceAppManagement.IosManagedAppProtections.Item.Apps.Item {
    ...
    public class ManagedMobileAppItemRequestBuilder : BaseRequestBuilder {
        ...
        public ManagedMobileAppItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceAppManagement/iosManagedAppProtections/{iosManagedAppProtection%2Did}/apps/{managedMobileApp%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ManagedMobileAppItemRequestBuilder and sets the default values.
        /// </summary>
