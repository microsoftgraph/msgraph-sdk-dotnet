...
namespace Microsoft.Graph.DeviceAppManagement.IosManagedAppProtections.Item.Apps {
    ...
    public class AppsRequestBuilder : BaseRequestBuilder {
        ...
        public AppsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceAppManagement/iosManagedAppProtections/{iosManagedAppProtection%2Did}/apps{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AppsRequestBuilder and sets the default values.
        /// </summary>
