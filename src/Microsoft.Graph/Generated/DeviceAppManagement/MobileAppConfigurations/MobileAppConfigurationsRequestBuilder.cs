...
namespace Microsoft.Graph.DeviceAppManagement.MobileAppConfigurations
{
    ...
    public class MobileAppConfigurationsRequestBuilder : BaseRequestBuilder
    {
        ...
        public ManagedDeviceMobileAppConfigurationItemRequestBuilder this[string position]
        {
            get
            {
...
#nullable enable
        public async Task<ManagedDeviceMobileAppConfigurationCollectionResponse?> GetAsync(Action<RequestConfiguration<MobileAppConfigurationsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<ManagedDeviceMobileAppConfigurationCollectionResponse> GetAsync(Action<RequestConfiguration<MobileAppConfigurationsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ManagedDeviceMobileAppConfiguration?> PostAsync(ManagedDeviceMobileAppConfiguration body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<ManagedDeviceMobileAppConfiguration> PostAsync(ManagedDeviceMobileAppConfiguration body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="MobileAppConfigurationsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public MobileAppConfigurationsRequestBuilder WithUrl(string rawUrl)
        {
...
#nullable restore
        ...
        public class MobileAppConfigurationsRequestBuilderGetRequestConfiguration : RequestConfiguration<MobileAppConfigurationsRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
