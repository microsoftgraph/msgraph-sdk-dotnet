...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ManagedDeviceMobileAppConfigurationItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ManagedDeviceMobileAppConfigurationItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ManagedDeviceMobileAppConfiguration?> GetAsync(CancellationToken cancellationToken = default, Action<ManagedDeviceMobileAppConfigurationItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ManagedDeviceMobileAppConfiguration> GetAsync(CancellationToken cancellationToken = default, Action<ManagedDeviceMobileAppConfigurationItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ManagedDeviceMobileAppConfiguration?> PatchAsync(ManagedDeviceMobileAppConfiguration body, CancellationToken cancellationToken = default, Action<ManagedDeviceMobileAppConfigurationItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ManagedDeviceMobileAppConfiguration> PatchAsync(ManagedDeviceMobileAppConfiguration body, CancellationToken cancellationToken = default, Action<ManagedDeviceMobileAppConfigurationItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
