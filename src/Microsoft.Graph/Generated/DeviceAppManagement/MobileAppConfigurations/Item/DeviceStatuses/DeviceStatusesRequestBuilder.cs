...
namespace Microsoft.Graph.DeviceAppManagement.MobileAppConfigurations.Item.DeviceStatuses {
    ...
    public class DeviceStatusesRequestBuilder : BaseRequestBuilder {
        ...
        public ManagedDeviceMobileAppConfigurationDeviceStatusItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("managedDeviceMobileAppConfigurationDeviceStatus%2Did", position);
...
#nullable enable
        public async Task<ManagedDeviceMobileAppConfigurationDeviceStatusCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<DeviceStatusesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ManagedDeviceMobileAppConfigurationDeviceStatusCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<DeviceStatusesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ManagedDeviceMobileAppConfigurationDeviceStatus?> PostAsync(ManagedDeviceMobileAppConfigurationDeviceStatus body, CancellationToken cancellationToken = default, Action<DeviceStatusesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ManagedDeviceMobileAppConfigurationDeviceStatus> PostAsync(ManagedDeviceMobileAppConfigurationDeviceStatus body, CancellationToken cancellationToken = default, Action<DeviceStatusesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(ManagedDeviceMobileAppConfigurationDeviceStatus body, Action<DeviceStatusesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ManagedDeviceMobileAppConfigurationDeviceStatus body, Action<DeviceStatusesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
