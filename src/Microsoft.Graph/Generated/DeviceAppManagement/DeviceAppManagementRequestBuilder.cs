...
#nullable enable
        public async Task<Microsoft.Graph.Models.DeviceAppManagement?> GetAsync(CancellationToken cancellationToken = default, Action<DeviceAppManagementRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.DeviceAppManagement> GetAsync(CancellationToken cancellationToken = default, Action<DeviceAppManagementRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.DeviceAppManagement?> PatchAsync(Microsoft.Graph.Models.DeviceAppManagement body, CancellationToken cancellationToken = default, Action<DeviceAppManagementRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.DeviceAppManagement> PatchAsync(Microsoft.Graph.Models.DeviceAppManagement body, CancellationToken cancellationToken = default, Action<DeviceAppManagementRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
