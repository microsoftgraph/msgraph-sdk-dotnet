...
#nullable enable
        public async Task<VppToken?> PostAsync(CancellationToken cancellationToken = default, Action<SyncLicensesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<VppToken> PostAsync(CancellationToken cancellationToken = default, Action<SyncLicensesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
