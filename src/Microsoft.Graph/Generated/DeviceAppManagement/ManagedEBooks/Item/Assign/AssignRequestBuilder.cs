...
namespace Microsoft.Graph.DeviceAppManagement.ManagedEBooks.Item.Assign {
    ...
    public class AssignRequestBuilder : BaseRequestBuilder {
        ...
        public AssignRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceAppManagement/managedEBooks/{managedEBook%2Did}/assign", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AssignRequestBuilder and sets the default values.
        /// </summary>
