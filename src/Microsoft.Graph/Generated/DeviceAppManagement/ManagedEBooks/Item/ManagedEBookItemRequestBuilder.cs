...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ManagedEBookItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ManagedEBookItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ManagedEBook?> GetAsync(CancellationToken cancellationToken = default, Action<ManagedEBookItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ManagedEBook> GetAsync(CancellationToken cancellationToken = default, Action<ManagedEBookItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ManagedEBook?> PatchAsync(ManagedEBook body, CancellationToken cancellationToken = default, Action<ManagedEBookItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ManagedEBook> PatchAsync(ManagedEBook body, CancellationToken cancellationToken = default, Action<ManagedEBookItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
