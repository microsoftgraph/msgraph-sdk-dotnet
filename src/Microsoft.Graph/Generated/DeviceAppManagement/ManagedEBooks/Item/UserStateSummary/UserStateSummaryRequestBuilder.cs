using Microsoft.Graph.DeviceAppManagement.ManagedEBooks.Item.UserStateSummary.Count;
using Microsoft.Graph.DeviceAppManagement.ManagedEBooks.Item.UserStateSummary.Item;
...
#nullable enable
        public async Task<UserInstallStateSummaryCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<UserStateSummaryRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UserInstallStateSummaryCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<UserStateSummaryRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<UserInstallStateSummary?> PostAsync(UserInstallStateSummary body, CancellationToken cancellationToken = default, Action<UserStateSummaryRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UserInstallStateSummary> PostAsync(UserInstallStateSummary body, CancellationToken cancellationToken = default, Action<UserStateSummaryRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
