...
namespace Microsoft.Graph.DeviceAppManagement.ManagedEBooks.Item.Assignments {
    ...
    public class AssignmentsRequestBuilder : BaseRequestBuilder {
        ...
        public ManagedEBookAssignmentItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("managedEBookAssignment%2Did", position);
        ...
        public AssignmentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceAppManagement/managedEBooks/{managedEBook%2Did}/assignments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AssignmentsRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<ManagedEBookAssignmentCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<AssignmentsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ManagedEBookAssignmentCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AssignmentsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<ManagedEBookAssignmentCollectionResponse>(requestInfo, ManagedEBookAssignmentCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ManagedEBookAssignment?> PostAsync(ManagedEBookAssignment body, CancellationToken cancellationToken = default, Action<AssignmentsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ManagedEBookAssignment> PostAsync(ManagedEBookAssignment body, CancellationToken cancellationToken = default, Action<AssignmentsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(ManagedEBookAssignment body, Action<AssignmentsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ManagedEBookAssignment body, Action<AssignmentsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
