...
using Microsoft.Graph.Planner.Buckets.Item.Tasks.Count;
using Microsoft.Graph.Planner.Buckets.Item.Tasks.Item;
...
namespace Microsoft.Graph.Planner.Buckets.Item.Tasks {
    ...
    public class TasksRequestBuilder : BaseRequestBuilder {
        ...
        public TasksRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/planner/buckets/{plannerBucket%2Did}/tasks{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new TasksRequestBuilder and sets the default values.
        /// </summary>
