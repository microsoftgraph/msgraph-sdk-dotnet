...
#nullable enable
        public async Task<Microsoft.Graph.Models.Planner?> GetAsync(CancellationToken cancellationToken = default, Action<PlannerRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Planner> GetAsync(CancellationToken cancellationToken = default, Action<PlannerRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<Microsoft.Graph.Models.Planner>(requestInfo, Microsoft.Graph.Models.Planner.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
        /// Update planner
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.Planner?> PatchAsync(Microsoft.Graph.Models.Planner body, CancellationToken cancellationToken = default, Action<PlannerRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Planner> PatchAsync(Microsoft.Graph.Models.Planner body, CancellationToken cancellationToken = default, Action<PlannerRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(Microsoft.Graph.Models.Planner body, Action<PlannerRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(Microsoft.Graph.Models.Planner body, Action<PlannerRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
