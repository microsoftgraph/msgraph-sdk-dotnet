...
#nullable enable
        public async Task<Microsoft.Graph.Models.Privacy?> GetAsync(CancellationToken cancellationToken = default, Action<PrivacyRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Privacy> GetAsync(CancellationToken cancellationToken = default, Action<PrivacyRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<Microsoft.Graph.Models.Privacy>(requestInfo, Microsoft.Graph.Models.Privacy.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
        /// Update privacy
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.Privacy?> PatchAsync(Microsoft.Graph.Models.Privacy body, CancellationToken cancellationToken = default, Action<PrivacyRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Privacy> PatchAsync(Microsoft.Graph.Models.Privacy body, CancellationToken cancellationToken = default, Action<PrivacyRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(Microsoft.Graph.Models.Privacy body, Action<PrivacyRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(Microsoft.Graph.Models.Privacy body, Action<PrivacyRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
