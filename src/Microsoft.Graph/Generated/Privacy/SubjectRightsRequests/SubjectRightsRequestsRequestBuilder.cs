...
#nullable enable
        public async Task<SubjectRightsRequestCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<SubjectRightsRequestsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<SubjectRightsRequestCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<SubjectRightsRequestsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<SubjectRightsRequest?> PostAsync(SubjectRightsRequest body, CancellationToken cancellationToken = default, Action<SubjectRightsRequestsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<SubjectRightsRequest> PostAsync(SubjectRightsRequest body, CancellationToken cancellationToken = default, Action<SubjectRightsRequestsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
