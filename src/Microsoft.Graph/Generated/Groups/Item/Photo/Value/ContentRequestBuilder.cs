...
namespace Microsoft.Graph.Groups.Item.Photo.Value
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Groups.Item.Photo.Value.ContentRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Groups.Item.Photo.Value.ContentRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Groups.Item.Photo.Value.ContentRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Groups.Item.Photo.Value.ContentRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
