...
namespace Microsoft.Graph.Groups.Item.AddFavorite
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Groups.Item.AddFavorite.AddFavoriteRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Groups.Item.AddFavorite.AddFavoriteRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Groups.Item.AddFavorite.AddFavoriteRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Groups.Item.AddFavorite.AddFavoriteRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class AddFavoriteRequestBuilderPostRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
    }
}
