using Microsoft.Graph.Groups.Item.Planner.Plans.Count;
using Microsoft.Graph.Groups.Item.Planner.Plans.Item;
...
namespace Microsoft.Graph.Groups.Item.Planner.Plans {
    ...
    public class PlansRequestBuilder : BaseRequestBuilder {
        ...
        public PlansRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/planner/plans{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new PlansRequestBuilder and sets the default values.
        /// </summary>
