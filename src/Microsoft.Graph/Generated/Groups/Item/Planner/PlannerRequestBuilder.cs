...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<PlannerRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<PlannerRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<PlannerGroup?> GetAsync(CancellationToken cancellationToken = default, Action<PlannerRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PlannerGroup> GetAsync(CancellationToken cancellationToken = default, Action<PlannerRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<PlannerGroup?> PatchAsync(PlannerGroup body, CancellationToken cancellationToken = default, Action<PlannerRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PlannerGroup> PatchAsync(PlannerGroup body, CancellationToken cancellationToken = default, Action<PlannerRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
