...
namespace Microsoft.Graph.Groups.Item.Owners.Item.GraphUser {
    ...
    public class GraphUserRequestBuilder : BaseRequestBuilder {
        ...
        public GraphUserRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/owners/{directoryObject%2Did}/graph.user{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GraphUserRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GraphUserRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/owners/{directoryObject%2Did}/graph.user{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
