using Microsoft.Graph.Groups.Item.CalendarView.Item.Instances.Item.Accept;
using Microsoft.Graph.Groups.Item.CalendarView.Item.Instances.Item.Attachments;
using Microsoft.Graph.Groups.Item.CalendarView.Item.Instances.Item.Calendar;
using Microsoft.Graph.Groups.Item.CalendarView.Item.Instances.Item.Cancel;
using Microsoft.Graph.Groups.Item.CalendarView.Item.Instances.Item.Decline;
using Microsoft.Graph.Groups.Item.CalendarView.Item.Instances.Item.DismissReminder;
using Microsoft.Graph.Groups.Item.CalendarView.Item.Instances.Item.Extensions;
using Microsoft.Graph.Groups.Item.CalendarView.Item.Instances.Item.Forward;
...
using System;
namespace Microsoft.Graph.Groups.Item.CalendarView.Item.Instances.Item {
    /// <summary>
    ...
    public class EventItemRequestBuilder : BaseRequestBuilder {
        ...
        public EventItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}{?startDateTime*,endDateTime*,%24select}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new EventItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EventItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}{?startDateTime*,endDateTime*,%24select}", rawUrl) {
        }
        /// <summary>
