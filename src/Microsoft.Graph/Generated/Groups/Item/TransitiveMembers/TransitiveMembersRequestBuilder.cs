...
namespace Microsoft.Graph.Groups.Item.TransitiveMembers {
    ...
    public class TransitiveMembersRequestBuilder : BaseRequestBuilder {
        ...
        public TransitiveMembersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/transitiveMembers{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new TransitiveMembersRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TransitiveMembersRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/transitiveMembers{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<DirectoryObjectCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<TransitiveMembersRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DirectoryObjectCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<TransitiveMembersRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<TransitiveMembersRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<TransitiveMembersRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#nullable restore
        ...
        public class TransitiveMembersRequestBuilderGetRequestConfiguration {
            ...
            public TransitiveMembersRequestBuilderGetQueryParameters QueryParameters { get; set; } = new TransitiveMembersRequestBuilderGetQueryParameters();
            /// <summary>
            /// Instantiates a new transitiveMembersRequestBuilderGetRequestConfiguration and sets the default values.
            /// </summary>
