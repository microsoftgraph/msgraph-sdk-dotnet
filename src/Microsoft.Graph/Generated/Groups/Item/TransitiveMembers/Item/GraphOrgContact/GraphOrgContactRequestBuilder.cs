...
namespace Microsoft.Graph.Groups.Item.TransitiveMembers.Item.GraphOrgContact {
    ...
    public class GraphOrgContactRequestBuilder : BaseRequestBuilder {
        ...
        public GraphOrgContactRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/transitiveMembers/{directoryObject%2Did}/graph.orgContact{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GraphOrgContactRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GraphOrgContactRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/transitiveMembers/{directoryObject%2Did}/graph.orgContact{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
