using Microsoft.Graph.Groups.Item.TransitiveMembers.Item.GraphApplication;
using Microsoft.Graph.Groups.Item.TransitiveMembers.Item.GraphDevice;
using Microsoft.Graph.Groups.Item.TransitiveMembers.Item.GraphGroup;
using Microsoft.Graph.Groups.Item.TransitiveMembers.Item.GraphOrgContact;
using Microsoft.Graph.Groups.Item.TransitiveMembers.Item.GraphServicePrincipal;
using Microsoft.Graph.Groups.Item.TransitiveMembers.Item.GraphUser;
...
namespace Microsoft.Graph.Groups.Item.TransitiveMembers.Item {
    ...
    public class DirectoryObjectItemRequestBuilder : BaseRequestBuilder {
        ...
        public DirectoryObjectItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/transitiveMembers/{directoryObject%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new DirectoryObjectItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DirectoryObjectItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/transitiveMembers/{directoryObject%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
