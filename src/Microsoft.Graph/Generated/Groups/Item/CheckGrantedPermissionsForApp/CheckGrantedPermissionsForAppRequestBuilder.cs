...
#nullable enable
        public async Task<CheckGrantedPermissionsForAppResponse?> PostAsync(CancellationToken cancellationToken = default, Action<CheckGrantedPermissionsForAppRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<CheckGrantedPermissionsForAppResponse> PostAsync(CancellationToken cancellationToken = default, Action<CheckGrantedPermissionsForAppRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Action<CheckGrantedPermissionsForAppRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Action<CheckGrantedPermissionsForAppRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
