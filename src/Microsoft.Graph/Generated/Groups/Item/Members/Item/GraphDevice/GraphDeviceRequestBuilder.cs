...
namespace Microsoft.Graph.Groups.Item.Members.Item.GraphDevice {
    ...
    public class GraphDeviceRequestBuilder : BaseRequestBuilder {
        ...
        public GraphDeviceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/members/{directoryObject%2Did}/graph.device{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GraphDeviceRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GraphDeviceRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/members/{directoryObject%2Did}/graph.device{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
