...
namespace Microsoft.Graph.Groups.Item.Threads {
    ...
    public class ThreadsRequestBuilder : BaseRequestBuilder {
        ...
        public ConversationThreadItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("conversationThread%2Did", position);
        ...
        public ThreadsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/threads{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ThreadsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ThreadsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/threads{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<ConversationThreadCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ThreadsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ConversationThreadCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ThreadsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<ConversationThreadCollectionResponse>(requestInfo, ConversationThreadCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ConversationThread?> PostAsync(ConversationThread body, CancellationToken cancellationToken = default, Action<ThreadsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ConversationThread> PostAsync(ConversationThread body, CancellationToken cancellationToken = default, Action<ThreadsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
