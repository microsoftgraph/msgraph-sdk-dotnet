...
#nullable enable
        public async Task<Post?> GetAsync(CancellationToken cancellationToken = default, Action<InReplyToRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Post> GetAsync(CancellationToken cancellationToken = default, Action<InReplyToRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
