...
namespace Microsoft.Graph.Groups.Item.Threads.Item.Posts.Item.MicrosoftGraphReply {
    /// <summary>
    ...
    public class MicrosoftGraphReplyRequestBuilder {
        ...
        public MicrosoftGraphReplyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/threads/{conversationThread%2Did}/posts/{post%2Did}/microsoft.graph.reply";
