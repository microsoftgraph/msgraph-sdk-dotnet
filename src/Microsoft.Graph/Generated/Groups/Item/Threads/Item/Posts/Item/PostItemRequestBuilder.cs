...
namespace Microsoft.Graph.Groups.Item.Threads.Item.Posts.Item {
    ...
    public class PostItemRequestBuilder : BaseRequestBuilder {
        ...
        public PostItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/threads/{conversationThread%2Did}/posts/{post%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new PostItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PostItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/threads/{conversationThread%2Did}/posts/{post%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<Post?> GetAsync(CancellationToken cancellationToken = default, Action<PostItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Post> GetAsync(CancellationToken cancellationToken = default, Action<PostItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
