...
namespace Microsoft.Graph.Groups.Item.Sites.Item.Onenote {
    ...
    public class OnenoteRequestBuilder : BaseRequestBuilder {
        ...
        public OnenoteRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new OnenoteRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public OnenoteRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.Onenote?> GetAsync(CancellationToken cancellationToken = default, Action<OnenoteRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Onenote> GetAsync(CancellationToken cancellationToken = default, Action<OnenoteRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.Onenote?> PatchAsync(Microsoft.Graph.Models.Onenote body, CancellationToken cancellationToken = default, Action<OnenoteRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Onenote> PatchAsync(Microsoft.Graph.Models.Onenote body, CancellationToken cancellationToken = default, Action<OnenoteRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
