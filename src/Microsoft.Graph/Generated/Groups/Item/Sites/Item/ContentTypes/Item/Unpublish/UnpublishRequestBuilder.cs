...
namespace Microsoft.Graph.Groups.Item.Sites.Item.ContentTypes.Item.Unpublish {
    ...
    public class UnpublishRequestBuilder : BaseRequestBuilder {
        ...
        public UnpublishRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/contentTypes/{contentType%2Did}/unpublish", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new UnpublishRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public UnpublishRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/contentTypes/{contentType%2Did}/unpublish", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<UnpublishRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<UnpublishRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
