using Microsoft.Graph.Groups.Item.Sites.Item.Lists.Item.Items.Item.Versions.Item.Fields;
using Microsoft.Graph.Groups.Item.Sites.Item.Lists.Item.Items.Item.Versions.Item.RestoreVersion;
...
namespace Microsoft.Graph.Groups.Item.Sites.Item.Lists.Item.Items.Item.Versions.Item {
    ...
    public class ListItemVersionItemRequestBuilder : BaseRequestBuilder {
        ...
        public ListItemVersionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/versions/{listItemVersion%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ListItemVersionItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ListItemVersionItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/versions/{listItemVersion%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ListItemVersionItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ListItemVersionItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ListItemVersion?> GetAsync(CancellationToken cancellationToken = default, Action<ListItemVersionItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ListItemVersion> GetAsync(CancellationToken cancellationToken = default, Action<ListItemVersionItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ListItemVersion?> PatchAsync(ListItemVersion body, CancellationToken cancellationToken = default, Action<ListItemVersionItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ListItemVersion> PatchAsync(ListItemVersion body, CancellationToken cancellationToken = default, Action<ListItemVersionItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
