...
namespace Microsoft.Graph.Groups.Item.Sites.Item.Lists.Item.Drive {
    ...
    public class DriveRequestBuilder : BaseRequestBuilder {
        ...
        public DriveRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/drive{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new DriveRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DriveRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/drive{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<Microsoft.Graph.Models.Drive?> GetAsync(CancellationToken cancellationToken = default, Action<DriveRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Drive> GetAsync(CancellationToken cancellationToken = default, Action<DriveRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
