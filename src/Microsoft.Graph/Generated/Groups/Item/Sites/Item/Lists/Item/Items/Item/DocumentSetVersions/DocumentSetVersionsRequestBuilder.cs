using Microsoft.Graph.Groups.Item.Sites.Item.Lists.Item.Items.Item.DocumentSetVersions.Count;
using Microsoft.Graph.Groups.Item.Sites.Item.Lists.Item.Items.Item.DocumentSetVersions.Item;
...
namespace Microsoft.Graph.Groups.Item.Sites.Item.Lists.Item.Items.Item.DocumentSetVersions {
    ...
    public class DocumentSetVersionsRequestBuilder : BaseRequestBuilder {
        ...
        public DocumentSetVersionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/documentSetVersions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new DocumentSetVersionsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DocumentSetVersionsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/documentSetVersions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<DocumentSetVersionCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<DocumentSetVersionsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DocumentSetVersionCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<DocumentSetVersionsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DocumentSetVersion?> PostAsync(DocumentSetVersion body, CancellationToken cancellationToken = default, Action<DocumentSetVersionsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DocumentSetVersion> PostAsync(DocumentSetVersion body, CancellationToken cancellationToken = default, Action<DocumentSetVersionsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
