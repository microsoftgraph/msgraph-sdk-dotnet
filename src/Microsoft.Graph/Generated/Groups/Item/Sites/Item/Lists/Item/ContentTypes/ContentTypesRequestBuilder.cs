...
using Microsoft.Graph.Groups.Item.Sites.Item.Lists.Item.ContentTypes.AddCopyFromContentTypeHub;
using Microsoft.Graph.Groups.Item.Sites.Item.Lists.Item.ContentTypes.Count;
using Microsoft.Graph.Groups.Item.Sites.Item.Lists.Item.ContentTypes.GetCompatibleHubContentTypes;
...
namespace Microsoft.Graph.Groups.Item.Sites.Item.Lists.Item.ContentTypes {
    ...
    public class ContentTypesRequestBuilder : BaseRequestBuilder {
        ...
        public ContentTypesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/contentTypes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ContentTypesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ContentTypesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/contentTypes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
