...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.List?> GetAsync(CancellationToken cancellationToken = default, Action<ListItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.List> GetAsync(CancellationToken cancellationToken = default, Action<ListItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.List?> PatchAsync(Microsoft.Graph.Models.List body, CancellationToken cancellationToken = default, Action<ListItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.List> PatchAsync(Microsoft.Graph.Models.List body, CancellationToken cancellationToken = default, Action<ListItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
