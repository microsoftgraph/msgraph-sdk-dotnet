using Microsoft.Graph.Groups.Item.Sites.Item.Lists.Item.ContentTypes.Item.AssociateWithHubSites;
using Microsoft.Graph.Groups.Item.Sites.Item.Lists.Item.ContentTypes.Item.Base;
using Microsoft.Graph.Groups.Item.Sites.Item.Lists.Item.ContentTypes.Item.BaseTypes;
using Microsoft.Graph.Groups.Item.Sites.Item.Lists.Item.ContentTypes.Item.ColumnLinks;
using Microsoft.Graph.Groups.Item.Sites.Item.Lists.Item.ContentTypes.Item.ColumnPositions;
using Microsoft.Graph.Groups.Item.Sites.Item.Lists.Item.ContentTypes.Item.Columns;
using Microsoft.Graph.Groups.Item.Sites.Item.Lists.Item.ContentTypes.Item.CopyToDefaultContentLocation;
using Microsoft.Graph.Groups.Item.Sites.Item.Lists.Item.ContentTypes.Item.IsPublished;
using Microsoft.Graph.Groups.Item.Sites.Item.Lists.Item.ContentTypes.Item.Publish;
using Microsoft.Graph.Groups.Item.Sites.Item.Lists.Item.ContentTypes.Item.Unpublish;
...
namespace Microsoft.Graph.Groups.Item.Sites.Item.Lists.Item.ContentTypes.Item {
    ...
    public class ContentTypeItemRequestBuilder : BaseRequestBuilder {
        ...
        public ContentTypeItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/contentTypes/{contentType%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ContentTypeItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ContentTypeItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/contentTypes/{contentType%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
