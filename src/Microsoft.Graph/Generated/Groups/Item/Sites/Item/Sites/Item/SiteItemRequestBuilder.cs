...
namespace Microsoft.Graph.Groups.Item.Sites.Item.Sites.Item {
    ...
    public class SiteItemRequestBuilder : BaseRequestBuilder {
        ...
        public SiteItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/sites/{site%2Did1}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SiteItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SiteItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/sites/{site%2Did1}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<Microsoft.Graph.Models.Site?> GetAsync(CancellationToken cancellationToken = default, Action<SiteItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Site> GetAsync(CancellationToken cancellationToken = default, Action<SiteItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
