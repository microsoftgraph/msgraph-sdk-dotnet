...
using System;
namespace Microsoft.Graph.Groups.Item.Sites.Item.Sites.Remove {
    /// <summary>
    ...
    public class RemoveRequestBuilder : BaseRequestBuilder {
        ...
        public RemoveRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/sites/remove", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new <see cref="RemoveRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RemoveRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/sites/remove", rawUrl) {
        }
        /// <summary>
