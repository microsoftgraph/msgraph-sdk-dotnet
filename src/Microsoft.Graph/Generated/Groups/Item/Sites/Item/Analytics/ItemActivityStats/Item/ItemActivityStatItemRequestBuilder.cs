using Microsoft.Graph.Groups.Item.Sites.Item.Analytics.ItemActivityStats.Item.Activities;
...
namespace Microsoft.Graph.Groups.Item.Sites.Item.Analytics.ItemActivityStats.Item {
    ...
    public class ItemActivityStatItemRequestBuilder : BaseRequestBuilder {
        ...
        public ItemActivityStatItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/analytics/itemActivityStats/{itemActivityStat%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ItemActivityStatItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ItemActivityStatItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/analytics/itemActivityStats/{itemActivityStat%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ItemActivityStatItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ItemActivityStatItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ItemActivityStat?> GetAsync(CancellationToken cancellationToken = default, Action<ItemActivityStatItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ItemActivityStat> GetAsync(CancellationToken cancellationToken = default, Action<ItemActivityStatItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ItemActivityStat?> PatchAsync(ItemActivityStat body, CancellationToken cancellationToken = default, Action<ItemActivityStatItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ItemActivityStat> PatchAsync(ItemActivityStat body, CancellationToken cancellationToken = default, Action<ItemActivityStatItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
