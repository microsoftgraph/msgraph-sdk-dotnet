using Microsoft.Graph.Groups.Item.Sites.Item.TermStores.Item.Sets.Item.Children.Item.Relations.Item.FromTerm;
using Microsoft.Graph.Groups.Item.Sites.Item.TermStores.Item.Sets.Item.Children.Item.Relations.Item.Set;
using Microsoft.Graph.Groups.Item.Sites.Item.TermStores.Item.Sets.Item.Children.Item.Relations.Item.ToTerm;
...
namespace Microsoft.Graph.Groups.Item.Sites.Item.TermStores.Item.Sets.Item.Children.Item.Relations.Item {
    ...
    public class RelationItemRequestBuilder : BaseRequestBuilder {
        ...
        public RelationItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStores/{store%2Did}/sets/{set%2Did}/children/{term%2Did}/relations/{relation%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RelationItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RelationItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStores/{store%2Did}/sets/{set%2Did}/children/{term%2Did}/relations/{relation%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
