using Microsoft.Graph.Groups.Item.Sites.Item.TermStore.Sets.Item.Children;
using Microsoft.Graph.Groups.Item.Sites.Item.TermStore.Sets.Item.ParentGroup;
using Microsoft.Graph.Groups.Item.Sites.Item.TermStore.Sets.Item.Relations;
using Microsoft.Graph.Groups.Item.Sites.Item.TermStore.Sets.Item.Terms;
...
namespace Microsoft.Graph.Groups.Item.Sites.Item.TermStore.Sets.Item {
    ...
    public class SetItemRequestBuilder : BaseRequestBuilder {
        ...
        public SetItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStore/sets/{set%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SetItemRequestBuilder and sets the default values.
        /// </summary>
