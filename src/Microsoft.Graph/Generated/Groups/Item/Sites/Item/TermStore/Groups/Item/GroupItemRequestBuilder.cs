using Microsoft.Graph.Groups.Item.Sites.Item.TermStore.Groups.Item.Sets;
...
namespace Microsoft.Graph.Groups.Item.Sites.Item.TermStore.Groups.Item {
    ...
    public class GroupItemRequestBuilder : BaseRequestBuilder {
        ...
        public GroupItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStore/groups/{group%2Did1}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GroupItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GroupItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStore/groups/{group%2Did1}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.TermStore.Group?> GetAsync(CancellationToken cancellationToken = default, Action<GroupItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.TermStore.Group> GetAsync(CancellationToken cancellationToken = default, Action<GroupItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.TermStore.Group?> PatchAsync(Microsoft.Graph.Models.TermStore.Group body, CancellationToken cancellationToken = default, Action<GroupItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.TermStore.Group> PatchAsync(Microsoft.Graph.Models.TermStore.Group body, CancellationToken cancellationToken = default, Action<GroupItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
