...
#nullable enable
        public async Task<DirectoryObjectCollectionResponse?> GetAsync(Action<RequestConfiguration<MembersWithLicenseErrorsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<DirectoryObjectCollectionResponse> GetAsync(Action<RequestConfiguration<MembersWithLicenseErrorsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="MembersWithLicenseErrorsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public MembersWithLicenseErrorsRequestBuilder WithUrl(string rawUrl)
        {
...
#nullable restore
        ...
        public class MembersWithLicenseErrorsRequestBuilderGetRequestConfiguration : RequestConfiguration<MembersWithLicenseErrorsRequestBuilderGetQueryParameters> 
        {
        }
    }
}
