using Microsoft.Graph.Groups.Item.MembersWithLicenseErrors.Item.GraphApplication;
using Microsoft.Graph.Groups.Item.MembersWithLicenseErrors.Item.GraphDevice;
using Microsoft.Graph.Groups.Item.MembersWithLicenseErrors.Item.GraphGroup;
using Microsoft.Graph.Groups.Item.MembersWithLicenseErrors.Item.GraphOrgContact;
using Microsoft.Graph.Groups.Item.MembersWithLicenseErrors.Item.GraphServicePrincipal;
using Microsoft.Graph.Groups.Item.MembersWithLicenseErrors.Item.GraphUser;
...
namespace Microsoft.Graph.Groups.Item.MembersWithLicenseErrors.Item {
    ...
    public class DirectoryObjectItemRequestBuilder : BaseRequestBuilder {
        ...
        public DirectoryObjectItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/membersWithLicenseErrors/{directoryObject%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new DirectoryObjectItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DirectoryObjectItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/membersWithLicenseErrors/{directoryObject%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
