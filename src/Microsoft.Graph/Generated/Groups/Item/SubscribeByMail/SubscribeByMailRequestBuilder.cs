...
namespace Microsoft.Graph.Groups.Item.SubscribeByMail
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Groups.Item.SubscribeByMail.SubscribeByMailRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Groups.Item.SubscribeByMail.SubscribeByMailRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Groups.Item.SubscribeByMail.SubscribeByMailRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Groups.Item.SubscribeByMail.SubscribeByMailRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class SubscribeByMailRequestBuilderPostRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
    }
}
