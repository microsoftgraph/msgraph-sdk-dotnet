...
#nullable enable
        public async Task<DirectoryObjectCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<AcceptedSendersRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DirectoryObjectCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AcceptedSendersRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
