using Microsoft.Graph.Groups.Item.Events.Item.Accept;
using Microsoft.Graph.Groups.Item.Events.Item.Attachments;
using Microsoft.Graph.Groups.Item.Events.Item.Calendar;
using Microsoft.Graph.Groups.Item.Events.Item.Cancel;
using Microsoft.Graph.Groups.Item.Events.Item.Decline;
using Microsoft.Graph.Groups.Item.Events.Item.DismissReminder;
using Microsoft.Graph.Groups.Item.Events.Item.Extensions;
using Microsoft.Graph.Groups.Item.Events.Item.Forward;
using Microsoft.Graph.Groups.Item.Events.Item.Instances;
using Microsoft.Graph.Groups.Item.Events.Item.MultiValueExtendedProperties;
using Microsoft.Graph.Groups.Item.Events.Item.SingleValueExtendedProperties;
...
namespace Microsoft.Graph.Groups.Item.Events.Item {
    ...
    public class EventItemRequestBuilder : BaseRequestBuilder {
        ...
        public EventItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/events/{event%2Did}{?%24select}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new EventItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EventItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/events/{event%2Did}{?%24select}", rawUrl) {
        }
        /// <summary>
