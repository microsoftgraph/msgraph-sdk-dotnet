using Microsoft.Graph.Groups.Item.Events.Count;
using Microsoft.Graph.Groups.Item.Events.Delta;
using Microsoft.Graph.Groups.Item.Events.Item;
...
namespace Microsoft.Graph.Groups.Item.Events {
    ...
    public class EventsRequestBuilder : BaseRequestBuilder {
        ...
        public EventsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/events{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new EventsRequestBuilder and sets the default values.
        /// </summary>
