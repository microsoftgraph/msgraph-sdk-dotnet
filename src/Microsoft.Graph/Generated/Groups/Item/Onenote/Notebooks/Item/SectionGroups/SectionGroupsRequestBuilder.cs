using Microsoft.Graph.Groups.Item.Onenote.Notebooks.Item.SectionGroups.Count;
using Microsoft.Graph.Groups.Item.Onenote.Notebooks.Item.SectionGroups.Item;
...
namespace Microsoft.Graph.Groups.Item.Onenote.Notebooks.Item.SectionGroups {
    ...
    public class SectionGroupsRequestBuilder : BaseRequestBuilder {
        ...
        public SectionGroupItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("sectionGroup%2Did", position);
        ...
        public SectionGroupsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/onenote/notebooks/{notebook%2Did}/sectionGroups{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SectionGroupsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SectionGroupsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/onenote/notebooks/{notebook%2Did}/sectionGroups{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<SectionGroup?> PostAsync(SectionGroup body, CancellationToken cancellationToken = default, Action<SectionGroupsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<SectionGroup> PostAsync(SectionGroup body, CancellationToken cancellationToken = default, Action<SectionGroupsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
