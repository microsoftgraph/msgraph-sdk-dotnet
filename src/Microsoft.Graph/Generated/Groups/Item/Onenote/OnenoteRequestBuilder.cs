...
namespace Microsoft.Graph.Groups.Item.Onenote
{
    ...
    public class OnenoteRequestBuilder : BaseRequestBuilder
    {
        ...
        public Microsoft.Graph.Groups.Item.Onenote.Notebooks.NotebooksRequestBuilder Notebooks
        {
            get => new Microsoft.Graph.Groups.Item.Onenote.Notebooks.NotebooksRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to manage the operations property of the microsoft.graph.onenote entity.</summary>
        public Microsoft.Graph.Groups.Item.Onenote.Operations.OperationsRequestBuilder Operations
        {
            get => new Microsoft.Graph.Groups.Item.Onenote.Operations.OperationsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to manage the pages property of the microsoft.graph.onenote entity.</summary>
        public Microsoft.Graph.Groups.Item.Onenote.Pages.PagesRequestBuilder Pages
        {
            get => new Microsoft.Graph.Groups.Item.Onenote.Pages.PagesRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to manage the resources property of the microsoft.graph.onenote entity.</summary>
        public Microsoft.Graph.Groups.Item.Onenote.Resources.ResourcesRequestBuilder Resources
        {
            get => new Microsoft.Graph.Groups.Item.Onenote.Resources.ResourcesRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to manage the sectionGroups property of the microsoft.graph.onenote entity.</summary>
        public Microsoft.Graph.Groups.Item.Onenote.SectionGroups.SectionGroupsRequestBuilder SectionGroups
        {
            get => new Microsoft.Graph.Groups.Item.Onenote.SectionGroups.SectionGroupsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to manage the sections property of the microsoft.graph.onenote entity.</summary>
        public Microsoft.Graph.Groups.Item.Onenote.Sections.SectionsRequestBuilder Sections
        {
            get => new Microsoft.Graph.Groups.Item.Onenote.Sections.SectionsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Groups.Item.Onenote.OnenoteRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.Onenote?> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Groups.Item.Onenote.OnenoteRequestBuilder.OnenoteRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Onenote> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Groups.Item.Onenote.OnenoteRequestBuilder.OnenoteRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Groups.Item.Onenote.OnenoteRequestBuilder.OnenoteRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Groups.Item.Onenote.OnenoteRequestBuilder.OnenoteRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Groups.Item.Onenote.OnenoteRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Groups.Item.Onenote.OnenoteRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Groups.Item.Onenote.OnenoteRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class OnenoteRequestBuilderGetRequestConfiguration : RequestConfiguration<Microsoft.Graph.Groups.Item.Onenote.OnenoteRequestBuilder.OnenoteRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
