...
namespace Microsoft.Graph.Groups.Item.UnsubscribeByMail
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Groups.Item.UnsubscribeByMail.UnsubscribeByMailRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Groups.Item.UnsubscribeByMail.UnsubscribeByMailRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Groups.Item.UnsubscribeByMail.UnsubscribeByMailRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Groups.Item.UnsubscribeByMail.UnsubscribeByMailRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class UnsubscribeByMailRequestBuilderPostRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
    }
}
