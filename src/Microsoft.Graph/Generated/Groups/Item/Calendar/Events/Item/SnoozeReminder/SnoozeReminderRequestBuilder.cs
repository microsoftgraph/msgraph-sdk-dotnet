...
namespace Microsoft.Graph.Groups.Item.Calendar.Events.Item.SnoozeReminder {
    ...
    public class SnoozeReminderRequestBuilder : BaseRequestBuilder {
        ...
        public SnoozeReminderRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/calendar/events/{event%2Did}/snoozeReminder", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SnoozeReminderRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SnoozeReminderRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/calendar/events/{event%2Did}/snoozeReminder", rawUrl) {
        }
        /// <summary>
