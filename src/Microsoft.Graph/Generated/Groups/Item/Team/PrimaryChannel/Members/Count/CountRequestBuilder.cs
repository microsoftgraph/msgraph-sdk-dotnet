...
namespace Microsoft.Graph.Groups.Item.Team.PrimaryChannel.Members.Count {
    ...
    public class CountRequestBuilder : BaseRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/team/primaryChannel/members/$count{?%24search,%24filter}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CountRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CountRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/team/primaryChannel/members/$count{?%24search,%24filter}", rawUrl) {
        }
        /// <summary>
