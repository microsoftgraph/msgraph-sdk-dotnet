using Microsoft.Graph.Groups.Item.Team.PrimaryChannel.Messages.Item.HostedContents;
using Microsoft.Graph.Groups.Item.Team.PrimaryChannel.Messages.Item.Replies;
using Microsoft.Graph.Groups.Item.Team.PrimaryChannel.Messages.Item.SoftDelete;
using Microsoft.Graph.Groups.Item.Team.PrimaryChannel.Messages.Item.UndoSoftDelete;
...
namespace Microsoft.Graph.Groups.Item.Team.PrimaryChannel.Messages.Item {
    ...
    public class ChatMessageItemRequestBuilder : BaseRequestBuilder {
        ...
        public ChatMessageItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/team/primaryChannel/messages/{chatMessage%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ChatMessageItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ChatMessageItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/team/primaryChannel/messages/{chatMessage%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
