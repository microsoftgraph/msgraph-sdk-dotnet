...
using Microsoft.Graph.Groups.Item.Team.PermissionGrants.Delta;
using Microsoft.Graph.Groups.Item.Team.PermissionGrants.GetAvailableExtensionProperties;
using Microsoft.Graph.Groups.Item.Team.PermissionGrants.GetByIds;
using Microsoft.Graph.Groups.Item.Team.PermissionGrants.Item;
using Microsoft.Graph.Groups.Item.Team.PermissionGrants.ValidateProperties;
...
namespace Microsoft.Graph.Groups.Item.Team.PermissionGrants {
    ...
    public class PermissionGrantsRequestBuilder : BaseRequestBuilder {
        ...
        public PermissionGrantsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/team/permissionGrants{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new PermissionGrantsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PermissionGrantsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/team/permissionGrants{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
