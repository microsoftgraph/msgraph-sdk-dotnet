...
using Microsoft.Graph.Groups.Item.Team.Channels.Item.SharedWithTeams.Item.Team;
...
namespace Microsoft.Graph.Groups.Item.Team.Channels.Item.SharedWithTeams.Item {
    ...
    public class SharedWithChannelTeamInfoItemRequestBuilder : BaseRequestBuilder {
        ...
        public Microsoft.Graph.Groups.Item.Team.Channels.Item.SharedWithTeams.Item.Team.TeamRequestBuilder Team { get =>
            new Microsoft.Graph.Groups.Item.Team.Channels.Item.SharedWithTeams.Item.Team.TeamRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        ...
        public SharedWithChannelTeamInfoItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/team/channels/{channel%2Did}/sharedWithTeams/{sharedWithChannelTeamInfo%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SharedWithChannelTeamInfoItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SharedWithChannelTeamInfoItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/team/channels/{channel%2Did}/sharedWithTeams/{sharedWithChannelTeamInfo%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
