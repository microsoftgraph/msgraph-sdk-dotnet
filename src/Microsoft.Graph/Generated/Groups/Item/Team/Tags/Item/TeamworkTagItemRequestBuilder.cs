using Microsoft.Graph.Groups.Item.Team.Tags.Item.Members;
...
namespace Microsoft.Graph.Groups.Item.Team.Tags.Item {
    ...
    public class TeamworkTagItemRequestBuilder : BaseRequestBuilder {
        ...
        public TeamworkTagItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/team/tags/{teamworkTag%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new TeamworkTagItemRequestBuilder and sets the default values.
        /// </summary>
