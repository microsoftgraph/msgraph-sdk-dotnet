using Microsoft.Graph.Groups.Item.Team.Schedule.SwapShiftsChangeRequests.Count;
using Microsoft.Graph.Groups.Item.Team.Schedule.SwapShiftsChangeRequests.Item;
...
namespace Microsoft.Graph.Groups.Item.Team.Schedule.SwapShiftsChangeRequests {
    ...
    public class SwapShiftsChangeRequestsRequestBuilder : BaseRequestBuilder {
        ...
        public SwapShiftsChangeRequestsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/team/schedule/swapShiftsChangeRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SwapShiftsChangeRequestsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SwapShiftsChangeRequestsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/team/schedule/swapShiftsChangeRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
