using Microsoft.Graph.Groups.Item.Team.Schedule.TimesOff.Count;
using Microsoft.Graph.Groups.Item.Team.Schedule.TimesOff.Item;
...
namespace Microsoft.Graph.Groups.Item.Team.Schedule.TimesOff {
    ...
    public class TimesOffRequestBuilder : BaseRequestBuilder {
        ...
        public TimesOffRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/team/schedule/timesOff{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new TimesOffRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TimesOffRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/team/schedule/timesOff{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select}", rawUrl) {
        }
        /// <summary>
