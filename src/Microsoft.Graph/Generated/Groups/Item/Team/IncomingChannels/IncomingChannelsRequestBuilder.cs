using Microsoft.Graph.Groups.Item.Team.IncomingChannels.Count;
using Microsoft.Graph.Groups.Item.Team.IncomingChannels.Item;
...
namespace Microsoft.Graph.Groups.Item.Team.IncomingChannels {
    ...
    public class IncomingChannelsRequestBuilder : BaseRequestBuilder {
        ...
        public IncomingChannelsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/team/incomingChannels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new IncomingChannelsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public IncomingChannelsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/team/incomingChannels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
