...
namespace Microsoft.Graph.Groups.Item.AssignLicense
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Groups.Item.AssignLicense.AssignLicenseRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Microsoft.Graph.Models.Group?> PostAsync(Microsoft.Graph.Groups.Item.AssignLicense.AssignLicensePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Group> PostAsync(Microsoft.Graph.Groups.Item.AssignLicense.AssignLicensePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Groups.Item.AssignLicense.AssignLicensePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Groups.Item.AssignLicense.AssignLicensePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Groups.Item.AssignLicense.AssignLicenseRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Groups.Item.AssignLicense.AssignLicenseRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Groups.Item.AssignLicense.AssignLicenseRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
