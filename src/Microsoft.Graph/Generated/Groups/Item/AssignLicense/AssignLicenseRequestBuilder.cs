...
#nullable enable
        public async Task<Microsoft.Graph.Models.Group?> PostAsync(AssignLicensePostRequestBody body, CancellationToken cancellationToken = default, Action<AssignLicenseRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Group> PostAsync(AssignLicensePostRequestBody body, CancellationToken cancellationToken = default, Action<AssignLicenseRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
