using Microsoft.Graph.Groups.Item.Conversations.Item.Threads.Item.Posts;
using Microsoft.Graph.Groups.Item.Conversations.Item.Threads.Item.Reply;
...
namespace Microsoft.Graph.Groups.Item.Conversations.Item.Threads.Item {
    ...
    public class ConversationThreadItemRequestBuilder : BaseRequestBuilder {
        ...
        public ConversationThreadItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/conversations/{conversation%2Did}/threads/{conversationThread%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ConversationThreadItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ConversationThreadItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/conversations/{conversation%2Did}/threads/{conversationThread%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ConversationThreadItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ConversationThreadItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ConversationThread?> GetAsync(CancellationToken cancellationToken = default, Action<ConversationThreadItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ConversationThread> GetAsync(CancellationToken cancellationToken = default, Action<ConversationThreadItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ConversationThread?> PatchAsync(ConversationThread body, CancellationToken cancellationToken = default, Action<ConversationThreadItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ConversationThread> PatchAsync(ConversationThread body, CancellationToken cancellationToken = default, Action<ConversationThreadItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
