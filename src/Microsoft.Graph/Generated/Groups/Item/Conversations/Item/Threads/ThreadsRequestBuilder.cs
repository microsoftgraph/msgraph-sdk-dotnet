using Microsoft.Graph.Groups.Item.Conversations.Item.Threads.Count;
using Microsoft.Graph.Groups.Item.Conversations.Item.Threads.Item;
...
namespace Microsoft.Graph.Groups.Item.Conversations.Item.Threads {
    ...
    public class ThreadsRequestBuilder : BaseRequestBuilder {
        ...
        public ThreadsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/conversations/{conversation%2Did}/threads{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ThreadsRequestBuilder and sets the default values.
        /// </summary>
