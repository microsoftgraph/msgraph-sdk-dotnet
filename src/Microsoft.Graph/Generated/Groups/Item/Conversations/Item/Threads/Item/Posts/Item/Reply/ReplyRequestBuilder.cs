...
namespace Microsoft.Graph.Groups.Item.Conversations.Item.Threads.Item.Posts.Item.Reply {
    ...
    public class ReplyRequestBuilder : BaseRequestBuilder {
        ...
        public ReplyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/conversations/{conversation%2Did}/threads/{conversationThread%2Did}/posts/{post%2Did}/reply", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ReplyRequestBuilder and sets the default values.
        /// </summary>
