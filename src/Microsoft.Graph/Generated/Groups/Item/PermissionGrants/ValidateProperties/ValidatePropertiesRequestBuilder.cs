...
namespace Microsoft.Graph.Groups.Item.PermissionGrants.ValidateProperties {
    ...
    public class ValidatePropertiesRequestBuilder : BaseRequestBuilder {
        ...
        public ValidatePropertiesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/permissionGrants/validateProperties", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ValidatePropertiesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ValidatePropertiesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/permissionGrants/validateProperties", rawUrl) {
        }
        /// <summary>
