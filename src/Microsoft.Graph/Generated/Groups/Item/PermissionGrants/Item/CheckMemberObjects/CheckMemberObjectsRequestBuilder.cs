...
namespace Microsoft.Graph.Groups.Item.PermissionGrants.Item.CheckMemberObjects {
    ...
    public class CheckMemberObjectsRequestBuilder : BaseRequestBuilder {
        ...
        public CheckMemberObjectsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/permissionGrants/{resourceSpecificPermissionGrant%2Did}/checkMemberObjects", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CheckMemberObjectsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CheckMemberObjectsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/permissionGrants/{resourceSpecificPermissionGrant%2Did}/checkMemberObjects", rawUrl) {
        }
        /// <summary>
