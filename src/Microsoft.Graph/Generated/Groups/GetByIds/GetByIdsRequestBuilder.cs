...
namespace Microsoft.Graph.Groups.GetByIds {
    ...
    public class GetByIdsRequestBuilder : BaseRequestBuilder {
        ...
        public GetByIdsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/getByIds", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GetByIdsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetByIdsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/getByIds", rawUrl) {
        }
        /// <summary>
