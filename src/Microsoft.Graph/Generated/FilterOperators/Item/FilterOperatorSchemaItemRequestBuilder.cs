...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<FilterOperatorSchemaItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<FilterOperatorSchemaItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<FilterOperatorSchema?> GetAsync(CancellationToken cancellationToken = default, Action<FilterOperatorSchemaItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<FilterOperatorSchema> GetAsync(CancellationToken cancellationToken = default, Action<FilterOperatorSchemaItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<FilterOperatorSchema?> PatchAsync(FilterOperatorSchema body, CancellationToken cancellationToken = default, Action<FilterOperatorSchemaItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<FilterOperatorSchema> PatchAsync(FilterOperatorSchema body, CancellationToken cancellationToken = default, Action<FilterOperatorSchemaItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
