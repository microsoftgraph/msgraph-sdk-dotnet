...
using System;
namespace Microsoft.Graph.Localizations.Item.HeaderLogo {
    /// <summary>
    ...
    public class HeaderLogoRequestBuilder : BaseRequestBuilder {
        ...
        public HeaderLogoRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/localizations/{organizationalBrandingLocalization%2Did}/headerLogo", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new HeaderLogoRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public HeaderLogoRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/localizations/{organizationalBrandingLocalization%2Did}/headerLogo", rawUrl) {
        }
        /// <summary>
