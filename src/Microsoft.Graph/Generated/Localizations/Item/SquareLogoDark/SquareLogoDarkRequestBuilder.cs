...
using System;
namespace Microsoft.Graph.Localizations.Item.SquareLogoDark {
    /// <summary>
    ...
    public class SquareLogoDarkRequestBuilder : BaseRequestBuilder {
        ...
        public SquareLogoDarkRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/localizations/{organizationalBrandingLocalization%2Did}/squareLogoDark", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SquareLogoDarkRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SquareLogoDarkRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/localizations/{organizationalBrandingLocalization%2Did}/squareLogoDark", rawUrl) {
        }
        /// <summary>
        /// Get squareLogoDark for organizationalBrandingLocalization from localizations
        /// </summary>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Stream?> GetAsync(CancellationToken cancellationToken = default, Action<SquareLogoDarkRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Stream> GetAsync(CancellationToken cancellationToken = default, Action<SquareLogoDarkRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
        ...
        /// <summary>
        /// Update squareLogoDark for organizationalBrandingLocalization in localizations
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Stream?> PutAsync(Stream body, CancellationToken cancellationToken = default, Action<SquareLogoDarkRequestBuilderPutRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Stream> PutAsync(Stream body, CancellationToken cancellationToken = default, Action<SquareLogoDarkRequestBuilderPutRequestConfiguration> requestConfiguration = default) {
#endif
