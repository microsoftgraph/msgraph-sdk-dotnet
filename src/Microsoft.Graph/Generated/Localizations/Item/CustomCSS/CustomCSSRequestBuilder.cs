...
using System;
namespace Microsoft.Graph.Localizations.Item.CustomCSS {
    /// <summary>
    ...
    public class CustomCSSRequestBuilder : BaseRequestBuilder {
        ...
        public CustomCSSRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/localizations/{organizationalBrandingLocalization%2Did}/customCSS", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CustomCSSRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CustomCSSRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/localizations/{organizationalBrandingLocalization%2Did}/customCSS", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<Stream?> GetAsync(CancellationToken cancellationToken = default, Action<CustomCSSRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Stream> GetAsync(CancellationToken cancellationToken = default, Action<CustomCSSRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Stream?> PutAsync(Stream body, CancellationToken cancellationToken = default, Action<CustomCSSRequestBuilderPutRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Stream> PutAsync(Stream body, CancellationToken cancellationToken = default, Action<CustomCSSRequestBuilderPutRequestConfiguration> requestConfiguration = default) {
#endif
