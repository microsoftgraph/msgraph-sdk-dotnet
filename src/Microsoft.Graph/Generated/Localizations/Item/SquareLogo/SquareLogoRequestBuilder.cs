...
using System;
namespace Microsoft.Graph.Localizations.Item.SquareLogo {
    /// <summary>
    ...
    public class SquareLogoRequestBuilder : BaseRequestBuilder {
        ...
        public SquareLogoRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/localizations/{organizationalBrandingLocalization%2Did}/squareLogo", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SquareLogoRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SquareLogoRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/localizations/{organizationalBrandingLocalization%2Did}/squareLogo", rawUrl) {
        }
        /// <summary>
