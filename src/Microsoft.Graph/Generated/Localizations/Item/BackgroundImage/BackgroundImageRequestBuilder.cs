...
namespace Microsoft.Graph.Localizations.Item.BackgroundImage {
    ...
    public class BackgroundImageRequestBuilder : BaseRequestBuilder {
        ...
        public BackgroundImageRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/localizations/{organizationalBrandingLocalization%2Did}/backgroundImage", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new BackgroundImageRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public BackgroundImageRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/localizations/{organizationalBrandingLocalization%2Did}/backgroundImage", rawUrl) {
        }
        /// <summary>
