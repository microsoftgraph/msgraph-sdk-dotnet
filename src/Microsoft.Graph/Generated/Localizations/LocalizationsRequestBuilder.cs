using Microsoft.Graph.Localizations.Count;
using Microsoft.Graph.Localizations.Item;
...
namespace Microsoft.Graph.Localizations {
    ...
    public class LocalizationsRequestBuilder : BaseRequestBuilder {
        ...
        public LocalizationsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/localizations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new LocalizationsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public LocalizationsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/localizations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<OrganizationalBrandingLocalizationCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<LocalizationsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<OrganizationalBrandingLocalizationCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<LocalizationsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<OrganizationalBrandingLocalization?> PostAsync(OrganizationalBrandingLocalization body, CancellationToken cancellationToken = default, Action<LocalizationsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<OrganizationalBrandingLocalization> PostAsync(OrganizationalBrandingLocalization body, CancellationToken cancellationToken = default, Action<LocalizationsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
