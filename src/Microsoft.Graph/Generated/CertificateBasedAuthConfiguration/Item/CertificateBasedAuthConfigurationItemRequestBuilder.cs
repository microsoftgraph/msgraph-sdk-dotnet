...
namespace Microsoft.Graph.CertificateBasedAuthConfiguration.Item {
    ...
    public class CertificateBasedAuthConfigurationItemRequestBuilder : BaseRequestBuilder {
        ...
        public CertificateBasedAuthConfigurationItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/certificateBasedAuthConfiguration/{certificateBasedAuthConfiguration%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CertificateBasedAuthConfigurationItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CertificateBasedAuthConfigurationItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/certificateBasedAuthConfiguration/{certificateBasedAuthConfiguration%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<CertificateBasedAuthConfigurationItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<CertificateBasedAuthConfigurationItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.CertificateBasedAuthConfiguration?> GetAsync(CancellationToken cancellationToken = default, Action<CertificateBasedAuthConfigurationItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.CertificateBasedAuthConfiguration> GetAsync(CancellationToken cancellationToken = default, Action<CertificateBasedAuthConfigurationItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.CertificateBasedAuthConfiguration?> PatchAsync(Microsoft.Graph.Models.CertificateBasedAuthConfiguration body, CancellationToken cancellationToken = default, Action<CertificateBasedAuthConfigurationItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.CertificateBasedAuthConfiguration> PatchAsync(Microsoft.Graph.Models.CertificateBasedAuthConfiguration body, CancellationToken cancellationToken = default, Action<CertificateBasedAuthConfigurationItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(Microsoft.Graph.Models.CertificateBasedAuthConfiguration body, Action<CertificateBasedAuthConfigurationItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(Microsoft.Graph.Models.CertificateBasedAuthConfiguration body, Action<CertificateBasedAuthConfigurationItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
