...
namespace Microsoft.Graph.Chats.Item.UnhideForUser {
    ...
    public class UnhideForUserRequestBuilder : BaseRequestBuilder {
        ...
        public UnhideForUserRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/chats/{chat%2Did}/unhideForUser", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new UnhideForUserRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task PostAsync(UnhideForUserPostRequestBody body, CancellationToken cancellationToken = default, Action<UnhideForUserRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(UnhideForUserPostRequestBody body, CancellationToken cancellationToken = default, Action<UnhideForUserRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
