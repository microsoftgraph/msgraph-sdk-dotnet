...
namespace Microsoft.Graph.Chats.Item.HideForUser {
    ...
    public class HideForUserRequestBuilder : BaseRequestBuilder {
        ...
        public HideForUserRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/chats/{chat%2Did}/hideForUser", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new HideForUserRequestBuilder and sets the default values.
        /// </summary>
