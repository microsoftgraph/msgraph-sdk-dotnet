...
namespace Microsoft.Graph.Chats.Item.MarkChatReadForUser {
    ...
    public class MarkChatReadForUserRequestBuilder : BaseRequestBuilder {
        ...
        public MarkChatReadForUserRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/chats/{chat%2Did}/markChatReadForUser", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new MarkChatReadForUserRequestBuilder and sets the default values.
        /// </summary>
