...
namespace Microsoft.Graph.Chats.Item.InstalledApps {
    ...
    public class InstalledAppsRequestBuilder : BaseRequestBuilder {
        ...
        public InstalledAppsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/chats/{chat%2Did}/installedApps{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new InstalledAppsRequestBuilder and sets the default values.
        /// </summary>
