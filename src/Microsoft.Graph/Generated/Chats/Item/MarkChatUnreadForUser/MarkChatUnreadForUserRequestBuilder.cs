...
namespace Microsoft.Graph.Chats.Item.MarkChatUnreadForUser {
    ...
    public class MarkChatUnreadForUserRequestBuilder : BaseRequestBuilder {
        ...
        public MarkChatUnreadForUserRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/chats/{chat%2Did}/markChatUnreadForUser", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new MarkChatUnreadForUserRequestBuilder and sets the default values.
        /// </summary>
