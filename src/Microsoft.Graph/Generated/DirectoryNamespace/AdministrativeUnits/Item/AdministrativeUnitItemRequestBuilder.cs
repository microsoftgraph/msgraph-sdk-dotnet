...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.AdministrativeUnit?> GetAsync(CancellationToken cancellationToken = default, Action<AdministrativeUnitItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.AdministrativeUnit> GetAsync(CancellationToken cancellationToken = default, Action<AdministrativeUnitItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.AdministrativeUnit?> PatchAsync(Microsoft.Graph.Models.AdministrativeUnit body, CancellationToken cancellationToken = default, Action<AdministrativeUnitItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.AdministrativeUnit> PatchAsync(Microsoft.Graph.Models.AdministrativeUnit body, CancellationToken cancellationToken = default, Action<AdministrativeUnitItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
