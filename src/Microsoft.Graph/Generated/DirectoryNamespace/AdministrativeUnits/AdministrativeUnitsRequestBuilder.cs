...
namespace Microsoft.Graph.DirectoryNamespace.AdministrativeUnits {
    ...
    public class AdministrativeUnitsRequestBuilder : BaseRequestBuilder {
        ...
        public AdministrativeUnitItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("administrativeUnit%2Did", position);
...
#nullable enable
        public async Task<AdministrativeUnitCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<AdministrativeUnitsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<AdministrativeUnitCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AdministrativeUnitsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.AdministrativeUnit?> PostAsync(Microsoft.Graph.Models.AdministrativeUnit body, CancellationToken cancellationToken = default, Action<AdministrativeUnitsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.AdministrativeUnit> PostAsync(Microsoft.Graph.Models.AdministrativeUnit body, CancellationToken cancellationToken = default, Action<AdministrativeUnitsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Models.AdministrativeUnit body, Action<AdministrativeUnitsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Models.AdministrativeUnit body, Action<AdministrativeUnitsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
