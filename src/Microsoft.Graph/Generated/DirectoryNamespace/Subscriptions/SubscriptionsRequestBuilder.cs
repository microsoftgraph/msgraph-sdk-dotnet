...
namespace Microsoft.Graph.DirectoryNamespace.Subscriptions {
    ...
    public class SubscriptionsRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// <returns>A <see cref="CompanySubscriptionItemRequestBuilder"/></returns>
        public CompanySubscriptionItemRequestBuilder this[string position]
        {
            get
            {
...
#nullable enable
        public async Task<CompanySubscriptionCollectionResponse?> GetAsync(Action<RequestConfiguration<SubscriptionsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<CompanySubscriptionCollectionResponse> GetAsync(Action<RequestConfiguration<SubscriptionsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<CompanySubscriptionCollectionResponse>(requestInfo, CompanySubscriptionCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<CompanySubscription?> PostAsync(CompanySubscription body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<CompanySubscription> PostAsync(CompanySubscription body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
