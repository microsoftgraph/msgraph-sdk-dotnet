...
namespace Microsoft.Graph.DirectoryNamespace.OnPremisesSynchronization.Item {
    ...
    public class OnPremisesDirectorySynchronizationItemRequestBuilder {
        ...
        public OnPremisesDirectorySynchronizationItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public OnPremisesDirectorySynchronizationItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
