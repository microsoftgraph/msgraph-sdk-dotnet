...
namespace Microsoft.Graph.DirectoryNamespace.DeletedItems.Item.GraphServicePrincipal {
    ...
    public class GraphServicePrincipalRequestBuilder : BaseRequestBuilder {
        ...
        public GraphServicePrincipalRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/directory/deletedItems/{directoryObject%2Did}/graph.servicePrincipal{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GraphServicePrincipalRequestBuilder and sets the default values.
        /// </summary>
