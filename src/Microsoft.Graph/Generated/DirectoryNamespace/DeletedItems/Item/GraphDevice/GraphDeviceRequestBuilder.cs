...
namespace Microsoft.Graph.DirectoryNamespace.DeletedItems.Item.GraphDevice {
    ...
    public class GraphDeviceRequestBuilder : BaseRequestBuilder {
        ...
        public GraphDeviceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/directory/deletedItems/{directoryObject%2Did}/graph.device{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GraphDeviceRequestBuilder and sets the default values.
        /// </summary>
