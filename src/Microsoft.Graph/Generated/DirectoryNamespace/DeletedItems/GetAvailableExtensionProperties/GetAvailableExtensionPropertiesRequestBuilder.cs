...
namespace Microsoft.Graph.DirectoryNamespace.DeletedItems.GetAvailableExtensionProperties {
    ...
    public class GetAvailableExtensionPropertiesRequestBuilder : BaseRequestBuilder {
        ...
        /// </summary>
        /// <returns>A <cref="GetAvailableExtensionPropertiesPostResponse"></returns>
...
#nullable restore
        ...
        /// Find more info here <see href="https://learn.microsoft.com/graph/api/directoryobject-getavailableextensionproperties?view=graph-rest-1.0" />
        /// </summary>
        /// <returns>A <cref="GetAvailableExtensionPropertiesResponse"></returns>
        /// <param name="body">The request body</param>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="ODataError">When receiving a 4XX or 5XX status code</exception>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <cref="GetAvailableExtensionPropertiesRequestBuilder"></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
