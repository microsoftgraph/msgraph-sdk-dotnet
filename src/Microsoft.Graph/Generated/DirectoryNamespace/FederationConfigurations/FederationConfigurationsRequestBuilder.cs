using Microsoft.Graph.DirectoryNamespace.FederationConfigurations.AvailableProviderTypes;
using Microsoft.Graph.DirectoryNamespace.FederationConfigurations.Count;
using Microsoft.Graph.DirectoryNamespace.FederationConfigurations.Item;
...
namespace Microsoft.Graph.DirectoryNamespace.FederationConfigurations {
    ...
    public class FederationConfigurationsRequestBuilder : BaseRequestBuilder {
        ...
        public FederationConfigurationsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/directory/federationConfigurations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new FederationConfigurationsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public FederationConfigurationsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/directory/federationConfigurations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<FederationConfigurationsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<FederationConfigurationsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(IdentityProviderBase body, Action<FederationConfigurationsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(IdentityProviderBase body, Action<FederationConfigurationsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#nullable restore
        ...
        public class FederationConfigurationsRequestBuilderGetRequestConfiguration {
            ...
            public FederationConfigurationsRequestBuilderGetQueryParameters QueryParameters { get; set; } = new FederationConfigurationsRequestBuilderGetQueryParameters();
            /// <summary>
