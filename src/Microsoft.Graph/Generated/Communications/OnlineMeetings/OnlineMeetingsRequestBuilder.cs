using Microsoft.Graph.Communications.OnlineMeetings.Count;
using Microsoft.Graph.Communications.OnlineMeetings.CreateOrGet;
using Microsoft.Graph.Communications.OnlineMeetings.Item;
...
namespace Microsoft.Graph.Communications.OnlineMeetings {
    ...
    public class OnlineMeetingsRequestBuilder : BaseRequestBuilder {
        ...
        public OnlineMeetingsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/communications/onlineMeetings{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new OnlineMeetingsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public OnlineMeetingsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/communications/onlineMeetings{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
