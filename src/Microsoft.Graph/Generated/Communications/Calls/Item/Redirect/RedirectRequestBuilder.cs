...
#nullable enable
        public async Task PostAsync(RedirectPostRequestBody body, CancellationToken cancellationToken = default, Action<RedirectRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(RedirectPostRequestBody body, CancellationToken cancellationToken = default, Action<RedirectRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
