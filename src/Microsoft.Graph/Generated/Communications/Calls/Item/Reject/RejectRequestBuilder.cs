...
#nullable enable
        public async Task PostAsync(RejectPostRequestBody body, CancellationToken cancellationToken = default, Action<RejectRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(RejectPostRequestBody body, CancellationToken cancellationToken = default, Action<RejectRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
