...
#nullable enable
        public async Task<PlayPromptOperation?> PostAsync(PlayPromptPostRequestBody body, CancellationToken cancellationToken = default, Action<PlayPromptRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PlayPromptOperation> PostAsync(PlayPromptPostRequestBody body, CancellationToken cancellationToken = default, Action<PlayPromptRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
