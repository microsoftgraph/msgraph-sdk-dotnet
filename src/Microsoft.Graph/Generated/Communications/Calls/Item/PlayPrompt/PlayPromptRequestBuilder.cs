...
namespace Microsoft.Graph.Communications.Calls.Item.PlayPrompt {
    ...
    public class PlayPromptRequestBuilder : BaseRequestBuilder {
        ...
        /// </summary>
        /// <returns>A <cref="PlayPromptOperation"></returns>
...
#nullable enable
        public async Task<PlayPromptOperation?> PostAsync(PlayPromptPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<PlayPromptOperation> PostAsync(PlayPromptPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <cref="PlayPromptRequestBuilder"></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public PlayPromptRequestBuilder WithUrl(string rawUrl) {
