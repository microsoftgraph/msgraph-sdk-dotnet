using Microsoft.Graph.Communications.Calls.Item.ContentSharingSessions.Count;
using Microsoft.Graph.Communications.Calls.Item.ContentSharingSessions.Item;
...
namespace Microsoft.Graph.Communications.Calls.Item.ContentSharingSessions {
    ...
    /// </summary>
    public class ContentSharingSessionsRequestBuilder : BaseRequestBuilder {
        ...
        public ContentSharingSessionItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("contentSharingSession%2Did", position);
        ...
        public ContentSharingSessionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/communications/calls/{call%2Did}/contentSharingSessions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ContentSharingSessionsRequestBuilder and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        public async Task<ContentSharingSessionCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ContentSharingSessionsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
            ...
            return await RequestAdapter.SendAsync<ContentSharingSessionCollectionResponse>(requestInfo, ContentSharingSessionCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<ContentSharingSessionsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<ContentSharingSessionsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new ContentSharingSessionsRequestBuilderGetRequestConfiguration();
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(ContentSharingSession body, Action<ContentSharingSessionsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ContentSharingSession body, Action<ContentSharingSessionsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new ContentSharingSessionsRequestBuilderPostRequestConfiguration();
                requestConfiguration.Invoke(requestConfig);
                requestInfo.AddRequestOptions(requestConfig.Options);
                requestInfo.AddHeaders(requestConfig.Headers);
            }
...
#nullable restore
        ...
        public class ContentSharingSessionsRequestBuilderGetRequestConfiguration {
            ...
            public ContentSharingSessionsRequestBuilderGetQueryParameters QueryParameters { get; set; } = new ContentSharingSessionsRequestBuilderGetQueryParameters();
            /// <summary>
