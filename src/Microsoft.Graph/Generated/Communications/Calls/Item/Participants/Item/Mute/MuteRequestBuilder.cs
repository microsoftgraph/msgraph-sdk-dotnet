...
namespace Microsoft.Graph.Communications.Calls.Item.Participants.Item.Mute {
    ...
    public class MuteRequestBuilder : BaseRequestBuilder {
        ...
        public MuteRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/communications/calls/{call%2Did}/participants/{participant%2Did}/mute", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new MuteRequestBuilder and sets the default values.
        /// </summary>
