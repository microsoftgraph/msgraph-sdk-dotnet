...
#nullable enable
        public async Task<StartHoldMusicOperation?> PostAsync(StartHoldMusicPostRequestBody body, CancellationToken cancellationToken = default, Action<StartHoldMusicRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<StartHoldMusicOperation> PostAsync(StartHoldMusicPostRequestBody body, CancellationToken cancellationToken = default, Action<StartHoldMusicRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
