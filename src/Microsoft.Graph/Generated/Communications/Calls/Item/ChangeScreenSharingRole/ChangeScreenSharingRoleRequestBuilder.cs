...
namespace Microsoft.Graph.Communications.Calls.Item.ChangeScreenSharingRole {
    ...
    /// </summary>
    public class ChangeScreenSharingRoleRequestBuilder : BaseRequestBuilder {
        /// <summary>
        /// Instantiates a new ChangeScreenSharingRoleRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ChangeScreenSharingRoleRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/communications/calls/{call%2Did}/changeScreenSharingRole", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ChangeScreenSharingRoleRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task PostAsync(ChangeScreenSharingRolePostRequestBody body, CancellationToken cancellationToken = default, Action<ChangeScreenSharingRoleRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(ChangeScreenSharingRolePostRequestBody body, CancellationToken cancellationToken = default, Action<ChangeScreenSharingRoleRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(ChangeScreenSharingRolePostRequestBody body, Action<ChangeScreenSharingRoleRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ChangeScreenSharingRolePostRequestBody body, Action<ChangeScreenSharingRoleRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
