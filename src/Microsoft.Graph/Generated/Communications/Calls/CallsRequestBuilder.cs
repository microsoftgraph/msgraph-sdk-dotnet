...
namespace Microsoft.Graph.Communications.Calls {
    ...
    public class CallsRequestBuilder : BaseRequestBuilder {
        ...
        public CallsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/communications/calls{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CallsRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<CallCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<CallsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<CallCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<CallsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Call?> PostAsync(Call body, CancellationToken cancellationToken = default, Action<CallsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Call> PostAsync(Call body, CancellationToken cancellationToken = default, Action<CallsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<CallsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<CallsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new CallsRequestBuilderGetRequestConfiguration();
...
#nullable restore
        ...
        public RequestInformation ToPostRequestInformation(Call body, Action<CallsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new CallsRequestBuilderPostRequestConfiguration();
                requestConfiguration.Invoke(requestConfig);
                requestInfo.AddRequestOptions(requestConfig.Options);
                requestInfo.AddHeaders(requestConfig.Headers);
            }
...
#nullable restore
        ...
        /// </summary>
        public class CallsRequestBuilderGetRequestConfiguration {
            /// <summary>Request headers</summary>
            public RequestHeaders Headers { get; set; }
            /// <summary>Request options</summary>
            public IList<IRequestOption> Options { get; set; }
            /// <summary>Request query parameters</summary>
            public CallsRequestBuilderGetQueryParameters QueryParameters { get; set; } = new CallsRequestBuilderGetQueryParameters();
            /// <summary>
            /// Instantiates a new callsRequestBuilderGetRequestConfiguration and sets the default values.
            /// </summary>
            public CallsRequestBuilderGetRequestConfiguration() {
        ...
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
        public class CallsRequestBuilderPostRequestConfiguration {
            /// <summary>Request headers</summary>
            public RequestHeaders Headers { get; set; }
            /// <summary>Request options</summary>
            public IList<IRequestOption> Options { get; set; }
            /// <summary>
            /// Instantiates a new callsRequestBuilderPostRequestConfiguration and sets the default values.
            /// </summary>
            public CallsRequestBuilderPostRequestConfiguration() {
                Options = new List<IRequestOption>();
                Headers = new RequestHeaders();
            }
        }
