...
#nullable enable
        public async Task PostAsync(LogTeleconferenceDeviceQualityPostRequestBody body, CancellationToken cancellationToken = default, Action<LogTeleconferenceDeviceQualityRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(LogTeleconferenceDeviceQualityPostRequestBody body, CancellationToken cancellationToken = default, Action<LogTeleconferenceDeviceQualityRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
