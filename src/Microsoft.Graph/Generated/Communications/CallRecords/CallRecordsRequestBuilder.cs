...
#nullable enable
        public async Task<CallRecordCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<CallRecordsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<CallRecordCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<CallRecordsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<CallRecord?> PostAsync(CallRecord body, CancellationToken cancellationToken = default, Action<CallRecordsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<CallRecord> PostAsync(CallRecord body, CancellationToken cancellationToken = default, Action<CallRecordsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
