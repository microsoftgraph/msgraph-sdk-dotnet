...
namespace Microsoft.Graph.Communications.Presences.Item.SetUserPreferredPresence {
    ...
    /// </summary>
    public class SetUserPreferredPresenceRequestBuilder : BaseRequestBuilder {
        /// <summary>
        /// Instantiates a new SetUserPreferredPresenceRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SetUserPreferredPresenceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/communications/presences/{presence%2Did}/setUserPreferredPresence", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SetUserPreferredPresenceRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SetUserPreferredPresenceRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/communications/presences/{presence%2Did}/setUserPreferredPresence", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task PostAsync(SetUserPreferredPresencePostRequestBody body, CancellationToken cancellationToken = default, Action<SetUserPreferredPresenceRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(SetUserPreferredPresencePostRequestBody body, CancellationToken cancellationToken = default, Action<SetUserPreferredPresenceRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
