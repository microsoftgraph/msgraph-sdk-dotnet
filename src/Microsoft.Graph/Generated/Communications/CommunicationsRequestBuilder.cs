...
#nullable enable
        public async Task<CloudCommunications?> GetAsync(CancellationToken cancellationToken = default, Action<CommunicationsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<CloudCommunications> GetAsync(CancellationToken cancellationToken = default, Action<CommunicationsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<CloudCommunications?> PatchAsync(CloudCommunications body, CancellationToken cancellationToken = default, Action<CommunicationsRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<CloudCommunications> PatchAsync(CloudCommunications body, CancellationToken cancellationToken = default, Action<CommunicationsRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
