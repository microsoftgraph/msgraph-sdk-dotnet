...
namespace Microsoft.Graph.Search.Query
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Microsoft.Graph.Search.Query.QueryRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        public async Task<global::Microsoft.Graph.Search.Query.QueryResponse> PostAsync(global::Microsoft.Graph.Search.Query.QueryPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Microsoft.Graph.Search.Query.QueryResponse>(requestInfo, global::Microsoft.Graph.Search.Query.QueryResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Runs the query specified in the request body. Search results are provided in the response.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Microsoft.Graph.Search.Query.QueryPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Microsoft.Graph.Search.Query.QueryPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.Search.Query.QueryRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Microsoft.Graph.Search.Query.QueryRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Microsoft.Graph.Search.Query.QueryRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
