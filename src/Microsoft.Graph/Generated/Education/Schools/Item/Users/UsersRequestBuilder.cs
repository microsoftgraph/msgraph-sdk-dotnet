using Microsoft.Graph.Education.Schools.Item.Users.Count;
using Microsoft.Graph.Education.Schools.Item.Users.Item;
using Microsoft.Graph.Education.Schools.Item.Users.Ref;
...
namespace Microsoft.Graph.Education.Schools.Item.Users {
    ...
    public class UsersRequestBuilder : BaseRequestBuilder {
        ...
        public UsersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/education/schools/{educationSchool%2Did}/users{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new UsersRequestBuilder and sets the default values.
        /// </summary>
