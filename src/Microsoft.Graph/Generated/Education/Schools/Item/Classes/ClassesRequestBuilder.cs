using Microsoft.Graph.Education.Schools.Item.Classes.Count;
using Microsoft.Graph.Education.Schools.Item.Classes.Item;
using Microsoft.Graph.Education.Schools.Item.Classes.Ref;
...
namespace Microsoft.Graph.Education.Schools.Item.Classes {
    ...
    public class ClassesRequestBuilder : BaseRequestBuilder {
        ...
        public ClassesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/education/schools/{educationSchool%2Did}/classes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ClassesRequestBuilder and sets the default values.
        /// </summary>
