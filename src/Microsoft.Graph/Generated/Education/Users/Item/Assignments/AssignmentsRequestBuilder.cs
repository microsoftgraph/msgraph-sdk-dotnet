using Microsoft.Graph.Education.Users.Item.Assignments.Count;
using Microsoft.Graph.Education.Users.Item.Assignments.Delta;
using Microsoft.Graph.Education.Users.Item.Assignments.Item;
...
namespace Microsoft.Graph.Education.Users.Item.Assignments {
    ...
    public class AssignmentsRequestBuilder : BaseRequestBuilder {
        ...
        public EducationAssignmentItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("educationAssignment%2Did", position);
        ...
        public AssignmentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/education/users/{educationUser%2Did}/assignments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AssignmentsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AssignmentsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/education/users/{educationUser%2Did}/assignments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<EducationAssignmentCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<AssignmentsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<EducationAssignmentCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AssignmentsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<EducationAssignment?> PostAsync(EducationAssignment body, CancellationToken cancellationToken = default, Action<AssignmentsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<EducationAssignment> PostAsync(EducationAssignment body, CancellationToken cancellationToken = default, Action<AssignmentsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
