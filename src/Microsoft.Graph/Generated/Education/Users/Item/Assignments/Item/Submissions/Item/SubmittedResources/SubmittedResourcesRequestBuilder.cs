using Microsoft.Graph.Education.Users.Item.Assignments.Item.Submissions.Item.SubmittedResources.Count;
using Microsoft.Graph.Education.Users.Item.Assignments.Item.Submissions.Item.SubmittedResources.Item;
...
namespace Microsoft.Graph.Education.Users.Item.Assignments.Item.Submissions.Item.SubmittedResources {
    ...
    /// </summary>
    public class SubmittedResourcesRequestBuilder : BaseRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SubmittedResourcesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/education/users/{educationUser%2Did}/assignments/{educationAssignment%2Did}/submissions/{educationSubmission%2Did}/submittedResources{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<EducationSubmissionResourceCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<SubmittedResourcesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<EducationSubmissionResourceCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<SubmittedResourcesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<EducationSubmissionResource?> PostAsync(EducationSubmissionResource body, CancellationToken cancellationToken = default, Action<SubmittedResourcesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<EducationSubmissionResource> PostAsync(EducationSubmissionResource body, CancellationToken cancellationToken = default, Action<SubmittedResourcesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
