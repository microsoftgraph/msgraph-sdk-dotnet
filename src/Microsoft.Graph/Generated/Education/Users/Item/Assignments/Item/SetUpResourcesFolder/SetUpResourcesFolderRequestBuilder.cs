...
#nullable enable
        public async Task<EducationAssignment?> PostAsync(CancellationToken cancellationToken = default, Action<SetUpResourcesFolderRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<EducationAssignment> PostAsync(CancellationToken cancellationToken = default, Action<SetUpResourcesFolderRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
