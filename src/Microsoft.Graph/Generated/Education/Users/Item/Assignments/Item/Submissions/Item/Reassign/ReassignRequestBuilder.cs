...
namespace Microsoft.Graph.Education.Users.Item.Assignments.Item.Submissions.Item.Reassign {
    ...
    public class ReassignRequestBuilder : BaseRequestBuilder {
        ...
        public ReassignRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/education/users/{educationUser%2Did}/assignments/{educationAssignment%2Did}/submissions/{educationSubmission%2Did}/reassign", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ReassignRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ReassignRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/education/users/{educationUser%2Did}/assignments/{educationAssignment%2Did}/submissions/{educationSubmission%2Did}/reassign", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<EducationSubmission?> PostAsync(CancellationToken cancellationToken = default, Action<ReassignRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<EducationSubmission> PostAsync(CancellationToken cancellationToken = default, Action<ReassignRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
