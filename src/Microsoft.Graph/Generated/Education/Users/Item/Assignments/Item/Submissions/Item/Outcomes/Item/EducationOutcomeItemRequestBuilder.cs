...
namespace Microsoft.Graph.Education.Users.Item.Assignments.Item.Submissions.Item.Outcomes.Item {
    ...
    public class EducationOutcomeItemRequestBuilder : BaseRequestBuilder {
        ...
        public EducationOutcomeItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/education/users/{educationUser%2Did}/assignments/{educationAssignment%2Did}/submissions/{educationSubmission%2Did}/outcomes/{educationOutcome%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new EducationOutcomeItemRequestBuilder and sets the default values.
        /// </summary>
