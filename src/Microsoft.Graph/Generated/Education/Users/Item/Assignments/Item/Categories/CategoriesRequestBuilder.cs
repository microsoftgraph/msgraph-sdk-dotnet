...
using Microsoft.Graph.Education.Users.Item.Assignments.Item.Categories.Delta;
using Microsoft.Graph.Education.Users.Item.Assignments.Item.Categories.Item;
using Microsoft.Graph.Education.Users.Item.Assignments.Item.Categories.Ref;
...
namespace Microsoft.Graph.Education.Users.Item.Assignments.Item.Categories {
    ...
    public class CategoriesRequestBuilder : BaseRequestBuilder {
        ...
        public CategoriesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/education/users/{educationUser%2Did}/assignments/{educationAssignment%2Did}/categories{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CategoriesRequestBuilder and sets the default values.
        /// </summary>
