...
namespace Microsoft.Graph.Education.Users.Item.TaughtClasses.Item {
    ...
    public class EducationClassItemRequestBuilder : BaseRequestBuilder {
        ...
        public EducationClassItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/education/users/{educationUser%2Did}/taughtClasses/{educationClass%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new EducationClassItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EducationClassItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/education/users/{educationUser%2Did}/taughtClasses/{educationClass%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<EducationClass?> GetAsync(CancellationToken cancellationToken = default, Action<EducationClassItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<EducationClass> GetAsync(CancellationToken cancellationToken = default, Action<EducationClassItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
