...
#nullable enable
        public async Task<Microsoft.Graph.Models.User?> GetAsync(CancellationToken cancellationToken = default, Action<UserRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.User> GetAsync(CancellationToken cancellationToken = default, Action<UserRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
