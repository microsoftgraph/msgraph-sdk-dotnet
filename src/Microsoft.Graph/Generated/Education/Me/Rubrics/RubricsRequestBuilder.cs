...
namespace Microsoft.Graph.Education.Me.Rubrics {
    ...
    public class RubricsRequestBuilder : BaseRequestBuilder {
        ...
        public RubricsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/education/me/rubrics{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RubricsRequestBuilder and sets the default values.
        /// </summary>
