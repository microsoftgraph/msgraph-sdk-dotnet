...
namespace Microsoft.Graph.Education.Me.Assignments.Item.Resources.Item {
    ...
    public class EducationAssignmentResourceItemRequestBuilder : BaseRequestBuilder {
        ...
        public EducationAssignmentResourceItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/education/me/assignments/{educationAssignment%2Did}/resources/{educationAssignmentResource%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new EducationAssignmentResourceItemRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<EducationAssignmentResourceItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<EducationAssignmentResourceItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<EducationAssignmentResource?> GetAsync(CancellationToken cancellationToken = default, Action<EducationAssignmentResourceItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<EducationAssignmentResource> GetAsync(CancellationToken cancellationToken = default, Action<EducationAssignmentResourceItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<EducationAssignmentResource?> PatchAsync(EducationAssignmentResource body, CancellationToken cancellationToken = default, Action<EducationAssignmentResourceItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<EducationAssignmentResource> PatchAsync(EducationAssignmentResource body, CancellationToken cancellationToken = default, Action<EducationAssignmentResourceItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
