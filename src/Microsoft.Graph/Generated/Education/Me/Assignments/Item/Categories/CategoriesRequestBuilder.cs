using Microsoft.Graph.Education.Me.Assignments.Item.Categories.Count;
using Microsoft.Graph.Education.Me.Assignments.Item.Categories.Delta;
using Microsoft.Graph.Education.Me.Assignments.Item.Categories.Item;
using Microsoft.Graph.Education.Me.Assignments.Item.Categories.Ref;
...
namespace Microsoft.Graph.Education.Me.Assignments.Item.Categories {
    ...
    public class CategoriesRequestBuilder : BaseRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.education.me.assignments.item.categories.item collection</summary>
        ...
        public CategoriesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/education/me/assignments/{educationAssignment%2Did}/categories{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CategoriesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CategoriesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/education/me/assignments/{educationAssignment%2Did}/categories{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
