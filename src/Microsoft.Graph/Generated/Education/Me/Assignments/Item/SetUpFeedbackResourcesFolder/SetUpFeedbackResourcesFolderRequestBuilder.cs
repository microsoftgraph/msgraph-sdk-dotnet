...
namespace Microsoft.Graph.Education.Me.Assignments.Item.SetUpFeedbackResourcesFolder {
    ...
    public class SetUpFeedbackResourcesFolderRequestBuilder : BaseRequestBuilder {
        ...
        public SetUpFeedbackResourcesFolderRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/education/me/assignments/{educationAssignment%2Did}/setUpFeedbackResourcesFolder", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SetUpFeedbackResourcesFolderRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SetUpFeedbackResourcesFolderRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/education/me/assignments/{educationAssignment%2Did}/setUpFeedbackResourcesFolder", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<EducationAssignment?> PostAsync(CancellationToken cancellationToken = default, Action<SetUpFeedbackResourcesFolderRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<EducationAssignment> PostAsync(CancellationToken cancellationToken = default, Action<SetUpFeedbackResourcesFolderRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
