...
namespace Microsoft.Graph.Education.Me.TaughtClasses.Item {
    ...
    public class EducationClassItemRequestBuilder : BaseRequestBuilder {
        ...
        public EducationClassItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/education/me/taughtClasses/{educationClass%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new EducationClassItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EducationClassItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/education/me/taughtClasses/{educationClass%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
