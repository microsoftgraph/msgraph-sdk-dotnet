...
namespace Microsoft.Graph.Education.Me.Schools.Item {
    ...
    public class EducationSchoolItemRequestBuilder : BaseRequestBuilder {
        ...
        public EducationSchoolItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/education/me/schools/{educationSchool%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new EducationSchoolItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EducationSchoolItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/education/me/schools/{educationSchool%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
