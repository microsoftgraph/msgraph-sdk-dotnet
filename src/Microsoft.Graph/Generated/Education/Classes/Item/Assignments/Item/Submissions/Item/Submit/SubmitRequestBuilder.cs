...
namespace Microsoft.Graph.Education.Classes.Item.Assignments.Item.Submissions.Item.Submit {
    ...
    public class SubmitRequestBuilder : BaseRequestBuilder {
        ...
        public SubmitRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/education/classes/{educationClass%2Did}/assignments/{educationAssignment%2Did}/submissions/{educationSubmission%2Did}/submit", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SubmitRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SubmitRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/education/classes/{educationClass%2Did}/assignments/{educationAssignment%2Did}/submissions/{educationSubmission%2Did}/submit", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<EducationSubmission?> PostAsync(CancellationToken cancellationToken = default, Action<SubmitRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<EducationSubmission> PostAsync(CancellationToken cancellationToken = default, Action<SubmitRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
