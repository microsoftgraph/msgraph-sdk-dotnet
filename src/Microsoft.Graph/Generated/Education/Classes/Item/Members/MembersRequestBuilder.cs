using Microsoft.Graph.Education.Classes.Item.Members.Count;
using Microsoft.Graph.Education.Classes.Item.Members.Item;
using Microsoft.Graph.Education.Classes.Item.Members.Ref;
...
namespace Microsoft.Graph.Education.Classes.Item.Members {
    ...
    public class MembersRequestBuilder : BaseRequestBuilder {
        ...
        public MembersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/education/classes/{educationClass%2Did}/members{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new MembersRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<EducationUserCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<MembersRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<EducationUserCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<MembersRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
