using Microsoft.Graph.Education.Classes.Item.Schools.Count;
using Microsoft.Graph.Education.Classes.Item.Schools.Item;
...
namespace Microsoft.Graph.Education.Classes.Item.Schools {
    ...
    public class SchoolsRequestBuilder : BaseRequestBuilder {
        ...
        public SchoolsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/education/classes/{educationClass%2Did}/schools{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SchoolsRequestBuilder and sets the default values.
        /// </summary>
