...
namespace Microsoft.Graph.Education.Classes.Item.Modules {
    ...
    public class ModulesRequestBuilder : BaseRequestBuilder 
    {
        ...
        public EducationModuleItemRequestBuilder this[string position]
        {
            get
            {
...
#nullable enable
        public async Task<EducationModuleCollectionResponse?> GetAsync(Action<RequestConfiguration<ModulesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<EducationModuleCollectionResponse> GetAsync(Action<RequestConfiguration<ModulesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<EducationModule?> PostAsync(EducationModule body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<EducationModule> PostAsync(EducationModule body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ModulesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
...
#nullable restore
        ...
        public class ModulesRequestBuilderGetRequestConfiguration : RequestConfiguration<ModulesRequestBuilderGetQueryParameters> 
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
