...
namespace Microsoft.Graph.Education.Classes.Item.Modules.Item.Resources {
    ...
    public class ResourcesRequestBuilder : BaseRequestBuilder 
    {
        ...
        public EducationModuleResourceItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("educationModuleResource%2Did", position);
                return new EducationModuleResourceItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
...
#nullable enable
        public async Task<EducationModuleResourceCollectionResponse?> GetAsync(Action<RequestConfiguration<ResourcesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<EducationModuleResourceCollectionResponse> GetAsync(Action<RequestConfiguration<ResourcesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<EducationModuleResource?> PostAsync(EducationModuleResource body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<EducationModuleResource> PostAsync(EducationModuleResource body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
