...
#nullable enable
        public async Task<SubscribedSkuCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<SubscribedSkusRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<SubscribedSkuCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<SubscribedSkusRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<SubscribedSku?> PostAsync(SubscribedSku body, CancellationToken cancellationToken = default, Action<SubscribedSkusRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<SubscribedSku> PostAsync(SubscribedSku body, CancellationToken cancellationToken = default, Action<SubscribedSkusRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
