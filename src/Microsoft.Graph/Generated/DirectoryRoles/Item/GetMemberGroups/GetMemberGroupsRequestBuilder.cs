...
namespace Microsoft.Graph.DirectoryRoles.Item.GetMemberGroups {
    ...
    public class GetMemberGroupsRequestBuilder : BaseRequestBuilder {
        ...
        public GetMemberGroupsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/directoryRoles/{directoryRole%2Did}/getMemberGroups", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GetMemberGroupsRequestBuilder and sets the default values.
        /// </summary>
