...
namespace Microsoft.Graph.DirectoryRoles.Item.Members.Item.GraphServicePrincipal {
    ...
    public class GraphServicePrincipalRequestBuilder : BaseRequestBuilder {
        ...
        public GraphServicePrincipalRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/directoryRoles/{directoryRole%2Did}/members/{directoryObject%2Did}/graph.servicePrincipal{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GraphServicePrincipalRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GraphServicePrincipalRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/directoryRoles/{directoryRole%2Did}/members/{directoryObject%2Did}/graph.servicePrincipal{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
