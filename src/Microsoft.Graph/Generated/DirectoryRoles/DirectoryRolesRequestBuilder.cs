using Microsoft.Graph.DirectoryRoles.Count;
using Microsoft.Graph.DirectoryRoles.Delta;
using Microsoft.Graph.DirectoryRoles.GetAvailableExtensionProperties;
using Microsoft.Graph.DirectoryRoles.GetByIds;
using Microsoft.Graph.DirectoryRoles.Item;
using Microsoft.Graph.DirectoryRoles.ValidateProperties;
...
namespace Microsoft.Graph.DirectoryRoles {
    ...
    public class DirectoryRolesRequestBuilder : BaseRequestBuilder {
        ...
        public DirectoryRoleItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("directoryRole%2Did", position);
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/directoryrole-list?view=graph-rest-1.0" />
        /// </summary>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DirectoryRoleCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<DirectoryRolesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DirectoryRoleCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<DirectoryRolesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/directoryrole-post-directoryroles?view=graph-rest-1.0" />
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DirectoryRole?> PostAsync(DirectoryRole body, CancellationToken cancellationToken = default, Action<DirectoryRolesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DirectoryRole> PostAsync(DirectoryRole body, CancellationToken cancellationToken = default, Action<DirectoryRolesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
