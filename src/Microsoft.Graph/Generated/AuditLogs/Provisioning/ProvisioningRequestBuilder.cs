...
namespace Microsoft.Graph.AuditLogs.Provisioning {
    ...
    /// </summary>
    public class ProvisioningRequestBuilder : BaseRequestBuilder {
        ...
        public ProvisioningObjectSummaryItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("provisioningObjectSummary%2Did", position);
        ...
        public ProvisioningRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/auditLogs/provisioning{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ProvisioningRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<ProvisioningObjectSummaryCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ProvisioningRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ProvisioningObjectSummaryCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ProvisioningRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ProvisioningObjectSummary?> PostAsync(ProvisioningObjectSummary body, CancellationToken cancellationToken = default, Action<ProvisioningRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ProvisioningObjectSummary> PostAsync(ProvisioningObjectSummary body, CancellationToken cancellationToken = default, Action<ProvisioningRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<ProvisioningRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<ProvisioningRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new ProvisioningRequestBuilderGetRequestConfiguration();
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(ProvisioningObjectSummary body, Action<ProvisioningRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ProvisioningObjectSummary body, Action<ProvisioningRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new ProvisioningRequestBuilderPostRequestConfiguration();
                requestConfiguration.Invoke(requestConfig);
                requestInfo.AddRequestOptions(requestConfig.Options);
                requestInfo.AddHeaders(requestConfig.Headers);
            }
...
#nullable restore
        ...
        public class ProvisioningRequestBuilderGetRequestConfiguration {
            ...
            public ProvisioningRequestBuilderGetQueryParameters QueryParameters { get; set; } = new ProvisioningRequestBuilderGetQueryParameters();
            /// <summary>
