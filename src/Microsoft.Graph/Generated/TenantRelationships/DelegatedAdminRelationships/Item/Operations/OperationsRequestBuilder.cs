...
using Microsoft.Graph.TenantRelationships.DelegatedAdminRelationships.Item.Operations.Count;
using Microsoft.Graph.TenantRelationships.DelegatedAdminRelationships.Item.Operations.Item;
...
namespace Microsoft.Graph.TenantRelationships.DelegatedAdminRelationships.Item.Operations {
    ...
    public class OperationsRequestBuilder : BaseRequestBuilder {
        ...
        public DelegatedAdminRelationshipOperationItemRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("delegatedAdminRelationshipOperation%2Did", position);
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public OperationsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/tenantRelationships/delegatedAdminRelationships/{delegatedAdminRelationship%2Did}/operations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<DelegatedAdminRelationshipOperationCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<OperationsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DelegatedAdminRelationshipOperationCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<OperationsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<DelegatedAdminRelationshipOperationCollectionResponse>(requestInfo, DelegatedAdminRelationshipOperationCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DelegatedAdminRelationshipOperation?> PostAsync(DelegatedAdminRelationshipOperation body, CancellationToken cancellationToken = default, Action<OperationsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DelegatedAdminRelationshipOperation> PostAsync(DelegatedAdminRelationshipOperation body, CancellationToken cancellationToken = default, Action<OperationsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(DelegatedAdminRelationshipOperation body, Action<OperationsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(DelegatedAdminRelationshipOperation body, Action<OperationsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
