...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DelegatedAdminAccessAssignmentItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DelegatedAdminAccessAssignmentItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/delegatedadminaccessassignment-get?view=graph-rest-1.0" />
        /// </summary>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DelegatedAdminAccessAssignment?> GetAsync(CancellationToken cancellationToken = default, Action<DelegatedAdminAccessAssignmentItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DelegatedAdminAccessAssignment> GetAsync(CancellationToken cancellationToken = default, Action<DelegatedAdminAccessAssignmentItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/delegatedadminaccessassignment-update?view=graph-rest-1.0" />
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DelegatedAdminAccessAssignment?> PatchAsync(DelegatedAdminAccessAssignment body, CancellationToken cancellationToken = default, Action<DelegatedAdminAccessAssignmentItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DelegatedAdminAccessAssignment> PatchAsync(DelegatedAdminAccessAssignment body, CancellationToken cancellationToken = default, Action<DelegatedAdminAccessAssignmentItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
