...
#nullable enable
        public async Task<DelegatedAdminAccessAssignmentCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<AccessAssignmentsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DelegatedAdminAccessAssignmentCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AccessAssignmentsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DelegatedAdminAccessAssignment?> PostAsync(DelegatedAdminAccessAssignment body, CancellationToken cancellationToken = default, Action<AccessAssignmentsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DelegatedAdminAccessAssignment> PostAsync(DelegatedAdminAccessAssignment body, CancellationToken cancellationToken = default, Action<AccessAssignmentsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
