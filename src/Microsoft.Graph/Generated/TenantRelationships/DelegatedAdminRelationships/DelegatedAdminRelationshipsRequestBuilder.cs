...
#nullable enable
        public async Task<DelegatedAdminRelationshipCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<DelegatedAdminRelationshipsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DelegatedAdminRelationshipCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<DelegatedAdminRelationshipsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DelegatedAdminRelationship?> PostAsync(DelegatedAdminRelationship body, CancellationToken cancellationToken = default, Action<DelegatedAdminRelationshipsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DelegatedAdminRelationship> PostAsync(DelegatedAdminRelationship body, CancellationToken cancellationToken = default, Action<DelegatedAdminRelationshipsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
