using Microsoft.Graph.ApplicationTemplates.Count;
using Microsoft.Graph.ApplicationTemplates.Item;
...
namespace Microsoft.Graph.ApplicationTemplates {
    ...
    /// </summary>
    public class ApplicationTemplatesRequestBuilder : BaseRequestBuilder {
        ...
        public ApplicationTemplatesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/applicationTemplates{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ApplicationTemplatesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/applicationtemplate-list?view=graph-rest-1.0" />
        /// </summary>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ApplicationTemplateCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<ApplicationTemplatesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ApplicationTemplateCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ApplicationTemplatesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<ApplicationTemplatesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<ApplicationTemplatesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#nullable restore
        ...
        /// </summary>
        public class ApplicationTemplatesRequestBuilderGetRequestConfiguration {
            /// <summary>Request headers</summary>
            public RequestHeaders Headers { get; set; }
            /// <summary>Request options</summary>
            public IList<IRequestOption> Options { get; set; }
            /// <summary>Request query parameters</summary>
            public ApplicationTemplatesRequestBuilderGetQueryParameters QueryParameters { get; set; } = new ApplicationTemplatesRequestBuilderGetQueryParameters();
            /// <summary>
