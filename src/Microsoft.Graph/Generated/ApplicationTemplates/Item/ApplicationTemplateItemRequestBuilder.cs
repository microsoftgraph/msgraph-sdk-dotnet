...
namespace Microsoft.Graph.ApplicationTemplates.Item {
    ...
    public class ApplicationTemplateItemRequestBuilder : BaseRequestBuilder {
        ...
        public ApplicationTemplateItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/applicationTemplates/{applicationTemplate%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ApplicationTemplateItemRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<ApplicationTemplate?> GetAsync(CancellationToken cancellationToken = default, Action<ApplicationTemplateItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ApplicationTemplate> GetAsync(CancellationToken cancellationToken = default, Action<ApplicationTemplateItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
