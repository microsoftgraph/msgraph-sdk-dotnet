...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public GetOneDriveActivityUserDetailWithPeriodRequestBuilder WithUrl(string rawUrl) {
            return new GetOneDriveActivityUserDetailWithPeriodRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
