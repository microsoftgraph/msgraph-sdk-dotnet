...
namespace Microsoft.Graph.Reports.GetSkypeForBusinessPeerToPeerActivityMinuteCountsWithPeriod {
    ...
    /// </summary>
    public class GetSkypeForBusinessPeerToPeerActivityMinuteCountsWithPeriodRequestBuilder : BaseRequestBuilder {
        /// <summary>
        ...
        public GetSkypeForBusinessPeerToPeerActivityMinuteCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = "") : base(requestAdapter, "{+baseurl}/reports/getSkypeForBusinessPeerToPeerActivityMinuteCounts(period='{period}')", pathParameters) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetSkypeForBusinessPeerToPeerActivityMinuteCountsWithPeriodRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/reports/getSkypeForBusinessPeerToPeerActivityMinuteCounts(period='{period}')", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<Stream?> GetAsync(CancellationToken cancellationToken = default, Action<GetSkypeForBusinessPeerToPeerActivityMinuteCountsWithPeriodRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Stream> GetAsync(CancellationToken cancellationToken = default, Action<GetSkypeForBusinessPeerToPeerActivityMinuteCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
