...
#nullable enable
        public async Task<Report?> GetAsync(CancellationToken cancellationToken = default, Action<DeviceConfigurationUserActivityRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Report> GetAsync(CancellationToken cancellationToken = default, Action<DeviceConfigurationUserActivityRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
