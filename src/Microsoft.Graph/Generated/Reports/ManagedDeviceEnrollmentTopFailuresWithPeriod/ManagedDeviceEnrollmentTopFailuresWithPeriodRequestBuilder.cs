...
namespace Microsoft.Graph.Reports.ManagedDeviceEnrollmentTopFailuresWithPeriod {
    ...
    public class ManagedDeviceEnrollmentTopFailuresWithPeriodRequestBuilder : BaseRequestBuilder {
        ...
        public ManagedDeviceEnrollmentTopFailuresWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = "") : base(requestAdapter, "{+baseurl}/reports/managedDeviceEnrollmentTopFailures(period='{period}')", pathParameters) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ManagedDeviceEnrollmentTopFailuresWithPeriodRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/reports/managedDeviceEnrollmentTopFailures(period='{period}')", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<Report?> GetAsync(CancellationToken cancellationToken = default, Action<ManagedDeviceEnrollmentTopFailuresWithPeriodRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Report> GetAsync(CancellationToken cancellationToken = default, Action<ManagedDeviceEnrollmentTopFailuresWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
