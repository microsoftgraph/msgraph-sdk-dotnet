...
namespace Microsoft.Graph.Reports.GetEmailAppUsageUserDetailWithDate {
    ...
    public class GetEmailAppUsageUserDetailWithDateRequestBuilder : BaseRequestBuilder {
        ...
        public GetEmailAppUsageUserDetailWithDateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, Date? date = default) : base(requestAdapter, "{+baseurl}/reports/getEmailAppUsageUserDetail(date={date})", pathParameters) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetEmailAppUsageUserDetailWithDateRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/reports/getEmailAppUsageUserDetail(date={date})", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<Stream?> GetAsync(CancellationToken cancellationToken = default, Action<GetEmailAppUsageUserDetailWithDateRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Stream> GetAsync(CancellationToken cancellationToken = default, Action<GetEmailAppUsageUserDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
