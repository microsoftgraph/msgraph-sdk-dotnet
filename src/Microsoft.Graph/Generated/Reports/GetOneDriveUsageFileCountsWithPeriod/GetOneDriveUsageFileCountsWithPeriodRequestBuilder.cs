...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public GetOneDriveUsageFileCountsWithPeriodRequestBuilder WithUrl(string rawUrl) {
            return new GetOneDriveUsageFileCountsWithPeriodRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
