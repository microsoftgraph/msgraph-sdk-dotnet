...
#nullable enable
        public async Task<GetGroupArchivedPrintJobsWithGroupIdWithStartDateTimeWithEndDateTimeResponse?> GetAsync(CancellationToken cancellationToken = default, Action<GetGroupArchivedPrintJobsWithGroupIdWithStartDateTimeWithEndDateTimeRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GetGroupArchivedPrintJobsWithGroupIdWithStartDateTimeWithEndDateTimeResponse> GetAsync(CancellationToken cancellationToken = default, Action<GetGroupArchivedPrintJobsWithGroupIdWithStartDateTimeWithEndDateTimeRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
