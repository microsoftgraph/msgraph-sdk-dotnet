...
#nullable enable
        public async Task<GetAttackSimulationTrainingUserCoverageResponse?> GetAsync(CancellationToken cancellationToken = default, Action<GetAttackSimulationTrainingUserCoverageRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GetAttackSimulationTrainingUserCoverageResponse> GetAsync(CancellationToken cancellationToken = default, Action<GetAttackSimulationTrainingUserCoverageRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
