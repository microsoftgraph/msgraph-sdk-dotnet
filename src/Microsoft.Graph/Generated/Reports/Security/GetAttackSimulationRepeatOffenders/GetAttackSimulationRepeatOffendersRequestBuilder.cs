...
namespace Microsoft.Graph.Reports.Security.GetAttackSimulationRepeatOffenders {
    ...
    public class GetAttackSimulationRepeatOffendersRequestBuilder : BaseRequestBuilder {
        ...
        /// </summary>
        /// <returns>A <cref="GetAttackSimulationRepeatOffendersGetResponse"></returns>
...
#nullable restore
        ...
        /// Invoke function getAttackSimulationRepeatOffenders
        /// </summary>
        /// <returns>A <cref="GetAttackSimulationRepeatOffendersResponse"></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="ODataError">When receiving a 4XX or 5XX status code</exception>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <cref="GetAttackSimulationRepeatOffendersRequestBuilder"></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
