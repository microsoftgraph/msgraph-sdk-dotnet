...
namespace Microsoft.Graph.Reports.GetMailboxUsageMailboxCountsWithPeriod {
    ...
    public class GetMailboxUsageMailboxCountsWithPeriodRequestBuilder : BaseRequestBuilder {
        ...
        public GetMailboxUsageMailboxCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = "") : base(requestAdapter, "{+baseurl}/reports/getMailboxUsageMailboxCounts(period='{period}')", pathParameters) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetMailboxUsageMailboxCountsWithPeriodRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/reports/getMailboxUsageMailboxCounts(period='{period}')", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<Stream?> GetAsync(CancellationToken cancellationToken = default, Action<GetMailboxUsageMailboxCountsWithPeriodRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Stream> GetAsync(CancellationToken cancellationToken = default, Action<GetMailboxUsageMailboxCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
