...
#nullable enable
        public async Task<Report?> GetAsync(CancellationToken cancellationToken = default, Action<ManagedDeviceEnrollmentTopFailuresRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Report> GetAsync(CancellationToken cancellationToken = default, Action<ManagedDeviceEnrollmentTopFailuresRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
