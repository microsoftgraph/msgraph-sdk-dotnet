...
namespace Microsoft.Graph.Reports.ManagedDeviceEnrollmentTopFailures {
    ...
    public class ManagedDeviceEnrollmentTopFailuresRequestBuilder {
        ...
        /// </summary>
        public ManagedDeviceEnrollmentTopFailuresRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/reports/microsoft.graph.managedDeviceEnrollmentTopFailures()";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public ManagedDeviceEnrollmentTopFailuresRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<ManagedDeviceEnrollmentTopFailuresRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public async Task<Stream> GetAsync(Action<ManagedDeviceEnrollmentTopFailuresRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
