...
namespace Microsoft.Graph.Reports.GetM365AppUserDetailWithPeriod
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="GetM365AppUserDetailWithPeriodRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public GetM365AppUserDetailWithPeriodRequestBuilder WithUrl(string rawUrl)
        {
            return new GetM365AppUserDetailWithPeriodRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
