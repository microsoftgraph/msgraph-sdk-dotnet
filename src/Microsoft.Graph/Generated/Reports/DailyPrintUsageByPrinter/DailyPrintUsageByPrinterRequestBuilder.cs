...
#nullable enable
        public async Task<PrintUsageByPrinterCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<DailyPrintUsageByPrinterRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PrintUsageByPrinterCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<DailyPrintUsageByPrinterRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<PrintUsageByPrinter?> PostAsync(PrintUsageByPrinter body, CancellationToken cancellationToken = default, Action<DailyPrintUsageByPrinterRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PrintUsageByPrinter> PostAsync(PrintUsageByPrinter body, CancellationToken cancellationToken = default, Action<DailyPrintUsageByPrinterRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
