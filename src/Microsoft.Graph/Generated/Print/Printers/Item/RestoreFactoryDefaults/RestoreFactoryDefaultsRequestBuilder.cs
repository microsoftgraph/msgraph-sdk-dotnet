...
namespace Microsoft.Graph.Print.Printers.Item.RestoreFactoryDefaults
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Print.Printers.Item.RestoreFactoryDefaults.RestoreFactoryDefaultsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Print.Printers.Item.RestoreFactoryDefaults.RestoreFactoryDefaultsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Print.Printers.Item.RestoreFactoryDefaults.RestoreFactoryDefaultsRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Print.Printers.Item.RestoreFactoryDefaults.RestoreFactoryDefaultsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class RestoreFactoryDefaultsRequestBuilderPostRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
    }
}
