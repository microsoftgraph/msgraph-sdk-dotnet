...
namespace Microsoft.Graph.Print.Printers.Item.Jobs.Item.Tasks.Item.Definition {
    ...
    public class DefinitionRequestBuilder : BaseRequestBuilder {
        ...
        public DefinitionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/printers/{printer%2Did}/jobs/{printJob%2Did}/tasks/{printTask%2Did}/definition{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new DefinitionRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DefinitionRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/printers/{printer%2Did}/jobs/{printJob%2Did}/tasks/{printTask%2Did}/definition{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
