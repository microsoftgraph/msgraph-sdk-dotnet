...
namespace Microsoft.Graph.Print.Printers.Item.Jobs.Item.Start
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Print.Printers.Item.Jobs.Item.Start.StartRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Microsoft.Graph.Models.PrintJobStatus?> PostAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.PrintJobStatus> PostAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<Microsoft.Graph.Models.PrintJobStatus>(requestInfo, Microsoft.Graph.Models.PrintJobStatus.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Submits the print job to the associated printer or printerShare. It will be printed after any existing pending jobs are completed, aborted, or canceled.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Print.Printers.Item.Jobs.Item.Start.StartRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Print.Printers.Item.Jobs.Item.Start.StartRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Print.Printers.Item.Jobs.Item.Start.StartRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
