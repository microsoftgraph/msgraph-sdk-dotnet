...
namespace Microsoft.Graph.Print.Printers.Item.Jobs.Item.Tasks.Item.Trigger {
    ...
    public class TriggerRequestBuilder : BaseRequestBuilder {
        ...
        public TriggerRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/printers/{printer%2Did}/jobs/{printJob%2Did}/tasks/{printTask%2Did}/trigger{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new TriggerRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TriggerRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/printers/{printer%2Did}/jobs/{printJob%2Did}/tasks/{printTask%2Did}/trigger{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<PrintTaskTrigger?> GetAsync(CancellationToken cancellationToken = default, Action<TriggerRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PrintTaskTrigger> GetAsync(CancellationToken cancellationToken = default, Action<TriggerRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
