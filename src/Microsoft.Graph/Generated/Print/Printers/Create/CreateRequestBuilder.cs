...
#nullable enable
        public async Task PostAsync(CreatePostRequestBody body, CancellationToken cancellationToken = default, Action<CreateRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(CreatePostRequestBody body, CancellationToken cancellationToken = default, Action<CreateRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(CreatePostRequestBody body, Action<CreateRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(CreatePostRequestBody body, Action<CreateRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
