...
#nullable enable
        public async Task<PrinterShareCollectionResponse?> GetAsync(Action<RequestConfiguration<SharesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<PrinterShareCollectionResponse> GetAsync(Action<RequestConfiguration<SharesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
