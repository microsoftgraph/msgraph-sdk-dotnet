...
#nullable enable
        public async Task<UserCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<AllowedUsersRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UserCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AllowedUsersRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<AllowedUsersRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<AllowedUsersRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#nullable restore
        ...
        public class AllowedUsersRequestBuilderGetRequestConfiguration {
            ...
            public AllowedUsersRequestBuilderGetQueryParameters QueryParameters { get; set; } = new AllowedUsersRequestBuilderGetQueryParameters();
            /// <summary>
