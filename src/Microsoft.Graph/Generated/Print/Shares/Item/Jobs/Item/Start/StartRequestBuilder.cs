...
#nullable enable
        public async Task<PrintJobStatus?> PostAsync(CancellationToken cancellationToken = default, Action<StartRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PrintJobStatus> PostAsync(CancellationToken cancellationToken = default, Action<StartRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
