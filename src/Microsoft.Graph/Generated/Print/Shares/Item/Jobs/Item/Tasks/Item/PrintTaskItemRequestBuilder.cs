...
using Microsoft.Graph.Print.Shares.Item.Jobs.Item.Tasks.Item.Definition;
using Microsoft.Graph.Print.Shares.Item.Jobs.Item.Tasks.Item.Trigger;
...
namespace Microsoft.Graph.Print.Shares.Item.Jobs.Item.Tasks.Item {
    ...
    public class PrintTaskItemRequestBuilder : BaseRequestBuilder {
        ...
        public PrintTaskItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/shares/{printerShare%2Did}/jobs/{printJob%2Did}/tasks/{printTask%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new PrintTaskItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PrintTaskItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/print/shares/{printerShare%2Did}/jobs/{printJob%2Did}/tasks/{printTask%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<PrintTaskItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<PrintTaskItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<PrintTask?> GetAsync(CancellationToken cancellationToken = default, Action<PrintTaskItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PrintTask> GetAsync(CancellationToken cancellationToken = default, Action<PrintTaskItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<PrintTask?> PatchAsync(PrintTask body, CancellationToken cancellationToken = default, Action<PrintTaskItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PrintTask> PatchAsync(PrintTask body, CancellationToken cancellationToken = default, Action<PrintTaskItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
