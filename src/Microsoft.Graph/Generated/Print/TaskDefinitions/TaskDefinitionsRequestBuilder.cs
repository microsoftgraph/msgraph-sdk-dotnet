...
#nullable enable
        public async Task<PrintTaskDefinitionCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<TaskDefinitionsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PrintTaskDefinitionCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<TaskDefinitionsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<PrintTaskDefinition?> PostAsync(PrintTaskDefinition body, CancellationToken cancellationToken = default, Action<TaskDefinitionsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<PrintTaskDefinition> PostAsync(PrintTaskDefinition body, CancellationToken cancellationToken = default, Action<TaskDefinitionsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
