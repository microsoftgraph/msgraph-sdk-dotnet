...
namespace Microsoft.Graph.Shares.Item.List.Drive {
    ...
    public class DriveRequestBuilder : BaseRequestBuilder {
        ...
        public DriveRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/shares/{sharedDriveItem%2Did}/list/drive{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new DriveRequestBuilder and sets the default values.
        /// </summary>
