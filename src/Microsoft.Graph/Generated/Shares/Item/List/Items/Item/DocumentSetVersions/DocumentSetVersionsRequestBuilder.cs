...
using Microsoft.Graph.Shares.Item.List.Items.Item.DocumentSetVersions.Count;
using Microsoft.Graph.Shares.Item.List.Items.Item.DocumentSetVersions.Item;
...
namespace Microsoft.Graph.Shares.Item.List.Items.Item.DocumentSetVersions {
    ...
    public class DocumentSetVersionsRequestBuilder : BaseRequestBuilder {
        ...
        public DocumentSetVersionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/shares/{sharedDriveItem%2Did}/list/items/{listItem%2Did}/documentSetVersions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new DocumentSetVersionsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DocumentSetVersionsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/shares/{sharedDriveItem%2Did}/list/items/{listItem%2Did}/documentSetVersions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
