...
using Microsoft.Graph.Shares.Item.List.ContentTypes.Item.BaseTypes.Count;
using Microsoft.Graph.Shares.Item.List.ContentTypes.Item.BaseTypes.Item;
...
namespace Microsoft.Graph.Shares.Item.List.ContentTypes.Item.BaseTypes {
    ...
    public class BaseTypesRequestBuilder : BaseRequestBuilder {
        ...
        public Microsoft.Graph.Shares.Item.List.ContentTypes.Item.BaseTypes.Item.ContentTypeItemRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("contentType%2Did1", position);
            return new Microsoft.Graph.Shares.Item.List.ContentTypes.Item.BaseTypes.Item.ContentTypeItemRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
        ...
        public BaseTypesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/shares/{sharedDriveItem%2Did}/list/contentTypes/{contentType%2Did}/baseTypes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new BaseTypesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public BaseTypesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/shares/{sharedDriveItem%2Did}/list/contentTypes/{contentType%2Did}/baseTypes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
