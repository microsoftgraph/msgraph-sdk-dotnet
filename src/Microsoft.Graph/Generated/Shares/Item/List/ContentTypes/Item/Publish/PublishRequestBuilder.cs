...
namespace Microsoft.Graph.Shares.Item.List.ContentTypes.Item.Publish {
    ...
    public class PublishRequestBuilder : BaseRequestBuilder {
        ...
        public PublishRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/shares/{sharedDriveItem%2Did}/list/contentTypes/{contentType%2Did}/publish", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new PublishRequestBuilder and sets the default values.
        /// </summary>
