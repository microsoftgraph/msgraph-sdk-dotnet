...
using Microsoft.Graph.Shares.Item.List.ContentTypes.AddCopy;
using Microsoft.Graph.Shares.Item.List.ContentTypes.AddCopyFromContentTypeHub;
using Microsoft.Graph.Shares.Item.List.ContentTypes.Count;
using Microsoft.Graph.Shares.Item.List.ContentTypes.GetCompatibleHubContentTypes;
using Microsoft.Graph.Shares.Item.List.ContentTypes.Item;
...
namespace Microsoft.Graph.Shares.Item.List.ContentTypes {
    ...
    public class ContentTypesRequestBuilder : BaseRequestBuilder {
        ...
        public ContentTypesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/shares/{sharedDriveItem%2Did}/list/contentTypes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ContentTypesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ContentTypesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/shares/{sharedDriveItem%2Did}/list/contentTypes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
