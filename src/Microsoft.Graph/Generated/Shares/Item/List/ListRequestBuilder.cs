...
namespace Microsoft.Graph.Shares.Item.List
{
    ...
    public class ListRequestBuilder : BaseRequestBuilder
    {
        ...
        public Microsoft.Graph.Shares.Item.List.Columns.ColumnsRequestBuilder Columns
        {
            get => new Microsoft.Graph.Shares.Item.List.Columns.ColumnsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to manage the contentTypes property of the microsoft.graph.list entity.</summary>
        public Microsoft.Graph.Shares.Item.List.ContentTypes.ContentTypesRequestBuilder ContentTypes
        {
            get => new Microsoft.Graph.Shares.Item.List.ContentTypes.ContentTypesRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to manage the createdByUser property of the microsoft.graph.baseItem entity.</summary>
        public Microsoft.Graph.Shares.Item.List.CreatedByUser.CreatedByUserRequestBuilder CreatedByUser
        {
            get => new Microsoft.Graph.Shares.Item.List.CreatedByUser.CreatedByUserRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to manage the drive property of the microsoft.graph.list entity.</summary>
        public Microsoft.Graph.Shares.Item.List.Drive.DriveRequestBuilder Drive
        {
            get => new Microsoft.Graph.Shares.Item.List.Drive.DriveRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to manage the items property of the microsoft.graph.list entity.</summary>
        public Microsoft.Graph.Shares.Item.List.Items.ItemsRequestBuilder Items
        {
            get => new Microsoft.Graph.Shares.Item.List.Items.ItemsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to manage the lastModifiedByUser property of the microsoft.graph.baseItem entity.</summary>
        public Microsoft.Graph.Shares.Item.List.LastModifiedByUser.LastModifiedByUserRequestBuilder LastModifiedByUser
        {
            get => new Microsoft.Graph.Shares.Item.List.LastModifiedByUser.LastModifiedByUserRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to manage the operations property of the microsoft.graph.list entity.</summary>
        public Microsoft.Graph.Shares.Item.List.Operations.OperationsRequestBuilder Operations
        {
            get => new Microsoft.Graph.Shares.Item.List.Operations.OperationsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to manage the subscriptions property of the microsoft.graph.list entity.</summary>
        public Microsoft.Graph.Shares.Item.List.Subscriptions.SubscriptionsRequestBuilder Subscriptions
        {
            get => new Microsoft.Graph.Shares.Item.List.Subscriptions.SubscriptionsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Shares.Item.List.ListRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.List?> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Shares.Item.List.ListRequestBuilder.ListRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.List> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Shares.Item.List.ListRequestBuilder.ListRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Shares.Item.List.ListRequestBuilder.ListRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Shares.Item.List.ListRequestBuilder.ListRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Shares.Item.List.ListRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Shares.Item.List.ListRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Shares.Item.List.ListRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class ListRequestBuilderGetRequestConfiguration : RequestConfiguration<Microsoft.Graph.Shares.Item.List.ListRequestBuilder.ListRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
