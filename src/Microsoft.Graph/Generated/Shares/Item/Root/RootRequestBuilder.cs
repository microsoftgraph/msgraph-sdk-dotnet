...
using Microsoft.Graph.Shares.Item.Root.Content;
...
namespace Microsoft.Graph.Shares.Item.Root {
    ...
    public class RootRequestBuilder : BaseRequestBuilder {
        ...
        public RootRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/shares/{sharedDriveItem%2Did}/root{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RootRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RootRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/shares/{sharedDriveItem%2Did}/root{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<Microsoft.Graph.Models.DriveItem?> GetAsync(CancellationToken cancellationToken = default, Action<RootRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.DriveItem> GetAsync(CancellationToken cancellationToken = default, Action<RootRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
