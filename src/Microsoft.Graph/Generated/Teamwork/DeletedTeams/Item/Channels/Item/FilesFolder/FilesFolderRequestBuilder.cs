...
using Microsoft.Graph.Teamwork.DeletedTeams.Item.Channels.Item.FilesFolder.Content;
...
namespace Microsoft.Graph.Teamwork.DeletedTeams.Item.Channels.Item.FilesFolder {
    ...
    public class FilesFolderRequestBuilder : BaseRequestBuilder {
        ...
        public FilesFolderRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/teamwork/deletedTeams/{deletedTeam%2Did}/channels/{channel%2Did}/filesFolder{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new FilesFolderRequestBuilder and sets the default values.
        /// </summary>
