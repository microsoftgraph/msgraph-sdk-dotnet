...
using Microsoft.Graph.Teamwork.DeletedTeams.Item.Channels.Item.Members.Add;
using Microsoft.Graph.Teamwork.DeletedTeams.Item.Channels.Item.Members.Count;
using Microsoft.Graph.Teamwork.DeletedTeams.Item.Channels.Item.Members.Item;
...
namespace Microsoft.Graph.Teamwork.DeletedTeams.Item.Channels.Item.Members {
    ...
    public class MembersRequestBuilder : BaseRequestBuilder {
        ...
        public MembersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/teamwork/deletedTeams/{deletedTeam%2Did}/channels/{channel%2Did}/members{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new MembersRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MembersRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/teamwork/deletedTeams/{deletedTeam%2Did}/channels/{channel%2Did}/members{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
