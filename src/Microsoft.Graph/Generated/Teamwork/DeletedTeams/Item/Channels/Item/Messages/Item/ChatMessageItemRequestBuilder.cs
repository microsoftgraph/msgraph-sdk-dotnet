...
using Microsoft.Graph.Teamwork.DeletedTeams.Item.Channels.Item.Messages.Item.HostedContents;
using Microsoft.Graph.Teamwork.DeletedTeams.Item.Channels.Item.Messages.Item.Replies;
using Microsoft.Graph.Teamwork.DeletedTeams.Item.Channels.Item.Messages.Item.SoftDelete;
using Microsoft.Graph.Teamwork.DeletedTeams.Item.Channels.Item.Messages.Item.UndoSoftDelete;
...
namespace Microsoft.Graph.Teamwork.DeletedTeams.Item.Channels.Item.Messages.Item {
    ...
    public class ChatMessageItemRequestBuilder : BaseRequestBuilder {
        ...
        public ChatMessageItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/teamwork/deletedTeams/{deletedTeam%2Did}/channels/{channel%2Did}/messages/{chatMessage%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ChatMessageItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ChatMessageItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/teamwork/deletedTeams/{deletedTeam%2Did}/channels/{channel%2Did}/messages/{chatMessage%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
