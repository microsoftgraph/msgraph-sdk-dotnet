...
using Microsoft.Graph.Teamwork.DeletedTeams.Item.Channels.Item.Messages.Count;
using Microsoft.Graph.Teamwork.DeletedTeams.Item.Channels.Item.Messages.Delta;
using Microsoft.Graph.Teamwork.DeletedTeams.Item.Channels.Item.Messages.Item;
...
namespace Microsoft.Graph.Teamwork.DeletedTeams.Item.Channels.Item.Messages {
    ...
    public class MessagesRequestBuilder : BaseRequestBuilder {
        ...
        public MessagesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/teamwork/deletedTeams/{deletedTeam%2Did}/channels/{channel%2Did}/messages{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new MessagesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MessagesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/teamwork/deletedTeams/{deletedTeam%2Did}/channels/{channel%2Did}/messages{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
