...
using Microsoft.Graph.Teamwork.DeletedTeams.Item.Channels.Item.Messages.MicrosoftGraphDelta;
...
namespace Microsoft.Graph.Teamwork.DeletedTeams.Item.Channels.Item.Messages {
    ...
    public class MessagesRequestBuilder {
        ...
        public MessagesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/teamwork/deletedTeams/{deletedTeam%2Did}/channels/{channel%2Did}/messages{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
