...
using Microsoft.Graph.Teamwork.DeletedTeams.Item.Channels.MicrosoftGraphGetAllMessages;
...
namespace Microsoft.Graph.Teamwork.DeletedTeams.Item.Channels {
    ...
    public class ChannelsRequestBuilder {
        ...
        public ChannelsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/teamwork/deletedTeams/{deletedTeam%2Did}/channels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
