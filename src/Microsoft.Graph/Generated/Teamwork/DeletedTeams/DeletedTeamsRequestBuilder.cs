...
using Microsoft.Graph.Teamwork.DeletedTeams.Count;
using Microsoft.Graph.Teamwork.DeletedTeams.GetAllMessages;
using Microsoft.Graph.Teamwork.DeletedTeams.Item;
...
#nullable enable
        public async Task<DeletedTeamCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<DeletedTeamsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeletedTeamCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<DeletedTeamsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DeletedTeam?> PostAsync(DeletedTeam body, CancellationToken cancellationToken = default, Action<DeletedTeamsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<DeletedTeam> PostAsync(DeletedTeam body, CancellationToken cancellationToken = default, Action<DeletedTeamsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
