...
using Microsoft.Graph.Teamwork.DeletedTeams.MicrosoftGraphGetAllMessages;
...
namespace Microsoft.Graph.Teamwork.DeletedTeams {
    ...
    public class DeletedTeamsRequestBuilder {
        ...
        public DeletedTeamsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/teamwork/deletedTeams{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DeletedTeamsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
