...
#nullable enable
        public async Task PostAsync(SendActivityNotificationToRecipientsPostRequestBody body, CancellationToken cancellationToken = default, Action<SendActivityNotificationToRecipientsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task PostAsync(SendActivityNotificationToRecipientsPostRequestBody body, CancellationToken cancellationToken = default, Action<SendActivityNotificationToRecipientsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
