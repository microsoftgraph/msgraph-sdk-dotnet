...
#nullable enable
        public async Task PostAsync(SendActivityNotificationToRecipientsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task PostAsync(SendActivityNotificationToRecipientsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="SendActivityNotificationToRecipientsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public SendActivityNotificationToRecipientsRequestBuilder WithUrl(string rawUrl)
        {
            return new SendActivityNotificationToRecipientsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
