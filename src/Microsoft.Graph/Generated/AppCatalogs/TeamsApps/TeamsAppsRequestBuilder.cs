...
namespace Microsoft.Graph.AppCatalogs.TeamsApps {
    ...
    public class TeamsAppsRequestBuilder : BaseRequestBuilder {
        ...
        public TeamsAppItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("teamsApp%2Did", position);
...
#nullable enable
        public async Task<TeamsAppCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<TeamsAppsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<TeamsAppCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<TeamsAppsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.TeamsApp?> PostAsync(Microsoft.Graph.Models.TeamsApp body, CancellationToken cancellationToken = default, Action<TeamsAppsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.TeamsApp> PostAsync(Microsoft.Graph.Models.TeamsApp body, CancellationToken cancellationToken = default, Action<TeamsAppsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
