...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<BotRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<BotRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<TeamworkBot?> GetAsync(CancellationToken cancellationToken = default, Action<BotRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<TeamworkBot> GetAsync(CancellationToken cancellationToken = default, Action<BotRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<TeamworkBot?> PatchAsync(TeamworkBot body, CancellationToken cancellationToken = default, Action<BotRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<TeamworkBot> PatchAsync(TeamworkBot body, CancellationToken cancellationToken = default, Action<BotRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
