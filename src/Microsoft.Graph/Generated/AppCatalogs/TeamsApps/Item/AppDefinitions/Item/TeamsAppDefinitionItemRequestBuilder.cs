...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<TeamsAppDefinitionItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<TeamsAppDefinitionItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.TeamsAppDefinition?> GetAsync(CancellationToken cancellationToken = default, Action<TeamsAppDefinitionItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.TeamsAppDefinition> GetAsync(CancellationToken cancellationToken = default, Action<TeamsAppDefinitionItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.TeamsAppDefinition?> PatchAsync(Microsoft.Graph.Models.TeamsAppDefinition body, CancellationToken cancellationToken = default, Action<TeamsAppDefinitionItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.TeamsAppDefinition> PatchAsync(Microsoft.Graph.Models.TeamsAppDefinition body, CancellationToken cancellationToken = default, Action<TeamsAppDefinitionItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
