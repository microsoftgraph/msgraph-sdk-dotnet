...
#nullable enable
        public async Task<Microsoft.Graph.Models.Admin?> GetAsync(CancellationToken cancellationToken = default, Action<AdminRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Admin> GetAsync(CancellationToken cancellationToken = default, Action<AdminRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<Microsoft.Graph.Models.Admin>(requestInfo, Microsoft.Graph.Models.Admin.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
        /// Update admin
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.Admin?> PatchAsync(Microsoft.Graph.Models.Admin body, CancellationToken cancellationToken = default, Action<AdminRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Admin> PatchAsync(Microsoft.Graph.Models.Admin body, CancellationToken cancellationToken = default, Action<AdminRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
