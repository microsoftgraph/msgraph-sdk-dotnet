using Microsoft.Graph.Admin.Sharepoint.Settings;
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.Sharepoint?> GetAsync(CancellationToken cancellationToken = default, Action<SharepointRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Sharepoint> GetAsync(CancellationToken cancellationToken = default, Action<SharepointRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<Microsoft.Graph.Models.Sharepoint>(requestInfo, Microsoft.Graph.Models.Sharepoint.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.Sharepoint?> PatchAsync(Microsoft.Graph.Models.Sharepoint body, CancellationToken cancellationToken = default, Action<SharepointRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Sharepoint> PatchAsync(Microsoft.Graph.Models.Sharepoint body, CancellationToken cancellationToken = default, Action<SharepointRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(Microsoft.Graph.Models.Sharepoint body, Action<SharepointRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(Microsoft.Graph.Models.Sharepoint body, Action<SharepointRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
