...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<EdgeRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<EdgeRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.Edge?> GetAsync(CancellationToken cancellationToken = default, Action<EdgeRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Edge> GetAsync(CancellationToken cancellationToken = default, Action<EdgeRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.Edge?> PatchAsync(Microsoft.Graph.Models.Edge body, CancellationToken cancellationToken = default, Action<EdgeRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Edge> PatchAsync(Microsoft.Graph.Models.Edge body, CancellationToken cancellationToken = default, Action<EdgeRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
