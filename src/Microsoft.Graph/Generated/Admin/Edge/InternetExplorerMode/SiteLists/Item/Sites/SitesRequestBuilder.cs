...
namespace Microsoft.Graph.Admin.Edge.InternetExplorerMode.SiteLists.Item.Sites {
    ...
    public class SitesRequestBuilder : BaseRequestBuilder {
        ...
        /// <returns>A <cref="BrowserSiteItemRequestBuilder"></returns>
        ...
        /// </summary>
        /// <returns>A <cref="BrowserSiteCollectionResponse"></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="ODataError">When receiving a 4XX or 5XX status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<BrowserSiteCollectionResponse?> GetAsync(Action<RequestConfiguration<SitesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<BrowserSiteCollectionResponse> GetAsync(Action<RequestConfiguration<SitesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<BrowserSite?> PostAsync(BrowserSite body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<BrowserSite> PostAsync(BrowserSite body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
