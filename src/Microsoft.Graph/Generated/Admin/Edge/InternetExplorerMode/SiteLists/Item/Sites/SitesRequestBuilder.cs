...
namespace Microsoft.Graph.Admin.Edge.InternetExplorerMode.SiteLists.Item.Sites {
    ...
    public class SitesRequestBuilder : BaseRequestBuilder {
        ...
        public BrowserSiteItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("browserSite%2Did", position);
        ...
        public SitesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/admin/edge/internetExplorerMode/siteLists/{browserSiteList%2Did}/sites{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SitesRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<BrowserSiteCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<SitesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<BrowserSiteCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<SitesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<BrowserSite?> PostAsync(BrowserSite body, CancellationToken cancellationToken = default, Action<SitesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<BrowserSite> PostAsync(BrowserSite body, CancellationToken cancellationToken = default, Action<SitesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(BrowserSite body, Action<SitesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(BrowserSite body, Action<SitesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
