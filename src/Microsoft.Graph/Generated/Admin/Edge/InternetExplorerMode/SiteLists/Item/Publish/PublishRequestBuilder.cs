...
#nullable enable
        public async Task<BrowserSiteList?> PostAsync(PublishPostRequestBody body, CancellationToken cancellationToken = default, Action<PublishRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<BrowserSiteList> PostAsync(PublishPostRequestBody body, CancellationToken cancellationToken = default, Action<PublishRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
