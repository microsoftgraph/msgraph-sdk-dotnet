...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<BrowserSharedCookieItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<BrowserSharedCookieItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<BrowserSharedCookie?> GetAsync(CancellationToken cancellationToken = default, Action<BrowserSharedCookieItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<BrowserSharedCookie> GetAsync(CancellationToken cancellationToken = default, Action<BrowserSharedCookieItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<BrowserSharedCookie?> PatchAsync(BrowserSharedCookie body, CancellationToken cancellationToken = default, Action<BrowserSharedCookieItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<BrowserSharedCookie> PatchAsync(BrowserSharedCookie body, CancellationToken cancellationToken = default, Action<BrowserSharedCookieItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
