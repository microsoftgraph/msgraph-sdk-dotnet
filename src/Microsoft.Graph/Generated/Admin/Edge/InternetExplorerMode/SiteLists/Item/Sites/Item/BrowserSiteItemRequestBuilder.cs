...
namespace Microsoft.Graph.Admin.Edge.InternetExplorerMode.SiteLists.Item.Sites.Item
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Admin.Edge.InternetExplorerMode.SiteLists.Item.Sites.Item.BrowserSiteItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.BrowserSite?> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Admin.Edge.InternetExplorerMode.SiteLists.Item.Sites.Item.BrowserSiteItemRequestBuilder.BrowserSiteItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.BrowserSite> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Admin.Edge.InternetExplorerMode.SiteLists.Item.Sites.Item.BrowserSiteItemRequestBuilder.BrowserSiteItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.BrowserSite?> PatchAsync(Microsoft.Graph.Models.BrowserSite body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.BrowserSite> PatchAsync(Microsoft.Graph.Models.BrowserSite body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Admin.Edge.InternetExplorerMode.SiteLists.Item.Sites.Item.BrowserSiteItemRequestBuilder.BrowserSiteItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Admin.Edge.InternetExplorerMode.SiteLists.Item.Sites.Item.BrowserSiteItemRequestBuilder.BrowserSiteItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(Microsoft.Graph.Models.BrowserSite body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(Microsoft.Graph.Models.BrowserSite body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Admin.Edge.InternetExplorerMode.SiteLists.Item.Sites.Item.BrowserSiteItemRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Admin.Edge.InternetExplorerMode.SiteLists.Item.Sites.Item.BrowserSiteItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class BrowserSiteItemRequestBuilderGetRequestConfiguration : RequestConfiguration<Microsoft.Graph.Admin.Edge.InternetExplorerMode.SiteLists.Item.Sites.Item.BrowserSiteItemRequestBuilder.BrowserSiteItemRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
