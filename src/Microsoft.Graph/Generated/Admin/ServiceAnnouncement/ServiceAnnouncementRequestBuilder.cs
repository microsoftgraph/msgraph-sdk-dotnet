...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ServiceAnnouncementRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ServiceAnnouncementRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.ServiceAnnouncement?> GetAsync(CancellationToken cancellationToken = default, Action<ServiceAnnouncementRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.ServiceAnnouncement> GetAsync(CancellationToken cancellationToken = default, Action<ServiceAnnouncementRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.ServiceAnnouncement?> PatchAsync(Microsoft.Graph.Models.ServiceAnnouncement body, CancellationToken cancellationToken = default, Action<ServiceAnnouncementRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.ServiceAnnouncement> PatchAsync(Microsoft.Graph.Models.ServiceAnnouncement body, CancellationToken cancellationToken = default, Action<ServiceAnnouncementRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
