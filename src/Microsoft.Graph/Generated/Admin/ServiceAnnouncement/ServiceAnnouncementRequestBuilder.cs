...
namespace Microsoft.Graph.Admin.ServiceAnnouncement
{
    ...
    public class ServiceAnnouncementRequestBuilder : BaseRequestBuilder
    {
        ...
        public Microsoft.Graph.Admin.ServiceAnnouncement.HealthOverviews.HealthOverviewsRequestBuilder HealthOverviews
        {
            get => new Microsoft.Graph.Admin.ServiceAnnouncement.HealthOverviews.HealthOverviewsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to manage the issues property of the microsoft.graph.serviceAnnouncement entity.</summary>
        public Microsoft.Graph.Admin.ServiceAnnouncement.Issues.IssuesRequestBuilder Issues
        {
            get => new Microsoft.Graph.Admin.ServiceAnnouncement.Issues.IssuesRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to manage the messages property of the microsoft.graph.serviceAnnouncement entity.</summary>
        public Microsoft.Graph.Admin.ServiceAnnouncement.Messages.MessagesRequestBuilder Messages
        {
            get => new Microsoft.Graph.Admin.ServiceAnnouncement.Messages.MessagesRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Admin.ServiceAnnouncement.ServiceAnnouncementRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.ServiceAnnouncement?> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Admin.ServiceAnnouncement.ServiceAnnouncementRequestBuilder.ServiceAnnouncementRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.ServiceAnnouncement> GetAsync(Action<RequestConfiguration<Microsoft.Graph.Admin.ServiceAnnouncement.ServiceAnnouncementRequestBuilder.ServiceAnnouncementRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Admin.ServiceAnnouncement.ServiceAnnouncementRequestBuilder.ServiceAnnouncementRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Admin.ServiceAnnouncement.ServiceAnnouncementRequestBuilder.ServiceAnnouncementRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Admin.ServiceAnnouncement.ServiceAnnouncementRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Admin.ServiceAnnouncement.ServiceAnnouncementRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Admin.ServiceAnnouncement.ServiceAnnouncementRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class ServiceAnnouncementRequestBuilderGetRequestConfiguration : RequestConfiguration<Microsoft.Graph.Admin.ServiceAnnouncement.ServiceAnnouncementRequestBuilder.ServiceAnnouncementRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
