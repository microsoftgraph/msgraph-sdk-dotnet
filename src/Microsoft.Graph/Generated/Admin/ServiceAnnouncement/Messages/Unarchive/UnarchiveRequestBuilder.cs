...
namespace Microsoft.Graph.Admin.ServiceAnnouncement.Messages.Unarchive {
    ...
    public class UnarchiveRequestBuilder : BaseRequestBuilder {
        ...
        /// </summary>
        /// <returns>A <cref="UnarchivePostResponse"></returns>
...
#nullable enable
        public async Task<UnarchivePostResponse?> PostAsUnarchivePostResponseAsync(UnarchivePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<UnarchivePostResponse> PostAsUnarchivePostResponseAsync(UnarchivePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<UnarchivePostResponse>(requestInfo, UnarchivePostResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Unarchive a list of serviceUpdateMessages for the signed in user.
        /// Find more info here <see href="https://learn.microsoft.com/graph/api/serviceupdatemessage-unarchive?view=graph-rest-1.0" />
        /// </summary>
        /// <returns>A <cref="UnarchiveResponse"></returns>
        /// <param name="body">The request body</param>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="ODataError">When receiving a 4XX or 5XX status code</exception>
...
#nullable restore
        ...
        public async Task<UnarchiveResponse> PostAsync(UnarchivePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<UnarchiveResponse>(requestInfo, UnarchiveResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Unarchive a list of serviceUpdateMessages for the signed in user.
        /// </summary>
