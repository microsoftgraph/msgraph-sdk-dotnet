...
#nullable enable
        public async Task<MarkUnreadResponse?> PostAsync(MarkUnreadPostRequestBody body, CancellationToken cancellationToken = default, Action<MarkUnreadRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<MarkUnreadResponse> PostAsync(MarkUnreadPostRequestBody body, CancellationToken cancellationToken = default, Action<MarkUnreadRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(MarkUnreadPostRequestBody body, Action<MarkUnreadRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(MarkUnreadPostRequestBody body, Action<MarkUnreadRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new MarkUnreadRequestBuilderPostRequestConfiguration();
