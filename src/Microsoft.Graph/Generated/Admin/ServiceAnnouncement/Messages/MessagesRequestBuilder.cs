...
#nullable enable
        public async Task<ServiceUpdateMessageCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<MessagesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ServiceUpdateMessageCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<MessagesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ServiceUpdateMessage?> PostAsync(ServiceUpdateMessage body, CancellationToken cancellationToken = default, Action<MessagesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ServiceUpdateMessage> PostAsync(ServiceUpdateMessage body, CancellationToken cancellationToken = default, Action<MessagesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
