...
namespace Microsoft.Graph.Admin.ServiceAnnouncement.Messages.Item.AttachmentsArchive
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Admin.ServiceAnnouncement.Messages.Item.AttachmentsArchive.AttachmentsArchiveRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Microsoft.Graph.Admin.ServiceAnnouncement.Messages.Item.AttachmentsArchive.AttachmentsArchiveRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Admin.ServiceAnnouncement.Messages.Item.AttachmentsArchive.AttachmentsArchiveRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Admin.ServiceAnnouncement.Messages.Item.AttachmentsArchive.AttachmentsArchiveRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class AttachmentsArchiveRequestBuilderDeleteRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class AttachmentsArchiveRequestBuilderGetRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class AttachmentsArchiveRequestBuilderPutRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
    }
}
