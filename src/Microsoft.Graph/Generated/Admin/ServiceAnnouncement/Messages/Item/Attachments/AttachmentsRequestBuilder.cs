using Microsoft.Graph.Admin.ServiceAnnouncement.Messages.Item.Attachments.Count;
using Microsoft.Graph.Admin.ServiceAnnouncement.Messages.Item.Attachments.Item;
...
namespace Microsoft.Graph.Admin.ServiceAnnouncement.Messages.Item.Attachments {
    ...
    public class AttachmentsRequestBuilder : BaseRequestBuilder {
        ...
        public ServiceAnnouncementAttachmentItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("serviceAnnouncementAttachment%2Did", position);
        ...
        public AttachmentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/admin/serviceAnnouncement/messages/{serviceUpdateMessage%2Did}/attachments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AttachmentsRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<ServiceAnnouncementAttachmentCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<AttachmentsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ServiceAnnouncementAttachmentCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AttachmentsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<ServiceAnnouncementAttachmentCollectionResponse>(requestInfo, ServiceAnnouncementAttachmentCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ServiceAnnouncementAttachment?> PostAsync(ServiceAnnouncementAttachment body, CancellationToken cancellationToken = default, Action<AttachmentsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ServiceAnnouncementAttachment> PostAsync(ServiceAnnouncementAttachment body, CancellationToken cancellationToken = default, Action<AttachmentsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(ServiceAnnouncementAttachment body, Action<AttachmentsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ServiceAnnouncementAttachment body, Action<AttachmentsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
