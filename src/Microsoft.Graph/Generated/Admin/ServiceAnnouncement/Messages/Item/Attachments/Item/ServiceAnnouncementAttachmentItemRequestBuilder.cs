using Microsoft.Graph.Admin.ServiceAnnouncement.Messages.Item.Attachments.Item.Content;
...
#nullable enable
        public async Task<Stream?> DeleteAsync(Action<ServiceAnnouncementAttachmentItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Stream> DeleteAsync(Action<ServiceAnnouncementAttachmentItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
