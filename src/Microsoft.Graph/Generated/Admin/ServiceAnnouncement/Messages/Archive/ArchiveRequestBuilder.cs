...
namespace Microsoft.Graph.Admin.ServiceAnnouncement.Messages.Archive
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Microsoft.Graph.Admin.ServiceAnnouncement.Messages.Archive.ArchiveRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// Find more info here <see href="https://learn.microsoft.com/graph/api/serviceupdatemessage-archive?view=graph-rest-1.0" />
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.Admin.ServiceAnnouncement.Messages.Archive.ArchiveResponse"/></returns>
        /// <param name="body">The request body</param>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="global::Microsoft.Graph.Models.ODataErrors.ODataError">When receiving a 4XX or 5XX status code</exception>
...
#nullable restore
        ...
        public async Task<global::Microsoft.Graph.Admin.ServiceAnnouncement.Messages.Archive.ArchiveResponse> PostAsync(global::Microsoft.Graph.Admin.ServiceAnnouncement.Messages.Archive.ArchivePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Microsoft.Graph.Admin.ServiceAnnouncement.Messages.Archive.ArchiveResponse>(requestInfo, global::Microsoft.Graph.Admin.ServiceAnnouncement.Messages.Archive.ArchiveResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Archive a list of serviceUpdateMessages for the signed in user.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Microsoft.Graph.Admin.ServiceAnnouncement.Messages.Archive.ArchivePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Microsoft.Graph.Admin.ServiceAnnouncement.Messages.Archive.ArchivePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.Admin.ServiceAnnouncement.Messages.Archive.ArchiveRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Microsoft.Graph.Admin.ServiceAnnouncement.Messages.Archive.ArchiveRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Microsoft.Graph.Admin.ServiceAnnouncement.Messages.Archive.ArchiveRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
