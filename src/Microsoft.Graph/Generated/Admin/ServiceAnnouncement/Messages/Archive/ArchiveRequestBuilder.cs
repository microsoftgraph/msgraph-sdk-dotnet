...
#nullable enable
        public async Task<ArchiveResponse?> PostAsync(ArchivePostRequestBody body, CancellationToken cancellationToken = default, Action<ArchiveRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ArchiveResponse> PostAsync(ArchivePostRequestBody body, CancellationToken cancellationToken = default, Action<ArchiveRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
