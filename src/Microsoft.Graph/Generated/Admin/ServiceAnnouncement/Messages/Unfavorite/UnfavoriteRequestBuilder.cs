...
namespace Microsoft.Graph.Admin.ServiceAnnouncement.Messages.Unfavorite {
    ...
    /// </summary>
    public class UnfavoriteRequestBuilder : BaseRequestBuilder {
        /// <summary>
        /// Instantiates a new UnfavoriteRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public UnfavoriteRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/admin/serviceAnnouncement/messages/unfavorite", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new UnfavoriteRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<UnfavoriteResponse?> PostAsync(UnfavoritePostRequestBody body, CancellationToken cancellationToken = default, Action<UnfavoriteRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<UnfavoriteResponse> PostAsync(UnfavoritePostRequestBody body, CancellationToken cancellationToken = default, Action<UnfavoriteRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(UnfavoritePostRequestBody body, Action<UnfavoriteRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(UnfavoritePostRequestBody body, Action<UnfavoriteRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new UnfavoriteRequestBuilderPostRequestConfiguration();
