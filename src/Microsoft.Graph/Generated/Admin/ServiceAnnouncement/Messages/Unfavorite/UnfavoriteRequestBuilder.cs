...
namespace Microsoft.Graph.Admin.ServiceAnnouncement.Messages.Unfavorite {
    ...
    public class UnfavoriteRequestBuilder : BaseRequestBuilder {
        ...
        /// </summary>
        /// <returns>A <cref="UnfavoritePostResponse"></returns>
...
#nullable enable
        public async Task<UnfavoritePostResponse?> PostAsUnfavoritePostResponseAsync(UnfavoritePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<UnfavoritePostResponse> PostAsUnfavoritePostResponseAsync(UnfavoritePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
        ...
        /// Find more info here <see href="https://learn.microsoft.com/graph/api/serviceupdatemessage-unfavorite?view=graph-rest-1.0" />
        /// </summary>
        /// <returns>A <cref="UnfavoriteResponse"></returns>
        /// <param name="body">The request body</param>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="ODataError">When receiving a 4XX or 5XX status code</exception>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <cref="UnfavoriteRequestBuilder"></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
