...
#nullable enable
        public async Task<FavoriteResponse?> PostAsync(FavoritePostRequestBody body, CancellationToken cancellationToken = default, Action<FavoriteRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<FavoriteResponse> PostAsync(FavoritePostRequestBody body, CancellationToken cancellationToken = default, Action<FavoriteRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
