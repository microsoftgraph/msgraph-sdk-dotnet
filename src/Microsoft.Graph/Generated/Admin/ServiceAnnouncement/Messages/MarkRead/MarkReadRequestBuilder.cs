...
#nullable enable
        public async Task<MarkReadResponse?> PostAsync(MarkReadPostRequestBody body, CancellationToken cancellationToken = default, Action<MarkReadRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<MarkReadResponse> PostAsync(MarkReadPostRequestBody body, CancellationToken cancellationToken = default, Action<MarkReadRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
