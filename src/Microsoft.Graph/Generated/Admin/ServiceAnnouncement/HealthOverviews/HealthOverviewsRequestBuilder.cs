...
namespace Microsoft.Graph.Admin.ServiceAnnouncement.HealthOverviews {
    ...
    public class HealthOverviewsRequestBuilder : BaseRequestBuilder {
        ...
        public ServiceHealthItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("serviceHealth%2Did", position);
...
#nullable restore
        ...
        public async Task<ServiceHealthCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<HealthOverviewsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
            ...
            return await RequestAdapter.SendAsync<ServiceHealthCollectionResponse>(requestInfo, ServiceHealthCollectionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<HealthOverviewsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<HealthOverviewsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(ServiceHealth body, Action<HealthOverviewsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ServiceHealth body, Action<HealthOverviewsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
