...
#nullable enable
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ServiceHealthItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ServiceHealthItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ServiceHealth?> GetAsync(CancellationToken cancellationToken = default, Action<ServiceHealthItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ServiceHealth> GetAsync(CancellationToken cancellationToken = default, Action<ServiceHealthItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ServiceHealth?> PatchAsync(ServiceHealth body, CancellationToken cancellationToken = default, Action<ServiceHealthItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<ServiceHealth> PatchAsync(ServiceHealth body, CancellationToken cancellationToken = default, Action<ServiceHealthItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
