...
#nullable enable
        public async Task<Microsoft.Graph.Models.Compliance?> GetAsync(CancellationToken cancellationToken = default, Action<ComplianceRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Compliance> GetAsync(CancellationToken cancellationToken = default, Action<ComplianceRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.Compliance?> PatchAsync(Microsoft.Graph.Models.Compliance body, CancellationToken cancellationToken = default, Action<ComplianceRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Compliance> PatchAsync(Microsoft.Graph.Models.Compliance body, CancellationToken cancellationToken = default, Action<ComplianceRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(Microsoft.Graph.Models.Compliance body, Action<ComplianceRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(Microsoft.Graph.Models.Compliance body, Action<ComplianceRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
