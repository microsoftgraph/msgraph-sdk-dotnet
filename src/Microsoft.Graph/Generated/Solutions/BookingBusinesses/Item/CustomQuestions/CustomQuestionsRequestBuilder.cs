...
using Microsoft.Graph.Solutions.BookingBusinesses.Item.CustomQuestions.Count;
using Microsoft.Graph.Solutions.BookingBusinesses.Item.CustomQuestions.Item;
...
namespace Microsoft.Graph.Solutions.BookingBusinesses.Item.CustomQuestions {
    ...
    public class CustomQuestionsRequestBuilder : BaseRequestBuilder {
        ...
        public BookingCustomQuestionItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("bookingCustomQuestion%2Did", position);
...
#nullable enable
        public async Task<BookingCustomQuestionCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<CustomQuestionsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<BookingCustomQuestionCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<CustomQuestionsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<BookingCustomQuestion?> PostAsync(BookingCustomQuestion body, CancellationToken cancellationToken = default, Action<CustomQuestionsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<BookingCustomQuestion> PostAsync(BookingCustomQuestion body, CancellationToken cancellationToken = default, Action<CustomQuestionsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(BookingCustomQuestion body, Action<CustomQuestionsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(BookingCustomQuestion body, Action<CustomQuestionsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
