...
#nullable enable
        public async Task<BookingAppointmentCollectionResponse?> GetAsync(CancellationToken cancellationToken = default, Action<CalendarViewRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<BookingAppointmentCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<CalendarViewRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<BookingAppointment?> PostAsync(BookingAppointment body, CancellationToken cancellationToken = default, Action<CalendarViewRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<BookingAppointment> PostAsync(BookingAppointment body, CancellationToken cancellationToken = default, Action<CalendarViewRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
