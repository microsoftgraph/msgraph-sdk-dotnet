...
namespace Microsoft.Graph.Solutions.BookingBusinesses.Item.CalendarView.Item
{
    ...
    public class BookingAppointmentItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public Microsoft.Graph.Solutions.BookingBusinesses.Item.CalendarView.Item.Cancel.CancelRequestBuilder Cancel
        {
            get => new Microsoft.Graph.Solutions.BookingBusinesses.Item.CalendarView.Item.Cancel.CancelRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="Microsoft.Graph.Solutions.BookingBusinesses.Item.CalendarView.Item.BookingAppointmentItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.BookingAppointment?> PatchAsync(Microsoft.Graph.Models.BookingAppointment body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.BookingAppointment> PatchAsync(Microsoft.Graph.Models.BookingAppointment body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Solutions.BookingBusinesses.Item.CalendarView.Item.BookingAppointmentItemRequestBuilder.BookingAppointmentItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Microsoft.Graph.Solutions.BookingBusinesses.Item.CalendarView.Item.BookingAppointmentItemRequestBuilder.BookingAppointmentItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(Microsoft.Graph.Models.BookingAppointment body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(Microsoft.Graph.Models.BookingAppointment body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Microsoft.Graph.Solutions.BookingBusinesses.Item.CalendarView.Item.BookingAppointmentItemRequestBuilder WithUrl(string rawUrl)
        {
            return new Microsoft.Graph.Solutions.BookingBusinesses.Item.CalendarView.Item.BookingAppointmentItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class BookingAppointmentItemRequestBuilderGetRequestConfiguration : RequestConfiguration<Microsoft.Graph.Solutions.BookingBusinesses.Item.CalendarView.Item.BookingAppointmentItemRequestBuilder.BookingAppointmentItemRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
