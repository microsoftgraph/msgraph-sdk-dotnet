...
namespace Microsoft.Graph.Solutions.BookingBusinesses.Item.GetStaffAvailability {
    ...
    /// </summary>
    public class GetStaffAvailabilityRequestBuilder : BaseRequestBuilder {
        /// <summary>
...
#nullable enable
        public async Task<GetStaffAvailabilityResponse?> PostAsync(GetStaffAvailabilityPostRequestBody body, CancellationToken cancellationToken = default, Action<GetStaffAvailabilityRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<GetStaffAvailabilityResponse> PostAsync(GetStaffAvailabilityPostRequestBody body, CancellationToken cancellationToken = default, Action<GetStaffAvailabilityRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(GetStaffAvailabilityPostRequestBody body, Action<GetStaffAvailabilityRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(GetStaffAvailabilityPostRequestBody body, Action<GetStaffAvailabilityRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new GetStaffAvailabilityRequestBuilderPostRequestConfiguration();
        ...
        public class GetStaffAvailabilityRequestBuilderPostRequestConfiguration {
            ...
            /// <summary>
            /// Instantiates a new getStaffAvailabilityRequestBuilderPostRequestConfiguration and sets the default values.
            /// </summary>
