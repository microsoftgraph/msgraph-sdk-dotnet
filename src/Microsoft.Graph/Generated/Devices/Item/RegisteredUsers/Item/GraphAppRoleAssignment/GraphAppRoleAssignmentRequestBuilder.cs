...
namespace Microsoft.Graph.Devices.Item.RegisteredUsers.Item.GraphAppRoleAssignment {
    ...
    public class GraphAppRoleAssignmentRequestBuilder : BaseRequestBuilder {
        ...
        public GraphAppRoleAssignmentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/devices/{device%2Did}/registeredUsers/{directoryObject%2Did}/graph.appRoleAssignment{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GraphAppRoleAssignmentRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GraphAppRoleAssignmentRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/devices/{device%2Did}/registeredUsers/{directoryObject%2Did}/graph.appRoleAssignment{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
