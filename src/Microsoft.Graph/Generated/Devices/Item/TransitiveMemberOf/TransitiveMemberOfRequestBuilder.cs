using Microsoft.Graph.Devices.Item.TransitiveMemberOf.Count;
using Microsoft.Graph.Devices.Item.TransitiveMemberOf.GraphAdministrativeUnit;
using Microsoft.Graph.Devices.Item.TransitiveMemberOf.GraphGroup;
using Microsoft.Graph.Devices.Item.TransitiveMemberOf.Item;
...
namespace Microsoft.Graph.Devices.Item.TransitiveMemberOf {
    ...
    public class TransitiveMemberOfRequestBuilder : BaseRequestBuilder {
        ...
        public TransitiveMemberOfRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/devices/{device%2Did}/transitiveMemberOf{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new TransitiveMemberOfRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TransitiveMemberOfRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/devices/{device%2Did}/transitiveMemberOf{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
