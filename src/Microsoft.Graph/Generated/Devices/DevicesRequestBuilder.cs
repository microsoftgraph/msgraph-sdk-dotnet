...
using Microsoft.Graph.Devices.ValidateProperties;
...
namespace Microsoft.Graph.Devices {
    ...
    public class DevicesRequestBuilder : BaseRequestBuilder {
        ...
        public DevicesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/devices{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new DevicesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DevicesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/devices{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Retrieve a list of device objects registered in the organization.
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/device-list?view=graph-rest-1.0" />
        /// </summary>
...
#nullable restore
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/device-post-devices?view=graph-rest-1.0" />
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.Device?> PostAsync(Microsoft.Graph.Models.Device body, CancellationToken cancellationToken = default, Action<DevicesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Device> PostAsync(Microsoft.Graph.Models.Device body, CancellationToken cancellationToken = default, Action<DevicesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Models.Device body, Action<DevicesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Models.Device body, Action<DevicesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
